...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "captcha", function() { return index; });
...
var CodemaoError = /** @class */ (function (_super) {
    ...
    function CodemaoError(options) {
        ...
        var error_code = options.error_code, _a = options.error_origin_response, error_origin_response = _a === void 0 ? {
...
// IrisInitParams;
var _initParams = {};
var getInitParams = function () { return _initParams; };
var setInitParams = function (initParams) {
    _initParams = initParams;
};
// IrisConfig
var _config = configs['prod'];
var getConfig = function () { return _config; };
var setConfig = function (config) {
    _config = config;
};
// AuthConfig
var _authConfig;
var getAuthConfig = function () { return _authConfig; };
...
var CodemaoRequest = /** @class */ (function () {
    ...
    CodemaoRequest.prototype.get_complete_url = function (url, params) {
        ...
        return Object.keys(params).length === 0
            ? "" + getConfig().host[this.hostType] + url
            : "" + getConfig().host[this.hostType] + url + "?" + params_str;
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var url = options.url, method = options.method, data = options.data, without_base_url = options.without_base_url;
                        ...
                        var request_url = without_base_url
                            ? url
                            : _this.get_complete_url(url, params);
                        ...
                        request.onreadystatechange = function handle_loaded() {
                            ...
                            if (request.status >= 200 && request.status <= 300) {
                                ...
                                try {
                                    ...
                                    if (error) {
                                        reject(new CodemaoError(__assign(__assign({}, error), { error_origin_response: response })));
                                    }
                                    else {
...
function check_register_options(options) {
    var phone_number = options.phone_number, password = options.password, captcha = options.captcha, agreement_ids = options.agreement_ids;
...
var CodemaoToken = /** @class */ (function () {
    function CodemaoToken() {
        this.request = new CodemaoRequest({
            public_headers: __assign({ 'Product-Code': getAuthConfig().product_code, Platform: getAuthConfig().platform }, PUBLIC_HEADERS),
        });
    }
...
var mergeHeaderConf = function (originalHeader, assertion, specifiedNewHeader) {
    return assertion !== false
        ? __assign(__assign(__assign({}, originalHeader), { 'X-Captcha-Id': getAuthConfig().appid || '' }), specifiedNewHeader) : originalHeader;
};
...
var CodemaoAuth = /** @class */ (function () {
    function CodemaoAuth() {
        var _a;
        this.request = new CodemaoRequest({
            public_headers: __assign(__assign({ 'Product-Code': getAuthConfig().product_code, pid: getAuthConfig().pid, Platform: getAuthConfig().platform }, PUBLIC_HEADERS), (_a = getInitParams()) === null || _a === void 0 ? void 0 : _a.custom_headers),
        });
    ...
    CodemaoAuth.prototype.dispatch_request = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(options.with_token && getInitParams().auth_version)) return [3 /*break*/, 2];
    ...
    CodemaoAuth.prototype.register_email = function (register_params, pid) {
        return __awaiter(this, void 0, void 0, function () {
            var captchaTicket, password, rePassword;
            return __generator(this, function (_a) {
                captchaTicket = register_params.captchaTicket, password = register_params.password, rePassword = register_params.rePassword;
                check_password(password);
    ...
    CodemaoAuth.prototype.send_voice_captcha = function (captcha_params, ticket, oauth_ticket) {
        return __awaiter(this, void 0, void 0, function () {
            var phone_number, type, register_res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        phone_number = captcha_params.phone_number, type = captcha_params.type;
                        check_phone_number(phone_number);
    ...
    CodemaoAuth.prototype.login_phone_silence = function (first_param, second_param, third_param, agreement_ids) {
        return __awaiter(this, void 0, void 0, function () {
            var phone_number, captcha,
            // agreement_ids = undefined,
            specific_pid, pid, login_res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        phone_number = '', captcha = '', specific_pid = '';
...
var GeetestCaptcha = /** @class */ (function (_super) {
    ...
    GeetestCaptcha.create = function (create_options, extra) {
        var dom_id = create_options.dom_id, success_callback = create_options.success_callback, fail_callback = create_options.fail_callback, close_callback = create_options.close_callback, specified_appid = create_options.product_id, init_options = create_options.init_options;
...
var SMCaptcha = /** @class */ (function (_super) {
    ...
    SMCaptcha.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(typeof initSMCaptcha === 'undefined')) return [3 /*break*/, 2];
    ...
    SMCaptcha.prototype.init_smCaptcha = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, dom_id, success_callback, fail_callback, close_callback, init_options;
            var _this = this;
            return __generator(this, function (_b) {
                _a = this.options, dom_id = _a.dom_id, success_callback = _a.success_callback, fail_callback = _a.fail_callback, close_callback = _a.close_callback, init_options = _a.init_options;
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        initSMCaptcha(__assign(__assign(__assign({ appendTo: dom_id && "#" + dom_id, appid: _this.options.product_id }, defaultSMInitOptions), init_options), { organization: 'sXoTexBWs1dfyzt8eTev' }), function (instance) {
                            if (!instance) {
                            ...
                            instance.onSuccess(function (data) { return __awaiter(_this, void 0, void 0, function () {
                                var ticket_res, error_1;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!data.pass) return [3 /*break*/, 5];
                                            _a.label = 1;
                                        case 1:
                                            _a.trys.push([1, 3, , 4]);
                                            return [4 /*yield*/, this.get_ticket()];
                                        case 2:
                                            ticket_res = (_a.sent());
                                            success_callback === null || success_callback === void 0 ? void 0 : success_callback(ticket_res.data.ticket, this.options.product_id || '');
                                            return [3 /*break*/, 4];
                                        case 3:
                                            error_1 = _a.sent();
                                            fail_callback === null || fail_callback === void 0 ? void 0 : fail_callback(fallbackParamsMaker('success_callback triggerd fatal error', error_1));
                                            return [3 /*break*/, 4];
                                        case 4: return [3 /*break*/, 6];
                                        case 5:
                                            fail_callback === null || fail_callback === void 0 ? void 0 : fail_callback(fallbackParamsMaker('incorrect captcha checking', data));
                                            _a.label = 6;
                            ...
                            instance.onError(function (errType, errMsg) {
                                ...
                                fail_callback === null || fail_callback === void 0 ? void 0 : fail_callback(errorObj);
                                reject(errorObj);
                            });
                            instance.onClose(function () {
                                close_callback === null || close_callback === void 0 ? void 0 : close_callback();
                            });
                        });
                    })];
            });
    ...
    SMCaptcha.prototype.show = function () {
        ...
        if (this.options &&
            ['embed', 'float'].includes((init_options === null || init_options === void 0 ? void 0 : init_options.product) || '')) {
    ...
    SMCaptcha.create = function (create_options, extra) {
        var dom_id = create_options.dom_id, success_callback = create_options.success_callback, fail_callback = create_options.fail_callback, close_callback = create_options.close_callback, init_options = create_options.init_options, specified_appid = create_options.product_id;
...
var CmTencentCaptcha = /** @class */ (function (_super) {
    ...
    CmTencentCaptcha.create = function (create_options, extra) {
        var dom_id = create_options.dom_id, success_callback = create_options.success_callback, fail_callback = create_options.fail_callback, close_callback = create_options.close_callback, specified_appid = create_options.product_id;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            offset = 0 -
                                (((_b = (_a = that.options) === null || _a === void 0 ? void 0 : _a.init_options) === null || _b === void 0 ? void 0 : _b.width) || defaultNeteaseInitOptions.width) /
                                    2;
                            if (!(!that.options.dom_id && !document.getElementById(WrapperId))) return [3 /*break*/, 2];
    ...
    NeteaseCaptcha.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(typeof initNECaptcha === 'undefined')) return [3 /*break*/, 2];
    ...
    NeteaseCaptcha.prototype.init_NECaptcha = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                _a = this.options, dom_id = _a.dom_id, success_callback = _a.success_callback, fail_callback = _a.fail_callback, close_callback = _a.close_callback, init_options = _a.init_options;
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        initNECaptcha(__assign(__assign(__assign({ captchaId: _this.options.product_id, element: dom_id ? "#" + dom_id : "#" + InnerId, appendTo: dom_id ? "#" + dom_id : "#" + InnerId }, defaultNeteaseInitOptions), init_options), { onVerify: function (err, data) { return __awaiter(_this, void 0, void 0, function () {
                                var ticket_res;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!err) return [3 /*break*/, 1];
                                            fail_callback === null || fail_callback === void 0 ? void 0 : fail_callback(fallbackParamsMaker('incorrect captcha checking', err));
                                            return [3 /*break*/, 3];
                                        case 1: return [4 /*yield*/, this.get_ticket(data.validate)];
                                        case 2:
                                            ticket_res = (_a.sent());
                                            success_callback === null || success_callback === void 0 ? void 0 : success_callback(ticket_res.data.ticket, this.options.product_id || '');
                                            this.clearMask();
                                ...
                                fail_callback === null || fail_callback === void 0 ? void 0 : fail_callback(fallbackParamsMaker('fatal error occurred', err));
                            }, onClose: function () {
                                close_callback === null || close_callback === void 0 ? void 0 : close_callback();
                                _this.clearMask();
                            } }), function (instance) {
...
var AliyunCaptcha = /** @class */ (function (_super) {
    ...
    function AliyunCaptcha(options) {
        ...
        _this.handleOnCancel = function () {
            _this.close_callback && _this.close_callback();
            _this.clearMask();
        };
        // 滑块验证
        _this.initNCCaptcha = function (config) {
            AWSC.use('nc', function (state, module) {
                // 初始化
                window.nc = module.init(__assign(__assign({}, config), { renderTo: aliyun_captcha_dom_id,
                    // 前端滑动验证通过时会触发该回调参数。您可以在该回调参数中将会话ID（sessionId）、签名串（sig）、请求唯一标识（token）字段记录下来，随业务请求一同发送至您的服务端调用验签。
                    success: function (data) { return __awaiter(_this, void 0, void 0, function () {
                        var ticketData;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.get_ticket(data)];
                                case 1:
                                    ticketData = _a.sent();
                                    if (ticketData.status === 200) {
                                        this === null || this === void 0 ? void 0 : this.success_callback(ticketData.data.ticket, ticketData.data.appid);
                                        this === null || this === void 0 ? void 0 : this.clearMask();
                                    }
                                    else {
                                        this.fail_callback && this.fail_callback(ticketData);
                                    }
                                    return [2 /*return*/];
                            }
                        });
                    ...
                    fail: function (failCode) {
                        _this.fail_callback && _this.fail_callback(failCode);
                        throw new Error('验证失败');
                    },
                    // 验证码加载出现异常时触发该回调参数。
                    error: function (errorCode) {
                        _this.fail_callback && _this.fail_callback(errorCode);
    ...
    AliyunCaptcha.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(typeof AWSC === 'undefined')) return [3 /*break*/, 2];
                        return [4 /*yield*/, load_script(captchaResourceUrls.ALIYUN, 'ALIYUN_GT')];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.initAliyunCaptcha()];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AliyunCaptcha.prototype.initAliyunCaptcha = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!document.getElementById(aliyun_captcha_dom_id)) return [3 /*break*/, 2];
                        return [4 /*yield*/, appendDomNode('div', {
                    ...
                    case 1:
                        ...
                        aliyunCloseBtn === null || aliyunCloseBtn === void 0 ? void 0 : aliyunCloseBtn.addEventListener('click', this.handleOnCancel);
                        _a.label = 2;
                    case 2:
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, PlatformApi.dispatch_request({
                        ...
                        method: 'post',
                        data: __assign({ appKey: aliyun_config.appkey, scene: aliyun_config.scene }, params),
                    })];
            });
        });
    };
...
var CodemaoCaptcha = /** @class */ (function () {
    ...
    CodemaoCaptcha.prototype.get_rule_from_server = function (identity, scene) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, load_script(captchaResourceUrls.FINGER_PRINT_2, 'finger-print', 10)];
                    case 1:
                        _a.sent();
    ...
    CodemaoCaptcha.prototype.get_captcha = function (options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var identity, _b, scene, success_callback, fail_callback, res, rule, appid, ticket, disableCaptcha;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        identity = options.identity, _b = options.scene, scene = _b === void 0 ? '' : _b, success_callback = options.success_callback, fail_callback = options.fail_callback;
                    ...
                    case 1:
                        ...
                        if (res) {
                            ...
                            if (Object.keys(captchaResourceUrls).includes(rule)) {
                                ...
                                if (appid) {
                                    // 根据策略执行对应的算法
                                    return [2 /*return*/, (_a = strategyTargetSelector(rule)) === null || _a === void 0 ? void 0 : _a.create(options, { appid: appid })];
                                }
                            }
                            else {
...
function init$1(options) {
    var env = options.env, domain = options.domain, _a = options.auth_version, _b = options.pid, _c = options.client_id, requestTimeout = options.requestTimeout, host = options.host;
    if (env) {
        if (configs[env]) {
