...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__crc_iframe_api__ = __webpack_require__("JrJq");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__crc_iframe_api___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__crc_iframe_api__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__cfg__ = __webpack_require__("dpNx");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__sensorsData__ = __webpack_require__("yI2H");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__api_login__ = __webpack_require__("yshM");
...
function getCurrentEnvironment() {
    switch (Object(__WEBPACK_IMPORTED_MODULE_5__cfg__["a" /* config */])().env) {
        case 'dev':
            return 'development';
        case 'test':
            return 'test';
...
var SignInDialogView = function (_React$Component) {
    ...
    _createClass(SignInDialogView, [{
        ...
        value: function componentDidMount() {
            ...
            this._api = Object(__WEBPACK_IMPORTED_MODULE_1__crc_iframe_api__["createCodemaoLoginIframeApi"])({
                onEvent: function onEvent(payload) {
                    // console.log('收到事件:', payload);
                    switch (payload.event) {
                        case 'IFRAME_READY':
                            _this2.setState({ iframeReady: true });
                        ...
                        case 'CLOSE_ANIMATION_END':
                            ...
                            _this2.setState({ iframeReady: false });
                            break;
                        case 'REPORT':
                            break;
                        default:
        ...
        value: function componentDidUpdate() {
            ...
            var _props = this.props,
                signDialogVisible = _props.signDialogVisible,
                setSignDialogVisibleAction = _props.setSignDialogVisibleAction,
                setCommonToastAction = _props.setCommonToastAction;
            ...
            if (signDialogVisible && !this.state.iframeReady) {
                this.timer = setTimeout(function () {
                    ...
                    _this3.setState({ iframeReady: false });
                }, 5000);
            }
        }
    }, {
                        ...
                        switch (_context.prev = _context.next) {
                            case 0:
                                if (closeDialogFirst) {
                                    ...
                                    this.setState({ iframeReady: false });
                                }
                                _context.prev = 1;
                                _context.next = 4;
                                return Object(__WEBPACK_IMPORTED_MODULE_7__api_login__["a" /* getAccountProfile */])();
                            ...
                            case 4:
                                ...
                                // 神策用户关联
                                Object(__WEBPACK_IMPORTED_MODULE_6__sensorsData__["b" /* sensorsLoginReport */])(data.id);
                                if (loginMethod) {
                                    Object(__WEBPACK_IMPORTED_MODULE_6__sensorsData__["a" /* sensorsCustomReport */])('LoginResult', {
        ...
        value: function render() {
            ...
            var iframeUrl = Object(__WEBPACK_IMPORTED_MODULE_1__crc_iframe_api__["getCodemaoLoginIframeUrl"])({
                ...
                theme: 'violet',
                pageView: 'login',
                pid: Object(__WEBPACK_IMPORTED_MODULE_5__cfg__["a" /* config */])().pid,
                productCode: Object(__WEBPACK_IMPORTED_MODULE_5__cfg__["a" /* config */])().productCode
            });
            return signDialogVisible ? __WEBPACK_IMPORTED_MODULE_2_react__["createElement"]("div", { styleName: __WEBPACK_IMPORTED_MODULE_4_classnames___default()('wrapper', this.state.iframeReady && 'ready') }, __WEBPACK_IMPORTED_MODULE_2_react__["createElement"]("iframe", { allow: "autoplay; fullscreen; clipboard-read; clipboard-write; encrypted-media; microphone; geolocation; camera", ref: this._iframeRef, src: iframeUrl, style: {
                    border: 'none',
                    width: '100%',
                    height: '100%',
                    overflow: 'hidden',
                    display: this.state.iframeReady ? 'block' : 'none'
                }, title: "codemao-login iframe" })) : null;
        }
    }]);

    return SignInDialogView;
}(__WEBPACK_IMPORTED_MODULE_2_react__["Component"]);
SignInDialogView = __decorate([__WEBPACK_IMPORTED_MODULE_3_react_css_modules__(styles, { allowMultiple: true })], SignInDialogView);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_antd__ = __webpack_require__("nFWT");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_classnames__ = __webpack_require__("HW6M");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__IconFont__ = __webpack_require__("zVV7");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__api_login__ = __webpack_require__("yshM");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__sensorsData__ = __webpack_require__("yI2H");
...
var HeaderView = function (_React$Component) {
    ...
    _createClass(HeaderView, [{
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.prev = 0;
                                _context.next = 3;
                                return Object(__WEBPACK_IMPORTED_MODULE_6__api_login__["b" /* loginOut */])();
        ...
        value: function renderUserInfo(userInfo) {
            if (userInfo) {
                return __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", null, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"](__WEBPACK_IMPORTED_MODULE_3_antd__["b" /* Dropdown */], { overlay: __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: 'dropdown' }, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: "dropdownItem", onClick: function onClick() {
                            return window.open(Object(__WEBPACK_IMPORTED_MODULE_8__utils_url__["a" /* getCommunityAccountSettingUrl */])(), '_blank');
                        } }, "\u8D26\u53F7\u8BBE\u7F6E"), __WEBPACK_IMPORTED_MODULE_1_react__["createElement"](__WEBPACK_IMPORTED_MODULE_3_antd__["b" /* Dropdown */], { overlay: __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: "dropdown agreementDropdown" }, serviceAgreementList.map(function (item, index) {
                        ...
                        })), placement: "topLeft" }, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: "dropdownItem" }, "\u670D\u52A1\u534F\u8BAE", __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("span", { className: styles.subMenuArrow }, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"](__WEBPACK_IMPORTED_MODULE_5__IconFont__["a" /* default */], { type: "icon-dropdown-down" })))), __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: 'dropdownItem', onClick: this.handleLoginOut }, "\u9000\u51FA\u767B\u5F55")), trigger: ['click'] }, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: 'userInfo' }, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: 'userAvatar', style: { backgroundImage: "url(" + userInfo.avatar + ")" } }), __WEBPACK_IMPORTED_MODULE_1_react__["createElement"](__WEBPACK_IMPORTED_MODULE_5__IconFont__["a" /* default */], { type: 'icon-dropdown-down', styleName: 'iconDown' }))));
            }
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: 'header' }, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: 'left' }, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("img", { src: 'https://creation.codemao.cn/coco/home/logo.png', styleName: 'logoImg', alt: "" }), __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: 'iconItem' }, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"](__WEBPACK_IMPORTED_MODULE_3_antd__["b" /* Dropdown */], { overlay: __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: 'dropdown' }, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: __WEBPACK_IMPORTED_MODULE_4_classnames___default()('dropdownItem', (!userInfo || userInfo.isNewUser || courseListVisible) && 'disabled'), onClick: this.handleShowCourse }, "\u5165\u95E8\u6559\u7A0B"), __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: 'dropdownItem', onClick: this.handleDocument }, "\u5E2E\u52A9\u6587\u6863")), onVisibleChange: this.handleHelpDropdownVisibleChange, visible: helpDropdownVisible, trigger: ['click'] }, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", null, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"](__WEBPACK_IMPORTED_MODULE_5__IconFont__["a" /* default */], { type: 'icon-help' }), __WEBPACK_IMPORTED_MODULE_1_react__["createElement"](__WEBPACK_IMPORTED_MODULE_5__IconFont__["a" /* default */], { type: 'icon-dropdown-down', styleName: 'iconDown' })))), __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { styleName: 'iconItem', onClick: this.handleFeedback }, __WEBPACK_IMPORTED_MODULE_1_react__["createElement"](__WEBPACK_IMPORTED_MODULE_5__IconFont__["a" /* default */], { type: 'icon-feedback' }))), this.renderUserInfo(userInfo));
        }
    }]);
...
// removed by extract-text-webpack-plugin
module.exports = {"wrapper":"wrapper_1SK8O","ready":"ready_3Gvez"};
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getAccountProfile;
/* harmony export (immutable) */ __webpack_exports__["b"] = loginOut;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__ = __webpack_require__("Xxa5");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__);
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(signInHost + '/tiger/v3/web/accounts/profile', {
                            withCredentials: true
                        });
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        _context2.next = 2;
                        return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(signInHost + '/tiger/v3/web/accounts/logout', {}, {
                            withCredentials: true
                        });
