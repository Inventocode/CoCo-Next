...
var Gesture = /** @class */ (function () {
    function Gesture(o) {
         ...
         */
        this.mouse_down_xy = gl_matrix_1.vec2.create();
        /**
         * How far the mouse has moved during this drag, in pixel units.
         * (0, 0) is at protected mouseDownXY_.
         */
        this.current_drag_delta_xy = gl_matrix_1.vec2.create();
        /**
     ...
     */
    Gesture.prototype.update_from_event = function (e) {
        var current_xy = gl_matrix_1.vec2.fromValues(e.clientX, e.clientY);
        var changed = this.update_drag_delta(current_xy);
     ...
     *     first time.
     */
    Gesture.prototype.update_drag_delta = function (current_xy) {
        gl_matrix_1.vec2.sub(this.current_drag_delta_xy, current_xy, this.mouse_down_xy);
        if (!this.has_exceeded_drag_radius) {
            var current_drag_delta = gl_matrix_1.vec2.sqrLen(this.current_drag_delta_xy);
            // The flyout has a different drag radius from the rest of Editor.
            var limit_radius = this.flyout_ ?
                this.theme.blink_params.FLYOUT_DRAG_RADIUS :
                this.theme.blink_params.DRAG_RADIUS;
     ...
     */
    Gesture.prototype.update_is_dragging_from_flyout = function () {
        // Disabled blocks may not be dragged from the flyout.
        if (!this.target_block || this.target_block.disabled || !(0, base_1.is_block_svg)(this.target_block)) {
            return false;
        }
        if ((this.flyout_ && !this.flyout_.is_scrollable()) ||
            ...
            this.start_block = undefined;
            this.target_block = this.flyout_.create_block(this.target_block, false, gl_matrix_1.vec2.fromValues(this.mouse_down_xy[0], this.mouse_down_xy[1]));
            if (this.target_block != undefined) {
                this.target_block.select();
                if ((0, base_1.is_block_svg)(this.target_block)) {
     ...
     */
    Gesture.prototype.update_is_dragging_block = function () {
     ...
     */
    Gesture.prototype.update_is_dragging_workspace = function () {
     ...
     * drag radius is exceeded.  It should be called no more than once per gesture.
     */
    Gesture.prototype.update_is_dragging = function () {
    ...
    Gesture.prototype.update_is_mutation_click = function (is_click) {
        this.is_mutation_click = is_click;
    };
    /**
     * Create a block dragger and start dragging the selected block.
     */
    Gesture.prototype.start_dragging_block = function () {
     ...
     */
    Gesture.prototype.do_start = function (e) {
        if ((0, event_1.is_target_input)(e)) {
            this.cancel();
            return;
        }
        if (this.start_workspace == undefined) {
        ...
        if ((0, event_1.is_right_button)(e)) {
            this.handle_right_click(e);
            return;
        }
        if ((0, string_1.case_insensitive_equals)(e.type, 'touchstart')) {
            this.touch_manager.long_start(e, this);
        }
        this.mouse_down_xy = gl_matrix_1.vec2.fromValues(e.clientX, e.clientY);
     ...
     * @param e A mouse down or touch start event.
     */
    Gesture.prototype.bind_mouse_events = function (e) {
     ...
     */
    Gesture.prototype.handle_move = function (e) {
     ...
     */
    Gesture.prototype.handle_up = function (e) {
        if (this.is_ending) {
     ...
     * @param e A mouse move or touch move event.
     */
    Gesture.prototype.handle_right_click = function (e) {
        if (this.target_block) {
            this.bring_block_to_front();
            this.utils.hide_chaff(!!this.flyout_);
            this.target_block.show_context_menu(e);
        }
        else if (this.start_workspace && !this.flyout_) {
     ...
     */
    Gesture.prototype.handle_ws_start = function (e, ws) {
     ...
     */
    Gesture.prototype.handle_flyout_start = function (e, flyout) {
        if (this.has_started_) {
            return;
        }
     ...
     */
    Gesture.prototype.handle_block_start = function (e, block) {
        if (this.has_started_) {
            return;
        }
     ...
     */
    Gesture.prototype.do_field_click = function (e) {
        ...
        if (this.events.is_enabled()) {
            this.events.fire(this.ui_event_factory({
                type: interfaces_1.UIEventType.CLICK,
     ...
     */
    Gesture.prototype.do_block_click = function () {
        if (!(0, base_1.is_block_svg)(this.start_block) ||
            !(0, base_1.is_block_svg)(this.target_block)) {
            return;
        }
        var current_group = this.events.get_group();
        ...
        if (this.flyout_ && this.flyout_.is_auto_close()) {
            if (this.target_block != undefined && !this.target_block.disabled) {
                this.events.set_group(current_group || true);
                var new_block = this.flyout_.create_block(this.target_block, true, gl_matrix_1.vec2.fromValues(this.mouse_down_xy[0], this.mouse_down_xy[1]));
                new_block.select();
            ...
            if (!field_editing) {
                if (this.events.is_enabled()) {
                    ...
                    this.events.fire(this.ui_event_factory({
                        type: interfaces_1.UIEventType.STACK_CLICK,
                        workspace_id: workspace_id,
     ...
     */
    Gesture.prototype.do_workspace_click = function () {
    ...
    * of target. */
     ...
     */
    Gesture.prototype.bring_block_to_front = function () {
     ...
     */
    Gesture.prototype.set_start_field = function (field) {
        // if (!!this.has_started_) {
     ...
     */
    Gesture.prototype.set_start_block = function (block) {
        var _a;
        ...
        if ((0, base_1.is_block_svg)(block) && ((_a = block.parent_block) === null || _a === void 0 ? void 0 : _a.element_type) === 'param_color' && block.is_shadow()) {
            block = block.parent_block;
        }
        this.start_block = block;
        if ((0, base_1.is_block_svg)(block) && block.is_in_flyout && block != block.get_root_block()) {
            this.should_duplicate_on_drag = false;
     ...
     */
    Gesture.prototype.set_target_block = function (block) {
        if ((0, base_1.is_block_svg)(block) && block.is_shadow() && !this.should_duplicate_on_drag) {
     ...
     */
    Gesture.prototype.set_start_workspace = function (ws) {
        if (!this.start_workspace) {
     ...
     */
    Gesture.prototype.set_start_flyout = function (flyout) {
        if (!this.flyout_) {
            this.flyout_ = flyout;
        }
    };
    Gesture.prototype.is_start_from_flyout = function () {
        return !!this.flyout_;
    };
    /**
     ...
     */
    Gesture.prototype.is_block_click = function () {
     ...
     */
    Gesture.prototype.is_field_click = function () {
        var fieldEditable = this.start_field ?
            this.start_field.is_currently_editable() : false;
        return fieldEditable && !this.has_exceeded_drag_radius;
    };
    /**
     ...
     */
    Gesture.prototype.is_workspace_click = function () {
     ...
     */
    Gesture.prototype.is_dragging = function () {
     ...
     * @return whether this gesture was a click on a workspace.
     */
    Gesture.prototype.has_started = function () {
     ...
     */
    Gesture.prototype.force_start_block_drag = function (fakeEvent, block) {
     ...
     */
    Gesture.prototype.duplicate_on_drag = function () {
    ...
    ], Gesture.prototype, "events", void 0);
    (0, tslib_1.__decorate)([
        (0, di_1.lazy_inject)(di_1.BINDING.runtime_data)
    ], Gesture.prototype, "runtime_data", void 0);
    (0, tslib_1.__decorate)([
        (0, di_1.lazy_inject)(di_1.BINDING.touch_manager)
    ], Gesture.prototype, "touch_manager", void 0);
    (0, tslib_1.__decorate)([
        (0, di_1.lazy_inject)(di_1.BINDING.utils)
    ], Gesture.prototype, "utils", void 0);
    (0, tslib_1.__decorate)([
        (0, di_1.lazy_inject)(di_1.BINDING.widget_div)
    ], Gesture.prototype, "widget_div", void 0);
    (0, tslib_1.__decorate)([
        (0, di_1.lazy_inject)(di_1.BINDING.xml)
    ], Gesture.prototype, "xml", void 0);
    (0, tslib_1.__decorate)([
        (0, di_1.lazy_inject)(di_1.BINDING.theme)
    ], Gesture.prototype, "theme", void 0);
    (0, tslib_1.__decorate)([
        (0, di_1.lazy_inject)(di_1.BINDING.CreateEvent)
    ], Gesture.prototype, "create_event_factory", void 0);
    (0, tslib_1.__decorate)([
        (0, di_1.lazy_inject)(di_1.BINDING.UIEvent)
    ], Gesture.prototype, "ui_event_factory", void 0);
    (0, tslib_1.__decorate)([
        (0, di_1.lazy_inject)(di_1.BINDING.WorkspaceElementDragger)
    ], Gesture.prototype, "element_dragger_factory", void 0);
    (0, tslib_1.__decorate)([
        (0, di_1.lazy_inject)(di_1.BINDING.WorkspaceDragger)
    ], Gesture.prototype, "workspace_dragger_factory", void 0);
    Gesture = (0, tslib_1.__decorate)([
