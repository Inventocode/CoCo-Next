...
function register_procedure_blocks(blink, procedure_manager, on_procedure_name_click, on_add_param_click) {
    ...
    blink.define_block_with_object(constants_1.PROCEDURE_BLOCK_TYPES.DEF, {
        init: function () {
            ...
            var name_field = field_textinput_factory({
                text: proc_name,
                opt_validator: function (new_name) {
            ...
            if (!this.is_in_flyout && !this.is_insertion_marker()) {
                name_field.on_mouse_down = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                    var block_id, new_name, block, ori_name, proc, old_name;
            ...
            this.append_dummy_input('PROCEDURES_2_DEFNORETURN_DEFINE')
                .append_field(icon)
                .append_field(blink.Msg.PROCEDURES_DEFNORETURN_TITLE)
            ...
            this.append_dummy_input(constants_1.PROCEDURE_BLOCK_INPUT_NAMES.DEF_MUTATOR)
        ...
        addMutation: function (new_param_name) {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
                var block_id, param_default_value, promise, block, _procedure_manager, proc, params, index, input, param_block, block_input, current_group;
                return (0, tslib_1.__generator)(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            block_id = this.id;
                            param_default_value = undefined;
                            if (!(typeof new_param_name !== 'string' || !new_param_name)) return [3 /*break*/, 2];
                            return [4 /*yield*/, on_add_param_click.call(this, block_id)];
                        case 1:
                            promise = _a.sent();
                            new_param_name = promise === null || promise === void 0 ? void 0 : promise.param_name;
                            param_default_value = promise === null || promise === void 0 ? void 0 : promise.default_value;
                            _a.label = 2;
                        case 2:
                            if (!new_param_name) {
                                return [2 /*return*/];
        ...
        removeMutation: function () {
            ...
            var params = (_a = _procedure_manager.get_procedure_by_name(proc_name)) === null || _a === void 0 ? void 0 : _a.params;
    ...
    blink.define_block_with_object(constants_1.PROCEDURE_BLOCK_TYPES.RETURN, {
        init: function () {
            this.append_dummy_input('PROCEDURES_2_DEFRETURN_RETURN')
            ...
            this.append_dummy_input(constants_1.PROCEDURE_BLOCK_INPUT_NAMES.RETURN_MUTATOR)
        ...
        addMutation: function (new_value) {
            var _a;
    ...
    var call_block_mutations = {
        ...
        */
        ...
        domToMutation: function (xml_element) {
            var _a;
            var _procedure_manager = (0, base_1.is_func)(procedure_manager) ? procedure_manager() : procedure_manager;
    ...
    blink.define_block_with_object(constants_1.PROCEDURE_BLOCK_TYPES.CALL_RETURN, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, call_block_mutations), { init: function () {
            call_block_mutations.build_inputs.call(this);
            this.set_output(true);
            this.set_inputs_inline(true);
            this.set_colour(blink.theme.block_color.ORANGE_4.fill);
        } }));
    blink.define_block_with_object(constants_1.PROCEDURE_BLOCK_TYPES.CALL_NORETURN, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, call_block_mutations), { init: function () {
            call_block_mutations.build_inputs.call(this);
            this.set_previous_statement(true);
...
exports.register_procedure_blocks = register_procedure_blocks;
