...
import /* [auto-meaningful-name] */$$_$$_unrestored_about_64_301 from "../../unrestored/about/64/30"
import * as /* [auto-meaningful-name] */$_styles$module from "./styles.module"
import /* [auto-meaningful-name] */$_styles$module1 from "./styles.module"
...
var y = function () {
  ...
  return React_jsxRuntime.jsxs("div", {
    className: $_styles$module1.pageWrapper,
    children: [
      React_jsxRuntime.jsxs("div", {
        className: $$_$$_unrestored_about_64_301($_styles$module1.flexTC, $_styles$module1.bannerBox),
        children: [
          React_jsxRuntime.jsx("img", {
            className: $_styles$module1.bannerLeftBg,
            src: "https://static.codemao.cn/coco/image/about_page_left_banner.png",
            alt: ""
          }), React_jsxRuntime.jsx("img", {
            className: $_styles$module1.bannerRightBg,
            src: "https://static.codemao.cn/coco/image/about_page_right_banner.png",
            alt: ""
          }), React_jsxRuntime.jsx("div", {
            className: $_styles$module1.left
          }), React_jsxRuntime.jsxs("div", {
            className: $_styles$module1.bannerContent,
            children: [
              React_jsxRuntime.jsx("div", {
                className: $_styles$module1.bannerLogoBox,
                children: React_jsxRuntime.jsx("img", {
                  className: $_styles$module1.bannerLogoImg,
                  src: "https://static.codemao.cn/coco/image/about_page_logo_new.png",
                  alt: "logo"
                })
              }), React_jsxRuntime.jsxs("div", {
                className: $_styles$module1.bannerText,
                children: [
                  React_jsxRuntime.jsx("img", {
                    className: $_styles$module1.quotesLeft,
                    ...
                    className: $_styles$module1.quotesRight,
                ...
                className: $_styles$module1.bannerTexSpeech,
                children: "—— prince"
              })
            ]
          }), React_jsxRuntime.jsx("div", {
            className: $_styles$module1.right
          })
        ]
      }), React_jsxRuntime.jsxs("div", {
        className: $$_$$_unrestored_about_64_301($_styles$module1.flexTC, $_styles$module1.courseAndFamilyBox),
        children: [
          React_jsxRuntime.jsx("div", {
            className: $_styles$module1.left
          }), React_jsxRuntime.jsxs("div", {
            className: $_styles$module1.courseAndFamilyContent,
            children: [
              React_jsxRuntime.jsx("h3", {
                className: $_styles$module1.courseTitle,
                children: $$_$$_unrestored_about_64_71_index$a$formatMessage({
                  id: "about.toolCourse"
                })
              }), React_jsxRuntime.jsxs("div", {
                className: $_styles$module1.courseList,
                children: [
                  React_jsxRuntime.jsx("div", {
                    className: $_styles$module1.courseUpList,
                    children: h.map(function (e) {
                      return React_jsxRuntime.jsxs("div", {
                        className: $$_$$_unrestored_about_64_301($_styles$module1.courseItem, $_styles$module1.courseUpItem),
                        children: [
                          React_jsxRuntime.jsx("img", {
                            className: $_styles$module1.courseUpImg,
                            src: "https://static.codemao.cn/coco/image/about_page_timeline_up.png",
                            alt: ""
                          }), React_jsxRuntime.jsxs("div", {
                            className: $_styles$module1.courseText,
                            children: [
                              React_jsxRuntime.jsx("p", {
                                className: $_styles$module1.courseItemTitle,
                                children: e.time
                              }), React_jsxRuntime.jsx("p", {
                                className: $_styles$module1.courseItemDesc,
                                children: e.desc
                              })
                            ]
                          })
                    ...
                    className: $_styles$module1.courseTimeline,
                    children: React_jsxRuntime.jsx("img", {
                      className: $_styles$module1.courseTimelineImg,
                      src: "https://static.codemao.cn/coco/image/about_page_timeline.png",
                      alt: ""
                    })
                  }), React_jsxRuntime.jsx("div", {
                    className: $_styles$module1.courseDownList,
                    children: f.map(function (e) {
                      return React_jsxRuntime.jsxs("div", {
                        className: $$_$$_unrestored_about_64_301($_styles$module1.courseItem, $_styles$module1.courseDownItem),
                        children: [
                          React_jsxRuntime.jsx("img", {
                            className: $_styles$module1.courseDownImg,
                ...
                className: $_styles$module1.familyTitle,
                children: $$_$$_unrestored_about_64_71_index$a$formatMessage({
                  id: "about.familyPhoto"
                })
              }), React_jsxRuntime.jsxs("div", {
                className: $_styles$module1.familyBox,
                children: [
                  React_jsxRuntime.jsx("div", {
                    className: $_styles$module1.familyImgBox,
                    children: React_jsxRuntime.jsx("img", {
                      className: $_styles$module1.familyPhotoImg,
                      src: "https://static.codemao.cn/coco/image/about_page_family.png",
                      alt: "family"
                    })
                  }), React_jsxRuntime.jsx("div", {
                    className: $_styles$module1.familyIconBox,
                    children: React_jsxRuntime.jsx("img", {
                      className: $_styles$module1.familyLikeImg,
        ...
        className: $$_$$_unrestored_about_64_301($_styles$module1.flexTC, $_styles$module1.TeamBox),
        children: [
          React_jsxRuntime.jsx("div", {
            className: $_styles$module1.left
          }), React_jsxRuntime.jsxs("div", {
            className: $_styles$module1.teamContent,
            children: [
              React_jsxRuntime.jsx("div", {
                className: $_styles$module1.thanksText,
                children: "— Thanks —"
              }), x.map(function (e) {
                return React_jsxRuntime.jsxs("div", {
                  className: $_styles$module1.teamItem,
                  children: [
                    React_jsxRuntime.jsx("img", {
                      className: $_styles$module1.teamIcon,
                      src: e.icon,
                      alt: ""
                    }), React_jsxRuntime.jsxs("div", {
                      className: $_styles$module1.itemDetail,
                      children: [
                        React_jsxRuntime.jsx("p", {
                          className: $_styles$module1.itemPosition,
                          children: e.position
                        }), React_jsxRuntime.jsx("p", {
                          className: $_styles$module1.itemMember,
                          children: e.member
                        })
                      ]
                    })
