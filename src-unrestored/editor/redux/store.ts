...
import * as /* [auto-meaningful-name] */$_common_actions from "./common/actions"
    ...
    for (;;) {
      switch (n.prev = n.next) {
        case 0:
          e$payload = e.payload
          n.next = 3
          return $$_$$_$$_unrestored_shared_1571_2636_48_3_index.e($_common_actions.ej(e.payload))
        case 3:
          if (!e$payload) {
            n.next = 9
            break
        ...
        case 9:
          ...
          n.next = 12
          return $$_$$_$$_unrestored_shared_1571_2636_48_3_index.e($_common_actions.Gf())
        case 12:
          n.next = 14
    ...
    for (;;) {
      switch (e.prev = e.next) {
        ...
        case 3:
          e$sent = e.sent
          e.next = 6
          return $$_$$_$$_unrestored_shared_1571_2636_48_3_index.e($_common_actions.gi(e$sent))
        case 6:
          e.next = 10
          break
        case 8:
    ...
    for (;;) {
      switch (e.prev = e.next) {
        ...
        case 3:
          e$sent = e.sent
          e.next = 6
          return $$_$$_$$_unrestored_shared_1571_2636_48_3_index.e($_common_actions.bj(e$sent))
        case 6:
          e.next = 10
          break
        case 8:
...
var bl
var yl = qn((ll = {}, $$_$$_$$_unrestored_shared_1571_2636_11.a(ll, $_common_actions.wb, gl), $$_$$_$$_unrestored_shared_1571_2636_11.a(ll, $_common_actions.S, _l), $$_$$_$$_unrestored_shared_1571_2636_11.a(ll, $_common_actions.W, vl), ll))
function El() {
  return RegeneratorRuntime.wrap(function (e) {
    for (;;) {
      switch (e.prev = e.next) {
        case 0:
          e.next = 2
          return $$_$$_$$_unrestored_shared_1571_2636_48_3_index.g([$_common_actions.wb], yl)
        case 2:
          e.next = 4
          return $$_$$_$$_unrestored_shared_1571_2636_48_3_index.g([$_common_actions.S], yl)
        case 4:
          e.next = 6
          return $$_$$_$$_unrestored_shared_1571_2636_48_3_index.g([$_common_actions.W], yl)
        case 6:
        case "end":
          return e.stop()
      }
