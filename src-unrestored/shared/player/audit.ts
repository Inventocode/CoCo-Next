...
import * as /* [auto-meaningful-name] */$$_widget_custom_shop from "../widget/custom/shop"
function s(e) {
      ...
      for (;;) {
        switch (e.prev = e.next) {
          ...
          case 7:
            ...
            u = 100
            e.next = 13
            return $$_widget_custom_shop.e(l, u)
          case 13:
...
function d() {
  return (d = $$_$$_$$_unrestored_shared_1571_2636_7.a(RegeneratorRuntime1.mark(function e() {
    var /* [auto-meaningful-name] */e$sent
    var /* [auto-meaningful-name] */e$sent1
    return RegeneratorRuntime1.wrap(function (e) {
      for (;;) {
