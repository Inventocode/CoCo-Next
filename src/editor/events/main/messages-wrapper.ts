...
export { wrapOpenSignInDialog as Ch }
...
export { wrapAsyncSaveProject as tg }
...
export function wrapShowCommonToastInfo(payload: {
...
export function wrapOpenConfirmDialog(payload: {
  title: string
...
export function wrapOpenSignInDialog(onSuccess?: () => void) {
  return {
...
export function wrapAsyncGetProjectError(data) {
  return {
    payload: {
      code: data.code
    },
...
export function wrapAsyncSaveProject({
