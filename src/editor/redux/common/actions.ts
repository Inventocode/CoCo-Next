...
export { updateExtensionWidgetListAction as Rj }
export { SHOW_COMMON_TOAST_INFO as re }
export { showCommonToastInfoAction as mj }
...
export { openSignInDialogAction as Ch }
...
export { asyncSaveProjectAction as tg }
...
export function updateExtensionWidgetListAction() {
  return {
    payload: undefined,
...
export function closeProjectDialogAction() {
  return {
...
export function openSignInDialogAction(onSuccess?: () => void) {
  return {
...
export function asyncGetProjectErrorAction(data) {
  return {
    payload: {
      code: data.code
    },
...
export function asyncSaveProjectAction({
  isUpdate, isAutoSave, isNeedReport, isSaveAs
}: {
  isUpdate: boolean
  isAutoSave: boolean
