...
import * as /* [auto-meaningful-name] */Module_542 from "../../../../../unrestored/shared/1571/2636/542"
...
import PreviewAreaStyles from "../styles.module.css"

var iv = [require("../../../../../unrestored/shared/1571/2636/543").a, Module_542.a, "UNSAFE_EXTENSION_KANO_WAND_WIDGET"]
    ...
    >
      <div
        ...
        onClick={() => {
          ...
          const stageElement = document.querySelector(`.${PreviewAreaStyles.stage}`)
          const appZoneElement = document.querySelector(`.${PreviewAreaStyles.appZone}`)
