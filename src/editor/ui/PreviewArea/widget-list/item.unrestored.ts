...
var av = memo(function (e) {
  ...
  var B = true
  if (!(e$type !== Widget_builtIn_types.a && e$type !== Widget_builtIn_types.c || !s)) {
    B = s.widgetIds.some(function (e) {
      var t
      return (null === (t = Module_9.Bb(e)) || undefined === t ? undefined : t.type) === Widget_builtIn_types.f
    })
  }
  var F = function () {
        ...
        for (;;) {
          switch (e.prev = e.next) {
            case 0:
              ...
              e.next = 3
              return Shared_widget_custom_shop.g([e$widgetServerId])
            case 3:
              if (e.sent) {
  ...
  return React.createElement(Module_1213.a, {
    ...
    onDragStart: function (e) {
      if (!B || !D) {
        ...
        c(Redux_common_actions.xj(t))
        return void e.preventDefault()
      }
      if (!(e$type !== Widget_builtIn_types.a && e$type !== Widget_builtIn_types.c)) {
        c(Redux_common_actions.Yh(true))
      }
      ...
      if (e$target && e$target.dataset.widgetType && s) {
        ...
        e.dataTransfer.setData("widget/action", Widget_builtIn_types.r.CREATE)
      }
    },
    onDragEnd: function () {
      if (!(e$type !== Widget_builtIn_types.a && e$type !== Widget_builtIn_types.c)) {
        c(Redux_common_actions.Yh(false))
      }
    },
...
var sv = memo(function (e) {
  ...
  return e$configList.length ? React.createElement("div", {
    ...
    return !e.isDiscard && React.createElement(av, {
      ...
      isMallExtensionWidget: Shared_widget_custom_type.e(e$type),
