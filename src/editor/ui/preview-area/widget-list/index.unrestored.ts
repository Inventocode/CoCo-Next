...
import /* [auto-meaningful-name] */Stage_style_css from /* 279 */"../stage/style.css"
...
var wv = React.memo(function () {
  ...
  return e$visible ? React.createElement("div", {
    className: Stage_style_css.toastWrapper
  }, React.createElement("span", {
    className: Stage_style_css.toast
  }, i && React.createElement(Shared_ui_components_index.j, {
    type: "icon-alert-success",
    className: Stage_style_css.icon
  }), r)) : null
})
...
var Sv = React.memo(function () {
  ...
  return React.createElement("div", {
    ...
    className: Stage_style_css.body
    ...
    className: Stage_style_css.main,
    ref: n
