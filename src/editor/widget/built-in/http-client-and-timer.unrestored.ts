...
import * as /* [auto-meaningful-name] */Types from /* 5 */"./types"
  ...
  blockDeclareGroup: {
    ...
    setBlockGroupProfile: function (e, t) {
      var n = {
        ...
        custom: true,
        options: function () {
          return Module_46.c().getWidgetListByType(Types.J)
        }
      }
  ...
  blockDeclareGroup: {
    ...
    setBlockGroupProfile: function (e, t) {
      var n = {
        ...
        custom: true,
        options: function () {
          return Module_46.c().getWidgetListByType(Types.u)
        }
      }
