...
const blockConfig: Widget.BlockConfig = {
  ...
  getTemplate(widgetId) {
    ...
    return [
      ...
      // [CoCo Next] 显示隐藏的 http 积木
      `<block type="http_send_delete_request" uncache="true">${widgetIdField}</block>`,
      `<block type="http_send_put_request" uncache="true">
        ${widgetIdField}
        <value name="VALUE">
          <shadow type="text">
            <field name="TEXT"></field>
      ...
      `<block type="http_send_patch_request" uncache="true">
        ${widgetIdField}
        <value name="VALUE">
          <shadow type="text">
            <field name="TEXT"></field>
