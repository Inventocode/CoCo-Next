...
import * as __WEBPACK_IMPORTED_MODULE_0_redux_actions__ from /* sTbe */"redux-actions" // 我创建的
var SET_CREATE_WORK_OFFSET_ACTION = "work/set_create_work_offset"
var setCreateWorkOffsetAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(SET_CREATE_WORK_OFFSET_ACTION)
var SET_CREATE_WORK_IS_LOADED_ACTION = "work/set_create_work_is_loaded"
var setCreateWorkIsLoadedAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(SET_CREATE_WORK_IS_LOADED_ACTION)
var GET_CREATE_WORK_LIST_ACTION = "work/get_create_work_list"
var getCreateWorkListAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(GET_CREATE_WORK_LIST_ACTION)
var SET_CREATE_WORK_LIST_ACTION = "work/set_create_work_list"
var setCreateWorkListAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(SET_CREATE_WORK_LIST_ACTION)
// 我参与的
var SET_COLL_WORK_OFFSET_ACTION = "work/set_coll_work_offset"
var setCollWorkOffsetAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(SET_COLL_WORK_OFFSET_ACTION)
var SET_COLL_WORK_IS_LOADED_ACTION = "work/set_coll_work_is_loaded"
var setCollWorkIsLoadedAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(SET_COLL_WORK_IS_LOADED_ACTION)
var GET_COLL_WORK_LIST_ACTION = "work/get_coll_work_list"
var getCollWorkListAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(GET_COLL_WORK_LIST_ACTION)
var SET_COLL_WORK_LIST_ACTION = "work/set_coll_work_list"
var setCollWorkListAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(SET_COLL_WORK_LIST_ACTION)
// 回收站作品
var SET_DELETE_WORK_OFFSET_ACTION = "work/set_delete_work_offset"
var setDeleteWorkOffsetAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(SET_DELETE_WORK_OFFSET_ACTION)
var SET_DELETE_WORK_IS_LOADED_ACTION = "work/set_delete_work_is_loaded"
var setDeleteWorkIsLoadedAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(SET_DELETE_WORK_IS_LOADED_ACTION)
var GET_DELETE_WORK_LIST_ACTION = "work/get_delete_work_list"
var getDeleteWorkListAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(GET_DELETE_WORK_LIST_ACTION)
var SET_DELETE_WORK_LIST_ACTION = "work/set_delete_work_list"
var setDeleteWorkListAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(SET_DELETE_WORK_LIST_ACTION)
// 作品重命名
var RENAME_WORK_ACTION = "work/rename_work"
var renameWorkAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(RENAME_WORK_ACTION)
// 退出协作
var QUIT_COLL_WORK_ACTION = "work/quit_coll_work"
var quitCollWorkAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(QUIT_COLL_WORK_ACTION)
// 删除coco作品到回收站
var DELETE_WORK_ACTION = "work/delete_work"
var deleteWorkAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(DELETE_WORK_ACTION)
// 回收站 恢复作品
var RECOVER_DELETE_WORK_ACTION = "work/recover_delete_work"
var recoverDeleteWorkAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(RECOVER_DELETE_WORK_ACTION)
// 回收站 彻底删除coco作品
var AGAIN_DELETE_WORK_ACTION = "work/again_delete_work"
var againDeleteWorkAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(AGAIN_DELETE_WORK_ACTION)
// 清空回收站
var CLEAR_DELETED_WORK_ACTION = "work/clear_deleted_work"
var clearDeletedWorkAction = __WEBPACK_IMPORTED_MODULE_0_redux_actions__.createAction(CLEAR_DELETED_WORK_ACTION)
