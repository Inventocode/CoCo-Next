...
var l = function () {
  function e(e) {
    this.traceId = Module_14.i()
    this.spanId = Module_14.i().substring(16)
    this.startTimestamp = Module_31.d()
    this.tags = {}
    this.data = {}
    if (!e) {
      return this
  ...
  e.prototype.startChild = function (t) {
    var n = new e(Module_1.a(Module_1.a({}, t), {
  ...
  e.prototype.setTag = function (e, t) {
    var n
    this.tags = Module_1.a(Module_1.a({}, this.tags), ((n = {})[e] = t, n))
    return this
  }
  e.prototype.setData = function (e, t) {
    var n
    this.data = Module_1.a(Module_1.a({}, this.data), ((n = {})[e] = t, n))
    return this
  }
  ...
  e.prototype.setHttpStatus = function (e) {
    ...
    var t = Module_12.a.fromHttpCode(e)
    if (t !== Module_12.a.UnknownError) {
      this.setStatus(t)
    }
    return this
  }
  e.prototype.isSuccess = function () {
    return this.status === Module_12.a.Ok
  }
  e.prototype.finish = function (e) {
    this.endTimestamp = "number" === typeof e ? e : Module_31.d()
  }
