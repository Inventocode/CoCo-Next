...
import { "64__part-2__r" as r, "64__part-2__b" as b } from "./index__part-2"
import * as /* [auto-meaningful-name] */$_73_index from "./73/index"
import /* [auto-meaningful-name] */ReactDom from "react-dom"
import * as /* [auto-meaningful-name] */$_71_index from "./71/index"
import * as p from "./30"
import g from "./30"
import * as j from "./4"
import d from "./4"
...
var y = function () {
  var /* [auto-meaningful-name] */$_71_index$a$formatMessage = $_71_index.a().formatMessage
  return React_jsxRuntime.jsxs("div", {
    className: d.pageWrapper,
    children: [React_jsxRuntime.jsxs("div", {
      className: g(d.flexTC, d.bannerBox),
      children: [React_jsxRuntime.jsx("img", {
        className: d.bannerLeftBg,
        src: "https://static.codemao.cn/coco/image/about_page_left_banner.png",
        alt: ""
      }), React_jsxRuntime.jsx("img", {
        className: d.bannerRightBg,
        ...
        children: [React_jsxRuntime.jsx("div", {
          className: d.bannerLogoBox,
          children: React_jsxRuntime.jsx("img", {
            className: d.bannerLogoImg,
            src: "https://static.codemao.cn/coco/image/about_page_logo_new.png",
            alt: "logo"
          })
        }), React_jsxRuntime.jsxs("div", {
          className: d.bannerText,
          children: [React_jsxRuntime.jsx("img", {
            className: d.quotesLeft,
            ...
            children: $_71_index$a$formatMessage({
              id: "about.remarks1"
            })
          }), React_jsxRuntime.jsx("p", {
            children: $_71_index$a$formatMessage({
      ...
      className: g(d.flexTC, d.courseAndFamilyBox),
      children: [React_jsxRuntime.jsx("div", {
        className: d.left
      }), React_jsxRuntime.jsxs("div", {
        className: d.courseAndFamilyContent,
        children: [React_jsxRuntime.jsx("h3", {
          className: d.courseTitle,
          children: $_71_index$a$formatMessage({
            id: "about.toolCourse"
          })
        }), React_jsxRuntime.jsxs("div", {
          className: d.courseList,
          children: [React_jsxRuntime.jsx("div", {
            className: d.courseUpList,
            children: h.map(function (e) {
              return React_jsxRuntime.jsxs("div", {
                className: g(d.courseItem, d.courseUpItem),
                children: [React_jsxRuntime.jsx("img", {
                  className: d.courseUpImg,
                  src: "https://static.codemao.cn/coco/image/about_page_timeline_up.png",
                  alt: ""
                }), React_jsxRuntime.jsxs("div", {
                  className: d.courseText,
                  children: [React_jsxRuntime.jsx("p", {
                    className: d.courseItemTitle,
                    children: e.time
                  }), React_jsxRuntime.jsx("p", {
                    className: d.courseItemDesc,
                    children: e.desc
                  })]
                })]
              })
            ...
            className: d.courseTimeline,
            children: React_jsxRuntime.jsx("img", {
              className: d.courseTimelineImg,
              src: "https://static.codemao.cn/coco/image/about_page_timeline.png",
              alt: ""
            })
          }), React_jsxRuntime.jsx("div", {
            className: d.courseDownList,
            children: f.map(function (e) {
              return React_jsxRuntime.jsxs("div", {
                className: g(d.courseItem, d.courseDownItem),
                children: [React_jsxRuntime.jsx("img", {
                  className: d.courseDownImg,
          ...
          className: d.familyTitle,
          children: $_71_index$a$formatMessage({
            id: "about.familyPhoto"
          })
        }), React_jsxRuntime.jsxs("div", {
          className: d.familyBox,
          children: [React_jsxRuntime.jsx("div", {
            className: d.familyImgBox,
            children: React_jsxRuntime.jsx("img", {
              className: d.familyPhotoImg,
              src: "https://static.codemao.cn/coco/image/about_page_family.png",
              alt: "family"
            })
          }), React_jsxRuntime.jsx("div", {
            className: d.familyIconBox,
            children: React_jsxRuntime.jsx("img", {
              className: d.familyLikeImg,
      ...
      className: g(d.flexTC, d.TeamBox),
      children: [React_jsxRuntime.jsx("div", {
        className: d.left
      }), React_jsxRuntime.jsxs("div", {
        className: d.teamContent,
        children: [React_jsxRuntime.jsx("div", {
          className: d.thanksText,
          children: "— Thanks —"
        }), x.map(function (e) {
          return React_jsxRuntime.jsxs("div", {
            className: d.teamItem,
            children: [React_jsxRuntime.jsx("img", {
              className: d.teamIcon,
              src: e.icon,
              alt: ""
            }), React_jsxRuntime.jsxs("div", {
              className: d.itemDetail,
              children: [React_jsxRuntime.jsx("p", {
                className: d.itemPosition,
                children: e.position
              }), React_jsxRuntime.jsx("p", {
                className: d.itemMember,
                children: e.member
              })]
            })]
          })
...
ReactDom.render(React_jsxRuntime.jsx($_73_index.a, {
  locale: r,
  messages: b["zh-CN"],
