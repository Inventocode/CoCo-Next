...
import { p, l } from "./index__part-2"
import { K } from "./index__part-3"
import { A } from "./index__part-4"
import /* [auto-meaningful-name] */Module_32 from /* 32 */"./32"
import /* [auto-meaningful-name] */Module_68 from /* 68 */"./68"
import * as /* [auto-meaningful-name] */Module_306 from /* 306 */"./306/index"
import * as /* [auto-meaningful-name] */Module_308 from /* 308 */"./308/index"
import /* [auto-meaningful-name] */ReactDom from /* 184 */"react-dom"
import { useState, useEffect } from /* 17 */"react"
import * as /* [auto-meaningful-name] */React_jsxRuntime from /* 15 */"react/jsx-runtime"
function w(t) {
...
const k = () => {
  ...
  return React_jsxRuntime.jsxs("div", {
    className: Module_32.browserTips,
    children: [
      React_jsxRuntime.jsx("img", {
        className: Module_32.arrow,
...
const x = t => {
  ...
  const [C, j] = useState(false)
  useEffect(() => {
    if (i && !function (t, s) {
      const e = parseInt(t || "")
      const i = parseInt(s || "")
      return e > 0 && i > 0 && Date.now() - i > 1e3 * e
    }(n, r) && (i.startsWith("https://") || i.startsWith("http://"))) {
      w(i)
    }
  }, [i, n, r])
  useEffect(() => {
  ...
  return React_jsxRuntime.jsxs("div", {
    className: Module_32.appInfo,
    children: [
      C ? React_jsxRuntime.jsxs(React_jsxRuntime.Fragment, {
        children: [
          React_jsxRuntime.jsx("img", {
            ...
            className: Module_32.expireImage,
            alt: ""
          }), React_jsxRuntime.jsx("div", {
            className: Module_32.expireTitle,
            children: "链接已失效"
          }), React_jsxRuntime.jsx("div", {
            className: Module_32.expireTips,
            children: "请在网页重新打包扫描二维码下载"
          })
        ]
      }) : React_jsxRuntime.jsxs(React_jsxRuntime.Fragment, {
        children: [
          s && React_jsxRuntime.jsx("img", {
            className: Module_32.icon,
            src: s,
            alt: "app icon"
          }), e && React_jsxRuntime.jsx("div", {
            className: Module_32.name,
            children: e
          }), a && React_jsxRuntime.jsxs("div", {
            className: Module_32.version,
            children: ["VersionCode：", a]
          }), React_jsxRuntime.jsx("div", {
            onClick: () => {
              if (i && (i.startsWith("https://") || i.startsWith("http://"))) {
                w(i)
              }
            },
            className: Module_32.download,
            children: c({
              id: "package.download"
            })
          })
...
var b = () => {
  ...
  switch (useEffect(() => {
    var /* [auto-meaningful-name] */InstallShareApk
    var e
    InstallShareApk = "InstallShareApk"
    e = {
      workId: t.projectId || "",
      apkName: t.name || "",
      isScanCode: true,
      isCopyApkLink: false,
      isDownloadPackage: false
    }
    if (!("development" !== K && "test" !== K)) {
      Module_68.track(InstallShareApk, function (t) {
        if (!t) {
          return {}
        }
        const s = {}
        for (const e in t) s[e.replace(/([A-Z])/g, "_$1").toLowerCase()] = t[e]
        return s
      }(e))
    }
  }, [t]), s) {
    case "Wechat":
    case "QQ":
      return React_jsxRuntime.jsx(k, {})
    default:
      return React_jsxRuntime.jsx(x, {
        package: t
      })
  }
}
ReactDom.render(React_jsxRuntime.jsx(Module_308.a, {
  locale: p,
  messages: l[p],
  children: React_jsxRuntime.jsx(b, {})
