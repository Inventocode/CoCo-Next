...
var y = function () {
      ...
      if (null != c[0] || null != c[3]) {
        ...
        try {
          for (n = undefined, f = g(i), h = f.next(), undefined; !h.done; h = f.next()) {
            ...
            var l = h.value;
            if (null != l[1]) {
              a = Math.trunc(Math.max(a, l[1].getY()));
            }
            if (null != l[3]) {
              a = Math.max(a, Math.trunc(l[3].getY()));
            }
          }
        } catch (d) {
          n = {
  ...
  t.findGuardPattern = function (e, r, n, o, i, a, u) {
    ...
    for (var f = s, h = 0, p = a.length, g = i; f < o; f++) {
      if (e.get(f, n) !== g) {
        u[h]++;
      } else {
        if (h === p - 1) {
    ...
    return h === p - 1 && t.patternMatchVariance(u, a, t.MAX_INDIVIDUAL_VARIANCE) < t.MAX_AVG_VARIANCE ? new Int32Array([s, f - 1]) : null;
  };
...
var _ = function () {
  ...
  t.prototype.addMissingRows = function (e, r, n) {
    var o = this.topLeft;
    var i = this.bottomLeft;
    var a = this.topRight;
    var u = this.bottomRight;
    if (e > 0) {
...
var D = function () {
  ...
  t.prototype.getDetectionResultColumns = function () {
    ...
    var t;
    var e = s.a.MAX_CODEWORDS_IN_BARCODE;
    do {
      t = e;
    ...
    for (var c = 0; t.isValidBarcodeColumn(e, r - u);) {
      ...
      try {
        for (i = undefined, f = F(e.getDetectionResultColumn(r).getCodewords()), h = f.next(), undefined; !h.done; h = f.next()) {
          ...
          var l = h.value;
          if (null != l) {
            return (o ? l.getEndX() : l.getStartX()) + u * c * (l.getEndX() - l.getStartX());
          }
        }
      } catch (d) {
        i = {
