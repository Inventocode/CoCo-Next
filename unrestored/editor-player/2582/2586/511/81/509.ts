...
var n = require("./602/351");
var o = require("./602/409");
var i = function () {
  var t = function (e, r) {
...
var d = require("./602/604");
var p = require("./118");
var g = require("./602/382");
var y = require("./117");
var w = require("./170");
var v = function () {
  var t = function (e, r) {
...
var m = function (t) {
  ...
  e.prototype.decodeRow = function (t, r, n) {
    ...
    var a;
    var u;
    var s = this.decodePair(r, !1, t, n);
    e.addOrTally(this.possibleLeftPairs, s);
    r.reverse();
    var f = this.decodePair(r, !0, t, n);
    ...
    try {
      for (var h = _(this.possibleLeftPairs), l = h.next(); !l.done; l = h.next()) {
        ...
        if (d.getCount() > 1) {
          try {
            for (a = void 0, p = _(this.possibleRightPairs), g = p.next(), void 0; !g.done; g = p.next()) {
              var p;
              var g;
              var y = g.value;
              if (y.getCount() > 1 && e.checkChecksum(d, y)) {
                return e.constructResult(d, y);
              }
            }
          } catch (w) {
            a = {
  ...
  e.prototype.decodePair = function (t, e, r, n) {
    try {
      ...
      var h = this.decodeDataCharacter(t, i, !1);
  ...
  e.prototype.decodeDataCharacter = function (t, r, n) {
    ...
    if (n) {
      ...
      var N = g.a.getRSSvalue(d, B, !1);
      var D = g.a.getRSSvalue(y, R, !0);
    ...
    N = g.a.getRSSvalue(d, B, !0);
    D = g.a.getRSSvalue(y, R, !1);
    var B;
  ...
  e.prototype.findFinderPattern = function (t, e) {
    ...
    r[2] = 0;
    r[3] = 0;
    for (var o = t.getSize(), i = !1, a = 0; a < o && e !== (i = !t.get(a));) {
      a++;
    }
