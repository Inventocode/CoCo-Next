...
var s = function () {
  ...
  t.prototype.evaluateAt = function (t) {
    ...
    for (var s = this.coefficients[0], this$coefficients$length = this.coefficients.length, f = 1; f < this$coefficients$length; f++) {
  ...
  t.prototype.multiplyOther = function (e) {
    ...
    for (var this$coefficients = this.coefficients, this$coefficients$length = this$coefficients.length, e$coefficients = e.coefficients, e$coefficients$length = e$coefficients.length, u = new Int32Array(this$coefficients$length + e$coefficients$length - 1), s = 0; s < this$coefficients$length; s++) {
  ...
  t.prototype.negative = function () {
    for (var this$coefficients$length = this.coefficients.length, r = new Int32Array(this$coefficients$length), n = 0; n < this$coefficients$length; n++) {
  ...
  t.prototype.multiplyScalar = function (e) {
    ...
    for (var this$coefficients$length = this.coefficients.length, n = new Int32Array(this$coefficients$length), o = 0; o < this$coefficients$length; o++) {
  ...
  t.prototype.multiplyByMonomial = function (e, r) {
    ...
    for (var this$coefficients$length = this.coefficients.length, i = new Int32Array(this$coefficients$length + e), a = 0; a < this$coefficients$length; a++) {
