  ...
  t.prototype.write = function (e, r, o, i) {
    ...
    if (i) {
      if (undefined !== i.get(n.EncodeHintType.ERROR_CORRECTION)) {
        ...
        n$QRCodeDecoderErrorCorrectionLevel$L = n.QRCodeDecoderErrorCorrectionLevel.fromString(s)
      }
      if (undefined !== i.get(n.EncodeHintType.MARGIN)) {
        t$QUIET_ZONE_SIZE = Number.parseInt(i.get(n.EncodeHintType.MARGIN).toString(), 10)
      }
    }
    var c = n.QRCodeEncoder.encode(e, n$QRCodeDecoderErrorCorrectionLevel$L, i)
    return this.renderResult(c, r, o, t$QUIET_ZONE_SIZE)
  }
