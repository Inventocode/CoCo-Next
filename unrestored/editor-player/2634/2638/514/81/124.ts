...
var a = function () {
  ...
  t.guessEncoding = function (e, r) {
    ...
    for (var /* [auto-meaningful-name] */e$length = e.length, i = true, a = true, u = true, s = 0, c = 0, f = 0, h = 0, l = 0, d = 0, p = 0, g = 0, y = 0, w = 0, v = 0, _ = e.length > 3 && 239 === e[0] && 187 === e[1] && 191 === e[2], m = 0; m < e$length && (i || a || u); m++) {
      var A = 255 & e[m]
      if (u) {
        if (s > 0) {
          if (0 === (128 & A)) {
    ...
    return u && (_ || c + f + h > 0) ? t.UTF8 : a && (t.ASSUME_SHIFT_JIS || y >= 3 || w >= 3) ? t.SHIFT_JIS : i && a ? 2 === y && 2 === d || 10 * v >= e$length ? t.SHIFT_JIS : t.ISO88591 : i ? t.ISO88591 : a ? t.SHIFT_JIS : u ? t.UTF8 : t.PLATFORM_DEFAULT_ENCODING
  }
  t.format = function (t) {
