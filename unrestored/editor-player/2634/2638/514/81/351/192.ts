...
var l = function (t) {
  ...
  e.findStartGuardPattern = function (t) {
    for (var r, n = false, o = 0, i = Int32Array.from([0, 0, 0]); !n;) {
      i = Int32Array.from([0, 0, 0])
      var a = (r = e.findGuardPattern(t, o, false, this.START_END_PATTERN, i))[0]
      var u = a - ((o = r[1]) - a)
      if (u >= 0) {
        n = t.isRange(u, a, false)
      }
    }
    return r
  }
  ...
  e.checkStandardUPCEANChecksum = function (t) {
    ...
    var n = parseInt(t.charAt(t$length - 1), 10)
  ...
  e.decodeEnd = function (t, r) {
    return e.findGuardPattern(t, r, false, e.START_END_PATTERN, new Int32Array(e.START_END_PATTERN.length).fill(0))
  }
...
var p = function () {
  ...
  t.prototype.decodeMiddle = function (e, r, n) {
    ...
    for (var u = e.getSize(), s = r[1], f = 0, h = 0; h < 5 && s < u; h++) {
      var p = l.decodeDigit(e, this$decodeMiddleCounters, s, l.L_AND_G_PATTERNS)
      n += String.fromCharCode("0".charCodeAt(0) + p % 10)
      try {
        for (o = undefined, g = d(this$decodeMiddleCounters), y = g.next(), undefined; !y.done; y = g.next()) {
          var g
          var y
          s += y.value
        }
...
var y = function () {
  ...
  t.prototype.decodeMiddle = function (t, e, r) {
    ...
    for (var a = t.getSize(), u = e[1], s = 0, f = 0; f < 2 && u < a; f++) {
      var h = l.decodeDigit(t, this$decodeMiddleCounters, u, l.L_AND_G_PATTERNS)
      r += String.fromCharCode("0".charCodeAt(0) + h % 10)
      try {
        for (n = undefined, d = g(this$decodeMiddleCounters), p = d.next(), undefined; !p.done; p = d.next()) {
          var d
          var p
          u += p.value
        }
...
var w = function () {
  ...
  t.decodeRow = function (t, e, r) {
    var n = l.findGuardPattern(e, r, false, this.EXTENSION_START_PATTERN, new Int32Array(this.EXTENSION_START_PATTERN.length).fill(0))
    try {
...
var m = function (t) {
  ...
  e.prototype.decodeRow = function (t, r, s) {
    ...
    var m = e.decodeEnd(r, p$rowOffset)
    if (null != l) {
    ...
    var E = m[1]
    var C = E + (E - m[0])
    if (C >= r.getSize() || !r.isRange(E, C, false)) {
      throw new c.a()
    }
    var I = p$resultString.toString()
    if (I.length < 8) {
      throw new f.a()
    }
