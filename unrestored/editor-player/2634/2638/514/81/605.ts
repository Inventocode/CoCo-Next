...
var m = function () {
  ...
  t.prototype.addBinaryShiftChar = function (e) {
    ...
    var u = new t(this$token, this$mode, this.binaryShiftByteCount + 1, this$bitCount + a)
    ...
    try {
      for (var a = E(t), u = a.next(); !u.done; u = a.next()) {
        ...
        var f = function (t) {
          ...
          if (u$value.isBetterThanOrEqualTo(t)) {
        ...
        try {
          for (n = undefined, h = E(i), l = h.next(), undefined; !l.done; l = h.next()) {
            var h
            var l
            if ("break" === f(l.value)) {
              break
