...
var c = function () {
  ...
  e.prototype.normalize_config = function (e) {
    for (var t in e.font.SIZE.match(/^\d*\.?\d+\s*[Pp][Tt]$/) || (console.warn("Font size " + e.font.SIZE + " replaced by default"), e.font.SIZE = d.font.SIZE), e.flyout.BACKGROUND_COLOR = new s.Color(e.flyout.BACKGROUND_COLOR, d.flyout.BACKGROUND_COLOR, "Flyout background color " + e.flyout.BACKGROUND_COLOR + " replaced by default"), e.insertion_marker.COLOR = new s.Color(e.insertion_marker.COLOR, d.insertion_marker.COLOR, "Insertion marker color " + e.insertion_marker.COLOR + " replaced by default"), (e.insertion_marker.OPACITY < 0 || e.insertion_marker.OPACITY > 1) && (console.warn("Insertion marker opacity " + e.insertion_marker.OPACITY + " replaced by default"), e.insertion_marker.OPACITY = d.insertion_marker.OPACITY), e.shadow_style.SHADOW_COLOR = new s.Color(e.shadow_style.SHADOW_COLOR, d.shadow_style.SHADOW_COLOR, "Shadow color " + e.shadow_style.SHADOW_COLOR + " replaced by default"), e.shadow_style.EMPTY_COLOR = new s.Color(e.shadow_style.EMPTY_COLOR, d.shadow_style.EMPTY_COLOR, "Invalid empty shadow color " + e.shadow_style.EMPTY_COLOR + " replaced by default"), e.shadow_style.BORDER.match(/^\d*\.?\d+\s*[Pp][Xx]$/) || (console.warn("Invalid shadow border " + e.shadow_style.BORDER + " replaced by default"), e.shadow_style.BORDER = d.shadow_style.BORDER), "0" !== e.shadow_style.NO_BORDER && (console.warn("Invalid shadow no_border " + e.shadow_style.NO_BORDER + " replaced by default"), e.shadow_style.NO_BORDER = d.shadow_style.NO_BORDER), e.block_group_color) {
      var n = t;
      e.block_group_color[n] = new s.Color(e.block_group_color[n], d.block_group_color[n], "Block group " + t + " replaced by default");
    }
    ...
    e.disabled_color.fill = new s.Color(e.disabled_color.fill, d.disabled_color.fill, "Block disabled fill color " + e.disabled_color.fill + " replaced by default");
    e.disabled_color.border = new s.Color(e.disabled_color.border, d.disabled_color.border, "Block disabled border color " + e.disabled_color.border + " replaced by default");
  };
...
exports.DEFAULT_THEME_CONFIG = (0, a.clone_deep)(d);
