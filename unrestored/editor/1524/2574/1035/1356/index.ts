...
var f = l ? function () {} : require("./2307").default;
function h(e, t) {
  if (l) {
    if (!e) {
      throw new Error(t);
...
exports.type = {
    ...
    e = function e(t, r) {
      ...
      for (--o; o >= 0; o--) {
        ...
        if ("object" !== typeof c) {
          ...
          h(void 0 !== t, "Cannot pick up or remove undefined");
          if (null != c.p) {
            n[c.p] = t;
          }
          t = void 0;
  ...
  transformPosition: function (e, t) {
    ...
    for (var n, r, i = c.readCursor(t), o = !1, a = [], s = function (t) {
        ...
        if (f("pick phase", t, ":", s, u), u && (void 0 !== u.r ? o = !0 : null != u.p && (o = !1, n = u.p, r = t)), t >= e.length) {
          return "break";
        }
        var l = 0;
        var h = c.advancer(i, void 0, function (e, t) {
          if (g(t)) {
            l++;
          }
        });
    ...
    if (a.forEach(function (e) {
      return e.end();
    }), N(), f("after pick phase. Remove", o, "pi", r, "pas", n, "po", e), o) {
...
function m(e, t) {
  h(null != e);
  if ("number" === typeof t) {
    h(Array.isArray(e), "Invalid key - child is not an array");
    (e = e.slice()).splice(t, 1);
  } else {
    h(_(e), "Invalid key - child is not an object");
...
function y(e, t, n) {
  if ("number" === typeof t) {
    h(null != e, "Container is missing for key");
    h(Array.isArray(e), "Cannot use numerical key for object container");
    h(e.length >= t, "Cannot insert into out of bounds index");
    e.splice(t, 0, n);
  } else {
    h(_(e), "Cannot insert into missing item");
    h(void 0 === e[t], "Trying to overwrite value at key. Your op needs to remove it first");
    e[t] = n;
  }
  return n;
}
...
function F(e) {
  if (null !== e) {
    ...
    var r = function (e) {
      ...
      for (var o in e) {
        var a = e[o];
        if (r = !1, h("p" === o || "r" === o || "d" === o || "i" === o || "e" === o || "es" === o || "ena" === o || "et" === o, "Invalid component item '" + o + "'"), "p" === o) {
          D(a);
          h(!t.has(a));
          t.add(a);
          h(void 0 === e.r);
    ...
    !function e(t, n, i) {
      ...
      for (var o = 1, a = 0, s = 0, u = 0; u < t.length; u++) {
        var l = t[u];
        if (h(null != l), Array.isArray(l)) {
          var f = e(l, !1, i);
          if (a) {
            var d = typeof s;
            var p = typeof f;
            if (d === p) {
              h(s < f, "descent keys are not in order");
            } else {
              h("number" === d && "string" === p);
            }
          }
          ...
          h(1 === o, "Prev not scalar - instead ".concat(o));
          r(l);
          o = 2;
        } else {
          h(3 !== o);
          I(l);
          h(c.isValidPathItem(l), "Invalid path key");
          o = 1;
        }
      }
      h(1 !== a, "Operation makes multiple descents. Remove some []");
      h(2 === o || 3 === o);
      return t[0];
    }(e, !0, !1);
    h(t.size === n.size, "Mismatched picks and drops in op");
...
function M(e, t) {
  if (d && !l && (f("composing:"), f("  op1:", e), f("  op2:", t)), F(e), F(t), null == e) {
    return t;
  }
  if (null == t) {
    return e;
  ...
  var E = c.writeCursor();
  !function e(t, r, i, o, d, b, E, x) {
    h(r || i);
    if (!l) {
      f("xfBoundary", d, !!t && t.getPath(), !!r && r.getPath(), !!i && i.getPath(), !!o && o.getPath(), "lit:", d, "rmParent:", b);
    }
    P();
    var C = p(r);
    var O = p(i);
    ...
    var L = p(o);
    if (null != I) {
      if (f("teleporting via c1 drop1Slot", I), t = u[I], x = a[I] = new c.WriteCursor(), R) {
        f("Cancelling op1 move", I, "rmParent", b, "rmHere", S);
        if (b && !S) {
          x.write("r", !0);
        }
      } else {
    ...
    var V = (null == F ? !D || b || S : void 0 === j) ? null : E.getComponent();
    if (f(V ? "insComponent" : "no insComponent - this insert will be discarded", D && !b && !S && null == F, null != F && void 0 !== j), null != F) {
      if (void 0 !== d || D) {
        ;
      } else {
        var G = null != I ? A[I] : n++;
    ...
    var z = R ? null : k(C);
    var Q = k(L);
    if (f("components", C, L), (z || Q) && f("types", z && z.name, Q && Q.name), z && Q) {
      h(z === Q);
      var W = T(C);
      var K = T(L);
      var X = z.compose(W, K);
    ...
    if (c.eachChildOf(r, i, function (t, n, r) {
      ...
      if ("number" === typeof t) {
        ...
        h(a >= 0, "p1PickKey is negative");
        h(s >= 0, "p2DropKey is negative");
        var d = v(p(n));
        var _ = g(p(r));
        if (d || _ && !R) {
          te--;
...
function j(e) {
  ...
  var o = [];
  var a = [];
  if (f("inverting", e), function e(n, i, a) {
    if (!l) {
    ...
    try {
      for (_.s(); !(d = _.n()).done;) {
        ...
        var b = e(n, i, y);
        if (f("key", g, "raw", m, y, b, "subdoc", a), void 0 !== a && void 0 !== b) {
          if (u || (u = !0, a = A(a)), !w(a, m)) {
    ...
    i.write("r", a);
  }(n, i, void 0), l || f("invert after pass 1", i.get()), t) {
    i.reset();
    (function e(n, i, s) {
      if (!l) {
      ...
      if (u) {
        var h = u.d;
        if (null != h && (f("teleporting to drop slot", h), n = o[h], s = a[h] = c.writeCursor()), t.has(u)) {
          var d = k(u);
          if (!d.invert) {
            throw Error("Cannot invert subtype ".concat(d.name));
          }
          if (!l) {
            f("inverting subtype", d.name, T(u));
          }
          B(s, d, d.invert(T(u)));
        }
      }
...
function L(e, t) {
  if (f("makeInvertible", e, t), null == e || !function e(t, n) {
    return t.some(function (t) {
      return "object" === typeof t && (Array.isArray(t) ? e(t, n) : n(t));
    });
  }(e, function (e) {
    var t;
    return void 0 !== e.r || null != (null === (t = k(e)) || void 0 === t ? void 0 : t.makeInvertible);
  })) {
    return e;
  }
  var n = new c.ReadCursor(e);
  ...
  if (function e(t, n, i) {
    ...
    if (c) {
      ...
      var p = c.p;
      if (null != p && (a[p] = t.clone(), h(void 0 !== i, "Operation picks up at an invalid key"), u[p] = i, n.write("p", c.p)), void 0 !== c.r && void 0 === i) {
    ...
    N();
    return i;
  }(n, i, t), f("after traversePick", i.get()), o) {
    i.reset();
      ...
      if (h) {
        if (void 0 !== h.i) {
          ...
          if (null != h.d) {
            ...
            t = a[h.d];
            s = !1;
            f("teleporting to pick", h.d, o);
          }
        }
        var d = k(h);
        if (d && d.makeInvertible) {
          var p = T(h);
          f("makeInvertible on child", p, o);
          B(i, d, d.makeInvertible(p, o), !0);
        }
      }
      var _;
      var A = 0;
...
function H(e, n, i) {
  h("left" === i || "right" === i, "Direction must be left or right");
  var o = "left" === i ? 0 : 1;
  if (f.quiet = !d, f.prefix = 0, null == n) {
    return {
      ok: !0,
      result: e
    };
  ...
  if (function e(t) {
    ...
    h.end();
    N();
  }(z, G, null), l || (f("op1PickAtOp2Pick", L), f("cancelledOp2", I), f("held op2 pick", C.map(function (e) {
    return !!e;
  }))), function e(n, i, a, s, h) {
    if (!l) {
      f("scanOp2Drop", "r1Pick", n && n.getPath(), i && i.getPath(), "r2Drop", a.getPath(), "pickSlot1", s, "removed:", h && h.getPath());
    }
    P();
    var d;
    ...
    if (_) {
      if (null != (d = _.d)) {
        ...
        f("tele r2Pick to op2 slot2", d, !!I[d]);
        n = x[d] || null;
        i = w[d] || null;
        if (I[d]) {
          if (h) {
          ...
          if (!(!h || 1 !== o && null != L[d])) {
            f("conflicting op2 move because drop destination removed", d);
            if (!l) {
    ...
    N();
    return A;
  }(G, z, z.clone(), null, null), f("held op2 drop", E.map(function (e) {
    return e && e.get();
  })), m) {
  ...
  (function e(t, n, i, a, s) {
    ...
    if (f("children", "2p", !!n, "2d", !!i), t) {
      var T;
      var B = r(t);
      try {
        for (B.s(); !(T = B.n()).done;) {
          var D = T.value;
          if (f("-> k", D), "string" === typeof D) {
            var I = C(D);
            var F = k(D);
            a.descend(D);
            e(t, I, F, a, s);
  ...
  var X = [];
  if (f("----- drop -----"), function e(n, d, _, x, D, F) {
    h(d);
    var R = d.getComponent();
    if (!l) {
      f("drop", n && n.getPath(), d.getPath(), _ && _.getPath(), x && x.getPath(), "c:", R, "r:", !!F);
    }
    P();
    var M = p(x);
    var U = !1;
    ...
    var he = fe;
    var de = c.advancer(_, void 0, function (e, t) {
      if (g(t)) {
        se++;
        f("p2Pick++", se, e, t);
      }
    ...
    var _e = pe;
    f("children.", "1p:", !!n, "1d:", !!d, "2p:", !!_);
    var Ae;
    var ge = r(d);
    try {
      for (ge.s(); !(Ae = ge.n()).done;) {
        var ve = Ae.value;
        if (f("-> p1Drop looking at child", ve), "number" === typeof ve) {
          var me = void 0;
          f("p1DropEachChild k:", ve, "p1d:", ae, "p1p:", oe, "raw: -", "p2p:", se, "p2d:", ce, "op:", ue, "od:", le);
          var ye = v(d.getComponent());
          var be = ve - ae;
          var we = void 0;
          for (f("Looking for p2 Pick at k1Mid", be), P(); fe && "number" === typeof (we = n.getKey());) {
            ...
            var xe = g(Ee);
            if (f("p1k", we, "k1mid", be, "hp", xe), we > be || we === be && (!xe || 0 === o && ye)) {
              break;
            }
            if (xe) {
              f("p1PickOff--");
          ...
          f("ap2p", Oe);
          var Se = de(Oe);
          f("_p2Pick", !!Se, "p2PickOff", se);
          var ke = Oe - se;
          var Te = null;
          var Be = void 0;
          var De = void 0;
          for (f("Looking for p2 Drop at p2mid", ke), P(); pe && "number" === typeof (Be = x.getKey());) {
            De = Be - ce;
            var Ie = x.getComponent();
            var Fe = v(Ie);
            if (f("p2d looking at child", Be, Ie, "at op2mid", De, "target", ke, "  / raw", Oe, ce, Fe, ye), De > ke) {
              break;
            }
            if (De === ke) {
              if (!Fe) {
          ...
          var Me = Ne + ue + le;
          f("k: " + ve + " -> mid " + be + " -> raw " + Oe + " -> k2Mid " + ke + " -> k2Final " + Ne + " -> descend " + Me);
          h(Me >= 0, "trying to descend to a negative index");
          D.descend(Me);
          if (ye) {
            me = Se = Te = null;
            f("omg p1dropoff", ae);
          ...
          for (var Le = fe && je === ve ? n : null, Ue = de(ve), He = void 0; pe && ("string" !== typeof (He = x.getKey()) || !(He > ve || He === ve));) {
            pe = x.nextSibling();
          }
  ...
  if ((j.length || I.length) && !m) {
    ...
    if (Y(J, null, function (e, t) {
    ...
    }), l || (f("merging writes into", J.get()), f("heldOutDropRead", q.map(function (e) {
      return e && e.getPath();
      ...
      if (u && g(u)) {
        if (null != u.p) {
          a = u;
          var h = u.p;
          f("teleporting writes to output slot", h, q[h].getPath());
          i = q[h];
          o = $[h] = c.writeCursor();
        } else if (void 0 !== u.r) {
          i = null;
      ...
      try {
        for (C.s(); !(y = C.n()).done;) {
          ...
          if ("number" === typeof O) {
            ...
            var T = x(k);
            var B = k + w;
            f("->", O, "outPickOff", b, "-> rmid", k, "dropOff", w, "final", B);
            o.descend(B);
            e(t, S, T, o, a, s);
            o.ascend();
          } else {
      ...
      E.end();
      x.end();
    }(z, J, J.clone(), Q, null, !1), Q.reset(), m) {
    ...
    if (f("-- after writeHeldOp2Drop", Q.get()), l || f("held output writes", $.map(function (e) {
      return e.get();
    })), $.length) {
...
function K(e, t, n, r) {
  for (var o = null;;) {
    ...
    var c = s.conflict;
    if (f("detected conflict", c), e(c) || V(c), !l && c.type === u.ConflictType.BLACKHOLE) {
      var d = H(n, t, "left" === r ? "right" : "left");
      h(!d.ok);
      try {
        h(a.default(W(d.conflict), W(Q(c))));
      } catch (v) {
        throw f.debug = !0, f("Inverted transform conflict", t, n, c, d.conflict), v;
      }
    }
    var p = z(c, r);
    var _ = i(p, 2);
