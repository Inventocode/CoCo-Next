...
var c = i(require("./1046/index"));
var u = i(require("./1047/index"));
var l = i(require("./926"));
var f = i(require("../../0/index"));
var h = i(require("./949"));
var d = i(require("./1746"));
var p = i(require("./1747/index"));
var _ = r(require("./1254/index"));
function A(e, t) {
  var n = Object.keys(e);
...
var m = function (e) {
  ...
  function n(e) {
    ...
    (0, h.default)(!("minimumTrackStyle" in e), "minimumTrackStyle will be deprecated, please use trackStyle instead.");
    (0, h.default)(!("maximumTrackStyle" in e), "maximumTrackStyle will be deprecated, please use railStyle instead.");
    return r;
  }
  (0, s.default)(n, [{
    key: "calcValueByPos",
    ...
    value: function () {
      ...
      var h = t.ariaLabelledByForHandle;
      ...
      var S = s[0] || s;
      return {
        tracks: f.default.createElement(d.default, {
