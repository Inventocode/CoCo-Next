...
var f = function (e) {
  ...
  return Object(r.isValidElement)(h) ? i.a.cloneElement(h, l({}, h.props, {
    style: l({}, h.props.style, d.grid)
...
var J = z ? z.toStringTag : void 0;
var Z = function (e) {
  return null == e ? void 0 === e ? "[object Undefined]" : "[object Null]" : J && J in Object(e) ? Y(e) : $(e);
};
var ee = function (e) {
  var t = typeof e;
...
var he = RegExp("^" + le.call(fe).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
var de = function (e) {
  return !(!ee(e) || ie(e)) && (te(e) ? he : se).test(ae(e));
};
var pe = function (e, t) {
...
var Ee = function (e) {
  var t = this.__data__;
  return ge ? void 0 !== t[e] : we.call(t, e);
};
var xe = function (e, t) {
  var n = this.__data__;
...
var He = function (e, t, n) {
  if (void 0 !== n && !B(e[t], n) || void 0 === n && !(t in e)) {
    Ue(e, t, n);
  }
};
var Ve = function (e) {
...
var Ot = function (e, t, n) {
  var r = e[t];
  if (!(Ct.call(e, t) && B(r, n) && (void 0 !== n || t in e))) {
    Ue(e, t, n);
  }
};
...
var It = function (e, t) {
  var n = st(e);
  var r = !n && at(e);
  var i = !n && !r && Object(ft.a)(e);
  var o = !n && !r && !i && Et(e);
  var a = n || r || i || o;
  var s = a ? kt(e.length, String) : [];
  var c = s.length;
...
var qt = function (e) {
  return Xt(function (t, n) {
    ...
    for (o = e.length > 3 && "function" == typeof o ? (i--, o) : void 0, a && Yt(n[0], n[1], a) && (o = i < 3 ? void 0 : o, i = 1), t = Object(t); ++r < i;) {
      var s = n[r];
      if (s) {
        e(t, s, r, o);
      }
...
var dn = function (e, t, n) {
  ...
  function A() {
    ...
    s = setTimeout(A, function (e) {
      var n = t - (e - c);
      return f ? hn(n, o - (e - u)) : n;
    }(e));
  }
  function g(e) {
    s = void 0;
    return h && r ? d(e) : (r = i = void 0, a);
  }
  function v() {
    var e = Zt();
    var n = _(e);
...
var tr = z ? z.prototype : void 0;
var nr = tr ? tr.valueOf : void 0;
...
var Or = function (e, t, n, r, i, o) {
  ...
  return !!h && (o || (o = new je()), dr(e, t, n, r, i, o));
};
var Sr = function e(t, n, r, i, o) {
...
var Hr = z ? z.prototype : void 0;
var Vr = Hr ? Hr.toString : void 0;
var Gr = function e(t) {
  if ("string" == typeof t) {
    return t;
  }
...
var qr = function (e, t, n) {
  for (var r = -1, i = (t = Qr(t, e)).length, o = !1; ++r < i;) {
    var a = Wr(t[r]);
    if (!(o = null != e && n(e, a))) {
      break;
    }
...
var Jr = function (e, t) {
  return Pr(e) && Tr(t) ? Dr(Wr(e), t) : function (n) {
    var r = Xr(n, e);
    return void 0 === r && r === t ? $r(n, e) : Sr(t, r, 3);
  };
};
var Zr = function (e) {
  return function (t) {
...
var Oi = Object(o.handleHover)(Ci);
var Si = function (e) {
  var t = e.width;
  var n = e.onChange;
  var r = e.onSwatchHover;
...
Si.defaultProps = {
  ...
  circleSize: 28,
  circleSpacing: 14,
  colors: [si[500], ci[500], ui[500], li[500], fi[500], hi[500], di[500], pi[500], _i[500], Ai[500], gi[500], vi[500], mi[500], yi[500], bi[500], wi[500], Ei[500], xi[500]],
  styles: {}
};
Rn(Si);
var ki = function (e) {
...
Rn(Li);
var Ui = Object(o.handleHover)(function (e) {
  var t = e.hover;
  var n = e.color;
  var r = e.onClick;
  var o = e.onSwatchHover;
...
Hi.propTypes = {
  width: k.a.oneOfType([k.a.string, k.a.number]),
  colors: k.a.arrayOf(k.a.string),
  triangle: k.a.oneOf(["hide", "top-left", "top-right", "bottom-left", "bottom-right"]),
  styles: k.a.object
};
Hi.defaultProps = {
  width: 200,
...
eo.propTypes = {
  colors: k.a.arrayOf(k.a.oneOfType([k.a.string, k.a.shape({
    color: k.a.string,
    title: k.a.string
  })])).isRequired
};
...
var yo = function (e) {
  ...
  var h = Math.round(s.h) + "\xb0, " + Math.round(100 * s.s) + "%, " + Math.round(100 * s.v) + "%";
  return i.a.createElement("div", {
    style: u.wrap,
    className: "flexbox-fix"
  }, i.a.createElement("div", {
