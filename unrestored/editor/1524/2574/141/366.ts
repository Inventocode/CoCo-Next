module.exports = function () {
  try {
          ...
          if ("bug-string-char-index" == e) {
            ...
            if ("json-stringify" == e) {
              ...
              if (u) {
                ...
                g(function () {
                  u = "0" === n(0) && "0" === n(new o()) && '""' == n(new a()) && n(_) === d && n(d) === d && n() === d && "1" === n(r) && "[1]" == n([r]) && "[null]" == n([d]) && "null" == n(null) && "[null,null,null]" == n([d, _, null]) && n({
                    a: [r, !0, !1, null, "\0\b\n\f\r\t"]
                  }) == s && "1" === n(null, r) && "[\n 1,\n 2\n]" == n([1, 2], null, 1);
                }, function () {
                  u = !1;
        ...
        if (g(function () {
          ...
          if (!m("json-stringify") && !m("date-serialization")) {
            ...
            if (m("json-stringify") && !m("date-serialization")) {
              ...
              var k = /[\x00-\x1f\x22\x5c]/g;
              var T = function (e) {
                k.lastIndex = 0;
                return '"' + (k.test(e) ? e.replace(k, S) : e) + '"';
              };
              var B = function e(t, n, r, i, o, a, s) {
                ...
                if (g(function () {
                  u = n[t];
                }), "object" == typeof u && u && (u.getUTCFullYear && "[object Date]" == _.call(u) && u.toJSON === c.prototype.toJSON ? u = x(u) : "function" == typeof u.toJSON && (u = u.toJSON(t))), r && (u = r.call(n, t, u)), u == d) {
                  return u === d ? u : "null";
                }
                switch ("object" == (f = typeof u) && (h = _.call(u)), h || f) {
                  case "boolean":
                  case "[object Boolean]":
                    return "" + u;
                  case "number":
                ...
                if ("object" == typeof u) {
                  ...
                  if (s.push(u), p = [], y = a, a += o, "[object Array]" == h) {
    ...
    n.UUID = (h = function () {
      ...
      return h() + "-" + n.getRandom().toString(16).replace(".", "") + "-" + function (e) {
        var t;
        var n;
      ...
      }() + "-" + e + "-" + h() || (String(n.getRandom()) + String(n.getRandom()) + String(n.getRandom())).slice(2, 15);
    });
    ...
    n.cookie = {
      ...
      set: function (e, r, i, o) {
        ...
        if (h && d) {
          document.cookie = h + "=" + encodeURIComponent(d) + s + "; path=/" + p + c;
        }
      },
      encrypt: function (e) {
    ...
    t.initPara = function (e) {
      ...
      if (t.para.heatmap && !n.isObject(t.para.heatmap) && (t.para.heatmap = {}), n.isObject(t.para.heatmap)) {
        ...
        var h = n.isArray(t.para.heatmap.track_attr) ? n.filter(t.para.heatmap.track_attr, function (e) {
          return e && "string" == typeof e;
        }) : [];
        h.push("data-sensors-click");
        t.para.heatmap.track_attr = h;
