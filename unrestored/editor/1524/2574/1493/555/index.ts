...
function p() {
  ...
  for (var t in d) if (t + "Transform" in e) {
    r = t;
  }
  return r;
}
...
function $(e, t) {
  ...
  var h = K.viewportWidth(o);
  var d = K.viewportHeight(o);
  var p = s.scrollWidth;
  ...
  if ("hidden" === A.overflowX && (p = o.innerWidth), "hidden" === A.overflowY && (_ = o.innerHeight), e.style && (e.style.position = u), t || function (e) {
    ...
    var g = Math.max(p, l + h);
    n.right = Math.min(n.right, g);
    var v = Math.max(_, f + d);
...
function se(e, t, n, r) {
  ...
  if (p.width !== h.width) {
    K.css(c, "width", K.width(c) + p.width - h.width);
  }
  if (p.height !== h.height) {
    K.css(c, "height", K.height(c) + p.height - h.height);
  }
  K.offset(c, {
    left: p.left,
    top: p.top
...
var Ae = s.a.forwardRef(function (e, t) {
  ...
  var v = function (e, t) {
    ...
    if (!t && n) {
      ...
      (function (e, t) {
        if (e !== document.activeElement && Object(he.a)(t, e) && "function" === typeof e.focus) {
          e.focus();
        }
      })(l, o);
      if (r && i) {
  ...
  s.a.useEffect(function () {
    ...
    if (_.current !== E.current.element) {
      ...
      E.current.cancel = de(_.current, y);
    }
