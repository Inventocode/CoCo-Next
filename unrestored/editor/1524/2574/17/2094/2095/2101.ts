    ...
    if (u) {
      if ((0, a.is_workspace_comment)(u)) {
        ...
        if (this.is("field", this._data)) {
          ...
          var p = f.old_value;
          l = e ? d : p;
          if (void 0 != h && (s = u.get_field(String(h)))) {
            s.call_validator(l);
            s.set_value(l, !0);
          }
          ...
          if ("undefined" !== typeof (d = e ? this._data.new_value : this._data.old_value)) {
            if (!(null === (t = u.addMutation) || void 0 === t)) {
              t.call(u, d, null === (n = this._data.name) || void 0 === n ? void 0 : n.toString());
            }
          } else {
