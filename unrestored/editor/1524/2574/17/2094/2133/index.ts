  ...
  e.prototype.svg_resize = function (e) {
    ...
    if (i) {
      ...
      if (!(u < a || f < s)) {
        ...
        if (r.cachedWidth_ != h) {
          r.setAttribute("width", h + "px");
          r.cachedWidth_ = h;
        }
        if (r.cachedHeight_ != d) {
          r.setAttribute("height", d + "px");
          r.cachedHeight_ = d;
        }
        t.resize();
    ...
    for (var r = l.TokenizationState.BaseCase, i = [], o = "", a = "", s = 0; s < n.length; s++) {
      ...
      switch (r) {
        ...
        case l.TokenizationState.MsgRefFound:
          ...
          if (/[A-Z]\w*/i.test(u)) {
            var f = u.toUpperCase();
            var h = f.startsWith("BKY_") ? f.substring(4) : void 0;
            var p = h && h in this.Msg ? this.Msg[h] : void 0;
            if (void 0 !== p) {
              if ((0, d.is_string)(p)) {
