...
var l = function () {
    ...
    if (i && (this.bubble_ || (this.bubble_ = document.createElement("div"), this.bubble_.classList.add("blocklySimplifiedCommentBubble", "blocklySimplifiedCommentBubbleCover"), this.bubble_content_ = document.createElement("div"), this.bubble_content_.classList.add("blocklySimplifiedCommentBubbleContent")), this.bubble_content_)) {
      if ("reset" !== e) {
        ...
        for (var u = (0, a.get_outer_block)(i), l = (0, a.get_nested_blocks_with_comment)(u), f = 0; f < l.length; f++) {
          var h = l[f];
          if ((0, s.is_block_group)(h)) {
            h.nested_blocks_with_comment.forEach(function (e) {
  ...
  e.prototype.create_comment_bubble_text = function (e) {
    ...
    if (n) {
      ...
      this.events.bind_event_with_checks(o, "click", n, function () {
        var e;
        var r;
        var i;
        if (s()) {
          var o = t.selected_comment;
          if (o) {
            t.selected_comment = "";
      ...
      this.events.bind_event_with_checks(l, "click", n, function () {
        if (t.events.is_enabled()) {
          t.events.fire(t.ui_event_factory({
      ...
      this.events.bind_event_with_checks(f, "click", n, function () {
        if (t.events.is_enabled()) {
          t.events.fire(t.ui_event_factory({
      ...
      var h = new Image();
      h.src = this.Msg.ICON_COMMENT_MORE;
      h.classList.add("blocklySimplifiedCommentMoreButton");
      h.setAttribute("tabindex", "-1");
      var d = !1;
      var p = !1;
      this.events.bind_event_with_checks(h, "focus", n, function () {
        var e;
        var r;
        if (!p) {
          var u;
          ...
          t.animate_once(h, "expandMoreButtonAnimation", function () {
      ...
      this.events.bind_event_with_checks(h, "blur", n, function () {
        if (!p) {
          p = !0;
          ...
          t.animate_once(h, "collapseMoreButtonAnimation", function () {
            h.style.transform = "";
            d = !1;
            p = !1;
          });
      ...
      this.events.bind_event_with_checks(h, "click", n, function () {
        if (d) {
          h.blur();
        } else {
          h.focus();
      ...
      a.innerText = n.get_text();
      this.comments.set(n.id, a);
...
export { l as SimplifiedCommentBubble };