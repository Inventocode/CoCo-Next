...
var p = function () {
  ...
  e.prototype._paste = function (e, t, n, r) {
    ...
    try {
      ...
      try {
        if (u = this.xml.dom_to_workspace_element(e, this), (0, h.is_block_svg)(u) && (u = u.parent_group || u), !u) {
          return;
        }
        var f = void 0;
        var d = void 0;
        if (t) {
          ...
          do {
            ...
            for (a = 0; a < m.length; a++) {
              ...
              if (Math.abs(f - y[0]) <= 1 && Math.abs(d - y[1]) <= 1) {
                v = !0;
                break;
              }
            }
            if (!v) {
              var b = (0, h.is_block_svg)(u) ? u.get_connections(!1) : [];
              for (a = 0; a < b.length; a++) {
                if (b[a].closest(this.theme.blink_params.SNAP_RADIUS, o.vec2.fromValues(f, d)).connection) {
                  v = !0;
                  break;
                }
              }
            ...
            if (v) {
              ...
              d += 2 * this.theme.blink_params.SNAP_RADIUS;
            }
          } while (v);
          l = {
            x: f,
          ...
          u.move_by(o.vec2.fromValues(f, d));
        }
      } finally {
        this.events.enable();
        if (s) {
      ...
      if (!(!this.events.is_enabled() || (0, h.is_block_svg)(u) && u.is_shadow())) {
        this.events.fire(this.create_event_factory({
          block: u
        }));
      }
      if ((0, h.is_block_svg)(u)) {
  ...
  e.prototype.center_on_block = function (e) {
    if (this._scrollbar) {
      ...
      if (t) {
        ...
        var h = u - l.contentTop;
        var d = f - l.viewWidth / 2;
        var p = h - l.viewHeight / 2;
        this.utils.hide_chaff();
        this._scrollbar.set(d, p);
      }
    }
  };
  ...
  e.getContentDimensionsBounded_ = function (e, t) {
    ...
    var h = Math.min(n.top - a, n.bottom - i);
    return {
      left: l,
      top: h,
      height: Math.max(n.bottom + a, n.top + i) - h,
      width: f - l
    };
  };
