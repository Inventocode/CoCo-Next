...
exports.block_render_svg = function (e) {
  return function (e) {
    ...
    t.prototype._render_compute = function (e) {
      for (var t, n = this.inputList, r = Object.assign([], {
          ...
          for (var l = 0; l < u.fieldRow.length; l++) {
            ...
            u.field_width += f.render_sep + h.width;
            u.field_height = Math.max(u.field_height, h.height);
          }
          if (u.render_width = 0, u.render_height = 0, u.connection) {
            var d = u.connection.targetBlock();
            if (d) {
              var p = d.get_height_width();
              if (d.is_shadow() && "param_color" !== d.element_type) {
    ...
    t.prototype.render_draw_right_ = function (e, t) {
      for (var n = i.vec2.create(), r = 0, c = 0, u = 0, l = t.length; u < l; u++) {
        ...
        if (f.type == o.InputRowType.INLINE) {
          if (h && h.type == o.InputRowType.STATEMENT && u !== l - 1) {
          ...
          if (f.type == o.InputRowType.STATEMENT) {
            if (void 0 != h && !this.is_starting_block() || 0 == this.inputs_inline) {
      ...
      if ((0, s.is_block_group)(this)) {
        var d = this.block_renderer.render_group_decoration_blocks(this);
        e.push("h " + d);
        n[0] += d;
        this.block_renderer.render_edge_shape_group_right(e, this);
        this.width += d + this.theme.renderer.GROUP_RIGHT_EXTENDED_WIDTH;
    ...
    t.prototype.render_row_inline_ = function (e, t, n, r, i, a) {
      ...
      var h = r.right_edge;
      var d = r[n - 1];
      if (void 0 != d && d.type === o.InputType.STATEMENT) {
        h = this.theme.renderer.STATEMENT_OTHER_ROW_MIN_WIDTH - this.theme.renderer.BLOCK_EDGE_WIDTH;
      }
      r.right_edge = Math.max(t[0], h);
