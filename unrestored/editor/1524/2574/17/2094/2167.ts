  ...
  e.prototype.set_block_offset_by_view = function (e) {
    if (this.workspace_) {
      ...
      if (this.horizontal_ ? (e = this.constrain_target_pos(-r.contentLeft - e), n.x = e) : (e = this.constrain_target_pos(-r.contentTop - e), n.y = e), e !== t) {
        ...
        if (this.horizontal_) {
          this.set_handle_position(i[0] * this.size_ratio_);
        } else {
          this.set_handle_position(i[1] * this.size_ratio_);
        }
...
var l = function () {
  ...
  e.prototype.set = function (e, t) {
    if (this.h_scroll && this.v_scroll && this.workspace_) {
      var n = this.workspace_.content_offset_by_view;
      var r = {
