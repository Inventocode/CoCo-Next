...
module.exports = function (e) {
  ...
  var c = function e(t, n, c) {
    ...
    var v = d ? i : i[n] || (i[n] = {});
    var m = v.prototype;
    var y = d ? r : p ? r[n] : (r[n] || {}).prototype;
    for (u in d && (c = n), c) if (!((l = !h && y && void 0 !== y[u]) && s(v, u))) {
      f = l ? y[u] : c[u];
      v[u] = d && "function" != typeof y[u] ? c[u] : A && l ? o(f, r) : g && y[u] == f ? function (e) {
  ...
  t.getUploadUrl = function (e, t) {
    ...
    return function (e) {
      try {
        ...
        return f(h() + "//api.qiniu.com/v2/query?ak=" + t.ak + "&bucket=" + t.bucket, {
          method: "GET"
        });
      } catch (e) {
  ...
  e.exports = function (e, t, n, p, _, A, g) {
    ...
    var S = O || b(_);
    var k = _ ? E ? b("entries") : S : void 0;
    var T = "Array" == t && C.entries || O;
    if (T && (y = l(T.call(new e()))) !== Object.prototype && y.next && (u(y, w, !0), r || "function" == typeof y[f] || a(y, f, d)), E && O && "values" !== O.name && (x = !0, S = function () {
      return O.call(this);
    }), r && !g || !h && !x && C[f] || a(C, f, S), s[t] = S, s[w] = d, _) {
      if (v = {
        values: E ? S : b("values"),
        keys: A ? S : b("keys"),
        entries: k
  ...
  t.__esModule = !0;
  t.pipeline = t.compressImage = t.exif = t.imageInfo = t.watermark = t.imageMogr2 = t.getUploadUrl = t.filterParams = t.getHeadersForMkFile = t.getResumeUploadedSize = t.getHeadersForChunkUpload = t.createMkFileUrl = t.region = t.upload = void 0;
  var r = n(39);
  var i = n(12);
  var o = n(92);
  var a = n(94);
  ...
  var D = !!function () {
    try {
      ...
      return (k || "function" == typeof PromiseRejectionEvent) && e.then(T) instanceof t && 0 !== O.indexOf("6.6") && -1 === b.indexOf("Chrome/66");
    } catch (e) {}
  }();
  var I = function (e) {
    var t;
  ...
  var R = function (e) {
    g.call(c, function () {
      ...
      }), e._h = k || P(e) ? 2 : 1), e._a = void 0, o && t.e) {
        throw t.v;
      }
    });
  };
  ...
  e.exports = !u || n(10)(function () {
    ...
    for (var n = s(e), u = arguments.length, l = 1, f = o.f, h = a.f; u > l;) {
      for (var d, p = c(arguments[l++]), _ = f ? i(p).concat(f(p)) : i(p), A = _.length, g = 0; A > g;) {
        d = _[g++];
        if (!(r && !h.call(p, d))) {
          n[d] = p[d];
        }
  ...
  function o(e, t, n) {
    ...
    d += a ? "/strip" : "";
    d += s ? "/gravity/" + encodeURIComponent(s) : "";
    d += u ? "/quality/" + encodeURIComponent(u) : "";
  ...
  function a(e, t, n) {
    ...
    var p = e.dx;
    var _ = e.dy;
    o += h ? "/dissolve/" + encodeURIComponent(h) : "";
  ...
  var a = function () {
    function e(t, n, r) {
      (0, o.default)(this, e);
      this.isStopped = !1;
      if ("object" === (void 0 === t ? "undefined" : (0, i.default)(t))) {
        this._onNext = t.next;
  ...
  var Y = function e(t, n, r) {
    ...
    n = w(n, !0);
    v(r);
    return i(U, n) ? (r.enumerable ? (i(t, N) && t[N][n] && (t[N][n] = !1), r = x(r, {
      enumerable: E(0, !1)
    })) : (i(t, N) || D(t, N, E(1, {})), t[N][n] = !0), W(t, n, r)) : D(t, n, r);
  };
  var q = function (e, t) {
    v(e);
  ...
  for (var re = T(d.store), ie = 0; re.length > ie;) {
    _(re[ie++]);
  }
  a(a.S + a.F * !G, "Symbol", {
    for: function (e) {
  ...
  var f = Math.log(2);
  var h = (0, s.default)(l).map(function (e) {
    return l[e];
  });
  var d = l.JPEG;
  var p = function () {
    ...
    e.prototype.doScale = function (e, t) {
      ...
      a.width = c;
      a.height = u;
      for (var d = void 0, p = void 0, _ = 0; _ < r; _++) {
        var A = c * o | 0;
        var g = u * o | 0;
        if (_ === r - 1) {
          A = l * t;
  ...
  (function () {
            ...
            if ("DOMParser" in self) {
              ...
              for (var n = 2, r = e.byteLength, i = new DOMParser(); n < r - 4;) {
                if ("http" == l(t, n, 4)) {
                  ...
                  return d(i.parseFromString(s, "text/xml"));
                }
                n++;
              }
            }
    ...
    function u(e, t, n, r, i) {
      ...
      var u;
      var f;
      var h = e.getUint16(t + 2, !i);
      var d = e.getUint32(t + 4, !i);
      ...
      switch (h) {
        ...
        case 7:
          ...
          for (o = d > 4 ? p : t + 8, a = [], c = 0; c < d; c++) {
            a[c] = e.getUint8(o + c);
          }
          return a;
        case 2:
          return l(e, o = d > 4 ? p : t + 8, d - 1);
        case 3:
          if (1 == d) {
            return e.getUint16(t + 8, !i);
          }
          for (o = d > 2 ? p : t + 8, a = [], c = 0; c < d; c++) {
