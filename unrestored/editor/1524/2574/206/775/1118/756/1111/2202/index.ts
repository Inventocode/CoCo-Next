...
var h = /^(?:Function(?:Declaration|Expression)|ArrowFunctionExpression)$/;
var d = /^(?:DoWhile|For|ForIn|ForOf|While)Statement$/;
var p = /Array$/;
    ...
    for (var o = null === e.id, a = e; a;) {
      ...
      switch (s.type) {
        ...
        case "MemberExpression":
          return s.object !== a || "Identifier" !== s.property.type || !A.test(s.property.name) || !T(s) || 0 === s.parent.arguments.length || k(s.parent.arguments[0]);
        case "CallExpression":
          return B(s.callee) ? 3 !== s.arguments.length || s.arguments[0] !== a || k(s.arguments[1]) : D(s.callee) ? 3 !== s.arguments.length || s.arguments[1] !== a || k(s.arguments[2]) : !I(s.callee) || 2 !== s.arguments.length || s.arguments[0] !== a || k(s.arguments[1]);
        default:
          return !0;
      }
    }
