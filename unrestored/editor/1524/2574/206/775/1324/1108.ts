...
function p(e, t) {
  return e < 65 ? 36 === e : e < 91 || (e < 97 ? 95 === e : e < 123 || (e <= 65535 ? e >= 170 && u.test(String.fromCharCode(e)) : !1 !== t && d(e, f)));
}
function _(e, t) {
  return e < 48 ? 36 === e : e < 58 || !(e < 65) && (e < 91 || (e < 97 ? 95 === e : e < 123 || (e <= 65535 ? e >= 170 && l.test(String.fromCharCode(e)) : !1 !== t && (d(e, f) || d(e, h)))));
}
var A = function (e, t) {
  if (void 0 === t) {
    t = {};
...
ve.regexp_eatHexDigits = function (e) {
  ...
  for (e.lastIntValue = 0; Oe(n = e.current());) {
    e.lastIntValue = 16 * e.lastIntValue + Se(n);
    e.advance();
  }
  return e.pos !== t;
};
...
ve.regexp_eatOctalDigit = function (e) {
  var t = e.current();
  return ke(t) ? (e.lastIntValue = t - 48, e.advance(), !0) : (e.lastIntValue = 0, !1);
};
ve.regexp_eatFixedHexDigits = function (e, t) {
  ...
  for (var r = 0; r < t; ++r) {
    ...
    e.lastIntValue = 16 * e.lastIntValue + Se(i);
    e.advance();
  }
  return !0;
};
