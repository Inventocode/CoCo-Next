    ...
    return function (e, t) {
      ...
      return function (t) {
        ...
        i(h, [{
          ...
          key: "parseExprAtom",
          value: function (e) {
            return this.type === g.jsxText ? this.jsx_parseText() : this.type === g.jsxTagStart ? this.jsx_parseElement() : o(a(h.prototype), "parseExprAtom", this).call(this, e);
          }
        }, {
          key: "readToken",
          value: function (e) {
            ...
            return 60 === e && this.exprAllowed && 33 !== this.input.charCodeAt(this.pos + 1) ? (++this.pos, this.finishToken(g.jsxTagStart)) : o(a(h.prototype), "readToken", this).call(this, e);
          }
        }, {
          key: "updateContext",
          value: function (e) {
            if (this.type == A.braceL) {
              ...
              if (t == m) {
                ...
                if (t == b) {
                  ...
                  o(a(h.prototype), "updateContext", this).call(this, e);
                }
              }
              this.exprAllowed = !0;
            } else {
              if (this.type !== A.slash || e !== g.jsxTagStart) {
                return o(a(h.prototype), "updateContext", this).call(this, e);
              }
