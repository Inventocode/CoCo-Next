...
function u(e, t) {
  ...
  return h.call(this, n, o, e.schema, e);
}
function l(e, t, n) {
...
c.ids = function (e) {
  ...
  s(e, {
    allKeys: !0
  }, function (e, t, s, l, f, h, d) {
    if ("" !== t) {
      var p = u._getId(e);
      var _ = n[l];
      var A = a[l] + "/" + f;
      if (void 0 !== d && (A += "/" + ("number" == typeof d ? d : o.escapeFragment(d))), "string" == typeof p) {
