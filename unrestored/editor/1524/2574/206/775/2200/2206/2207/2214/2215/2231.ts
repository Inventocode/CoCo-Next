...
module.exports = function (e, t, n) {
  ...
  if (r += "var " + f + " = errors;var " + p + " = true;", T && (r += " var " + m + " = undefined;"), k) {
    ...
    if ("all" == S) {
      ...
      if (e.opts._errorDataPathProperty && (e.errorPath = e.util.getPathExpr(e.errorPath, _, e.opts.jsonPointers)), C) {
        ...
        if ("failing" == S) {
          ...
          h.errorPath = e.opts._errorDataPathProperty ? e.errorPath : e.util.getPathExpr(e.errorPath, _, e.opts.jsonPointers);
          var Q = l + "[" + _ + "]";
          h.dataPathArr[g] = _;
          var W = e.validate(h);
          h.baseId = B;
          ...
          e.compositeRule = h.compositeRule = z;
        } else {
          h.schema = E;
          h.schemaPath = e.schemaPath + ".additionalProperties";
          h.errSchemaPath = e.errSchemaPath + "/additionalProperties";
    ...
    if (X) {
      for (var Y, q = -1, $ = X.length - 1; q < $;) {
        ...
        if (e.opts.strictKeywords ? "object" == typeof J && Object.keys(J).length > 0 || !1 === J : e.util.schemaHasRules(J, e.RULES.all)) {
          ...
          h.errorPath = e.util.getPath(e.errorPath, Y, e.opts.jsonPointers);
          h.dataPathArr[g] = e.util.toQuotedString(Y);
          W = e.validate(h);
          if (h.baseId = B, e.util.varOccurences(W, v) < 2) {
  ...
  if (w.length) {
    ...
    if (ie) {
      for (var oe, ae = -1, se = ie.length - 1; ae < se;) {
        ...
        if (e.opts.strictKeywords ? "object" == typeof J && Object.keys(J).length > 0 || !1 === J : e.util.schemaHasRules(J, e.RULES.all)) {
          h.schema = J;
          h.schemaPath = e.schemaPath + ".patternProperties" + e.util.getProperty(oe);
          h.errSchemaPath = e.errSchemaPath + "/patternProperties/" + e.util.escapeFragment(oe);
          r += T ? " " + m + " = " + m + " || Object.keys(" + l + "); for (var " + A + "=0; " + A + "<" + m + ".length; " + A + "++) { var " + _ + " = " + m + "[" + A + "]; " : " for (var " + _ + " in " + l + ") { ";
          r += " if (" + e.usePattern(oe) + ".test(" + _ + ")) { ";
          h.errorPath = e.util.getPathExpr(e.errorPath, _, e.opts.jsonPointers);
          Q = l + "[" + _ + "]";
          h.dataPathArr[g] = _;
          W = e.validate(h);
          h.baseId = B;
