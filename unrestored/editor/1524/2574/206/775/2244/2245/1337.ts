...
export { k as isNotSemicolonToken };
...
import * as o from "../../../../27";
import * as a from "../../../../40";
import * as s from "../../../../36/461";
import * as c from "../../../../25/index";
import * as u from "../../../../47";
import * as l from "../../766/index";
function f(e, t) {
  var n = t.range[0];
  var r = e;
  var i = !1;
        ...
        for (;;) {
          switch (e.prev = e.next) {
            ...
            case 15:
              ...
              if (h = f.value, d = [], !pe(p = this.globalScope.set.get(h))) {
                e.next = 21;
                break;
              }
              return e.abrupt("continue", 22);
            case 21:
              return e.delegateYield(this._iterateVariableReferences(p, d, t, !1), "t1", 22);
            case 22:
              e.next = 15;
              break;
            case 24:
    ...
    value: i.mark(function e(t) {
      ...
      return i.wrap(function (e) {
        for (;;) {
          switch (e.prev = e.next) {
            case 0:
              n = Object(u.a)(this.iterateGlobalReferences(de));
              e.prev = 1;
              n.s();
            case 3:
              if ((r = n.n()).done) {
        ...
        for (;;) {
          switch (e.prev = e.next) {
            ...
            case 32:
              ...
              if (g = A.value, v = ce(c, he), m = this._iterateImportReferences(g, l, v ? c : "legacy" === this.mode ? Object.assign({
                default: c
              }, c) : {
                default: c
              }), !v) {
        ...
        for (;;) {
          switch (e.prev = e.next) {
            case 0:
              ...
              if (null == (o = h(this.globalScope, t))) {
                e.next = 4;
                break;
              }
            ...
            case 19:
              return e.delegateYield(this._iterateLhsReferences(c.value, f, d), "t1", 20);
            case 20:
              e.next = 9;
              break;
            case 22:
      ...
      return i.wrap(function (e) {
        for (;;) {
          switch (e.prev = e.next) {
            ...
            case 10:
              return e.delegateYield(this._iterateVariableReferences(h(this.globalScope, t.local), n, s, !1), "t0", 11);
            case 11:
              return e.abrupt("return");
            case 12:
              ...
              return e.delegateYield(this._iterateVariableReferences(h(this.globalScope, t.local), n, r, !1), "t1", 14);
            case 14:
              return e.abrupt("return");
            case 15:
