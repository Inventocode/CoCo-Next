...
function p(e, t, n, r) {
  ...
  for (var i = t.range[1] <= n.range[0] ? [t, n] : [n, t], o = c(i, 2), a = o[0], s = o[1], u = e.getLastToken(a) || a, l = e.getFirstToken(s) || s, f = u; f !== l;) {
    var h = e.getTokenAfter(f, {
      includeComments: !0
    });
    if (f.range[1] !== h.range[0] || r && h !== l && "JSXText" === h.type && /[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]/.test(h.value)) {
      return !0;
    }
    f = h;
  }
...
var _ = function (e) {
  ...
  function n(e, i) {
    ...
    a.visitorKeys = d || h.DEFAULT_VISITOR_KEYS;
  ...
  i(n, [{
    ...
    value: function (e) {
      ...
      var t = d.sortedLastIndex(this.lineStartIndices, e);
      return {
        line: t,
