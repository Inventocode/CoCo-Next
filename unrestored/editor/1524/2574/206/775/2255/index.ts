...
function _(e, t) {
  ...
  var h = Math.max(u.length, f.length);
  for (n = 0; n < h; ++n) {
    if ((r = u[n]) !== (i = f[n]) && r) {
  ...
  for (a.currentSegments = f, n = 0; n < h; ++n) {
    if ((r = u[n]) !== (i = f[n]) && i) {
...
function A(e, t) {
  ...
  switch (t.type) {
    ...
    case "SwitchStatement":
      r.pushSwitchContext(t.cases.some(f), d(t));
      break;
    case "TryStatement":
