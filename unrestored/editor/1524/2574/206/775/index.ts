...
(function (t) {
  ...
  var a = require("../../../../3262/3188/2658/230");
  var s = require("./1049");
  var c = require("../../../../3262/3190/624/index");
  var u = require("../../../../3262/2873/2721/805/index");
  var l = require("../../../../3262/3190/494");
  var f = require("../../../../3262/3188/1184/index");
  var h = require("./2179/index");
  var d = require("./766/index");
  var p = require("./1324/index");
  var _ = require("../../31/index");
  var A = require("./1326/index");
  var g = require("./2199");
  var v = require("./964");
  var m = require("./1109");
  var y = require("./2200/index");
  var b = require("./1336");
  var w = require("./2244/index").SourceCode;
  var E = require("./2255/index");
  var x = require("./2259");
  var C = require("./2260/index");
  var O = require("./2271/index");
  var S = require("./2273/index");
  var k = require("./1118/index");
  var T = require("./2276");
  var B = require("./2277");
  var D = require("./2278");
  var I = require("./2279");
  var F = require("./806/index")("eslint:linter");
  var R = new C();
  var P = {
    start: {
      line: 1,
  ...
  function M(e, t, n, r) {
    ...
    t.comments.filter(function (e) {
      ...
      var t = e.value.trim();
      var h = /^(eslint(?:\x2Denv|\x2Denable|\x2Ddisable(?:(?:\x2Dnext)?\x2Dline)?)?|exported|globals?)(?:[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]|$)/.exec(t);
      if (h) {
        var d = h[1];
        var p = /^eslint\x2Ddisable\x2D(next\x2D)?line$/.test(d);
        if ("Line" !== e.type || p) {
          if (r) {
            var _ = "Block" === e.type ? "/*".concat(d, "*/") : "//".concat(d);
            s.push(N({
              ruleId: null,
            ...
            var A = "".concat(d, " comment should not span multiple lines.");
            s.push(N({
              ruleId: null,
              message: A,
              loc: e.loc
            ...
            var g = t.slice(h.index + d.length);
            switch (d) {
              case "eslint-disable":
              case "eslint-enable":
  ...
  function z(e, t, n, r, i, o, a, s, c) {
    ...
    var h = Object.freeze(Object.assign(Object.create(G), {
    ...
    Object.keys(t).forEach(function (r) {
      ...
      if (0 !== i) {
        ...
        if (null !== o) {
          ...
          var l = null;
          var f = Object.freeze(Object.assign(Object.create(h), {
            id: r,
    ...
    a(e, [{
      ...
      value: function (e, t, n) {
        ...
        if (i.lastSourceCode) {
          ...
          var k = function (e, t, n, r) {
            ...
            try {
              ...
              var f = "Parsing error: ".concat(h.message.replace(/^line [0-9]+:/i, "").trim());
              F("%s\n%s", f, h.stack);
              return {
                success: !1,
                error: {
        ...
        !function (e, t, n) {
          ...
          try {
            for (a.s(); !(r = a.n()).done;) {
              ...
              var d = o[s] && o[s].comments;
              if ("off" !== f) {
                var p = e.set.get(s);
                if (!p) {
                  p = new h.Variable(s, e);
                  e.variables.push(p);
                  e.set.set(s, p);
                }
                p.eslintImplicitGlobalSetting = c;
                p.eslintExplicitGlobal = void 0 !== d;
                p.eslintExplicitGlobalComments = d;
        ...
        try {
          D = z(T, I, function (e) {
            return Q(i, e);
          }, C, s, S, a.filename, a.disableFixes, i.cwd);
        } catch (N) {
          ...
          throw F("Parser Options:", C), F("Parser Path:", s), F("Settings:", S), N;
        }
        return x({
      ...
      value: function (e, t, n, r) {
        ...
        var h = n.filterCodeBlock || function (e) {
        ...
        return l(u(c, s).map(function (e, s) {
          ...
          return h(u, c) ? r && f.extname(u) !== d ? (F("Resolving configuration again because the file extension was changed."), o._verifyWithConfigArray(c, r, i(i({}, n), {}, {
            filename: u
