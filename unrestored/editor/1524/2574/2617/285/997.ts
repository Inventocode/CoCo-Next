...
(function (e) {
  ...
  function A(e, t, n, r, i) {
    ...
    var u = 0;
    var l = [];
    var h = new Promise(function (t, o) {
      var h = function (e) {
  ...
  var m = function (e, t, n, r, i, o) {
    if (!(!e.required || n.hasOwnProperty(e.field) && !d(t, o || e.type))) {
      r.push(h(i.messages.required, e.fullField));
    }
  };
  var y = {
  ...
  var w = {
    ...
    whitespace: function (e, t, n, r, i) {
      if (/^\s+$/.test(t) || "" === t) {
        r.push(h(i.messages.whitespace, e.fullField));
      }
    },
    type: function (e, t, n, r, i) {
      if (e.required && void 0 === t) {
        ...
        if (["integer", "float", "array", "regexp", "object", "method", "email", "number", "date", "url", "hex"].indexOf(o) > -1) {
          if (!b[o](t)) {
            r.push(h(i.messages.types[o], e.fullField, e.type));
          }
        } else {
    ...
    range: function (e, t, n, r, i) {
      ...
      if (l ? u = "number" : f ? u = "string" : d && (u = "array"), !u) {
        return !1;
      }
      if (d) {
        c = t.length;
      ...
      if (o) {
        if (c !== e.len) {
          r.push(h(i.messages[u].len, e.fullField, e.len));
        }
      } else {
        if (a && !s && c < e.min) {
          r.push(h(i.messages[u].min, e.fullField, e.min));
        } else {
          if (s && !a && c > e.max) {
            r.push(h(i.messages[u].max, e.fullField, e.max));
          } else {
            if (a && s && (c < e.min || c > e.max)) {
              r.push(h(i.messages[u].range, e.fullField, e.min, e.max));
            }
          }
        }
      }
    ...
    enum: function (e, t, n, r, i) {
      ...
      if (-1 === e.enum.indexOf(t)) {
        r.push(h(i.messages.enum, e.fullField, e.enum.join(", ")));
      }
    },
    pattern: function (e, t, n, r, i) {
      if (e.pattern) {
        if (e.pattern instanceof RegExp) {
          ...
          if (!e.pattern.test(t)) {
            r.push(h(i.messages.pattern.mismatch, e.fullField, t, e.pattern));
          }
  ...
  var x = {
    ...
    date: function (e, t, n, r, i) {
      var o = [];
      if (e.required || !e.required && r.hasOwnProperty(e.field)) {
        if (d(t, "date") && !e.required) {
          return n();
        }
        var a;
        if (w.required(e, t, r, o, i), !d(t, "date")) {
          ...
          if (c) {
            if (o.required && !t.value) {
              if (void 0 !== o.message) {
                ...
                if (s.error) {
                  f = [s.error(o, h(s.messages.required, o.field))];
                }
              }
              return n(f);
            }
