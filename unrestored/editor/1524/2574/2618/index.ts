...
function D(e, t) {
  return Object.keys(k(k({}, e), t)).reduce(function (n, r) {
    n[r] = k(k({}, e[r] || {}), t[r] || {});
    return n;
  }, {});
}
...
function R(e, t, n, r) {
  ...
  var f = e.onError;
  var h = e.timeZone;
  var d = e.wrapRichTextChunksInFragment;
  if (void 0 === n) {
    n = {
      id: ""
    };
  ...
  var v = r && function (e) {
    return Object.keys(e).reduce(function (t, n) {
      var r = e[n];
      t[n] = Object(S.b)(r) ? Object(o.b)(r) : r;
      return t;
    }, {});
  }(r);
  if (s = I(s, h), l = I(l, h), !g) {
    if ((!_ || i && i.toLowerCase() !== u.toLowerCase()) && f(new a.d(n, i)), _) {
      try {
        return F(t.getMessageFormat(_, u, l).format(v), d);
      } catch (m) {
...
function L(e, t, n, r) {
  ...
  try {
    ...
    s(new a.e("FORMAT_ERROR", "Error formatting list.", h));
  }
  return n;
}
