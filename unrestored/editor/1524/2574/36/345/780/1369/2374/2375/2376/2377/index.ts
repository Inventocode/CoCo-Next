...
var l = require("./1378/index")();
var f = Object.getPrototypeOf || function (e) {
  return e.__proto__;
};
var h = {};
var d = "undefined" === typeof Uint8Array ? void 0 : f(Uint8Array);
var p = {
...
module.exports = function (e, t) {
  ...
  for (var h = 1, d = !0; h < n.length; h += 1) {
    ...
    if ("constructor" !== _ && d || (l = !0), g(p, c = "%" + (i += "." + _) + "%")) {
      u = p[c];
    } else if (null != u) {
      if (!(_ in u)) {
        if (!t) {
      ...
      if (s && h + 1 >= n.length) {
        var w = s(u, _);
        u = (d = !!w) && "get" in w && !("originalValue" in w.get) ? w.get : u[_];
      } else {
        d = g(u, _);
        u = u[_];
      }
