...
var l = require("../2377/1378/index")();
var f = Object.getPrototypeOf || function (e) {
  return e.__proto__;
};
var h = a("async function* () {}");
var d = h ? h.prototype : void 0;
var p = d ? d.prototype : void 0;
...
import * as v from "../2377/968/index";
import * as m from "../2377/1379";
...
module.exports = function (e, t) {
  ...
  for (var f = 1, h = !0; f < n.length; f += 1) {
    var d = n[f];
    if ("constructor" !== d && h || (u = !0), m(A, a = "%" + (r += "." + d) + "%")) {
      c = A[a];
    } else if (null != c) {
      if (s && f + 1 >= n.length) {
        var p = s(c, d);
        ...
        c = h && "get" in p && !("originalValue" in p.get) ? p.get : c[d];
      } else {
        h = m(c, d);
        c = c[d];
      }
