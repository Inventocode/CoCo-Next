...
var h = "function" === typeof WeakSet && WeakSet.prototype ? WeakSet.prototype.has : null;
var d = Boolean.prototype.valueOf;
...
module.exports = function e(t, n, r, i) {
  ...
  if ("function" === typeof t) {
    ...
    var k = M(t, b);
    return "[Function" + (w ? ": " + w : " (anonymous)") + "]" + (k.length > 0 ? " { " + k.join(", ") + " }" : "");
  }
  if (S(t)) {
    var j = y.call(t);
