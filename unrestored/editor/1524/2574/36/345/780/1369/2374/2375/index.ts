...
var _ = {};
var A = function e(t, n, o, a, s, l, h, d, A, g, v, m, y, b, w) {
  for (var E, x = t, C = w, O = 0, S = !1; void 0 !== (C = C.get(_)) && !S;) {
    var k = C.get(t);
    if (O += 1, "undefined" !== typeof k) {
      if (k === O) {
  ...
  if ("function" === typeof h ? x = h(n, x) : x instanceof Date ? x = g(x) : "comma" === o && c(x) && (x = i.maybeMap(x, function (e) {
  ...
  for (var N = 0; N < F.length; ++N) {
    ...
    if (!s || null !== j) {
      ...
      var U = r();
      U.set(_, w);
      f(R, e(j, L, o, a, s, l, h, d, A, g, v, m, y, b, U));
    }
  }
  return R;
};
module.exports = function (e, t) {
  ...
  for (var _ = r(), g = 0; g < n.length; ++g) {
    ...
    if (!(u.skipNulls && null === i[v])) {
      f(h, A(i[v], v, d, u.strictNullHandling, u.skipNulls, u.encode ? u.encoder : null, u.filter, u.sort, u.allowDots, u.serializeDate, u.format, u.formatter, u.encodeValuesOnly, u.charset, _));
    }
  }
  var m = h.join(u.delimiter);
