...
module.exports = function (e, t) {
  ...
  for (var l = "string" === typeof e ? function (e, t) {
      ...
      var h = l.split(t.delimiter, f);
      var d = -1;
      var p = t.charset;
      if (t.charsetSentinel) {
        for (n = 0; n < h.length; ++n) {
          if (0 === h[n].indexOf("utf8=")) {
            if ("utf8=%E2%9C%93" === h[n]) {
              p = "utf-8";
            } else {
              if ("utf8=%26%2310003%3B" === h[n]) {
                p = "iso-8859-1";
              }
            }
            d = n;
      ...
      return u;
    }(e, n) : e, f = n.plainObjects ? Object.create(null) : {}, h = Object.keys(l), d = 0; d < h.length; ++d) {
    var p = h[d];
