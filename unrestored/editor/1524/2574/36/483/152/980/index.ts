...
var S = ["config", "onProps", "onStart", "onChange", "onPause", "onResume", "onRest"];
var k = {
  config: 1,
  from: 1,
  to: 1,
...
function q(e, t, n, r) {
  ...
  var s = n.asyncTo;
  var c = n.promise;
  return o || e !== s || t.reset ? n.promise = Object(p.a)(d.a.mark(function u() {
    var l;
    var f;
    var h;
    var _;
        ...
        switch (u.prev = u.next) {
          case 0:
            if (n.asyncId = i, n.asyncTo = e, l = O(t, function (e, t) {
              ...
              var o = new J();
              var a = new Z();
              return Object(p.a)(d.a.mark(function s() {
                var c;
                var u;
                return d.a.wrap(function (s) {
                  for (;;) {
...
var ue = function (e) {
  ...
  Object(c.a)(n, [{
          ...
          if (!f) {
            ...
            if (g.s.und(o.duration)) {
              if (o.decay) {
                ...
                h = _ + A / (1 - v) * (1 - y);
                f = Math.abs(c.lastPosition - h) < .1;
                d = A * y;
              } else {
                d = null == c.lastVelocity ? A : c.lastVelocity;
                for (var b = o.precision || (_ == l ? .005 : Math.min(1, .001 * Math.abs(l - _))), w = o.restVelocity || b / 10, E = o.clamp ? 0 : o.bounce, x = !g.s.und(E), C = _ == l ? c.v0 > 0 : _ < l, O = Math.ceil(e / 1), S = 0; S < O && (Math.abs(d) > w || !(f = Math.abs(l - h) <= b)); ++S) {
                  if (x && (h == l || h > l == C)) {
                    d = -d * E;
                    h = l;
                  }
                  h += 1 * (d += 1 * ((1e-6 * -o.tension * (h - l) + .001 * -o.friction * d) / o.mass));
                }
              }
            } else {
              var k = 1;
              if (o.duration > 0) {
                ...
                k = (k = (o.progress || 0) + p / t._memoizedDuration) > 1 ? 1 : k < 0 ? 0 : k;
                c.durationProgress = k;
              }
              d = ((h = _ + o.easing(k) * (l - _)) - c.lastPosition) / e;
              f = 1 == k;
            }
            c.lastVelocity = d;
            if (Number.isNaN(h)) {
    ...
    value: function (e, t, n) {
      ...
      var d = e.from;
      var p = void 0 === d ? l : d;
      if (!o || i || t.default && !g.s.und(h) || (h = p), t.reverse) {
        var _ = [p, h];
        h = _[0];
        p = _[1];
      }
      ...
      var S = Object(m.e)(this);
      if (!S || g.s.und(h)) {
        return n(X(this, !0));
      }
      var k = g.s.und(t.reset) ? o && !t.default : !g.s.und(p) && w(t.reset, a);
      var T = k ? p : this.get();
      var D = B(h);
      ...
      if (v) {
        ...
        if (P !== S.constructor) {
          if (!R) {
            throw Error("Cannot animate between ".concat(S.constructor.name, " and ").concat(P.name, ', as the "to" prop suggests'));
          }
          S = this._set(D);
        }
      }
      ...
      if (j && oe(this) && (c.changed && !k ? M = !0 : M || this._stop(u)), !E && ((M || Object(g.r)(u)) && (c.values = S.getPayload(), c.toValues = Object(g.r)(h) ? null : N == m.b ? [1] : Object(g.y)(D)), c.immediate != R && (c.immediate = R, R || k || this._set(u)), M)) {
        var H = c.onRest;
...
var ye = function () {
  ...
  Object(c.a)(e, [{
    ...
    value: function (e) {
      var t = this.queue;
      if (e) {
        t = Object(g.y)(e).map(he);
      } else {
        this.queue = [];
      }
      return this._flush ? this._flush(this, t) : (ke(this, t), be(this, t));
    }
  }, {
    key: "stop",
    value: function (e, t) {
...
function Ee() {
  return (Ee = Object(p.a)(d.a.mark(function e(t, n, r) {
    var i;
    var o;
    var a;
    var s;
      ...
      for (;;) {
        switch (e.prev = e.next) {
          case 0:
            ...
            }), h = t._state, n.pause === !h.paused ? (h.paused = n.pause, Object(g.n)(n.pause ? h.pauseQueue : h.resumeQueue)) : h.paused && (n.pause = !0), p = (i || Object.keys(t.springs)).map(function (e) {
              return t.springs[e].start(n);
            }), _ = !0 === n.cancel || !0 === x(n, "cancel"), (f || _ && h.asyncId) && p.push(Q(++t._lastAsyncId, {
              props: n,
              state: h,
              actions: {
                pause: g.v,
...
function Ne(e, t, n) {
  ...
  Object(v.useMemo)(function () {
    Object(g.k)(l.current.slice(e, h), function (e) {
      F(e, a);
      e.stop(!0);
    });
    l.current.length = e;
