  ...
  var x = function () {
    ...
    A.startOf = function (e, t) {
      ...
      switch (h) {
        ...
        case c:
          return u ? d(1, A) : d(0, A + 1);
        case s:
          var m = this.$locale().weekStart || 0,
            y = (_ < m ? _ + 7 : _) - m;
          return d(u ? g - y : g + (6 - y), A);
        case a:
        case f:
          return p(v + "Hours", 0);
        case o:
    ...
    A.$set = function (e, t) {
      ...
      var d = (s = {}, s[a] = h + "Date", s[f] = h + "Date", s[c] = h + "Month", s[l] = h + "FullYear", s[o] = h + "Hours", s[i] = h + "Minutes", s[r] = h + "Seconds", s[n] = h + "Milliseconds", s)[u];
    ...
    A.add = function (n, u) {
      ...
      var _ = (f = {}, f[i] = e, f[o] = t, f[r] = 1e3, f)[d] || 1;
    ...
    A.format = function (e) {
      ...
      var d = n.meridiem || function (e, t, n) {
        var r = e < 12 ? "AM" : "PM";
    ...
    A.diff = function (n, f, h) {
      ...
      var g = this - _;
      var v = E.m(this, _);
      v = (d = {}, d[l] = v / 12, d[c] = v, d[u] = v / 3, d[s] = (g - A) / 6048e5, d[a] = (g - A) / 864e5, d[o] = g / t, d[i] = g / e, d[r] = g / 1e3, d)[p] || g;
      return h ? v : E.a(v);
    };
