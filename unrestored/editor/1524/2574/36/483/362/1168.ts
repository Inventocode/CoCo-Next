...
var _ = function () {
  function e(t) {
    ...
    Object(c.e)(this, "_targetEventStore", new d(this));
  ...
  Object(a.a)(e, [{
    ...
    value: function () {
      ...
      if (!s.target || (a = s.target())) {
        ...
        if (s.enabled) {
          var h;
          var d = Object(i.a)(this.gestures);
          try {
            for (d.s(); !(h = d.n()).done;) {
              var p = h.value;
...
function A(e, t) {
  e.gestures.add(t);
  e.gestureEventStores[t] = new d(e);
...
var g = function (e, t, n) {
  return function (r, i, o) {
    ...
    var h = null !== (s = u.passive) && void 0 !== s ? s : t.passive;
    var d = l ? r : Object(c.h)(r, i, f);
    if (n && h) {
      d += "Passive";
    }
    e[d] = e[d] || [];
