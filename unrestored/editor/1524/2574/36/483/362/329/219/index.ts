...
var R = function () {
  ...
  Object(f.a)(e, [{
    ...
    value: function (e) {
      ...
      var a = Object(d.a)(t._movement, 2);
      var s = a[0];
      var c = a[1];
      var u = Object(d.a)(n.threshold, 2);
      var l = u[0];
      var f = u[1];
      var h = t._step;
      var _ = t.values;
      if (n.hasCustomTransform ? (!1 === h[0] && (h[0] = Math.abs(s) >= l && _[0]), !1 === h[1] && (h[1] = Math.abs(c) >= f && _[1])) : (!1 === h[0] && (h[0] = Math.abs(s) >= l && Math.sign(s) * l), !1 === h[1] && (h[1] = Math.abs(c) >= f && Math.sign(c) * f)), t.intentional = !1 !== h[0] || !1 !== h[1], t.intentional) {
        var A = [0, 0];
        if (n.hasCustomTransform) {
          var g = Object(d.a)(_, 2);
          var v = g[0];
          var m = g[1];
          A[0] = !1 !== h[0] ? v - h[0] : 0;
          A[1] = !1 !== h[1] ? m - h[1] : 0;
    ...
    value: function (e) {
      ...
      if (t._pointerActive) {
        ...
        if (!t._pointerId || r === t._pointerId) {
          ...
          this.setActive();
          this.compute(e);
          var i = Object(d.a)(t._distance, 2);
          var o = i[0];
          var a = i[1];
          if (t.tap = o <= 3 && a <= 3, t.tap && n.filterTaps) {
            t._force = !0;
          } else {
            var s = Object(d.a)(t.direction, 2);
            var c = s[0];
            var u = s[1];
            var l = Object(d.a)(t.velocity, 2);
            var f = l[0];
            var h = l[1];
            var p = Object(d.a)(t.movement, 2);
            var _ = p[0];
            var A = p[1];
            var g = Object(d.a)(n.swipe.velocity, 2);
            var v = g[0];
            var m = g[1];
            var y = Object(d.a)(n.swipe.distance, 2);
            var b = y[0];
            var w = y[1];
