import * as r from "../1969/1298/index";
import * as i from "../1969/837";
var o = require("../1969/1299").ArraySet;
var a = require("./1968").MappingList;
function s(e) {
  if (!e) {
    e = {};
  }
...
s.prototype._serializeMappings = function () {
  for (var e, t, n, o, a = 0, s = 1, c = 0, u = 0, l = 0, f = 0, h = "", d = this._mappings.toArray(), p = 0, _ = d.length; p < _; p++) {
    if (e = "", (t = d[p]).generatedLine !== s) {
...
export { s as SourceMapGenerator };