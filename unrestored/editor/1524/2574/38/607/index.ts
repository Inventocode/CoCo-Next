(function (e, r) {
  ...
  var o = require("../../206/775/1049");
  var a = require("../../../../3262/3190/494");
  var s = require("../../../../3262/3188/2658/230");
  var c = require("../../../../3262/2873/2721/805/index");
  var u = require("../../../../3262/3188/2658/220");
  var l = require("../../../../3262/3188/2658/2679/356/index");
  var f = require("../../../../3262/3188/2658/2679/357/index");
  var h = require("./1963/index");
  !function (t, n) {
    "use strict";
    ...
    var X = k(["in", "instanceof", "typeof", "new", "void", "delete", "++", "--", "+", "-", "!", "~", "&", "|", "^", "*", "**", "/", "%", ">>", "<<", ">>>", "<", ">", "<=", ">=", "==", "===", "!=", "!==", "?", "=", "+=", "-=", "/=", "*=", "**=", "%=", ">>=", "<<=", ">>>=", "|=", "^=", "&=", "&&", "??", "||"]);
    var Y = k(d(" \xa0\n\r\t\f\v\u200b\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u2028\u2029\u202f\u205f\u3000\ufeff"));
    var q = k(d("\n\r\u2028\u2029"));
    var $ = k(d(";]),:"));
    var J = k(d("[{(,;:"));
    ...
    function pe(e, t, n, r) {
      ...
      function A(e) {
        ...
        if (e && (u = e + u), G.test(u) && T.has_directive("use strict") && _("Legacy octal literals are not allowed in strict mode"), c && (u.endsWith("_") ? _("Numeric separators are not allowed at the end of numeric literals") : u.includes("__") && _("Only one underscore is allowed as numeric separator"), u = u.replace(/_/g, "")), u.endsWith("n")) {
          var l = u.slice(0, -1);
          var f = ue(l, V.test(l));
      ...
      var y = k("Unterminated string constant", function () {
        for (var e = a(), t = "";;) {
          var n = a(!0, !0);
          if ("\\" == n) {
            n = v(!0, !0);
      ...
      var b = k("Unterminated template", function (e) {
        if (e) {
        ...
        for (a(!0, !0); "`" != (t = a(!0, !0));) {
          if ("\r" == t) {
            ...
            a(!0, !0);
            i.brace_counter++;
            (n = d(e ? "template_head" : "template_substitution", r)).raw = s;
            return n;
          }
          if (s += t, "\\" == t) {
            var c = i.pos;
            t = v(!0, !(h && ("name" === h.type || "punc" === h.type && (")" === h.value || "]" === h.value))), !0);
      ...
      function w(e) {
        ...
        i.comments_before.push(d(e, t, !0));
        i.regex_allowed = n;
        return T;
      }
      var E = k("Unterminated multiline comment", function () {
        ...
        i.comments_before.push(d("comment2", n, !0));
        i.newline_before = i.newline_before || n.includes("\n");
        i.regex_allowed = e;
        return T;
      });
      var x = k("Unterminated identifier name", function () {
        var e;
        var t;
        var n = !1;
        var r = function () {
      ...
      var C = k("Unterminated regular expression", function (e) {
      ...
      function O(e) {
        return d("operator", function e(t) {
          if (!o()) {
            return t;
          }
          var n = t + o();
      ...
      function T(e) {
        ...
        for (r && 0 == i.pos && c("#!") && (l(), s(2), w("comment5"));;) {
          ...
          switch (u) {
            ...
            case 46:
              a();
              return ie(o().charCodeAt(0)) ? A(".") : "." === o() ? (a(), a(), d("expand", "...")) : d("punc", ".");
            case 47:
              var h = S();
              if (h === T) {
                continue;
          ...
          if (92 == u || oe(t)) {
            g = x();
            return f ? d("name", g) : M.has(g) ? d("atom", g) : N.has(g) ? X.has(g) ? d("operator", g) : d("keyword", g) : d("name", g);
          }
          break;
        }
        var g;
    ...
    var me = k(["atom", "num", "big_int", "string", "regexp", "name"]);
    function ye(e, t) {
      var n = new Map();
      t = A(t, {
        bare_returns: !1,
      ...
      var E = b(function (e, n, c) {
        switch (w(), r.token.type) {
          case "string":
            if (r.in_directives) {
              var A = o();
              if (!r.token.raw.includes("\\") && (he(A, "punc", ";") || he(A, "punc", "}") || p(A) || he(A, "eof"))) {
          ...
          case "atom":
            return x();
          case "name":
            if ("async" == r.token.value && he(o(), "keyword", "function")) {
              a();
              a();
              if (n) {
            ...
            if ("import" == r.token.value && !he(o(), "punc", "(")) {
              a();
              var O = function () {
                var e;
                var t;
              ...
              case "export":
                if (!he(o(), "punc", "(")) {
                  ...
                  O = function () {
                    ...
                    if (i("punc", "{") || e && (i("keyword", "class") || i("keyword", "function")) && he(o(), "punc")) {
                      c = be(!1);
                      m();
                    } else {
      ...
      function T(e, t) {
        ...
        var o = !1;
        if (void 0 === e) {
          e = k(!0, r.input.has_directive("use strict"));
        }
        if (i("expand", "...")) {
          o = r.token;
      ...
      function B(e, t) {
        ...
        var h = !1;
        var p = r.token;
        if (void 0 === e && (e = k(!1, r.input.has_directive("use strict"))), t = void 0 === t ? rn : t, i("punc", "[")) {
          for (a(); !i("punc", "]");) {
            if (l ? l = !1 : d(","), i("expand", "...") && (h = !0, n = r.token, e.mark_spread(r.token), a()), i("punc")) {
              switch (r.token.value) {
                case ",":
                  c.push(new Bn({
                    start: r.token,
        ...
        if (i("punc", "{")) {
          for (a(); !i("punc", "}");) {
            if (l ? l = !1 : d(","), i("expand", "...") && (h = !0, n = r.token, e.mark_spread(r.token), a()), i("name") && (he(o(), "punc") || he(o(), "operator")) && [",", "}", "="].includes(o().value)) {
              e.add_parameter(r.token);
              var _ = s();
              var A = re(t);
              if (h) {
      ...
      function D(e, n, o, s, c) {
        var u = r.in_loop;
        var l = r.labels;
        var h = r.in_generator;
        var p = r.in_async;
        if (++r.in_function, n && (r.in_generator = r.in_function), o && (r.in_async = r.in_function), c && function (e) {
          var n = k(!0, r.input.has_directive("use strict"));
          for (d("("); !i("punc", ")");) {
            var o = T(n);
            if (e.push(o), i("punc", ")") || (d(","), i("punc", ")") && t.ecma < 2017 && f()), o instanceof Qe) {
              break;
            }
          }
          a();
        }(c), e && (r.in_directives = !0), r.in_loop = 0, r.labels = [], e) {
      ...
      function R(e, t) {
        for (var n, o = [];;) {
          ...
          if (i("punc", "{") || i("punc", "[") ? n = new wt({
            start: r.token,
            name: B(void 0, c),
            value: i("operator", "=") ? (h("operator", "="), be(!1, e)) : null,
            end: s()
          }) : "import" == (n = new wt({
            start: r.token,
            name: re(c),
          ...
          })).name.name && u("Unexpected token: import"), o.push(n), !i("punc", ",")) {
            break;
          }
          a();
        }
          ...
          switch (r.token.value) {
            case "(":
              ...
              var m = g ? new Ot({
                expression: g,
                args: v
              }) : 1 == v.length ? v[0] : new kt({
                expressions: v
              });
              if (m.start) {
                var y;
                var b = A.comments_before.length;
                if (n.set(A, b), (y = m.start.comments_before).unshift.apply(y, c(A.comments_before)), A.comments_before = m.start.comments_before, 0 == b && A.comments_before.length > 0) {
      ...
      function z(e, t, n) {
        for (var o = !0, c = []; !i("punc", e) && (o ? o = !1 : d(","), !t || !i("punc", e));) {
          if (i("punc", ",") && n) {
            c.push(new Bn({
              start: r.token,
              end: r.token
      ...
      var K = b(function () {
        ...
        var n = !0;
        var o = [];
        for (d("{"); !i("punc", "}") && (n ? n = !1 : d(","), t.strict || !i("punc", "}"));) {
      ...
      function X(e) {
        ...
        var c;
        var u = [];
        for (r.input.push_directives_stack(), r.input.add_directive("use strict"), "name" == r.token.type && "extends" != r.token.value && (o = re(e === Xt ? un : ln)), e !== Xt || o || f(), "extends" == r.token.value && (a(), c = be(!0)), d("{"); i("punc", ";");) {
          a();
        }
        for (; !i("punc", "}");) {
      ...
      function Y(e, t, n) {
        ...
        var l = !1;
        var h = t;
        if (n && "static" === e && !i("punc", "(") && (u = !0, h = r.token, e = ee()), "async" !== e || i("punc", "(") || i("punc", ",") || i("punc", "}") || i("operator", "=") || (c = !0, h = r.token, e = ee()), null === e && (l = !0, h = r.token, null === (e = ee()) && f()), i("punc", "(")) {
          e = o(e, t);
          return new Qt({
            start: t,
            static: u,
        ...
        if (n) {
          ...
          var _ = p instanceof sn ? h.quote : void 0;
          if (i("operator", "=")) {
            a();
            return new Kt({
              start: t,
      ...
      var se = function e(t, n) {
        ...
        for (var h = V(t, n); i("operator") && Ae.has(r.token.value) && !p(r.token);) {
          if (h instanceof Ye) {
            f();
          }
          (h = ce(Rt, r.token, h)).start = o;
          h.end = r.token;
          a();
        }
        return h;
      ...
      var ue = function (e) {
        ...
        var n = function (e) {
          return function e(t, n, o) {
            ...
            if ("**" == s && t instanceof Ft && !he(t.start, "punc", "(") && "--" !== t.operator && "++" !== t.operator) {
              f(t.start);
            }
        ...
        if (e instanceof Ut) {
          ...
          for (var t = [], n = 0; n < e.elements.length; n++) {
            if (e.elements[n] instanceof Qe) {
              ...
              e.elements[n].expression = de(e.elements[n].expression);
            }
            t.push(de(e.elements[n]));
          }
          e = new $e({
            start: e.start,
            names: t,
    ...
    function be(e, t, n) {
      ...
      if (s && (c.prototype = s, c.BASE = r), r && r.SUBCLASSES.push(c), c.prototype.CTOR = c, c.prototype.constructor = c, c.PROPS = t || null, c.SELF_PROPS = i, c.SUBCLASSES = [], e && (c.prototype.TYPE = c.TYPE = e), n) {
        for (a in n) if (B(n, a)) {
          if ("$" === a[0]) {
            c[a.substr(1)] = n[a];
          } else {
    ...
    var Se = be("SimpleStatement", "body", {
    ...
    var ht = be("SwitchBranch", null, {
      $documentation: "Base class for `switch` branches"
    }, Be);
    var dt = be("Default", null, {
    ...
    var kt = be("Sequence", "expressions", {
    ...
    var hn = be("SymbolImport", null, {
      $documentation: "Symbol referring to an imported name"
    }, en);
    var dn = be("SymbolImportForeign", null, {
    ...
    function zn(e, t) {
      e.DEFMETHOD("transform", function (e, n) {
        var r = void 0;
        if (e.push(this), e.before && (r = e.before(this, t, n)), void 0 === r && (t(r = this, e), e.after)) {
          var i = e.after(r, n);
          if (void 0 !== i) {
            r = i;
          }
    ...
    function Wn(e) {
      for (var t, n = e.parent(-1), r = 0; t = e.parent(r); r++) {
        ...
        if (!(t instanceof kt && t.expressions[0] === n || "Call" === t.TYPE && t.expression === n || t instanceof Je && t.prefix === n || t instanceof Bt && t.expression === n || t instanceof Dt && t.expression === n || t instanceof Nt && t.condition === n || t instanceof Pt && t.left === n || t instanceof Rt && t.expression === n)) {
          return !1;
        }
        n = t;
      }
      ...
      return {
        ...
        prepend_comments: t ? g : function (t) {
          ...
          if (r) {
            ...
            if (a || (a = r.comments_before = []), i.add(a), o) {
              var s = new jn(function (e) {
                var t = s.parent();
                if (!(t instanceof nt || t instanceof Pt && t.left === e || "Call" == t.TYPE && t.expression === e || t instanceof Nt && t.condition === e || t instanceof Bt && t.expression === e || t instanceof kt && t.expressions[0] === e || t instanceof Dt && t.expression === e || t instanceof Rt)) {
                  return !0;
                }
                if (e.start) {
            ...
            if (0 != (a = a.filter(n, t).filter(function (e) {
              ...
              a.forEach(function (e, t) {
                if (i.add(e), l || (e.nlb ? (I("\n"), R(), l = !0) : t > 0 && F()), /comment[134]/.test(e.type)) {
                  if (n = V(e.value)) {
                    I("//" + n + "\n");
                    R();
                  }
          ...
          if (r) {
            ...
            if (o && !i.has(o) && (e instanceof xe || o.every(function (e) {
              ...
              o.filter(n, e).forEach(function (e, n) {
                if (!i.has(e)) {
                  if (i.add(e), x = !1, E ? (I("\n"), R(), E = !1) : e.nlb && (n > 0 || !H()) ? (I("\n"), R()) : (n > 0 || !t) && F(), /comment[134]/.test(e.type)) {
                    var r = V(e.value);
                    if (r) {
                      I("//" + r);
                    }
    ...
    !function () {
      ...
      function n(e, t, n, r) {
        ...
        e.forEach(function (e, r) {
          if (!(!0 !== n.in_directive || e instanceof Oe || e instanceof Ie || e instanceof Se && e.body instanceof wn)) {
            n.in_directive = !1;
          }
          if (!(e instanceof Ie)) {
            n.indent();
          ...
          if (!0 === n.in_directive && e instanceof Se && e.body instanceof wn) {
            n.in_directive = !1;
          }
        });
        n.in_directive = !1;
      ...
      t(Ot, function (e) {
        var t;
        var n = e.parent();
        return !!(n instanceof St && n.expression === this || n instanceof Ct && n.is_default && this.expression instanceof Xe) || this.expression instanceof Xe && n instanceof Tt && n.expression === this && (t = e.parent(1)) instanceof Mt && t.left === n;
      });
      t(St, function (e) {
        var t = e.parent();
      ...
      e(Je, function (e, t) {
        var n = e.prefix;
        var r = n instanceof We || n instanceof Pt || n instanceof Nt || n instanceof kt || n instanceof It || n instanceof Bt && n.expression instanceof Ut;
        if (r) {
          t.print("(");
        }
        e.prefix.print(t);
      ...
      Ye.DEFMETHOD("_do_print", function (e) {
        ...
        if (1 === t.body.length && o instanceof rt) {
          ...
          if (a) {
            if (function e(t) {
              return t instanceof Ut || (t instanceof kt ? e(t.expressions[0]) : "Call" === t.TYPE ? e(t.expression) : t instanceof Je ? e(t.prefix) : t instanceof Bt || t instanceof Dt ? e(t.expression) : t instanceof Nt ? e(t.condition) : t instanceof Pt ? e(t.left) : t instanceof Rt && e(t.expression));
            }(a)) {
              e.print("(");
              a.print(e);
              e.print(")");
      ...
      ht.DEFMETHOD("_do_print_body", function (e) {
        e.newline();
      ...
      e(Ct, function (e, t) {
        if (t.print("export"), t.space(), e.is_default && (t.print("default"), t.space()), e.exported_names) {
      ...
      e(Ot, function (e, t) {
        e.expression.print(t);
        if (!(e instanceof St && 0 === e.args.length)) {
      ...
      d([Ee, Re, ze], g);
      d([Lt, De, At, Wt, bn, Ce, vt, Oe, gt, tt, We, St, Ut, Fe, qt, ft, ht, Ze, et, _t], function (e) {
    ...
    Ge.DEFMETHOD("figure_out_scope", function (e) {
      ...
      var l = null;
      var f = [];
      var h = new jn(function (t, n) {
        if (t.is_block_scope()) {
          var r = s;
          t.block_scope = s = new Ge(t);
          s._block_scope = !0;
          var i = t instanceof At ? r.parent_scope : r;
          if (s.init_scope_vars(i), s.uses_with = r.uses_with, s.uses_eval = r.uses_eval, e.safari10 && (t instanceof Le || t instanceof Ue) && f.push(s), t instanceof ft) {
            var o = s;
            s = r;
            t.expression.walk(h);
            s = o;
        ...
        if (t instanceof Ve) {
          ...
          if (t instanceof qt && (t.scope = s), t instanceof pn && (t.thedef = t, t.references = []), t instanceof cn) {
            u.def_function(t, "arguments" == t.name ? void 0 : u);
          } else if (t instanceof on) {
            d((t.scope = u.parent_scope.get_defun_scope()).def_function(t, u), 1);
          } else if (t instanceof ln) {
            d(u.def_variable(t, u), 1);
          } else if (t instanceof hn) {
            s.def_variable(t);
          } else if (t instanceof un) {
            d((t.scope = u.parent_scope).def_function(t, u), 1);
            ...
            }) || fe('"'.concat(t.name, '" is redeclared'), t.start.file, t.start.line, t.start.col, t.start.pos), t instanceof rn || d(y, 2), u !== s) {
              t.mark_enclosed();
      ...
      if (this.walk(h), this instanceof ze && (this.globals = new Map()), h = new jn(function (e) {
        ...
        if (e instanceof _n) {
          var t;
          var n = e.name;
          if ("eval" == n && h.parent() instanceof Ot) {
            for (var r = e.scope; r && !r.uses_eval; r = r.parent_scope) {
              r.uses_eval = !0;
            }
          }
          if (h.parent() instanceof Et && h.parent(1).module_name || !(t = e.scope.find_variable(n))) {
            t = o.def_global(e);
            if (e instanceof An) {
              t.export = 1;
            }
      ...
      }), this.walk(h), (e.ie8 || e.safari10) && Pn(this, function (e) {
        if (e instanceof fn) {
          var t = e.name;
    ...
    kt.DEFMETHOD("tail_node", function () {
    ...
    Vt.prototype._size = function () {
      return hr(this.key) + 1;
    };
    var dr = function (e) {
      return e ? 7 : 0;
    };
    zt.prototype._size = function () {
      return 5 + dr(this.static) + hr(this.key);
    };
    Gt.prototype._size = function () {
      return 5 + dr(this.static) + hr(this.key);
    };
    Qt.prototype._size = function () {
      return dr(this.static) + hr(this.key) + lr(this);
    };
    Wt.prototype._size = function () {
      return (this.name ? 8 : 7) + (this.extends ? 8 : 0);
    };
    Kt.prototype._size = function () {
      return dr(this.static) + ("string" == typeof this.key ? this.key.length + 2 : 0) + (this.value ? 1 : 0);
    };
    qt.prototype._size = function () {
      ...
      s(n, [{
        ...
        value: function () {
          ...
          for (var e, t = this.self(), n = 0; e = this.parent(n); n++) {
            if (e instanceof Se || e instanceof Nt && e.condition === t || e instanceof Ne && e.condition === t || e instanceof Le && e.condition === t || e instanceof lt && e.condition === t || e instanceof Ft && "!" == e.operator && e.expression === t) {
              return !0;
            }
        ...
        value: function (e) {
          ...
          for (var n = +this.options.passes || 1, r = 1 / 0, i = !1, o = {
            ...
            if (Pn(e, function () {
              n++;
            }), t.info("pass " + a + ": last_count: " + r + ", count: " + n), n < r) {
              r = n;
              i = !1;
            } else {
              if (i) {
    ...
    function yr(e, t, n, r, i, o) {
      ...
      if (!o && a instanceof Ot && a.expression === n && !(r instanceof Ye) && !(r instanceof Wt) && !a.is_expr_pure(e) && (!(r instanceof Xe) || !(a instanceof St) && r.contains_this())) {
        return !0;
      }
      if (a instanceof Lt) {
    ...
    function Sr(e, t) {
      switch (typeof e) {
        ...
        case "number":
          return isNaN(e) ? E(kn, t) : isFinite(e) ? 1 / e < 0 ? E(Ft, t, {
            operator: "-",
            expression: E(En, t, {
              value: -e
            })
    ...
    Ee.DEFMETHOD("equivalent_to", function (e) {
      return function (e, t) {
        ...
        for (var n = [e], r = [t], i = n.push.bind(n), o = r.push.bind(r); n.length && r.length;) {
          ...
          if (a._children_backwards(i), s._children_backwards(o), n.length !== r.length) {
            return !1;
          }
        }
    ...
    (function (e) {
      ...
      function u(e, t, n, r, i, o, a) {
        ...
        if (s instanceof Mt && "=" == s.operator && r === s.right || s instanceof Ot && (r !== s.expression || s instanceof St) || s instanceof nt && r === s.value && r.scope !== t.scope || s instanceof wt && r === s.value || s instanceof ut && r === s.value && r.scope !== t.scope) {
          if (!(!(a > 1) || i && i.is_constant_expression(n))) {
            a = 1;
          }
          return void ((!t.escaped || t.escaped > a) && (t.escaped = a));
        }
        if (s instanceof Lt || s instanceof ct || s instanceof Pt && zr.has(s.operator) || s instanceof Nt && r !== s.condition || s instanceof Qe || s instanceof kt && r === s.tail_node()) {
          u(e, t, n, s, s, o + 1, a);
        ...
        if (!(o > 0 || s instanceof kt && r !== s.tail_node() || s instanceof Se)) {
          t.direct_access = !0;
        }
      }
      e(Ee, g);
    ...
    function Ur(e, t) {
      ...
      function s(e, t) {
        ...
        for (var a, s = [], c = e.length, u = new Ln(function (e) {
            ...
            if (!S) {
              return e !== f[h] ? e : ++h < f.length ? P(e) : (S = !0, (A = function e(t, n, r) {
                var i = u.parent(n);
                return i instanceof Mt ? r && !(i.left instanceof Tt || m.has(i.left.name)) ? e(i, n + 1, r) : t : i instanceof Pt ? !r || zr.has(i.operator) && i.left !== t ? t : e(i, n + 1, r) : i instanceof Ot || i instanceof pt ? t : i instanceof Nt ? r && i.condition === t ? e(i, n + 1, r) : t : i instanceof vt ? e(i, n + 1, !0) : i instanceof nt ? r ? e(i, n + 1, r) : t : i instanceof lt ? r && i.condition === t ? e(i, n + 1, r) : t : i instanceof Pe ? t : i instanceof kt ? e(i, n + 1, i.tail_node() !== t) : i instanceof Se ? e(i, n + 1, !0) : i instanceof ft || i instanceof wt ? t : null;
              }(e, 0)) === e && (k = !0), e);
            }
            var n;
            var a = u.parent();
            ...
            if (g || y && x || !(a instanceof Pt && zr.has(a.operator) && a.left !== e || a instanceof Nt && a.condition !== e || a instanceof lt && a.condition !== e) || (g = a), B && !(e instanceof Jt) && v.equivalent_to(e)) {
              if (g) {
                k = !0;
                return e;
              }
              ...
              if (T++, _ && d instanceof wt) {
                return e;
              }
              if (o = k = !0, t.info("Collapsing {name} [{file}:{line},{col}]", {
              ...
              if (d instanceof wt) {
                var s = d.name.definition();
                var c = d.value;
                return s.references.length - s.replaced != 1 || t.exposed(s) ? E(Mt, d, {
                  operator: "=",
                  left: E(_n, d.name, d.name),
                  right: c
                }) : (s.replaced++, O && Lr(c) ? c.transform(t) : kr(a, e, c));
              }
              Ar(d, 32);
              return d;
            }
            ...
            return e instanceof _n && e.name == F.name ? (--T || (k = !0), Wr(e, l.parent()) ? e : (F.replaced++, _.replaced--, d.value)) : e instanceof dt || e instanceof Ge ? e : void 0;
          }); --c >= 0;) {
          ...
          for (j(e[c]); s.length > 0;) {
            ...
            if (v && !wr(v) && !v.has_side_effects(t)) {
              ...
              var x = Q();
              var C = d.may_throw(t);
              var O = d.name instanceof rn;
              var S = O;
              var k = !1;
              var T = 0;
              var B = !a || !S;
              if (!B) {
                for (var D = t.self().argnames.lastIndexOf(d.name) + 1; !k && D < a.length; D++) {
                  a[D].transform(u);
                }
                B = !0;
              }
              for (var I = c; !k && I < e.length; I++) {
                e[I].transform(u);
              }
              if (_) {
                var F = d.name.definition();
                if (k && F.references.length - F.replaced > T) {
                  T = !1;
                } else {
                  for (k = !1, h = 0, S = O, I = c; !k && I < e.length; I++) {
                    e[I].transform(l);
                  }
                  _.single_use = !1;
                }
          ...
          if (e instanceof ft) {
            ...
            for (var t = 0, n = e.body.length; !k && t < n; t++) {
              ...
              if (r instanceof pt) {
                ...
                if (r.expression = r.expression.transform(u), !x) {
                  break;
                }
              }
            }
          ...
          if (br(n) && !n.name && !n.uses_arguments && !n.pinned() && (e = t.parent()) instanceof Ot && e.expression === n && e.args.every(function (e) {
            ...
            for (var o = new Set(), c = i; --c >= 0;) {
              ...
              if (!(f && f.orig.length > 1) && (a.unshift(E(wt, u, {
                ...
                if (o.add(u.name), u instanceof Qe) {
                  var h = e.args.slice(c);
        ...
        function G(e) {
          ...
          return e instanceof _n && e.definition().scope === i && !(n && (m.has(e.name) || d instanceof It || d instanceof Mt && "=" != d.operator));
        }
        function z(e) {
        ...
        function Q() {
          ...
          if (v instanceof _n) {
            var e = v.definition();
            if (e.references.length - e.replaced == (d instanceof wt ? 1 : 2)) {
              return !0;
            }
          }
          return !1;
      ...
      function l(e, t) {
        for (var n = t.self(), r = function (e) {
          ...
          if (s instanceof lt && s.body instanceof rt) {
            var d = s.body.value;
            if (!d && !s.alternative && (i && !u || u instanceof rt && !u.value)) {
              o = !0;
              e[a] = E(Se, s.condition, {
                body: s.condition
              });
              continue;
            }
            if (d && !s.alternative && u instanceof rt && u.value) {
              o = !0;
            ...
            if (d && !s.alternative && (!u && i && r || u instanceof rt)) {
              o = !0;
            ...
            var p = e[m(a)];
            if (t.option("sequences") && i && !s.alternative && p instanceof lt && p.body instanceof rt && v(c) == e.length && u instanceof Se) {
              o = !0;
        ...
        if (!(e.length < 2)) {
          for (var n = [], r = 0, i = 0, a = e.length; i < a; i++) {
            ...
            if (s instanceof Se) {
              ...
              if (!(s instanceof vt && h(s) || s instanceof qe)) {
                u();
              }
              e[r++] = s;
            }
      ...
      function A(e, t) {
        ...
        for (var r, i = 0, a = 0; a < e.length; a++) {
          var s = e[a];
          if (r && (s instanceof nt ? s.value = n(s.value || E(Tn, s).transform(t)) : s instanceof Le ? s.init instanceof vt || Pn(r.body, function (e) {
            return e instanceof Ge || (e instanceof Pt && "in" === e.operator ? Mn : void 0);
          }) || (s.init ? s.init = n(s.init) : (s.init = r.body, i--, o = !0)) : s instanceof Ue ? s.init instanceof bt || s.init instanceof yt || (s.object = n(s.object)) : s instanceof lt ? s.condition = n(s.condition) : (s instanceof ft || s instanceof Ve) && (s.expression = n(s.expression))), t.option("conditionals") && s instanceof lt) {
            var c = [];
            var u = _(s.body, c);
      ...
      function g(e, n) {
        if (e instanceof vt) {
          ...
          if (o.value instanceof Ut && (n instanceof Mt ? r = [n] : n instanceof kt && (r = n.expressions.slice()), r)) {
            var a = !1;
            do {
              var s = r[0];
              if (!(s instanceof Mt)) {
              ...
              if (u instanceof Ee && (u = u.evaluate(t)), u instanceof Ee) {
                break;
              }
              u = "" + u;
      ...
      function v(e) {
          ...
          if (a instanceof vt) {
            ...
            if (c = g(s, a.init)) {
              ...
              if (s instanceof mt && (!a.init || a.init.TYPE == s.TYPE)) {
                ...
                if (t && a.init && t.TYPE == a.init.TYPE && h(a.init)) {
        ...
        function u(t) {
          e[++r] = a;
          var n = g(s, t);
          return n ? (o = !0, n.length ? Or(t, n) : t instanceof kt ? t.tail_node().left : t.left) : t;
        }
        e.length = r + 1;
      }
    }
    ...
    !function (e) {
      ...
      e(Ft, function (e, t) {
        ...
        if (n.has(this.operator) || t++, (r = r._eval(e, t)) === this.expression) {
          return this;
        }
      ...
      e(_n, function (e, t) {
        ...
        if (B(r, "_eval")) {
          ...
          if (this._eval = y, n = r._eval(e, t), delete this._eval, n === r) {
            return this;
          }
          r._eval = function () {
            return n;
      ...
      e(Ot, function (e, t) {
        ...
        if (e.option("unsafe") && n instanceof Tt) {
          ...
          for (var l = [], f = 0, h = this.args.length; f < h; f++) {
            var d = this.args[f];
            var p = d._eval(e, t);
            if (d === p) {
              return this;
    ...
    var ei = k("Boolean decodeURI decodeURIComponent Date encodeURI encodeURIComponent Error escape EvalError isFinite isNaN Number Object parseFloat parseInt RangeError ReferenceError String SyntaxError TypeError unescape URIError");
    ...
    Ge.DEFMETHOD("drop_unused", function (e) {
      if (e.option("unused") && !e.has_directive("use asm")) {
        ...
        if (!t.pinned()) {
          ...
          var u = new Map();
          var l = this;
          var f = new jn(function (i, h) {
            if (i instanceof We && i.uses_arguments && !f.has_directive("use strict") && i.argnames.forEach(function (e) {
              if (e instanceof Jt) {
                var t = e.definition();
                if (!o.has(t.id)) {
                  o.set(t.id, t);
              ...
              if (i instanceof qe || i instanceof Xt) {
                ...
                if ((f.parent() instanceof Ct || !n && l === t) && p.global && !o.has(p.id) && o.set(p.id, p), i instanceof Xt) {
              ...
              if (i instanceof rn && l === t && T(c, i.definition().id, i), i instanceof vt && l === t) {
                var v = f.parent() instanceof Ct;
                i.definitions.forEach(function (t) {
                  if (t.name instanceof Zt && T(c, t.name.definition().id, t), !v && r || Pn(t.name, function (e) {
                    if (e instanceof Jt) {
                      var t = e.definition();
          ...
          var h = new Ln(function (a, u, f) {
              ...
              if (p instanceof _n) {
                ...
                if (a instanceof Mt) {
                  if (!A || s.has(_.id) && s.get(_.id) !== a) {
                    return kr(d, a, a.right.transform(h));
                  }
                } else if (!A) {
            ...
            if (l === t) {
              if (a.name && (a instanceof Yt && !D(e.option("keep_classnames"), (_ = a.name.definition()).name) || a instanceof Xe && !D(e.option("keep_fnames"), (_ = a.name.definition()).name)) && (!o.has(_.id) || _.orig.length > 1) && (a.name = null), a instanceof We && !(a instanceof Ke)) {
              ...
              if ((a instanceof qe || a instanceof Xt) && a !== t) {
                ...
                if (!(b.global && !n || o.has(b.id))) {
                  if (e[a.name.unreferenced() ? "warn" : "info"]("Dropping unused function {name} [{file}:{line},{col}]", R(a.name)), b.eliminated++, a instanceof Xt) {
              ...
              if (a instanceof vt && !(d instanceof Ue && d.init === a)) {
                var C = !(d instanceof ze || a instanceof mt);
                var S = [];
                var k = [];
                var T = [];
                var B = [];
                switch (a.definitions.forEach(function (t) {
                  ...
                  if (!r && !C || n && (t.name.names.length || t.name.is_array || 1 != e.option("pure_getters")) || o.has(i.id)) {
                    if (t.value && s.has(i.id) && s.get(i.id) !== t && (t.value = t.value.drop_side_effect_free(e)), t.name instanceof Zt) {
                      var u = c.get(i.id);
                    ...
                    if (d = t.value && t.value.drop_side_effect_free(e)) {
                      B.push(d);
                    }
                    t.value = null;
                    k.push(t);
                ...
                }), (k.length > 0 || T.length > 0) && (a.definitions = k.concat(T), S.push(a)), B.length > 0 && S.push(E(Se, a, {
                  body: Or(a, B)
                })), S.length) {
                  case 0:
                    return f ? w.skip : E(Ie, a);
              ...
              if (a instanceof Re && a.body instanceof Le) {
                if (u(a, this), a.body instanceof De) {
                  var I = a.body;
                  a.body = I.body.pop();
                  I.body.push(a);
      ...
      function d(e, n) {
        ...
        if (e instanceof _n) {
          if (r = e.definition(), !o.has(r.id) && (o.set(r.id, r), r.orig[0] instanceof fn)) {
    ...
    Ge.DEFMETHOD("hoist_declarations", function (e) {
      ...
      if (n || r) {
          ...
          if (c !== t) {
            ...
            if (r && c instanceof mt) {
              ...
              if (f instanceof Ue && f.init === c) {
                if (null == l) {
                  var h = c.definitions[0].name;
                  return E(_n, h, h);
                }
                return l;
              }
              return f instanceof Le && f.init === c ? l : l ? E(Se, c, {
                body: l
              }) : E(Ie, c);
            }
            if (c instanceof Ge) {
        ...
        if (t = t.transform(u), s > 0) {
          var l = [];
          var f = t instanceof We;
          var h = f ? t.args_as_names() : null;
          if (a.forEach(function (e, t) {
            if (f && h.some(function (t) {
            ...
            for (var d = 0; d < t.body.length;) {
              if (t.body[d] instanceof Se) {
                var p;
                var _;
                var A = t.body[d].body;
                ...
                if (A instanceof kt && (_ = A.expressions[0]) instanceof Mt && "=" == _.operator && (p = _.left) instanceof qt && a.has(p.name)) {
                  var g;
                  if ((g = a.get(p.name)).value) {
                    break;
                  }
                  ...
                  O(l, g);
                  l.push(g);
                  t.body[d].body = Or(A, A.expressions.slice(1));
                  continue;
                }
              }
              if (t.body[d] instanceof Ie) {
                t.body.splice(d, 1);
              } else {
                if (!(t.body[d] instanceof De)) {
                  break;
                }
                var v = [d, 1].concat(t.body[d].body);
    ...
    Ge.DEFMETHOD("hoist_properties", function (e) {
      ...
      var i = new Ln(function (o, a) {
        ...
        if (o instanceof wt) {
          ...
          var h = r.get(o.expression.definition().id);
          if (h) {
            var d = h.get(String(Vr(o.property)));
            var p = E(_n, o, {
              name: d.name,
    ...
    vr(lt, function (e, t) {
      if (Dr(e.alternative) && (e.alternative = null), !t.option("conditionals")) {
        return e;
      }
      var n = e.condition.evaluate(t);
      ...
      if (t.option("dead_code")) {
        if (n instanceof Ee && (n = e.condition.tail_node().evaluate(t)), !n) {
      ...
      if (Dr(e.body) && Dr(e.alternative)) {
        return E(Se, e.condition, {
          body: e.condition.clone()
        }).optimize(t);
      }
      if (e.body instanceof Se && e.alternative instanceof Se) {
        return E(Se, e, {
          body: E(Nt, e, {
      ...
      if (Dr(e.alternative) && e.body instanceof Se) {
      ...
      if (e.body instanceof Ie && e.alternative instanceof Se) {
        return E(Se, e, {
          body: E(Pt, e, {
            operator: "||",
            left: e.condition,
      ...
      if (e.body instanceof lt && !e.body.alternative && !e.alternative && (e = E(lt, e, {
    ...
    vr(ft, function (e, t) {
      ...
      for (var o, a, s = [], c = [], u = 0, l = e.body.length; u < l && !a; u++) {
        if ((n = e.body[u]) instanceof dt) {
          ...
          if (A instanceof Ee && (A = n.expression.tail_node().evaluate(t)), A === r && (a = n, o)) {
            var f = c.indexOf(o);
            c.splice(f, 1);
            v(o, c[f - 1]);
            o = null;
        ...
        if (ni(n)) {
          var h = c[c.length - 1];
          if (ni(h) && h.body.length == n.body.length && E(De, h, h).equivalent_to(E(De, n, n))) {
            h.body = [];
          }
        }
        c.push(n);
      ...
      for (c.length > 0 && (c[0].body = s.concat(c[0].body)), e.body = c; n = c[c.length - 1];) {
        ...
        if (d instanceof at && t.loopcontrol_target(d) === e && n.body.pop(), n.body.length || n instanceof pt && (o || n.expression.has_side_effects(t))) {
          break;
        }
        if (c.pop() === o) {
          o = null;
      ...
      if (0 == c.length) {
        return E(De, e, {
          body: s.concat(E(Se, e.expression, {
            body: e.expression
          }))
        }).optimize(t);
      }
      if (1 == c.length && (c[0] === a || c[0] === o)) {
        ...
        var _ = new jn(function (t) {
          if (p || t instanceof We || t instanceof Se) {
            return !0;
          }
    ...
    vr(_t, function (e, t) {
      if (Ur(e.body, t), e.bcatch && e.bfinally && e.bfinally.body.every(Dr) && (e.bfinally = null), t.option("dead_code") && e.body.every(Dr)) {
        var n = [];
        if (e.bcatch) {
          Hr(t, e.bcatch, n);
        }
    ...
    vr(Ot, function (e, t) {
      ...
      if (t.option("unsafe")) {
        if (Pr(n)) {
          switch (n.name) {
            case "Array":
              ...
              if (e.args[0] instanceof En && e.args[0].value <= 11) {
                for (var h = [], d = 0; d < e.args[0].value; d++) {
                  h.push(new Bn());
                }
                return new Lt({
                  elements: h
          ...
          switch (n.property) {
            ...
            case "call":
              var k = n.expression;
              if (k instanceof _n && (k = k.fixed_value()), k instanceof We && !k.contains_this()) {
      ...
      if (j) {
        ...
        if (i && !r.uses_arguments && !r.pinned() && !(t.parent() instanceof Wt) && !(r.name && r instanceof Xe) && (Q = function (e) {
          ...
          var n = new Set();
          do {
            if ((V = t.parent(++K)).is_block_scope() && V.block_scope && V.block_scope.variables.forEach(function (e) {
              n.add(e.name);
            }), V instanceof At) {
              if (V.argname) {
            ...
            for (var c = 0, u = r.body.length; c < u; c++) {
              ...
              if (l instanceof mt) {
                for (var f = l.definitions.length; --f >= 0;) {
                  var h = l.definitions[f].name;
                  if (h instanceof $e || t.has(h.name)) {
                    return !1;
                  }
                }
              }
              ...
              for (var n = t.length, i = 0, o = r.body.length; i < o; i++) {
                ...
                if (a instanceof mt) {
                  for (var s = 0, c = a.definitions.length; s < c; s++) {
                    ...
                    var l = u.name;
                    if ($(e, t, l, u.value), G && r.argnames.every(function (e) {
      ...
      if (t.option("negate_iife") && t.parent() instanceof Se && Rr(e)) {
        return e.negate(t, !0);
      }
      var Y = e.evaluate(t);
      return Y !== e ? (Y = Sr(Y, e).optimize(t), Yr(t, Y, e)) : e;
      function q(t) {
        return t ? t instanceof rt ? t.value ? t.value.clone(!0) : E(Tn, e) : t instanceof Se ? E(Ft, t, {
          operator: "void",
    ...
    vr(kt, function (e, t) {
      ...
      return 0 == o ? ((e = kr(t.parent(), t.self(), i[0])) instanceof kt || (e = e.optimize(t)), e) : (e.expressions = i, e);
    });
    It.DEFMETHOD("lift_sequences", function (e) {
      if (e.option("sequences") && this.expression instanceof kt) {
    ...
    vr(Ft, function (e, t) {
      ...
      if ("-" == e.operator && n instanceof Dn && (n = n.transform(t)), n instanceof Pt && ("+" == e.operator || "-" == e.operator) && ("*" == n.operator || "/" == n.operator || "%" == n.operator)) {
        return E(Pt, e, {
          operator: n.operator,
          left: E(Ft, n.left, {
            operator: e.operator,
      ...
      if ("-" != e.operator || !(n instanceof En || n instanceof Dn || n instanceof xn)) {
        var o = e.evaluate(t);
        if (o !== e) {
          return Yr(t, o = Sr(o, e).optimize(t), e);
        }
      }
      return e;
    });
    Pt.DEFMETHOD("lift_sequences", function (e) {
      if (e.option("sequences")) {
        if (this.left instanceof kt) {
          var t = this.left.expressions.slice();
          (n = this.clone()).left = t.pop();
          t.push(n);
          return Or(this, t).optimize(e);
        }
        if (this.right instanceof kt && !this.left.has_side_effects(e)) {
    ...
    vr(Pt, function (e, t) {
      ...
      if (ci.has(e.operator) && e.right.is_constant() && !e.left.is_constant() && (e.left instanceof Pt && ve[e.left.operator] >= ve[e.operator] || r()), e = e.lift_sequences(t), t.option("comparisons")) {
        switch (e.operator) {
          case "===":
          case "!==":
            var i = !0;
          ...
          case "||":
            var a = e.left;
            if (a.operator == e.operator && (a = a.right), a instanceof Pt && a.operator == ("&&" == e.operator ? "!==" : "===") && e.right instanceof Pt && a.operator == e.right.operator && (Gr(a.left, t) && e.right.left instanceof Sn || a.left instanceof Sn && Gr(e.right.left, t)) && !a.right.has_side_effects(t) && a.right.equivalent_to(e.right.right)) {
              var s = E(Pt, e, {
        ...
        switch (e.operator) {
          case "&&":
            if (!(u = !!pr(e.left, 2) || !pr(e.left, 4) && e.left.evaluate(t))) {
              ...
              return kr(t.parent(), t.self(), e.left).optimize(t);
            }
            if (!(u instanceof Ee)) {
            ...
            if (l = e.right.evaluate(t)) {
              if (!(l instanceof Ee) && ("&&" == (h = t.parent()).operator && h.left === t.self() || t.in_boolean_context())) {
            ...
            if ("||" == e.left.operator && !(d = e.left.right.evaluate(t))) {
              return E(Nt, e, {
          ...
          case "||":
            ...
            } else if ("||" == (h = t.parent()).operator && h.left === t.self() || t.in_boolean_context()) {
              t.warn("Dropping side-effect-free || [{file}:{line},{col}]", e.start);
              return e.left.optimize(t);
            }
            if ("&&" == e.left.operator && (d = e.left.right.evaluate(t)) && !(d instanceof Ee)) {
              return E(Nt, e, {
                condition: e.left.left,
      ...
      var x = e.evaluate(t);
      return x !== e ? (x = Sr(x, e).optimize(t), Yr(t, x, e)) : e;
    });
    vr(An, function (e) {
      return e;
    });
    vr(_n, function (e, t) {
      ...
      if (t.option("reduce_vars") && Wr(e, n) !== e) {
        ...
        if (o && i instanceof Wt && (o = (!i.extends || !i.extends.may_throw(t) && !i.extends.has_side_effects(t)) && !i.properties.some(function (e) {
          return e.may_throw(t) || e.has_side_effects(t);
        })), o && i) {
          if (i instanceof Xt && (_r(i, 256), i = E(Yt, i, i)), i instanceof qe && (_r(i, 256), i = E(Xe, i, i)), r.recursive_refs > 0 && i.name instanceof on) {
        ...
        if (i && void 0 === r.should_replace) {
          ...
          if (i instanceof mn) {
            ...
            var h = i.evaluate(t);
            if (!(h === i || !t.option("unsafe_regexp") && h instanceof RegExp)) {
              f = Sr(h, i);
            }
          }
          if (f) {
    ...
    function _i(e) {
      var t;
      return e instanceof Sn || Gr(e) || e instanceof _n && (t = e.definition().fixed) instanceof Ee && _i(t);
    }
    function Ai(e, t) {
      if (e instanceof _n) {
        e = e.fixed_value();
      }
      return !!e && (!(e instanceof We || e instanceof Wt) || !(e instanceof We && e.contains_this()) || t.parent() instanceof St);
    }
    function gi(e, t) {
    ...
    vr(Mt, function (e, t) {
      ...
      if (t.option("dead_code") && e.left instanceof _n && (n = e.left.definition()).scope === t.find_parent(We)) {
        ...
        var o = e;
        do {
          if (r = o, (o = t.parent(i++)) instanceof nt) {
            if (a(i, o)) {
              break;
            }
            if (hi(n.scope, [n])) {
        ...
        } while (o instanceof Pt && o.right === r || o instanceof kt && o.tail_node() === r);
      }
      if ("=" == (e = e.lift_sequences(t)).operator && e.left instanceof _n && e.right instanceof Pt) {
        if (e.right.left instanceof _n && e.right.left.name == e.left.name && di.has(e.right.operator)) {
    ...
    vr(Nt, function (e, t) {
      ...
      if (r !== e.condition) {
        return r ? (t.warn("Condition always true [{file}:{line},{col}]", e.start), kr(t.parent(), t.self(), e.consequent)) : (t.warn("Condition always false [{file}:{line},{col}]", e.start), kr(t.parent(), t.self(), e.alternative));
      }
      ...
      if (t.option("ecma") >= 2020 && function (e, t, n) {
        ...
        if (e instanceof Pt && "||" === e.operator) {
          ...
          var a = function (e) {
            ...
            var n;
            var r = 0;
            if (e.left instanceof Sn) {
              r++;
              i = e;
              n = e.right;
            }
            if (e.right instanceof Sn) {
              r++;
              i = e;
              n = e.left;
            }
      ...
      if (c instanceof kt && s.equivalent_to(c.expressions[c.expressions.length - 1])) {
        return Or(e, [E(Pt, e, {
          operator: "||",
          left: a,
      ...
      return h(e.consequent) ? d(e.alternative) ? f(e.condition) : E(Pt, e, {
        operator: "||",
        left: f(e.condition),
        right: e.alternative
      }) : d(e.consequent) ? h(e.alternative) ? f(e.condition.negate(t)) : E(Pt, e, {
        operator: "&&",
    ...
    vr(Dt, function (e, t) {
      ...
      if (t.option("properties")) {
        ...
        if (o !== i) {
          ...
          i = e.property = Kr(i, Sr(o, i).transform(t));
          var a = "" + o;
      ...
      e: if (t.option("arguments") && r instanceof _n && "arguments" == r.name && 1 == r.definition().orig.length && (n = r.scope) instanceof We && n.uses_arguments && !(n instanceof Ye) && i instanceof En) {
        ...
        var h = n.argnames[s];
        if (h && t.has_directive("use strict")) {
          var d = h.definition();
          if (!t.option("reduce_vars") || d.assignments || d.orig.length > 1) {
            h = null;
          }
        } else if (!h && !t.option("keep_fargs") && s < n.argnames.length + 5) {
          for (; s >= n.argnames.length;) {
            ...
            n.argnames.push(h);
            n.enclosed.push(n.def_variable(h));
          }
        }
        if (h) {
          var p = E(_n, e, h);
      ...
      var w = e.evaluate(t);
      return w !== e ? Yr(t, w = Sr(w, e).optimize(t), e) : e;
    });
    ...
    vr(Bt, function (e, t) {
      ...
      var o = e.evaluate(t);
      return o !== e ? Yr(t, o = Sr(o, e).optimize(t), e) : e;
    });
    vr(Lt, function (e, t) {
      var n = gi(e, t);
    ...
    vr(Ht, mi);
    vr(Qt, function (e, t) {
      if (mi(e, t), t.option("arrows") && t.parent() instanceof Ut && !e.is_generator && !e.value.uses_arguments && !e.value.pinned() && 1 == e.value.body.length && e.value.body[0] instanceof rt && e.value.body[0].value && !e.value.contains_this()) {
    ...
    function Ei(t, n) {
      ...
      var l = new Set();
      var f = new Set();
      var h = "strict" === n.keep_quoted;
      t.walk(new jn(function (e) {
        if (e instanceof Vt) {
          if (!("string" != typeof e.key || h && e.quote)) {
            _(e.key);
          }
        } else if (e instanceof Ht) {
          if (!(h && e.key.end.quote)) {
            _(e.key.name);
          }
    ...
    function Ti(e, t) {
      ...
      try {
        ...
        var c;
        var u = [];
        if (t.warnings && !Ee.warn_function && (Ee.warn_function = function (e) {
          u.push(e);
        }), s && (s.parse = Date.now()), e instanceof ze) {
          c = e;
        } else {
        ...
        var f = {};
        if (t.output.ast && (f.ast = c), !B(t.output, "code") || t.output.code) {
          ...
          var h = qn(t.output);
          if (c.print(h), f.code = h.get(), t.sourceMap) {
            if (t.sourceMap.asObject ? f.map = t.output.source_map.get().toJSON() : f.map = t.output.source_map.toString(), "inline" == t.sourceMap.url) {
              var d = "object" == typeof f.map ? JSON.stringify(f.map) : f.map;
              f.code += "\n//# sourceMappingURL=data:application/json;charset=utf-8;base64," + Ci(d);
        ...
        if (t.nameCache && t.mangle) {
          if (t.mangle.cache) {
            t.nameCache.vars = ki(t.mangle.cache);
          }
          if (t.mangle.properties && t.mangle.properties.cache) {
            t.nameCache.props = ki(t.mangle.properties.cache);
          }
        }
        if (s) {
          s.end = Date.now();
    ...
    !function () {
      ...
      function a(e, n, i) {
        ...
        s = new Function("to_moz", "to_moz_block", "to_moz_scope", "return(" + s + ")")(f, d, p);
        t[e] = a;
        u(n, s);
      }
      ...
      a("NewExpression", St, "callee>expression, arguments@args");
      ...
      Sn.DEFMETHOD("to_mozilla_ast", bn.prototype.to_mozilla_ast);
      ...
      function p(e, t) {
        var n = t.body.map(f);
        if (t.body[0] instanceof Se && t.body[0].body instanceof wn) {
    ...
    t.AST_SymbolImport = hn;
    t.AST_SymbolImportForeign = dn;
