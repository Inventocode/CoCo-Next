  ...
  return k(this, void 0, void 0, function () {
    ...
    return T(this, function (n) {
      ...
      return e ? D ? (__DEV__ && console.warn("Volume measurement is already running."), [2]) : (D = !0, E ? (E(e), [2]) : B ? (__DEV__ && console.warn("Volume measurement is already initialized."), [2, y.resume()]) : (t = {
        video: !1,
        audio: !0
      }, d().audio_recording ? (y && (w = (y.createScriptProcessor || y.createJavaScriptNode).call(y, 1024, 1, 1)).connect(y.destination), navigator.mediaDevices.getUserMedia(t).then(function (t) {
        if (y) {
