...
var h = function () {
  ...
  e.prototype.startSession = function (e) {
    ...
    var h = new f(Object(r.a)(Object(r.a)(Object(r.a)({
      release: c,
      environment: u
    }, n && {
      user: n.getUser()
...
function _() {
  ...
  return Object(c.b)() ? function (e) {
    ...
    var r;
    try {
      var i = null === (r = null === (n = null === (t = d().__SENTRY__) || void 0 === t ? void 0 : t.extensions) || void 0 === n ? void 0 : n.domain) || void 0 === r ? void 0 : r.active;
      if (!i) {
        return g(e);
      }
      if (!A(i) || g(i).isOlderThan(4)) {
        var o = g(e).getStackTop();
        v(i, new h(o.client, u.a.clone(o.scope)));
      }
      return g(i);
    } catch (a) {
      return g(e);
