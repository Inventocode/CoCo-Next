    ...
    switch (p[e] = !0, e) {
      case "console":
        !function () {
          ...
          ["debug", "info", "warn", "error", "log", "assert"].forEach(function (e) {
            if (e in h.console) {
              Object(s.b)(h.console, e, function (t) {
                return function () {
                  ...
                  if (t) {
                    Function.prototype.apply.call(t, h.console, n);
                  }
                };
              });
            }
        ...
        !function () {
          ...
          Object(s.b)(h, "fetch", function (e) {
            return function () {
              ...
              return e.apply(h, t).then(function (e) {
      ...
      case "history":
        !function () {
          ...
          Object(s.b)(h.history, "pushState", t);
          Object(s.b)(h.history, "replaceState", t);
        }();
        break;
      case "error":
        E = h.onerror;
...
function g(e, t) {
  ...
  if (e && d[e]) {
    try {
      for (var a = Object(r.g)(d[e] || []), s = a.next(); !s.done; s = a.next()) {
        var u = s.value;
        try {
          u(t);
        } catch (l) {
...
function v(e) {
  ...
  return "Request" in h && Object(i.d)(e[0], Request) && e[0].method ? String(e[0].method).toUpperCase() : e[1] && e[1].method ? String(e[1].method).toUpperCase() : "GET";
}
function m(e) {
  if (void 0 === e) {
    e = [];
  }
  return "string" === typeof e[0] ? e[0] : "Request" in h && Object(i.d)(e[0], Request) ? e[0].url : String(e[0]);
}
var y;
var b;
function w(e, t) {
