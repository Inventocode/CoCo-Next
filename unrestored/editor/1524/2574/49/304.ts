...
function f(e, t) {
  if (e) {
    ...
    return "Map" === n || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? h(e, t) : void 0;
  }
}
function h(e, t) {
...
function g(e, t, n, i, o) {
  ...
  var a = e && "object" === r(e);
  if (e = e || {}, this.json = e.json || n, this.path = e.path || t, this.resultType = e.resultType || "value", this.flatten = e.flatten || !1, this.wrap = !d.call(e, "wrap") || e.wrap, this.sandbox = e.sandbox || {}, this.preventEval = e.preventEval || !1, this.parent = e.parent || null, this.parentProperty = e.parentProperty || null, this.callback = e.callback || i || null, this.otherTypeCallback = e.otherTypeCallback || o || function () {
...
g.prototype.evaluate = function (e, t, n, i) {
  ...
  if (this.currResultType = this.resultType, this.currPreventEval = this.preventEval, this.currSandbox = this.sandbox, n = n || this.callback, this.currOtherTypeCallback = i || this.otherTypeCallback, t = t || this.json, (e = e || this.path) && "object" === r(e) && !Array.isArray(e)) {
    ...
    t = e.json;
    c = d.call(e, "flatten") ? e.flatten : c;
    this.currResultType = d.call(e, "resultType") ? e.resultType : this.currResultType;
    this.currSandbox = d.call(e, "sandbox") ? e.sandbox : this.currSandbox;
    u = d.call(e, "wrap") ? e.wrap : u;
    this.currPreventEval = d.call(e, "preventEval") ? e.preventEval : this.currPreventEval;
    n = d.call(e, "callback") ? e.callback : n;
    this.currOtherTypeCallback = d.call(e, "otherTypeCallback") ? e.otherTypeCallback : this.currOtherTypeCallback;
    a = d.call(e, "parent") ? e.parent : a;
    s = d.call(e, "parentProperty") ? e.parentProperty : s;
    e = e.path;
  }
...
g.prototype._trace = function (e, t, n, i, o, a, s, c) {
  ...
  if (("string" !== typeof h || c) && t && d.call(t, h)) {
    v(this._trace(A, t[h], p(n, h), t, h, a, s));
  } else if ("*" === h) {
    this._walk(h, A, t, n, i, o, a, function (e, t, n, r, i, o, a, s) {
      v(l._trace(_(e, n), r, i, o, a, s, !0, !0));
    });
  } else if (".." === h) {
    v(this._trace(A, t, n, i, o, a, s));
    this._walk(h, A, t, n, i, o, a, function (e, t, n, i, o, a, s, c) {
      if ("object" === r(i[e])) {
    ...
    if ("$" === h) {
      ...
      v(this._trace(_(this._eval(h, t, n[n.length - 1], n.slice(0, -1), i, o), A), t, n, i, o, a, s));
    } else if ("@" === h[0]) {
      var m = !1;
      var y = h.slice(1, -2);
      switch (y) {
    ...
    } else if ("`" === h[0] && t && d.call(t, h.slice(1))) {
      var b = h.slice(1);
    ...
    } else if (!c && t && d.call(t, h)) {
      v(this._trace(A, t[h], p(n, h), t, h, a, s, !0));
    }
  }
  if (this._hasParentSelector) {
    for (var C = 0; C < g.length; C++) {
      ...
      if (O && O.isParentSelector) {
        var S = this._trace(O.expr, t, O.path, i, o, a, s);
        if (Array.isArray(S)) {
          g[C] = S[0];
          for (var k = S.length, T = 1; T < k; T++) {
            C++;
            g.splice(C, 0, S[T]);
          }
        } else {
...
g.prototype._slice = function (e, t, n, r, i, o, a) {
  if (Array.isArray(n)) {
    ...
    for (var h = [], d = l; d < f; d += u) {
      this._trace(_(d, t), n, r, i, o, a, !0).forEach(function (e) {
        h.push(e);
      });
    }
    return h;
