...
var f = function () {
  ...
  e.prototype.refresh = function () {
    var e = this.Blink.mainWorkspace;
    if (e) {
      try {
        ...
        this.Blink.json.json_to_workspace(t, e);
      } catch (n) {
        ...
        if (s.input_name) {
          for (l = t - 1; l >= 0; l--) {
            ...
            if ((f = e[l]).type === a.BlockEventType.MOVE) {
              var h = f.get_old_loc();
              if (h.parent_id === s.parent_id && h.input_name === s.input_name) {
                u = !1;
                break;
              }
            }
  ...
  e.prototype.generate_connect_op = function (e, t, n, r, a) {
    ...
    try {
      ...
      if (f) {
        var h = f.shadows[n] ? "value" : "statement";
        u = ["connections", t, e];
        l = {
          type: "input",
          input_type: h,
      ...
      this.error("Generating Connect Op", d);
      return null;
    }
  };
    ...
    try {
      switch (n) {
        ...
        case "collapsed":
          ...
          return this.generate_collapse_block_op(e.get_block_id(), h);
        case "comment_expand":
          var d = e.get_new_value();
          if ("boolean" !== typeof d) {
            throw Error("Invalid expand comment event");
          }
          return this.generate_comment_expand_op(e.get_block_id(), d);
        case "comment_color":
        ...
        default:
          throw Error("unimplemented event type " + n);
      }
    } catch (C) {
  ...
  e.prototype.generate_mutate_op = function (e, t, n) {
    ...
    var u = {};
    if (a) {
      var l = a.blocks[e].parent_id;
      if (l) {
        var f = ["connections", l, e];
        var h = (0, i.removeOp)(f);
        c.push(h);
        u[l] = u[l] || {};
        u[l][e] = r.connections[l][e];
      }
  ...
  e.prototype.generate_edit_field_op = function (e, t, n, r) {
    ...
    if (h && void 0 !== l[h]) {
      var d = ["blocks", e, "fields", h];
      return [(0, i.removeOp)(d), (0, i.insertOp)(f, n)].reduce(o.type.compose, null);
    }
  ...
  e.prototype.respawn_shadow = function (e, t, n) {
    ...
    var h = ["connections", e, c];
    var d = {
      type: "input",
      input_type: "value",
      input_name: t
    };
    var p = (0, i.insertOp)(h, d);
    r.push(p);
    return r;
  };
    ...
    for (var s = a.connections[e], c = Object.keys(s), u = function (n) {
        ...
        if ("input" === u.type && u.input_name === t) {
          ...
          Object.keys(h.fields).forEach(function (e) {
            A = h.fields[e];
            if (h.field_extra_attr[e]) {
              g = h.field_extra_attr[e];
            }
          });
