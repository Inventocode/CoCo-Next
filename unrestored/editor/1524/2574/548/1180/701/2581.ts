...
var x = function (e) {
  function t(t, n, r) {
    ...
    if (o) {
      ...
      if (!1 !== a) {
        i.id = c(Object(f.a)(Object(f.a)(i)), s);
  ...
  n.toString = function (e) {
    ...
    var n = !!t && t.options.link ? Object(i.a)({}, e, {
      allowEmpty: !0
    }) : e;
...
var k = function () {
  function e(e, t, n) {
    ...
    this.key = e;
    var r = e.match(S);
    for (var o in this.at = r ? r[1] : "unknown", this.query = n.name || "@" + this.at, this.options = n, this.rules = new $(Object(i.a)({}, n, {
      parent: this
...
var B = {
  onCreateRule: function (e, t, n) {
    return T.test(e) ? new k(e, t, n) : null;
  }
};
var D = {
  indent: 1,
...
var F = function () {
  function e(e, t, n) {
    ...
    var a = n.sheet;
    var s = n.generateId;
    for (var c in this.id = !1 === o ? this.name : w(s(this, a)), this.rules = new $(Object(i.a)({}, n, {
      parent: this
...
var $ = function () {
  ...
  t.add = function (e, t, n) {
    ...
    this.raw[h] = t;
    if (h in this.classes) {
      f.selector = "." + w(this.classes[h]);
    }
    var d = _(h, t, f);
    if (!d) {
      return null;
...
var Be = function () {
  function e(e, t, n) {
    for (var r in this.type = "global", this.at = Te, this.rules = void 0, this.options = void 0, this.key = void 0, this.isProcessed = !1, this.key = e, this.options = n, this.rules = new $(Object(i.a)({}, n, {
      parent: this
...
var bt = {
  ...
  supportedProperty: function (e) {
    return "text-orientation" === e && ("apple" !== lt || ht ? e : ut + e);
  }
};
var wt = {
  noPrefill: ["transform"],
...
var Mt = [dt, pt, yt, bt, wt, Et, xt, Ct, Ot, St, kt, Tt, Bt, Dt, Ft, {
  supportedProperty: function (e, t, n) {
    var r = n.multiple;
    if (Pt.indexOf(e) > -1) {
      var i = Rt[e];
...
var Lt = Mt.filter(function (e) {
  ...
  e.push.apply(e, Object(Ze.a)(t.noPrefill));
  return e;
}, []);
var Ut = {};
if (c) {
...
function Jt() {
  return {
    plugins: [ke(), Re(), je(), Qe(), Je(), "undefined" === typeof window ? null : qt(), $t()]
  };
}
var Zt = me(Jt());
var en = {
...
function un(e, t) {
  ...
  if (!o.disableGeneration) {
    ...
    if (0 === c.refs) {
      ...
      var h = a.create(r, s);
      if (!f) {
        (f = o.jss.createStyleSheet(h, Object(i.a)({
          link: !1
        }, u))).attach();
        if (o.sheetsCache) {
...
function dn(e) {
  ...
  var u = void 0 === c ? sn : c;
  var l = Object(r.a)(t, ["name", "classNamePrefix", "Component", "defaultTheme"]);
  var f = an(e);
  var h = n || o || "makeStyles";
  f.options = {
    index: rn(),
    name: n,
    meta: h,
  ...
  var d = function () {
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    var t = Object(we.a)() || u;
    var r = Object(i.a)({}, a.a.useContext(tn), l);
    var o = a.a.useRef();
    var c = a.a.useRef();
    hn(function () {
      var i = {
    ...
    var h = cn(o.current, e.classes, s);
    return h;
  };
  return d;
}
