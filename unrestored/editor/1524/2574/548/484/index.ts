...
var b = {
  ...
  formatDistance: function (e, t, n) {
    var r;
    n = n || {};
    r = "string" === typeof d[e] ? d[e] : 1 === t ? d[e].one : d[e].other.replace("{{count}}", t);
...
function D(e, t) {
  ...
  var h = new Date(0);
  h.setUTCFullYear(a + 1, 0, f);
  h.setUTCHours(0, 0, 0, 0);
  var d = Object(B.a)(h, t);
  var p = new Date(0);
  p.setUTCFullYear(a, 0, f);
  p.setUTCHours(0, 0, 0, 0);
  var _ = Object(B.a)(p, t);
  return n.getTime() >= d.getTime() ? a + 1 : n.getTime() >= _.getTime() ? a : a - 1;
}
function I(e, t) {
  Object(o.a)(1, arguments);
  var n = t || {};
...
var ot = function () {
  ...
  e.prototype.parse = function (e, t) {
    return "" === e ? null : function (e, t, n, a) {
      ...
      var h = null == f ? 1 : Object(r.a)(f);
      var d = null == u.firstWeekContainsDate ? h : Object(r.a)(u.firstWeekContainsDate);
      if (!(d >= 1 && d <= 7)) {
        throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");
      }
      ...
      for (g = 0; g < y.length; g++) {
        ...
        var O = Qe[C];
        if (O) {
          var S = O.incompatibleTokens;
          if (Array.isArray(S)) {
            for (var k = void 0, T = 0; T < w.length; T++) {
              var B = w[T].token;
              if (-1 !== S.indexOf(B) || B === C) {
                k = w[T];
                break;
              }
            }
            if (k) {
              throw new RangeError("The format string mustn't contain `".concat(k.fullToken, "` and `").concat(x, "` at the same time"));
            }
