...
var k = function (e) {
  ...
  o.useEffect(function () {
    if (p) {
      ...
      var n = function (t) {
        if (!s && d() && 9 === t.keyCode && e.activeElement === m.current) {
          _.current = !0;
          if (t.shiftKey) {
            g.current.focus();
          } else {
