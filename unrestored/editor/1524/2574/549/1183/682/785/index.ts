...
function S(e, t) {
  ...
  var h = n.fontWeightRegular;
  var d = void 0 === h ? 400 : h;
  ...
  var T = {
    ...
    h5: k(d, 24, 1.334, 0),
    h6: k(_, 20, 1.6, .15),
    subtitle1: k(d, 16, 1.75, .15),
    subtitle2: k(_, 14, 1.57, .1),
    body1: k(d, 16, 1.5, .15),
    body2: k(d, 14, 1.43, .15),
    button: k(_, 14, 1.75, .4, O),
    caption: k(d, 12, 1.66, .4),
    overline: k(d, 12, 2.66, 1, O)
  };
  return Object(o.a)(Object(a.a)({
    htmlFontSize: m,
    pxToRem: S,
