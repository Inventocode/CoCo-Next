...
function r(e, t, n) {
  ...
  if (p && (g = function (e, t, n, r) {
    ...
    d = 0 !== (d = Math.max(s - r, c - o)) ? 32767 / d : 0;
  }
  a(g, v, n, r, o, d, 0);
  return v;
}
...
function a(e, t, n, r, i, f, h) {
  if (e) {
    ...
    for (var d, _, A = e; e.prev !== e.next;) {
      if (d = e.prev, _ = e.next, f ? c(e, r, i, f) : s(e)) {
        t.push(d.i / n | 0);
        t.push(e.i / n | 0);
        t.push(_.i / n | 0);
        O(e);
...
function s(e) {
  ...
  for (var i = t.x, o = n.x, a = r.x, s = t.y, c = n.y, u = r.y, l = i < o ? i < a ? i : a : o < a ? o : a, f = s < c ? s < u ? s : u : c < u ? c : u, h = i > o ? i > a ? i : a : o > a ? o : a, d = s > c ? s > u ? s : u : c > u ? c : u, p = r.next; p !== t;) {
    if (p.x >= l && p.x <= h && p.y >= f && p.y <= d && A(i, s, o, c, a, u, p.x, p.y) && v(p.prev, p, p.next) >= 0) {
      return !1;
    }
    p = p.next;
  }
...
function c(e, t, n, r) {
  ...
  for (var s = i.x, c = o.x, u = a.x, l = i.y, f = o.y, h = a.y, d = s < c ? s < u ? s : u : c < u ? c : u, _ = l < f ? l < h ? l : h : f < h ? f : h, g = s > c ? s > u ? s : u : c > u ? c : u, m = l > f ? l > h ? l : h : f > h ? f : h, y = p(d, _, t, n, r), b = p(g, m, t, n, r), w = e.prevZ, E = e.nextZ; w && w.z >= y && E && E.z <= b;) {
    if (w.x >= d && w.x <= g && w.y >= _ && w.y <= m && w !== i && w !== a && A(s, l, c, f, u, h, w.x, w.y) && v(w.prev, w, w.next) >= 0) {
      return !1;
    }
    if (w = w.prevZ, E.x >= d && E.x <= g && E.y >= _ && E.y <= m && E !== i && E !== a && A(s, l, c, f, u, h, E.x, E.y) && v(E.prev, E, E.next) >= 0) {
      return !1;
    }
    E = E.nextZ;
  }
  ...
  for (; E && E.z <= b;) {
    if (E.x >= d && E.x <= g && E.y >= _ && E.y <= m && E !== i && E !== a && A(s, l, c, f, u, h, E.x, E.y) && v(E.prev, E, E.next) >= 0) {
      return !1;
    }
    E = E.nextZ;
  }
  ...
  var n = function (e, t) {
    ...
    do {
      if (i >= r.x && r.x >= l && i !== r.x && A(o < f ? i : a, o, l, f, o < f ? a : i, o, r.x, r.y)) {
        ...
        if (E(r, e) && (c < h || c === h && (r.x > n.x || r.x === n.x && d(n, r)))) {
          n = r;
          h = c;
        }
      }
