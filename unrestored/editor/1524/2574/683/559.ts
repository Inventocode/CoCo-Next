...
!function (i, o, a, s) {
  ...
  pe.prototype = {
    set: function (e) {
      ...
      if (he && this.manager.element.style && de[e]) {
    ...
    preventDefaults: function (e) {
      ...
      if (this.manager.session.prevented) {
        ...
        var r = this.actions;
        var i = S(r, "none") && !de.none;
        var o = S(r, "pan-y") && !de["pan-y"];
        var a = S(r, "pan-x") && !de["pan-x"];
        if (i) {
  ...
  y(xe, me, {
    ...
    attrTest: function (e) {
      ...
      return this._super.attrTest.call(this, e) && n & e.offsetDirection && e.distance > this.options.threshold && e.maxPointers == this.options.pointers && h(t) > this.options.velocity && 4 & e.eventType;
    },
    emit: function (e) {
