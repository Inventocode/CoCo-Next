  ...
  !function (n) {
    !function (r) {
      ...
      (function (t) {
        ...
        var h = f || "function" !== typeof Map || "function" !== typeof Map.prototype.entries ? function () {
          var e = {};
          var t = [];
          var n = function () {
            function e(e, t, n) {
        ...
        var d = f || "function" !== typeof Set || "function" !== typeof Set.prototype.entries ? function () {
          function e() {
            this._map = new h();
          }
        ...
        t("getMetadataKeys", function (e, t) {
          ...
          return function e(t, n) {
            ...
            for (var a = new d(), s = [], c = 0, u = r; c < u.length; c++) {
              var l = u[c];
              if (!a.has(l)) {
                a.add(l);
                s.push(l);
