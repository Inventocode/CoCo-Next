...
var L = s.forwardRef(function (e, t) {
  ...
  var f = l[0];
  var h = l[1];
  var d = Object(s.useState)(!1);
  var p = Object(C.a)(d, 2);
  var _ = p[0];
  var A = p[1];
  ...
  return s.createElement("div", null, s.createElement(k, g), v);
});
L.displayName = "Popup";
var U = L;
  ...
  var t = function (t) {
    ...
    Object(u.a)(i, [{
      ...
      value: function () {
        ...
        var h = E()(l && l.props && l.props.className, c);
        if (h) {
          f.className = h;
        }
        var d = Object(o.a)({}, f);
        if (Object(v.c)(l)) {
          d.ref = Object(v.a)(this.triggerRef, l.ref);
        }
        var p;
        var _ = s.cloneElement(l, d);
