...
export default (function (e, t, n) {
  ...
  if (s) {
    ...
    if (o) {
      ...
      if (l) {
        var c = i(l);
        var p = l.name.startsWith("@babel/plugin") ? "plugins" : "presets";
        a += "\n\nAdd ".concat(c, " to the '").concat(p, "' section of your Babel config to enable transformation.\nIf you want to leave it as-is, add ").concat(u, " to the 'plugins' section to enable parsing.");
      } else {
        a += "\n\nAdd ".concat(u, " to the 'plugins' section of your Babel config ") + "to enable parsing.";
      }
    }
  }
  return a;
...
r.privateIn.syntax = r.privateIn.transform;
var i = function (e) {
  var t = e.name;
  var n = e.url;
