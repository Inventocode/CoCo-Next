...
var zh = {
  ...
  "sign_in_dialog/error/email/empty": "邮箱不能为空",
  "sign_in_dialog/error/email/exist": "注册失败，帐号已经存在",
  "sign_in_dialog/error/email/not_exist": "帐号不存在，请输入已注册的邮箱",
  "sign_in_dialog/error/email/format": "邮箱格式不正确",
  "sign_in_dialog/error/email/email_often": "邮件发送过于频繁",
  "sign_in_dialog/error/email/send_exceed_limit": "今天重置密碼發送郵件已達上限",
  "sign_in_dialog/error/other/network": "网络连接出错了,请稍后再试",
  "sign_in_dialog/verify_email/email_title": "验证邮件已发出",
  "sign_in_dialog/verify_email/email_success_content_1": "请在24小时内登录邮箱",
  "sign_in_dialog/verify_email/email_success_content_2": "并按邮件提示进行操作完成验证",
  ...
  "sign_in_dialog/create_account": "立即注册",
