...
var Spinner = function Spinner(props) {
  ...
  var currentTheme = __WEBPACK_IMPORTED_MODULE_2__themes__.getTheme()
  if (themeColor) {
    if (typeof themeColor === "string") {
      strokeColor = __WEBPACK_IMPORTED_MODULE_2__themes__.getColor(currentTheme, __WEBPACK_IMPORTED_MODULE_3__utils__.getNewThemeColorName(themeColor), "16")
    } else {
      var _themeColor = __WEBPACK_IMPORTED_MODULE_0__babel_runtime_helpers_esm_slicedToArray__.default(themeColor, 2)
      var dark = _themeColor[0]
      var light = _themeColor[1]
      if (currentTheme === __WEBPACK_IMPORTED_MODULE_2__themes__.ThemeTypeEnum.Yellow) {
        strokeColor = __WEBPACK_IMPORTED_MODULE_2__themes__.getColor(currentTheme, __WEBPACK_IMPORTED_MODULE_3__utils__.getNewThemeColorName(light), "16")
      } else {
        strokeColor = __WEBPACK_IMPORTED_MODULE_2__themes__.getColor(currentTheme, __WEBPACK_IMPORTED_MODULE_3__utils__.getNewThemeColorName(dark), "16")
      }
