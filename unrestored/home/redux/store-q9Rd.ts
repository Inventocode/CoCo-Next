...
function get_root_reducer() {
  return Object(__WEBPACK_IMPORTED_MODULE_1_redux__.combineReducers)({
...
function create_store() {
  ...
  var middleware_list = [];
  var saga_middleware = Object(__WEBPACK_IMPORTED_MODULE_2_redux_saga__.default)();
  middleware_list.push(saga_middleware);
  var store = Object(__WEBPACK_IMPORTED_MODULE_1_redux__.createStore)(root_reducer, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__(), __WEBPACK_IMPORTED_MODULE_1_redux__.applyMiddleware.apply(undefined, middleware_list));
  ...
  return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.wrap(function root_saga$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return Object(__WEBPACK_IMPORTED_MODULE_3_redux_saga_effects__.fork)(__WEBPACK_IMPORTED_MODULE_6__main_reducer__.mainSaga);
        case 2:
          _context.next = 4;
          return Object(__WEBPACK_IMPORTED_MODULE_3_redux_saga_effects__.fork)(__WEBPACK_IMPORTED_MODULE_4__routes_Home_model_reducer__.homeSaga);
        case 4:
          _context.next = 6;
          return Object(__WEBPACK_IMPORTED_MODULE_3_redux_saga_effects__.fork)(__WEBPACK_IMPORTED_MODULE_5__routes_Work_model_reducer__.workSaga);
        case 6:
        case 'end':
