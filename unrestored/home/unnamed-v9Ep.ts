...
var CodemaoError = /** @class */function (_super) {
  ...
  function CodemaoError(options) {
    ...
    var error_code = options.error_code,
      _a = options.error_origin_response,
      error_origin_response = _a === void 0 ? {
      ...
      return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
          var url = options.url,
            ...
            data = options.data,
            without_base_url = options.without_base_url;
...
function check_register_options(options) {
  var phone_number = options.phone_number,
    ...
    agreement_ids = options.agreement_ids;
...
function appendDomNode(domNodeType, opts, style) {
  return new Promise(function (resolve, reject) {
    ...
    opts && Object.keys(opts).forEach(function (keyname) {
      var value = opts[keyname];
      keyname !== 'innerHTML' && keyname !== 'style' && node.setAttribute(keyname, typeof value !== 'string' ? JSON.stringify(value) : value);
    });
...
var GeetestCaptcha = /** @class */function (_super) {
  ...
  GeetestCaptcha.create = function (create_options, extra) {
    var dom_id = create_options.dom_id,
      success_callback = create_options.success_callback,
      fail_callback = create_options.fail_callback,
      close_callback = create_options.close_callback,
      specified_appid = create_options.product_id,
      init_options = create_options.init_options;
...
function init$1(options) {
  var env = options.env,
    domain = options.domain,
    _a = options.auth_version,
    _b = options.pid,
    _c = options.client_id,
