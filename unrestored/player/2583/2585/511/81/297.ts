...
var d = function () {
  function t(t, e) {
    for (var n, r, i = [], o = 2; o < arguments.length; o++) {
      i[o - 2] = arguments[o];
    }
  ...
  t.decodeVersionInformation = function (e) {
    for (var n = Number.MAX_SAFE_INTEGER, r = 0, o = 0; o < t.VERSION_DECODE_INFO.length; o++) {
    ...
    return n <= 3 ? t.getVersionForNumber(r) : null;
  };
