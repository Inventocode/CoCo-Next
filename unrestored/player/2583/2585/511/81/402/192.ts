...
var f = function (t) {
  ...
  e.getStandardUPCEANChecksum = function (t) {
    for (var t$length = t.length, n = 0, r = t$length - 1; r >= 0; r -= 2) {
  ...
  e.findGuardPattern = function (t, n, r, i, o) {
    for (var a = t.getSize(), s = 0, l = n = r ? t.getNextUnset(n) : t.getNextSet(n), i$length = i.length, f = r, h = n; h < a; h++) {
      if (t.get(h) !== f) {
        o[s]++
      } else {
        if (s === i$length - 1) {
  ...
  e.decodeDigit = function (t, n, r, i) {
    ...
    for (var this$MAX_AVG_VARIANCE = this.MAX_AVG_VARIANCE, a = -1, i$length = i.length, l = 0; l < i$length; l++) {
      var d = i[l]
...
var p = function () {
  ...
  t.extensionChecksum = function (t) {
    for (var t$length = t.length, n = 0, r = t$length - 2; r >= 0; r -= 2) {
