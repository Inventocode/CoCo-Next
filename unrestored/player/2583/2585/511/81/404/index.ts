...
var b = function () {
  ...
  t.detect = function (e, n) {
    for (var r, i, o = new Array(), a = 0, s = 0, u = !1; a < n.getHeight();) {
      ...
      if (null != c[0] || null != c[3]) {
        ...
        s = 0;
        try {
          for (r = void 0, l = m(o), d = l.next(), void 0; !d.done; d = l.next()) {
            var l;
            var d;
            var f = d.value;
            if (null != f[1]) {
              a = Math.trunc(Math.max(a, f[1].getY()));
            }
            if (null != f[3]) {
              a = Math.max(a, Math.trunc(f[3].getY()));
            }
          }
        } catch (h) {
          r = {
  ...
  t.findRowsWithPattern = function (e, n, r, i, o, a) {
    for (var s = new Array(4), u = !1, c = new Int32Array(a.length); i < n; i += t.ROW_STEP) {
      if (null != (m = t.findGuardPattern(e, o, i, r, !1, a, c))) {
        for (; i > 0;) {
          if (null == (p = t.findGuardPattern(e, o, --i, r, !1, a, c))) {
            i++;
            break;
          }
          m = p;
    ...
    if (u) {
      for (var f = 0, p = Int32Array.from([Math.trunc(s[0].getX()), Math.trunc(s[1].getX())]); l < n; l++) {
        var m;
        if (null != (m = t.findGuardPattern(e, p[0], l, r, !1, a, c)) && Math.abs(p[0] - m[0]) < t.MAX_PATTERN_DRIFT && Math.abs(p[1] - m[1]) < t.MAX_PATTERN_DRIFT) {
          p = m;
          f = 0;
        } else {
  ...
  t.findGuardPattern = function (e, n, r, i, o, a, s) {
    ...
    for (var l = u, d = 0, p = a.length, m = o; l < i; l++) {
      if (e.get(l, r) !== m) {
        s[d]++;
      } else {
        if (d === p - 1) {
    ...
    return d === p - 1 && t.patternMatchVariance(s, a, t.MAX_INDIVIDUAL_VARIANCE) < t.MAX_AVG_VARIANCE ? new Int32Array([u, l - 1]) : null;
  };
  ...
  t.prototype.toString = function () {
    ...
    try {
      for (var i = E(this.codewords), o = i.next(); !o.done; o = i.next()) {
        var a = o.value;
        if (null != a) {
          n.format("%3d: %3d|%3d%n", r++, a.getRowNumber(), a.getValue());
        } else {
          n.format("%3d:    |   %n", r++);
        }
      }
  ...
  e.prototype.setRowNumbers = function () {
    ...
    try {
      for (var n = C(this.getCodewords()), r = n.next(); !r.done; r = n.next()) {
        var i = r.value;
        if (null != i) {
          i.setRowNumberAsRowIndicatorColumn();
        }
      }
    } catch (o) {
      t = {
    ...
    for (var n = this.getBoundingBox(), r = this._isLeft ? n.getTopLeft() : n.getTopRight(), i = this._isLeft ? n.getBottomLeft() : n.getBottomRight(), o = this.imageRowToCodewordIndex(Math.trunc(r.getY())), a = this.imageRowToCodewordIndex(Math.trunc(i.getY())), s = -1, u = 1, c = 0, l = o; l < a; l++) {
      if (null != e[l]) {
        ...
        if (0 === f) {
          ...
          for (var h = void 0, p = (h = u > 2 ? (u - 2) * f : f) >= l, m = 1; m <= h && !p; m++) {
            p = null != e[l - m];
          }
          if (p) {
            e[l] = null;
...
var k = function () {
  ...
  t.prototype.getDetectionResultColumns = function () {
    ...
    var t;
    var e = u.a.MAX_CODEWORDS_IN_BARCODE;
    do {
      t = e;
...
var B = function () {
  ...
  t.decode = function (e, n, r, i, o, s, u) {
    for (var c, l = new _(e, n, r, i, o), d = null, f = null, h = !0;; h = !1) {
      if (null != n) {
        d = t.getRowIndicatorColumn(e, l, n, !0, s, u);
      }
      if (null != i) {
        f = t.getRowIndicatorColumn(e, l, i, !1, s, u);
      }
  ...
  t.createBarcodeMatrix = function (t) {
    ...
    try {
      for (var c = L(t.getDetectionResultColumns()), l = c.next(); !l.done; l = c.next()) {
        ...
        if (null != d) {
          try {
            for (r = void 0, f = L(d.getCodewords()), h = f.next(), void 0; !h.done; h = f.next()) {
              var f;
              var h;
              var p = h.value;
              if (null != p) {
                var m = p.getRowNumber();
                if (m >= 0) {
                  if (m >= o.length) {
                    continue;
                  }
                  o[m][u].setValue(p.getValue());
                }
              }
            }
          } catch (b) {
  ...
  t.getStartColumn = function (e, n, r, i) {
    ...
    for (var c = 0; t.isValidBarcodeColumn(e, n - s);) {
      n -= s;
      try {
        for (o = void 0, l = L(e.getDetectionResultColumn(n).getCodewords()), d = l.next(), void 0; !d.done; d = l.next()) {
          var l;
          var d;
          var f = d.value;
          if (null != f) {
            return (i ? f.getEndX() : f.getStartX()) + s * c * (f.getEndX() - f.getStartX());
          }
        }
      } catch (h) {
        o = {
  ...
  t.decode = function (e, n, i) {
    ...
    try {
      for (var d = P(c.getPoints()), f = d.next(); !f.done; f = d.next()) {
        var h = f.value;
        var p = B.decode(c.getBits(), h[4], h[5], h[6], h[7], t.getMinCodewordWidth(h), t.getMaxCodewordWidth(h));
        var m = new s.a(p.getText(), p.getRawBytes(), void 0, h, r.a.PDF_417);
