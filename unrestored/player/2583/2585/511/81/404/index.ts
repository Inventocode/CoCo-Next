...
var b = function () {
  ...
  t.detect = function (e, n) {
    for (var r, i, o = new Array(), a = 0, s = 0, u = false; a < n.getHeight();) {
  ...
  t.createBarcodeMatrix = function (t) {
    ...
    try {
      for (var c = L(t.getDetectionResultColumns()), l = c.next(); !l.done; l = c.next()) {
        ...
        if (null != d) {
          try {
            for (r = undefined, f = L(d.getCodewords()), h = f.next(), undefined; !h.done; h = f.next()) {
              var f;
              var h;
              var p = h.value;
              if (null != p) {
  ...
  t.decode = function (e, n, i) {
    ...
    try {
      for (var d = P(c.getPoints()), f = d.next(); !f.done; f = d.next()) {
        ...
        var m = new s.a(p.getText(), p.getRawBytes(), undefined, h, r.a.PDF_417);
