...
var b = function () {
  ...
  t.prototype.mirror = function () {
    for (var t = this.bitMatrix, e = 0, n = t.getWidth(); e < n; e++) {
      for (var r = e + 1, i = t.getHeight(); r < i; r++) {
        if (t.get(e, r) !== t.get(r, e)) {
          t.flip(r, e);
          t.flip(e, r);
        }
      }
  ...
  t.getDataBlocks = function (e, n, r) {
    ...
    try {
      for (var m = v(l), b = m.next(); !b.done; b = m.next()) {
        for (var _ = b.value, y = 0; y < _.getCount(); y++) {
          var w = _.getDataCodewords();
    ...
    for (var O = h[0].codewords.length, T = h.length - 1; T >= 0;) {
      if (h[T].codewords.length === O) {
        break;
      }
      T--;
    }
    T++;
    var A = O - u.getECCodewordsPerBlock();
    var S = 0;
    for (y = 0; y < A; y++) {
      for (var I = 0; I < p; I++) {
        h[I].codewords[y] = e[S++];
...
var R = function () {
  ...
  t.prototype.find = function () {
    for (var t = this.startX, e = this.height, n = t + this.width, r = this.startY + e / 2, i = new Int32Array(3), o = this.image, s = 0; s < e; s++) {
      var u = r + (0 === (1 & s) ? Math.floor((s + 1) / 2) : -Math.floor((s + 1) / 2));
      i[0] = 0;
      i[1] = 0;
      i[2] = 0;
      for (var c = t; c < n && !o.get(c, u);) {
        c++;
      }
      for (var l = 0; c < n;) {
        if (o.get(c, u)) {
  ...
  t.prototype.crossCheckVertical = function (e, n, r, i) {
    ...
    s[1] = 0;
    s[2] = 0;
    for (var u = e; u >= 0 && o.get(n, u) && s[1] <= r;) {
      s[1]++;
      u--;
    }
    if (u < 0 || s[1] > r) {
    ...
    var c = s[0] + s[1] + s[2];
    return 5 * Math.abs(c - i) >= 2 * i ? NaN : this.foundPatternCross(s) ? t.centerFromEnd(s, u) : NaN;
  };
    ...
    if (!isNaN(u)) {
      ...
      try {
        for (var l = k(this.possibleCenters), d = l.next(); !d.done; d = l.next()) {
          var f = d.value;
          if (f.aboutEquals(c, u, s)) {
            return f.combineEstimate(u, s, c);
          }
        }
      } catch (p) {
        i = {
...
var B = function () {
  ...
  t.prototype.crossCheckDiagonal = function (e, n, r, i) {
    for (var o = this.getCrossCheckStateCount(), a = 0, s = this.image; e >= a && n >= a && s.get(n - a, e - a);) {
      o[2]++;
      a++;
    }
    if (e < a || n < a) {
    ...
    var u = s.getHeight();
    var c = s.getWidth();
    for (a = 1; e + a < u && n + a < c && s.get(n + a, e + a);) {
      o[2]++;
      a++;
    }
    if (e + a >= u || n + a >= c) {
  ...
  t.prototype.crossCheckVertical = function (e, n, r, i) {
    for (var o = this.image, a = o.getHeight(), s = this.getCrossCheckStateCount(), u = e; u >= 0 && o.get(n, u);) {
      s[2]++;
      u--;
    }
    if (u < 0) {
  ...
  t.prototype.crossCheckHorizontal = function (e, n, r, i) {
    for (var o = this.image, a = o.getWidth(), s = this.getCrossCheckStateCount(), u = e; u >= 0 && o.get(u, n);) {
      s[2]++;
      u--;
    }
    if (u < 0) {
  ...
  t.prototype.haveMultiplyConfirmedCenters = function () {
    ...
    try {
      for (var f = L(this.possibleCenters), h = f.next(); !h.done; h = f.next()) {
        var p = h.value;
        d += Math.abs(p.getEstimatedModuleSize() - l);
      }
    } catch (b) {
      r = {
        error: b
  ...
  t.prototype.selectBestPatterns = function () {
    ...
    var n;
    var r;
    var i = this.possibleCenters.length;
    if (i < 3) {
      throw new a.a();
    }
    var o;
    var s = this.possibleCenters;
    if (i > 3) {
      var u = 0;
      var c = 0;
      try {
    ...
    if (s.length > 3) {
      u = 0;
      try {
        for (var g = L(s), v = g.next(); !v.done; v = g.next()) {
