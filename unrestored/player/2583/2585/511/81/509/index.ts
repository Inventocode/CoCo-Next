...
var y = function (t) {
  ...
  e.prototype.decodeRow = function (t, n, r) {
    ...
    var a;
    var s;
    var u = this.decodePair(n, !1, t, r);
    e.addOrTally(this.possibleLeftPairs, u);
    n.reverse();
    var l = this.decodePair(n, !0, t, r);
    ...
    try {
      for (var d = _(this.possibleLeftPairs), f = d.next(); !f.done; f = d.next()) {
        ...
        if (h.getCount() > 1) {
          try {
            for (a = void 0, p = _(this.possibleRightPairs), m = p.next(), void 0; !m.done; m = p.next()) {
              var p;
              var m;
              var b = m.value;
              if (b.getCount() > 1 && e.checkChecksum(h, b)) {
                return e.constructResult(h, b);
              }
            }
          } catch (g) {
            a = {
  ...
  e.prototype.decodePair = function (t, e, n, r) {
    try {
      ...
      var l = this.decodeDataCharacter(t, o, !0);
      var d = this.decodeDataCharacter(t, o, !1);
  ...
  e.prototype.decodeDataCharacter = function (t, n, r) {
    ...
    if (r) {
      ...
      var M = m.a.getRSSvalue(h, x, !1);
      var k = m.a.getRSSvalue(b, j, !0);
    ...
    M = m.a.getRSSvalue(h, x, !0);
    k = m.a.getRSSvalue(b, j, !1);
    var x;
  ...
  e.prototype.findFinderPattern = function (t, e) {
    ...
    n[2] = 0;
    n[3] = 0;
    for (var i = t.getSize(), o = !1, a = 0; a < i && e !== (o = !t.get(a));) {
      a++;
    }
