...
var u = function () {
  ...
  t.prototype.evaluateAt = function (t) {
    ...
    for (var u = this.coefficients[0], this$coefficients$length = this.coefficients.length, l = 1; l < this$coefficients$length; l++) {
  ...
  t.prototype.multiplyOther = function (e) {
    ...
    for (var this$coefficients = this.coefficients, this$coefficients$length = this$coefficients.length, e$coefficients = e.coefficients, e$coefficients$length = e$coefficients.length, s = new Int32Array(this$coefficients$length + e$coefficients$length - 1), u = 0; u < this$coefficients$length; u++) {
  ...
  t.prototype.negative = function () {
    for (var this$coefficients$length = this.coefficients.length, n = new Int32Array(this$coefficients$length), r = 0; r < this$coefficients$length; r++) {
  ...
  t.prototype.multiplyScalar = function (e) {
    ...
    for (var this$coefficients$length = this.coefficients.length, r = new Int32Array(this$coefficients$length), i = 0; i < this$coefficients$length; i++) {
  ...
  t.prototype.multiplyByMonomial = function (e, n) {
    ...
    for (var this$coefficients$length = this.coefficients.length, o = new Int32Array(this$coefficients$length + e), a = 0; a < this$coefficients$length; a++) {
