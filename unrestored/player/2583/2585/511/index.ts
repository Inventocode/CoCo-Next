...
var w = require("../../../../shared/1531/2584/15/index");
var E = require("../../../../shared/1531/2584/676/index");
var O = require("../../../../shared/1531/2584/27");
var T = require("../../../../shared/1531/2584/40");
var A = require("../../../../shared/1531/2584/57/index");
var S = require("../../../../shared/1531/2584/58/index");
var I = require("../../../../shared/1531/2584/28/index");
var C = [];
var j = function () {};
var M = {
...
var k = require("../../../../shared/1531/2584/48/72");
var R = require("../../../../shared/1531/2584/48/index");
var N = require("../../../../shared/1531/2584/38/217/index");
var x = require("../../../../shared/1531/2584/676/70");
var D = function (t) {
  Object(A.a)(n, t);
  var e = Object(S.a)(n);
  function n(t) {
...
var L = require("../../../../shared/1531/2584/677/index");
var B = {
...
var z = require("../../../../shared/1531/2584/679");
var Y = require("../../../../shared/1531/2584/75/index");
...
var X = require("../../../../shared/1531/2584/8");
...
var Z = require("../../../../shared/1531/2584/51/index");
...
var at = {
  ...
  getContentBox: function (t, e, n, r, i, o) {
    ...
    return h.a.createElement("div", {
      ...
      className: q()(a && it.a.singleElementContentBox, !a && it.a.contentBox)
  ...
  _message: function (t) {
    ...
    var l = h.a.createElement("div", {
      id: ot,
      className: q()(it.a.dialog, this.style === Q.b.styleA ? it.a.styleA : it.a.styleB)
    }, u, c);
    K.a.render(l, s);
  },
...
var Tt;
var At = require("../../../../shared/1531/2584/23");
var St = require("./249");
var It = function __importDefault(module) {
  var defaultExport = module && module.__esModule ? function () {
    return module.default;
...
var kt = require("./899");
var Rt = function __importDefault(module) {
  var defaultExport = module && module.__esModule ? function () {
    return module.default;
  } : function () {
    return module;
...
var Ut = require("./902");
var Ft = function __importDefault(module) {
  var defaultExport = module && module.__esModule ? function () {
    return module.default;
  } : function () {
    return module;
  ...
  Object(T.a)(n, [{
    ...
    value: function () {
      if (this.previewPage) {
        ...
        t.classList.remove(It.a.scanning);
    ...
    value: function () {
      ...
      if (!this.previewPage) {
        ...
        var n = "\n        <img class=".concat(It.a.scanning, " src=").concat(Mt.a, " />\n        <p class=").concat(It.a.text, ">\n          ").concat(Object(At.c)(At.b, "ScanQrCode.tip"), "\n        </p>\n        <div class=").concat(It.a.error, ' style="display:none;">\n          <div>\n            <img src=').concat(xt.a, ' />\n            <p>\u7f51\u7edc\u4e0d\u4f73\uff0c\u4e8c\u7ef4\u7801\u8bc6\u522b\u5931\u8d25</p>\n          </div>\n        </div>\n        <div class="').concat(It.a.largeBtn, " ").concat(It.a.photoBtn, '">\n          <img src=').concat(Ft.a, ' />\n        </div>\n        <div class="').concat(It.a.smallBtn, " ").concat(It.a.returnBtn, '">\n          <img src=').concat(Rt.a, ' />\n        </div>\n        <div class="').concat(It.a.largeBtn, " ").concat(It.a.lightBtn, '">\n          <img src=').concat(Lt.a, " />\n        </div>\n      ");
        var r = document.createElement("div");
        r.id = "SCANNER_PREVIEW_CONTAINER_ID";
        r.className = It.a.container;
        r.innerHTML = n;
        this.previewPage = r;
            ...
            if (e.lightEnabled) {
              t.QRCodeScanner.disableLight(function (e) {
                if (e) {
                  ...
                  var n = document.getElementsByClassName(It.a.lightBtn)[0];
                  if (n) {
                    n.innerHTML = "<img src=".concat(Lt.a, " />");
                  }
                }
              });
            } else {
...
var Ht = require("../../../../shared/1531/2584/673");
var Vt = function (t) {
  Object(A.a)(n, t);
  var e = Object(S.a)(n);
  function n() {
...
var Yt = require("../../../../shared/1531/2584/36/345/114");
var Kt = require("../../../../shared/1531/2584/14");
var Xt = require("../../../../shared/1531/2584/116");
var qt = function (t) {
  Object(A.a)(n, t);
  var e = Object(S.a)(n);
  function n(t) {
...
var Zt = require("../../../../shared/1531/2584/77");
var Jt = function (t) {
  Object(A.a)(n, t);
  var e = Object(S.a)(n);
  function n(t) {
...
var ve = Object(f.memo)(function () {
  ...
  return h.a.createElement("div", {
    className: q()(be.a.dialerBox, !e.dialPageVisible && be.a.dialerBoxHide)
    ...
    return h.a.createElement("div", {
      key: t.number,
      className: q()(be.a.keyItem, be.a.numberKey),
    ...
    className: q()(be.a.keyItem, be.a.white)
  }), h.a.createElement("div", {
    className: q()(be.a.keyItem, be.a.callBtn),
    onClick: function () {
      if (i) {
        t(Object(k.s)({
          dialPageVisible: !1,
...
var ye = Object(f.memo)(function () {
  ...
  return h.a.createElement("div", {
    className: q()(be.a.callingBox, !n.callingPageVisible && be.a.callingBoxHide)
  }, "dialOutCall" === n.callType && h.a.createElement(h.a.Fragment, null, h.a.createElement("div", {
    className: be.a.phoneNumber
  }, n.phoneNumber), n.callStatus === x.b.RINGING && h.a.createElement("div", {
    className: be.a.phoneStatus
  }, e({
    id: "emulator.onRinging"
  })), n.callStatus === x.b.OFFHOOK && h.a.createElement("div", {
    className: be.a.phoneStatus
  }, s(o)), h.a.createElement("div", {
    className: q()(be.a.callBtnBox, be.a.flexCC)
  }, h.a.createElement("div", {
    className: be.a.callBtnItemBox,
    onClick: u
  }, h.a.createElement("div", {
    className: q()(be.a.callBtnItem, be.a.callEnd)
  }, h.a.createElement(pe.j, {
    ...
    className: q()(be.a.callBtnBox, n.callStatus === x.b.RINGING ? be.a.flexSC : be.a.flexCC)
  }, h.a.createElement("div", {
    className: be.a.callBtnItemBox,
    onClick: l
  }, h.a.createElement("div", {
    ...
    id: "emulator.callEnd"
  }))), n.callStatus === x.b.RINGING && h.a.createElement("div", {
    className: be.a.callBtnItemBox,
    onClick: d
  }, h.a.createElement("div", {
    className: q()(be.a.callBtnItem, be.a.callConnect)
  }, h.a.createElement(pe.j, {
    type: "icon-phone-call-dial"
  })), h.a.createElement("span", {
    className: be.a.callBtnText
...
var we = require("../../../../shared/1531/2584/677/476");
var Ee = [{
...
var Oe = Object(f.memo)(function () {
  ...
  return h.a.createElement("div", {
    className: q()(be.a.contactBox, !e.contactPageVisible && be.a.contactBoxHide)
  }, h.a.createElement("div", {
    className: be.a.backBox,
    onClick: function () {
      t(Object(k.s)({
    ...
    return h.a.createElement("div", {
      ...
      key: t.name,
      className: q()(be.a.contactItem, be.a.flexSC)
    }, h.a.createElement("div", {
...
var Ae = Object(f.memo)(function () {
  ...
  return h.a.createElement("div", {
    className: q()(be.a.sendSmsBox, !n.sendSmsPageVisible && be.a.sendSmsBoxHide)
  }, h.a.createElement("div", {
    className: be.a.backBox
  }, h.a.createElement("div", {
    onClick: function () {
    ...
    className: q()(be.a.sendSmsBtn, (!o || !l) && be.a.disable)
  }, h.a.createElement(pe.j, {
...
var Se = Object(f.memo)(function () {
  ...
  return h.a.createElement("div", {
    className: q()(be.a.receiveSms, !n.receiveSmsPageVisible && be.a.receiveSmsHide)
  }, h.a.createElement("div", {
...
var Ce = Object(f.memo)(function () {
  ...
  }, h.a.createElement(ve, null), h.a.createElement(Oe, null), h.a.createElement(Ae, null), h.a.createElement(Se, null), h.a.createElement(ye, null), h.a.createElement(Ie, null));
});
var je = require("../../../../shared/1531/2584/21/424/67/410");
var Me = function () {
...
var ke = h.a.memo(function () {
  ...
  return h.a.createElement("div", {
    ...
    id: t || ""
  }), h.a.createElement(Me, null), h.a.createElement(Ce, null));
});
var Re = require("../../../../shared/1531/2584/38/217/388");
var Ne = {
  x: 0,
  y: 0,
  z: 0
...
function We() {
  return (We = Object(d.a)(u.a.mark(function t(e) {
    var n;
    return u.a.wrap(function (t) {
      for (;;) {
        switch (t.prev = t.next) {
...
function Ye() {
  return (Ye = Object(d.a)(u.a.mark(function t(e) {
    var n;
    var r;
    var i;
    var s;
...
_a = h.a.memo(function (t) {
  ...
  return r ? h.a.createElement(p.a, {
    store: Object(R.a)()
  }, h.a.createElement(ke, null)) : null;
});
export { _a as a };
export default _a;