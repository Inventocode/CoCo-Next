          ...
          case 1:
            ...
            try {
              for (n = l(t), r = n.next(); !r.done; r = n.next()) {
                r$value = r.value
                if ("videoinput" === (s = "video" === r$value.kind ? "videoinput" : r$value.kind)) {
                  u = r$value.deviceId || r$value.id
                  d = r$value.label || "Video device " + (e.length + 1)
      ...
      return c(this, function (v) {
        switch (v.label) {
          case 0:
            ...
            return [4, t.attachStreamToVideo(e, n, this$options$tryPlayVideoTimeout)]
          case 1:
            o = v.sent()
            a = function () {
      ...
      return c(this, function (a) {
        switch (a.label) {
          case 0:
            ...
            this$options$tryPlayVideoTimeout = this.options.tryPlayVideoTimeout
            return [4, t.playVideoOnLoadAsync(i, this$options$tryPlayVideoTimeout)]
          case 1:
            a.sent()
      ...
      return c(this, function (o) {
        switch (o.label) {
          case 0:
            ...
            this$options$tryPlayVideoTimeout = this.options.tryPlayVideoTimeout
            return [4, t.playVideoOnLoadAsync(n, this$options$tryPlayVideoTimeout)]
          case 1:
            o.sent()
