...
var a = function () {
  ...
  t.prototype.evaluateAt = function (t) {
    ...
    if (1 === t) {
      e = 0
      for (var i = 0, /* [auto-meaningful-name] */this$coefficients$length = this$coefficients.length; i !== this$coefficients$length; i++) {
  ...
  t.prototype.multiplyScalar = function (e) {
    ...
    for (var /* [auto-meaningful-name] */this$coefficients$length = this.coefficients.length, /* [auto-meaningful-name] */this$field = this.field, i = new Int32Array(this$coefficients$length), /* [auto-meaningful-name] */this$coefficients = this.coefficients, a = 0; a < this$coefficients$length; a++) {
  ...
  t.prototype.multiplyByMonomial = function (e, n) {
    ...
    for (var /* [auto-meaningful-name] */this$coefficients = this.coefficients, /* [auto-meaningful-name] */this$coefficients$length = this$coefficients.length, a = new Int32Array(this$coefficients$length + e), /* [auto-meaningful-name] */this$field = this.field, u = 0; u < this$coefficients$length; u++) {
  ...
  t.prototype.divide = function (t) {
    ...
    for (var /* [auto-meaningful-name] */this$field = this.field, n = this$field.getZero(), r = this, i = t.getCoefficient(t.getDegree()), a = this$field.inverse(i); r.getDegree() >= t.getDegree() && !r.isZero();) {
