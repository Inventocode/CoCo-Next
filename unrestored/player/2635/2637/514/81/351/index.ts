...
var s = require(/* 507 */"../507")
var u = require(/* 508 */"../508")
var c = require(/* 151 */"../151")
var l = require(/* 171 */"../171")
var d = require(/* 405 */"../405")
var f = require(/* 192 */"./192")
var h = function () {
  var t = function (e, n) {
...
var m = function (t) {
  ...
  e.prototype.decodeMiddle = function (t, e, n) {
    ...
    for (var u = t.getSize(), c = e[1], l = 0; l < 4 && c < u; l++) {
      var d = f.a.decodeDigit(t, this$decodeMiddleCounters, c, f.a.L_PATTERNS)
      n += String.fromCharCode("0".charCodeAt(0) + d)
      try {
        for (r = undefined, h = p(this$decodeMiddleCounters), m = h.next(), undefined; !m.done; m = h.next()) {
          var h
          var m
          c += m.value
        }
    ...
    for (l = 0; l < 4 && c < u; l++) {
      d = f.a.decodeDigit(t, this$decodeMiddleCounters, c, f.a.L_PATTERNS)
      n += String.fromCharCode("0".charCodeAt(0) + d)
      try {
        for (o = undefined, b = p(this$decodeMiddleCounters), g = b.next(), undefined; !g.done; g = b.next()) {
          var b
          var g
          c += g.value
        }
...
var A = require(/* 606 */"../606/index")
var S = require(/* 512 */"../512")
var I = function () {
  var t = function (e, n) {
    return (t = Object.setPrototypeOf || {
      __proto__: []
