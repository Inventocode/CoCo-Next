...
var f = function (t) {
  ...
  e.prototype.decodeRow = function (t, n, o) {
    ...
    var m
    var b
    var g = e.findAsteriskPattern(n, this$counters)
    var v = n.getNextSet(g[1])
    var _ = n.getSize()
    do {
      e.recordPattern(n, v, this$counters)
      var y = e.toNarrowWidePattern(this$counters)
      if (y < 0) {
        throw new a.a()
      }
      m = e.patternToChar(y)
      ...
      b = v
      try {
        for (s = undefined, w = d(this$counters), E = w.next(), undefined; !E.done; E = w.next()) {
          var w
          var E
          v += E.value
        }
    ...
    var T = 0
    try {
      for (var A = d(this$counters), S = A.next(); !S.done; S = A.next()) {
        T += S.value
      }
    } catch (N) {
      f = {
  ...
  e.findAsteriskPattern = function (t, n) {
    for (var r = t.getSize(), i = t.getNextSet(0), o = 0, s = i, u = false, /* [auto-meaningful-name] */n$length = n.length, l = i; l < r; l++) {
      if (t.get(l) !== u) {
        n[o]++
      } else {
        if (o === n$length - 1) {
          if (this.toNarrowWidePattern(n) === e.ASTERISK_ENCODING && t.isRange(Math.max(0, s - Math.floor((l - s) / 2)), s, false)) {
            return [s, l]
          }
          s += n[0] + n[1]
  ...
  e.toNarrowWidePattern = function (t) {
    ...
    do {
      var a = 2147483647
      try {
        for (e = undefined, s = d(t), u = s.next(), undefined; !u.done; u = s.next()) {
          var s
          var u
          if ((h = u.value) < a && h > o) {
            a = h
      ...
      o = a
      r = 0
      for (var c = 0, l = 0, f = 0; f < t$length; f++) {
        if ((h = t[f]) > o) {
          l |= 1 << t$length - 1 - f
          r++
          c += h
  ...
  e.decodeExtended = function (t) {
    for (var /* [auto-meaningful-name] */t$length = t.length, n = "", r = 0; r < t$length; r++) {
      var i = t.charAt(r)
      if ("+" === i || "$" === i || "%" === i || "/" === i) {
        var a = t.charAt(r + 1)
