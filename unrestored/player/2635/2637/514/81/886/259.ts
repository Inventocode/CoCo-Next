...
var p = function () {
  ...
  t.prototype.listVideoInputDevices = function () {
    return d(this, undefined, undefined, function () {
      ...
      var a
      var s
      var /* [auto-meaningful-name] */r$value$groupId
      var c
      var l
          ...
          case 1:
            ...
            try {
              for (n = h(t), r = n.next(); !r.done; r = n.next()) {
                r$value = r.value
                if ("videoinput" === (o = "video" === r$value.kind ? "videoinput" : r$value.kind)) {
                  a = r$value.deviceId || r$value.id
                  s = r$value.label || "Video device " + (e.length + 1)
                  r$value$groupId = r$value.groupId
                  c = {
                    deviceId: a,
                    label: s,
                    kind: o,
  ...
  t.prototype._decodeOnLoadImage = function (t) {
    ...
    return new Promise(function (n, r) {
      e.imageLoadedListener = function () {
        return e.decodeOnce(t, false, true).then(n, r)
      }
    ...
    return new Promise(function (i, a) {
      return function i(a, c) {
        if (r._stopAsyncDecode) {
          ...
          return void (r._stopAsyncDecode = undefined)
        }
        try {
          a(r.decode(t))
        } catch (f) {
          var l = e && f instanceof Module_36.a
          var d = f instanceof Module_165.a || f instanceof Module_56.a
          if (l || d && n) {
  ...
  t.prototype.decodeContinuously = function (t, e) {
    ...
    !function r() {
      if (n._stopContinuousDecode) {
        n._stopContinuousDecode = undefined
      } else {
        try {
          var i = n.decode(t)
          e(i, null)
          ...
          e(null, l)
          var a = l instanceof Module_165.a || l instanceof Module_56.a
          var c = l instanceof Module_36.a
          if (a || c) {
  ...
  t.prototype.createBinaryBitmap = function (t) {
    ...
    var r = new Module_589.a(n)
    var o = new Module_586.a(r)
    return new Module_585.a(o)
  }
