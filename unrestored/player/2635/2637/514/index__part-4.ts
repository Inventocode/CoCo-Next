  ...
  openMessage: function (t, e) {
    if (t) {
      if ($$_$$_$$_$$_shared_1571_2636_28_index.d()) {
        ...
        if ($$_$$_$$_$$_shared_1571_2636_28_index.b()) {
  ...
  $$_$$_$$_$$_shared_1571_2636_39.a(n, [
    {
      ...
      value: function () {
        ...
        if (this.phoneNumber) {
          if (this.smsContent) {
            return $$_$$_$$_$$_shared_1571_2636_28_index.g() ? (this.emit("onSendSmsSuccess", this.smsContent, this.phoneNumber), void this.widgetLog("sendSmsLog", {
