...
function c(e, t, n, a, s, c) {
  ...
  if ("increase" === e) {
    ...
    if (E) {
      ...
      var I = document.createElement("shadow");
      I.setAttribute("type", "math_number");
      I.setAttribute("visible", "visible");
      w = f.gen_uid();
      I.setAttribute("id", w);
      var A = document.createElement("field");
      A.setAttribute("name", "NUM");
      A.setAttribute("constraints", "-Infinity,Infinity,0");
      A.textContent = "0";
      I.appendChild(A);
      O = h.block_dom_to_json(I, n);
      C = f.dom_to_string(I);
    }
...
exports.effect_of_update_param = function (e, t, n, r) {
  ...
  if (l.length) {
    ...
    l.forEach(function (t) {
      ...
      if ("decrease" === e) {
        o = t.mutation;
        if ((i = u.string_to_dom(o)).lastChild) {
