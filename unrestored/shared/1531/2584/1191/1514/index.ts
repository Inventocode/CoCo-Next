...
var a = p(require("../../8"))
var s = require("./1049/index")
var c = require("./1189")
var l = require("./928")
var u = p(require("./1516"))
var d = p(require("./1190"))
function p(e) {
...
var j = function (e) {
  ...
  O(n, [{
    ...
    value: function () {
      ...
      var w = (0, a.default)(this$props$children.props.className || "", this$props$defaultClassName, (A(e = {}, this$props$defaultClassNameDragging, this.state.dragging), A(e, this$props$defaultClassNameDragged, this.state.dragged), e))
