...
var o$RangeError = o.RangeError
var c$ArrayBuffer = c.ArrayBuffer
var c$DataView = c.DataView
var s$NATIVE_ARRAY_BUFFER_VIEWS = s.NATIVE_ARRAY_BUFFER_VIEWS
var s$TYPED_ARRAY_CONSTRUCTOR = s.TYPED_ARRAY_CONSTRUCTOR
var s$TYPED_ARRAY_TAG = s.TYPED_ARRAY_TAG
var s$TypedArray = s.TypedArray
var s$TypedArrayPrototype = s.TypedArrayPrototype
var s$aTypedArrayConstructor = s.aTypedArrayConstructor
var s$isTypedArray = s.isTypedArray
var Y = function (e, t) {
  for (var n = 0, t$length = t.length, o = new (s$aTypedArrayConstructor(e))(t$length); t$length > n;) {
    o[n] = t[n++]
  }
  return o
}
  ...
  module.exports = function (e, t, n) {
    ...
    if (s$NATIVE_ARRAY_BUFFER_VIEWS) {
      if (a) {
        ...
        require$$$$1733399$forEach(require$$$$1667631Index$f(p), function (e) {
          if (!(e in g)) {
            d(g, e, p[e])
          }
        })
