...
var require$$258Index$aTypedArrayConstructor = require("../258/index").aTypedArrayConstructor
module.exports = function (e) {
  ...
  for (_ && arguments$length > 2 && (g = c(g, arguments[2], 2)), n = o(h.length), u = new (require$$258Index$aTypedArrayConstructor(this))(n), t = 0; n > t; t++) {
    u[t] = _ ? g(h[t], t) : h[t]
  }
  return u
}
