...
var require$$1738709$getWeakData = require("../1738/709").getWeakData
...
var d$set = d.set
var d$getterFor = d.getterFor
var l$find = l.find
var l$findIndex = l.findIndex
var g = 0
var _ = function (e) {
...
module.exports = {
  getConstructor: function (e, t, n, l) {
    ...
    var m = function (e, t, n) {
      var r = h(e)
      var a = require$$1738709$getWeakData(i(t), true)
      if (true === a) {
        _(r).set(t, n)
      } else {
        a[r.id] = n
    ...
    r(d.prototype, {
      delete: function (e) {
        ...
        var n = require$$1738709$getWeakData(e)
