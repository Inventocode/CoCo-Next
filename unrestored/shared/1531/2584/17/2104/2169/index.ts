...
exports.block_render_svg = function (e) {
  return function (e) {
    ...
    t.prototype.compute_input_width_ = function (e) {
      ...
      switch (null === (e$connection = e.connection) || undefined === e$connection ? undefined : e$connection.get_output_shape()) {
    ...
    t.prototype._render_compute = function (e) {
      for (var /* [auto-meaningful-name] */u$type, /* [auto-meaningful-name] */this$inputList = this.inputList, r = Object.assign([], {
          ...
          var c
          var u = this$inputList[a]
          if (!u.is_visible()) {
            return "continue"
          }
          if (i && undefined != u$type && u$type !== o.InputType.STATEMENT && u.type !== o.InputType.STATEMENT) {
            c = r[r.length - 1]
          } else {
            c = s.create_row_for_input_(u, undefined == u$type ? e : 0)
            u$type = u.type
            r.push(c)
          }
          c.push(u)
        ...
        }, s = this, c = 0; c < this$inputList.length; c++) {
        a(c)
      }
      ...
      for (var t = 0; t < this.inputList.length; ++t) {
        ...
        if (this$inputListT$connection) {
          ...
          if (this$inputListT$connection.is_connected()) {
            this$inputListT$connection.tighten()
          }
        }
      }
    ...
    t.prototype.render_draw_right_ = function (e, t) {
      for (var n = i.vec2.create(), r = 0, c = 0, u = 0, /* [auto-meaningful-name] */t$length = t.length; u < t$length; u++) {
        ...
        if (f.type == o.InputRowType.INLINE) {
          if (d && d.type == o.InputRowType.STATEMENT && u !== t$length - 1) {
    ...
    t.prototype.render_row_inline_ = function (e, t, n, r, i, a) {
      ...
      r.right_edge = Math.max(t[0], r$right_edge)
