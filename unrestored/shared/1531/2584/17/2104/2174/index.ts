...
var g = function (e) {
  ...
  t.prototype.get_bounding_rectangle = function () {
    ...
    var t$topLeft = t.topLeft
    var t$bottomRight = t.bottomRight
    return {
  ...
  t.prototype.get_root_block = function () {
    for (var this$parent_block_ = this.parent_block_; null === this$parent_block_ || undefined === this$parent_block_ ? undefined : this$parent_block_.parent_block;) {
  ...
  t.prototype.show_context_menu = function (e) {
    ...
    if (!this.workspace.get_options().readOnly && this.context_menu && !this.is_in_flyout) {
      ...
      var r = function (e) {
        var t$color_theme = t.color_theme
        if (t$color_theme !== e) {
          t.set_color_theme(e)
  ...
  t.prototype.update_visibility = function () {
    if (this.parent_block_) {
      var this$parent_block_ = this.parent_block_
  ...
  t.prototype.compute_line_connect_position = function () {
    ...
    var this$parent_block_$first_row_width = this.parent_block_.first_row_width
