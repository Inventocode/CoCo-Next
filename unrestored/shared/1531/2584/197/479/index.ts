...
var _ = function (e, t) {
  return o(undefined, undefined, undefined, function () {
    ...
    return a(this, function (i) {
      ...
      return [2, h("https://collection.codemao.cn/report/" + f.get().pid, {
        method: "post",
    ...
    return o(this, undefined, undefined, function () {
      ...
      return a(this, function (k) {
        switch (k.label) {
          ...
          case 1:
            k.trys.push([1, 3,, 4])
            return [4, (S = t.type || "normal", T = m, t$authToken = t.authToken, o(undefined, undefined, undefined, function () {
              var e
              var t
              var n
              var r
                ...
                switch (a.label) {
                  ...
                  case 1:
                    ...
                    return "normal" === S ? [2, {
                      ...
                      bucket: r.bucket
                    }] : (r$file_path = r.file_path, r$token = r.token, r$bucket_url = r.bucket_url, r$bucket = r.bucket, "transcode" === S ? [2, {
                  ...
                  return a(this, function (a) {
                    switch (a.label) {
                      ...
                      case 1:
                        ...
                        r$bucket = r.bucket
                        return [4, this.ali.upload(e, r$uploadUrl, {
                          key: r$filename,
