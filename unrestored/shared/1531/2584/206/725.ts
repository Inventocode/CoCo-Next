...
function s(e) {
  ...
  var e$workspace_json = e.workspace_json
  var e$should_rename = e.should_rename
  var e$block_id = e.block_id
  ...
  if (u.type === i.PROCEDURE_BLOCK_TYPES.DEF) {
    ...
    var functionETNRVarIIfRRT$blocksNI$pushT$blocksNIfT$connectionsNObject$keysT$connectionsN$forEachFunctionNI$push$applyIETNRReturnIE$workspace_jsonE$block_idFunctionEReturnE$typeI$PROCEDURE_BLOCK_TYPES$RETURNObject$keysE$shadows$someFunctionEReturnVALUEE$length = function e(t, n, r) {
      var i = []
      if (!(r && !r(t.blocks[n]))) {
        i.push(t.blocks[n])
      }
