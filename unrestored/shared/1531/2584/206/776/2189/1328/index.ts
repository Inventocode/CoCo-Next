...
var require$1109Index$Syntax = require("./1109/index").Syntax
var l = require("../1110")
var f = require("../964")
var require$1329$Definition = require("./1329").Definition
...
var _ = function () {
  function e(t, n, r, i, o) {
    ...
    this.isStrict = function (e, t, n, r) {
      ...
      if ("function" === e.type) {
        if (t.type === require$1109Index$Syntax.ArrowFunctionExpression && t.body.type !== require$1109Index$Syntax.BlockStatement) {
          return false
        }
        if (!(i = t.type === require$1109Index$Syntax.Program ? t : t.body)) {
          return false
        }
      } else {
        if ("global" !== e.type) {
      ...
      if (r) {
        for (var o = 0, _i$body$length = i.body.length; o < _i$body$length; ++o) {
          var s = i.body[o]
          if (s.type !== require$1109Index$Syntax.DirectiveStatement) {
            break
          }
        ...
        for (var c = 0, i$body$length = i.body.length; c < i$body$length; ++c) {
          var f = i.body[c]
          if (f.type !== require$1109Index$Syntax.ExpressionStatement) {
            break
          }
          var f$expression = f.expression
          if (f$expression.type !== require$1109Index$Syntax.Literal || "string" !== typeof f$expression.value) {
            break
          }
  ...
  c(e, [{
    ...
    value: function (e) {
      var e$identifier$name = e.identifier.name
      if (!this.set.has(e$identifier$name)) {
        return false
      }
      var this$set$getE$identifier$name$defs = this.set.get(e$identifier$name).defs
    ...
    value: function (e) {
      ...
      for (var n = 0, this$__left$length = this.__left.length; n < this$__left$length; ++n) {
        var i = this.__left[n]
        t.call(this, i)
      }
      this.__left = null
    ...
    key: "__define",
    value: function (e, t) {
      if (e && e.type === require$1109Index$Syntax.Identifier) {
    ...
    value: function (e, t, n, r, i, o) {
      if (e && e.type === require$1109Index$Syntax.Identifier && "super" !== e.name) {
    ...
    value: function (e) {
      ...
      for (h(this.__isClosed(), "Scope should be closed."), h(e.type === require$1109Index$Syntax.Identifier, "Target should be identifier."), n = 0, this$references$length = this.references.length; n < this$references$length; ++n) {
    ...
    value: function (e) {
      ...
      for (var t = 0, this$through$length = this.through.length; t < this$through$length; ++t) {
...
var A = function (e) {
  ...
  c(n, [{
    key: "__close",
    value: function (e) {
      for (var t = [], o = 0, this$__left$length = this.__left.length; o < this$__left$length; ++o) {
        var s = this.__left[o]
        if (s.__maybeImplicitGlobal && !this.set.has(s.identifier.name)) {
          t.push(s.__maybeImplicitGlobal)
        }
      }
      for (var c = 0, t$length = t.length; c < t$length; ++c) {
        var l = t[c]
        this.__defineImplicit(l.pattern, new require$1329$Definition(f.ImplicitGlobalVariable, l.pattern, l.node, null, null, null))
      }
...
var v = function (e) {
  ...
  function n(e, r, i) {
    var o
    s(this, n);
    (o = t.call(this, e, "function-expression-name", r, i, false)).__define(i.id, new require$1329$Definition(f.FunctionName, i.id, i, null, null, null))
...
var y = function (e) {
  ...
  c(n, [{
    ...
    value: function (e) {
      ...
      for (var t = 0, this$__left$length = this.__left.length; t < this$__left$length; ++t) {
        var a = this.__left[t]
        a.tainted = true
...
var E = function (e) {
  ...
  function n(e, r, i, o) {
    var a
    s(this, n)
    if ((a = t.call(this, e, "function", r, i, o)).block.type !== require$1109Index$Syntax.ArrowFunctionExpression) {
      a.__defineArguments()
    }
    return a
  }
  c(n, [{
    key: "isArgumentsMaterialized",
    value: function () {
      if (this.block.type === require$1109Index$Syntax.ArrowFunctionExpression) {
        return false
      }
      if (!this.isStatic()) {
        return true
