...
(function (e) {
  ...
  exports.format = function (e) {
    ...
    n = 1
    for (var r = arguments, r$length = r.length, a = String(e).replace(i, function (e) {
        if ("%%" === e) {
          return "%"
        }
        if (n >= r$length) {
  ...
  function l(e, n, r) {
    ...
    return 0 !== a.length || x && 0 != n.length ? r < 0 ? m(n) ? e.stylize(RegExp.prototype.toString.call(n), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(n), u = x ? function (e, t, n, r, i) {
      for (var o = [], a = 0, t$length = t.length; a < t$length; ++a) {
        if (S(t, String(a))) {
  ...
  exports._extend = function (e, t) {
    ...
    for (var n = Object.keys(t), n$length = n.length; n$length--;) {
