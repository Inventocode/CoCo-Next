...
var s = require("../../../../965")
var s$breakableTypePattern = s.breakableTypePattern
var s$createGlobalLinebreakMatcher = s.createGlobalLinebreakMatcher
var s$lineBreakPattern = s.lineBreakPattern
var s$shebangPattern = s.shebangPattern
...
module.exports = {
  ...
  couldBeError: function (t) {
    switch (t.type) {
      ...
      case "SequenceExpression":
        var t$expressions = t.expressions
