...
(function (t) {
  ...
  var b = require("./1343")
  var require$2254Index$SourceCode = require("./2254/index").SourceCode
            ...
            switch (h) {
              ...
              case "eslint-disable-line":
                var v = function (e) {
                    ...
                    var e$loc = e.loc
                    var e$value = e.value
                    var e$ruleMapper = e.ruleMapper
                    var a = Object.keys(R.parseListConfig(e$value))
                  ...
                  v$directiveProblems = v.directiveProblems
  ...
  function z(e, t, n, r, i, o, a, s, c) {
    ...
    var d = Object.freeze(Object.assign(Object.create(G), {
      getAncestors: function () {
        return function (e) {
          for (var t = [], e$parent = e.parent; e$parent; e$parent = e$parent.parent) {
            t.push(e$parent)
          }
          return t.reverse()
        }(e$ast)
    ...
    a(e, [{
      ...
      value: function (e, t, n) {
        ...
        if (i.lastSourceCode) {
          if (!i.lastSourceCode.scopeManager) {
            i.lastSourceCode = new require$2254Index$SourceCode({
          ...
          var S = function (e, t, n, r) {
            ...
            try {
              ...
              return {
                success: true,
                sourceCode: new require$2254Index$SourceCode({
                  text: e,
                  ast: a$ast,
                  parserServices: c,
                  scopeManager: l,
        ...
        var i$lastSourceCode = i.lastSourceCode
        ...
        !function (e, t, n) {
          var r
          var n$exportedVariables = n.exportedVariables
          var n$enabledGlobals = n.enabledGlobals
          ...
          e.through = e.through.filter(function (t) {
            var t$identifier$name = t.identifier.name
        ...
        try {
          ...
          if (N.currentNode) {
            var n$currentNode$loc$start$line = N.currentNode.loc.start.line
            F("Line:", n$currentNode$loc$start$line)
      ...
      value: function (e, t, n) {
        ...
        if (o) {
          ...
          var o$preprocess = o.preprocess
          var o$postprocess = o.postprocess
          var o$supportsAutofix = o.supportsAutofix
      ...
      value: function (e, t, n, r) {
        ...
        return l(u(c, s).map(function (e, s) {
          ...
          return d(u, e$text) ? r && f.extname(u) !== h ? (F("Resolving configuration again because the file extension was changed."), o._verifyWithConfigArray(e$text, r, i(i({}, n), {}, {
            filename: u
      ...
      value: function () {
        var e = K.get(this)
        var e$lastConfigArray = e.lastConfigArray
        var e$ruleMap = e.ruleMap
