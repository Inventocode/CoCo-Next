...
var c = require("../../227/724/index")
var u = require("../../227/724/1316")
var l = require("../../206/725")
...
var _ = function () {
  ...
  e.prototype.get_procedure_by_def = function (e) {
    for (var t = this.get_all_procedure_names(), t$length = t.length, r = 0; r < t$length; r++) {
