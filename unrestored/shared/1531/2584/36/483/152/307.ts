...
var C = function (e, t) {
  ...
  return Object(f.forwardRef)(function (i, o) {
    ...
    var _ = function () {
      var e = a.current;
      if (!(n && !e)) {
        if (!1 === (!!e && t.applyAnimatedValues(e, d.getValue(!0)))) {
          p();
        }
      }
    };
    ...
    var v = t.getComponentProps(d.getValue());
...
var k = Symbol.for("AnimatedComponent");
var S = function (e) {
  ...
  var u = function e(t) {
    var n = T(t) || "Anonymous";
    (t = l.s.str(t) ? e[t] || (e[t] = C(t, c)) : t[k] || (t[k] = C(t, c))).displayName = "Animated(".concat(n, ")");
    return t;
  };
