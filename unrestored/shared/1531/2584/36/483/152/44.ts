...
var Be = new RegExp("(".concat(Se.source, ")(%|[a-z]+)"), "i");
...
var Ne = function (e) {
  ...
  var t = e.output.map(function (e) {
    return me(e).replace(Ie, Fe).replace(Te, he).replace(Oe, he);
  });
  var n = t.map(function (e) {
    return e.match(Se).map(Number);
  });
  ...
  return function (e) {
    ...
    var o = 0;
    return t[0].replace(Se, function () {
