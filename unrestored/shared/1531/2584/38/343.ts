  ...
  for (var n in e) {
    ...
    if (1 === t) {
      ...
      if (r.type !== o.H || r.parentId) {
        if (r.type === o.w) {
          var r$attributes$sizeType = r.attributes.sizeType
        ...
        var r$attributes$fontSize = r$attributes.fontSize
...
function u(e) {
  ...
  if (e$attributes$mode && e$attributes$sizeType) {
    var r = c.l[e$attributes$mode][e$attributes$sizeType]
...
function p(e) {
  var t = function (e) {
    ...
    for (var n in e) if (e[n]) {
      var eN$blocks = e[n].blocks
      if (eN$blocks) {
        for (var o in eN$blocks) {
          var eN$blocksO$fields = eN$blocks[o].fields
          if (eN$blocksO$fields) {
            var eN$blocksO$fields$BROADCAST = eN$blocksO$fields.BROADCAST
