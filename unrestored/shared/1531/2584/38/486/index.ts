    ...
    e.put = function (e) {
      if (!t) {
        if (O(e)) {
          ...
          for (var o = n = i, s = 0, o$length = o.length; s < o$length; s++) {
            var u = o[s]
            if (u[r.d](e)) {
              u.cancel()
              u(e)
...
B[s.a] = function (e, t, n, r) {
  var r$digestEffect = r.digestEffect
  var o = D
  var c = Object.keys(t)
  if (0 !== c.length) {
    var u = s.I(t, n)
...
function z(e, t) {
  var e$channel = e.channel
  var r = undefined === e$channel ? S() : e$channel
  var e$dispatch = e.dispatch
  var e$getState = e.getState
  var e$context = e.context
  var u = undefined === e$context ? {} : e$context
  var e$sagaMonitor = e.sagaMonitor
  var e$effectMiddlewares = e.effectMiddlewares
  var e$onError = e.onError
  var h = undefined === e$onError ? s.b : e$onError
  for (var arguments$length = arguments.length, A = new Array(arguments$length > 2 ? arguments$length - 2 : 0), g = 2; g < arguments$length; g++) {
    A[g - 2] = arguments[g]
  }
...
var Q = function (e) {
  ...
  var n$channel = n.channel
  var u = undefined === n$channel ? S() : n$channel
  var n$sagaMonitor = n.sagaMonitor
