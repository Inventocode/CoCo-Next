...
u.fromSourceMap = function (e, t) {
  ...
  for (var c = e._mappings.toArray().slice(), f = n.__generatedMappings = [], d = n.__originalMappings = [], h = 0, p = c.length; h < p; h++) {
    var _ = c[h];
    var A = new l();
...
u.prototype._parseMappings = function (e, t) {
  for (var n, i, o, c, u, f = 1, d = 0, h = 0, p = 0, _ = 0, A = 0, g = e.length, v = 0, m = {}, y = {}, b = [], w = []; v < g;) {
    if (";" === e.charAt(v)) {
      f++;
      v++;
      d = 0;
