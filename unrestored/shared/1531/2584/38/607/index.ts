  ...
  !function (t, n) {
    ...
    function ye(e, t) {
      ...
      function X(e) {
        ...
        for (; !i("punc", "}");) {
          for (t = r.token, (n = Y(ee(), t, true)) || f(), u.push(n); i("punc", ";");) {
            a();
          }
        }
        r.input.pop_directives_stack();
        ...
        if ("get" == e) {
          if (!i("punc") || i("punc", "[")) {
            ...
            return new zt({
              ...
              static: u,
              key: e,
              quote: e instanceof an ? h.quote : undefined,
              value: W(),
              end: s()
            });
          }
            ...
            if (v && !wr(v) && !v.has_side_effects(t)) {
              ...
              if (_) {
                ...
                if (S && F.references.length - F.replaced > T) {
                  ...
                  for (S = false, d = 0, k = O, I = c; !S && I < e.length; I++) {
                    e[I].transform(l);
                  }
                  _.single_use = false;
                }
    ...
    vr(ke, function (e, t) {
      if (t.option("side_effects")) {
        var n = e.body;
        var r = n.drop_side_effect_free(t, true);
        if (!r) {
    ...
    vr(Dt, function (e, t) {
      ...
      if (t.option("properties") && t.option("side_effects") && i instanceof En && r instanceof Lt) {
        ...
        var g = A[s];
        e: if (Ai(g, t)) {
          for (var v = true, m = [], y = A.length; --y > s;) {
