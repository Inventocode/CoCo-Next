...
(function (e, r) {
  ...
  !function (t, n) {
    ...
    function pe(e, t, n, r) {
      ...
      function w(e) {
        var t
        var i$regex_allowed = i.regex_allowed
        var r = function () {
          for (var i$text = i.text, i$pos = i.pos, i$text$length = i.text.length; i$pos < i$text$length; ++i$pos) {
            var r = i$text[i$pos]
            if (q.has(r)) {
              return i$pos
            }
    ...
    function ye(e, t) {
      ...
      var E = b(function (e, n, c) {
        switch (w(), r.token.type) {
          case "string":
            ...
            var r$in_directives = r.in_directives,
              b = x()
              ...
              case "for":
                ...
                return function () {
                  ...
                  if (i("punc", ";")) {
                    ...
                    n = i("keyword", "var") ? (a(), N(true)) : i("keyword", "let") ? (a(), M(true)) : i("keyword", "const") ? (a(), L(true)) : be(true, true)
                    var o = i("operator", "in")
                    var s = i("name", "of")
                    if (r$token && !s) {
                      l(r$token, e)
      ...
      function D(e, n, o, s, c) {
        var r$in_loop = r.in_loop
        var r$labels = r.labels
        var r$in_generator = r.in_generator
        var r$in_async = r.in_async
        ++r.in_function
        if (n) {
          ...
          switch (r.token.value) {
            case "(":
              ...
              if (m.start) {
                ...
                var r$token$comments_before$length = _r$token4.comments_before.length
                n.set(_r$token4, r$token$comments_before$length);
                (m$start$comments_before = m.start.comments_before).unshift.apply(m$start$comments_before, c(_r$token4.comments_before))
                _r$token4.comments_before = m.start.comments_before
                if (0 == r$token$comments_before$length && _r$token4.comments_before.length > 0) {
                  var w = _r$token4.comments_before[0]
                  if (!w.nlb) {
                    w.nlb = _r$token4.nlb
                    _r$token4.nlb = false
                  }
                }
                _r$token4.comments_after = m.start.comments_after
              }
              m.start = _r$token4
              var E = s()
              if (m.end) {
      ...
      function te(e) {
        var r$token$value = r.token.value
      ...
      function ie(e) {
        for (var e$start = e.start, e$start$comments_before = e$start.comments_before, i = n.get(e$start), o = null != i ? i : e$start$comments_before.length; --o >= 0;) {
      ...
      var se = function e(t, n) {
        ...
        for (var d = V(t, n); i("operator") && Ae.has(r.token.value) && !p(r.token);) {
          ...
          (d = ce(Rt, r.token, d)).start = r$token
          d.end = r.token
          a()
        }
        return d
      ...
      var ye = function e(t) {
        w()
        var _r$token3 = r.token
        if ("name" == _r$token3.type && "yield" == _r$token3.value) {
          if (g()) {
            a()
            return function () {
              if (!g()) {
      ...
      var be = function (e, t) {
        for (var r$token = r.token, s = []; s.push(ye(t)), e && i("punc", ",");) {
          a()
          e = true
        }
    ...
    function be(e, t, n) {
      ...
      for (var o = "return function AST_" + e + "(props){ if (props) { ", t$length = t.length; --t$length >= 0;) {
    ...
    function Se(e, t) {
      for (var e$body = e.body, r = 0, e$body$length = e$body.length; r < e$body$length; r++) {
        e$body[r]._walk(t)
      }
    }
    function Te(e) {
    ...
    var Be = be("Block", "body block_scope", {
      ...
      _children_backwards: function (e) {
        for (var this$body$length = this.body.length; this$body$length--;) {
    ...
    var We = be("Lambda", "name argnames uses_arguments is_generator async", {
      ...
      _walk: function (e) {
        return e._visit(this, function () {
          ...
          for (var this$argnames = this.argnames, n = 0, this$argnames$length = this$argnames.length; n < this$argnames$length; n++) {
    ...
    var $e = be("Destructuring", "names is_array", {
      ...
      _children_backwards: function (e) {
        for (var this$names$length = this.names.length; this$names$length--;) {
    ...
    var Ze = be("TemplateString", "segments", {
      ...
      _children_backwards: function (e) {
        for (var this$segments$length = this.segments.length; this$segments$length--;) {
    ...
    var vt = be("Definitions", "definitions", {
      ...
      _walk: function (e) {
        return e._visit(this, function () {
          for (var this$definitions = this.definitions, n = 0, this$definitions$length = this$definitions.length; n < this$definitions$length; n++) {
            this$definitions[n]._walk(e)
          }
        })
      },
      _children_backwards: function (e) {
        for (var this$definitions$length = this.definitions.length; this$definitions$length--;) {
    ...
    var xt = be("Import", "imported_name imported_names module_name", {
      ...
      _children_backwards: function (e) {
        e(this.module_name)
        if (this.imported_names) {
          for (var this$imported_names$length = this.imported_names.length; this$imported_names$length--;) {
    ...
    var Ct = be("Export", "exported_definition exported_value is_default exported_names module_name", {
      ...
      _children_backwards: function (e) {
        ...
        if (this.exported_names) {
          for (var this$exported_names$length = this.exported_names.length; this$exported_names$length--;) {
    ...
    var Ot = be("Call", "expression args _annotations", {
      ...
      _walk: function (e) {
        return e._visit(this, function () {
          for (var this$args = this.args, n = 0, this$args$length = this$args.length; n < this$args$length; n++) {
            this$args[n]._walk(e)
          }
          this.expression._walk(e)
        })
      ...
      _children_backwards: function (e) {
        for (var this$args$length = this.args.length; this$args$length--;) {
    ...
    var St = be("Sequence", "expressions", {
      ...
      _children_backwards: function (e) {
        for (var this$expressions$length = this.expressions.length; this$expressions$length--;) {
    ...
    var Lt = be("Array", "elements", {
      ...
      _walk: function (e) {
        return e._visit(this, function () {
          for (var this$elements = this.elements, n = 0, this$elements$length = this$elements.length; n < this$elements$length; n++) {
            this$elements[n]._walk(e)
          }
        })
      },
      _children_backwards: function (e) {
        for (var this$elements$length = this.elements.length; this$elements$length--;) {
    ...
    var Ut = be("Object", "properties", {
      ...
      _walk: function (e) {
        return e._visit(this, function () {
          for (var this$properties = this.properties, n = 0, this$properties$length = this$properties.length; n < this$properties$length; n++) {
            this$properties[n]._walk(e)
          }
        })
      },
      _children_backwards: function (e) {
        for (var this$properties$length = this.properties.length; this$properties$length--;) {
    ...
    var jn = function () {
      ...
      s(e, [{
        ...
        key: "find_parent",
        value: function (e) {
          for (var this$stack = this.stack, this$stack$length = this$stack.length; --this$stack$length >= 0;) {
        ...
        value: function (e) {
          var this$stack = this.stack
          if (e.label) {
            for (var this$stack$length = this$stack.length; --this$stack$length >= 0;) {
              if ((r = this$stack[this$stack$length]) instanceof Re && r.label.name == e.label.name) {
                return r.body
              }
            }
          } else {
    ...
    function qn(e) {
      ...
      return {
        ...
        prepend_comments: t ? g : function (t) {
          var t$start = t.start
          if (t$start) {
            var this$printed_comments = this.printed_comments
            ...
            var t$start$comments_before = t$start.comments_before
            ...
            if (o) {
              var s = new jn(function (e) {
                ...
                if (e.start) {
                  var e$start$comments_before = e.start.comments_before
    ...
    !function () {
      ...
      function s(e, t, n) {
        return n.option("quote_keys") ? n.print_string(e) : "" + +e == e && e >= 0 ? n.option("keep_numbers") ? n.print(e) : n.print(f(e)) : (j.has(e) ? n.option("ie8") : n.option("ecma") < 2015 ? !se(e) : !ce(e, true)) || t && n.option("keep_quoted_props") ? n.print_string(e, t) : n.print_name(e)
      }
      Ee.DEFMETHOD("print", function (e, t) {
        var n = this
        var n$_codegen = n._codegen
        function i() {
      ...
      t(Pt, function (e) {
        ...
        if (t instanceof Pt) {
          var t$operator = t.operator
          var this$operator = this.operator
      ...
      e($e, function (e, t) {
        t.print(e.is_array ? "[" : "{")
        var e$names$length = e.names.length
      ...
      nt.DEFMETHOD("_do_print", function (e, t) {
        ...
        if (this.value) {
          e.space()
          var this$value$start$comments_before = this.value.start.comments_before
      ...
      e(Bt, function (e, t) {
        ...
        if (j.has(e$property) ? t.option("ie8") : !ce(e$property, t.option("ecma") >= 2015)) {
          t.print("[")
          t.add_mapping(e.end)
      ...
      e(Ft, function (e, t) {
        var e$operator = e.operator
        t.print(e$operator)
        if (/^[a-z]/i.test(e$operator) || /[+-]$/.test(e$operator) && e.expression instanceof Ft && /^[+-]/.test(e.expression.operator)) {
          t.space()
        }
        e.expression.print(t)
      })
      ...
      e(Pt, function (e, t) {
        var e$operator = e.operator
        e.left.print(t)
        if (">" == e$operator[0] && e.left instanceof Rt && "--" == e.left.operator) {
          t.print(" ")
        } else {
          t.space()
        }
        t.print(e$operator)
        if (("<" == e$operator || "<<" == e$operator) && e.right instanceof Ft && "!" == e.right.operator && e.right.expression instanceof Ft && "--" == e.right.expression.operator) {
          t.print(" ")
        } else {
          t.space()
        }
      ...
      e(Lt, function (e, t) {
        t.with_square(function () {
          ...
          var e$elements$length = e$elements.length
      ...
      function f(e) {
        ...
        return function (e) {
          for (var t = e[0], t$length = t.length, r = 1; r < e.length; ++r) {
    ...
    function ir(e, t) {
      var e$enclosed = e.enclosed
      e: for (;;) {
        var r = or(++e.cname)
        if (!j.has(r) && !(t.reserved.has(r) || tr && tr.has(r))) {
          for (var e$enclosed$length = e$enclosed.length; --e$enclosed$length >= 0;) {
    ...
    Ge.DEFMETHOD("figure_out_scope", function (e) {
      var t = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : {}
      var t$parent_scope = t.parent_scope
      ...
      function h(e, t) {
        ...
        if (e.export = r instanceof Ct ? 1 : 0) {
          var r$exported_definition = r.exported_definition
      ...
      d = new jn(function (e) {
        ...
        if (e instanceof _n) {
          ...
          if ("eval" == e$name && d.parent() instanceof Ot) {
            for (var e$scope = e.scope; e$scope && !e$scope.uses_eval; e$scope = e$scope.parent_scope) {
      ...
      if (e.ie8 || e.safari10) {
        Pn(this, function (e) {
          if (e instanceof fn) {
            var e$name = e.name
            var e$thedef$references = e.thedef.references
    ...
    Ge.DEFMETHOD("var_names", function e() {
      var this$_var_name_cache = this._var_name_cache
    ...
    qt.DEFMETHOD("mark_enclosed", function () {
      for (var e = this.definition(), this$scope = this.scope; this$scope && (x(this$scope.enclosed, e), this$scope !== e.scope);) {
        this$scope = this$scope.parent_scope
      }
    })
    ...
    ze.DEFMETHOD("next_mangled", function (e) {
      var t
      var this$mangled_names = this.mangled_names
      do {
        t = ir(this, e)
    ...
    Pt.prototype._size = function (e) {
      ...
      var this$operator$length = this.operator.length
    ...
    var gr = function (e) {
      ...
      function n(e, r) {
        ...
        var i$options$global_defs = i.options.global_defs
        ...
        var i$options$pure_funcs = i.options.pure_funcs
        ...
        var i$options$top_retain = i.options.top_retain
        ...
        var i$options$toplevel = i.options.toplevel
        ...
        var i$options$sequences = i.options.sequences
      ...
      s(n, [{
        ...
        value: function (e) {
          ...
          if (e.global) {
            for (var t = 0, e$orig$length = e.orig.length; t < e$orig$length; t++) {
    ...
    function mr(e, t) {
      if (!((t = Vr(t)) instanceof Ee)) {
        ...
        if (e instanceof Lt) {
          ...
          t = "" + t
          for (var e$properties = e.properties, e$properties$length = e$properties.length; --e$properties$length >= 0;) {
    ...
    function Er(e, t) {
      ...
      for (var e$definition$orig = e.definition().orig, e$definition$orig$length = e$definition$orig.length; --e$definition$orig$length >= 0;) {
      ...
      return this.transform(new Ln(function (e) {
        if ("Call" == e.TYPE) {
          ...
          if (e$expression instanceof Tt) {
            for (var e$expression$expression = e$expression.expression; e$expression$expression.expression;) {
    ...
    qt.DEFMETHOD("fixed_value", function () {
      var this$thedef$fixed = this.thedef.fixed
    ...
    _n.DEFMETHOD("is_immutable", function () {
      var this$definition$orig = this.definition().orig
    ...
    function Ur(e, t) {
      ...
      function s(e, t) {
        ...
        for (var a, s = [], e$length = e.length, u = new Ln(function (e) {
            if (S) {
              return e
            }
            if (!k) {
            ...
            if (B && !(e instanceof Jt) && v.equivalent_to(e)) {
              ...
              if (h instanceof wt) {
                ...
                return s.references.length - s.replaced != 1 || t.exposed(s) ? E(Mt, h, {
                  ...
                  right: h$value
                }) : (s.replaced++, O && Lr(h$value) ? h$value.transform(t) : Sr(a, e, h$value))
              }
              Ar(h, 32)
              return h
            }
            ...
            return e instanceof _n && e.name == F.name ? (--T || (S = true), Wr(e, l.parent()) ? e : (F.replaced++, _.replaced--, h.value)) : e instanceof ht || e instanceof Ge ? e : undefined
          }); --e$length >= 0;) {
          if (0 == e$length && t.option("unused")) {
            M()
          }
          var f = []
          for (j(e[e$length]); s.length > 0;) {
            f = s.pop()
            var d = 0
            var h = f[f.length - 1]
            var _ = null
        ...
        function P(e) {
          ...
          if (e instanceof ft) {
            ...
            for (var t = 0, e$body$length = e.body.length; !S && t < e$body$length; t++) {
              var r = e.body[t]
              if (r instanceof pt) {
                if (!k) {
                  if (r !== f[d]) {
        ...
        function N(e, t, n) {
          ...
          t.walk(new jn(function (t, a) {
            ...
            if (t instanceof _n && (e.variables.has(t.name) || function (e, t) {
              ...
              for (var e$scope = e.scope; e$scope && e$scope !== t;) {
              ...
              var t$definition$scope = t.definition().scope
        ...
        function M() {
          ...
          if (br(n) && !n.name && !n.uses_arguments && !n.pinned() && (e = t.parent()) instanceof Ot && e.expression === n && e.args.every(function (e) {
            ...
            var n$argnames$length = n.argnames.length
        ...
        function j(e) {
          ...
          if (e instanceof Mt) {
            ...
            var e$definitions$length = e.definitions.length
        ...
        function V(n) {
          if (n.name instanceof rn) {
            var r = t.parent()
            var t$self$argnames = t.self().argnames
          ...
          var s = false
          return e[e$length].transform(new Ln(function (e, t, r) {
      ...
      function l(e, t) {
        for (var n = t.self(), r = function (e) {
            for (var t = 0, e$length = e.length; --e$length >= 0;) {
              var r = e[e$length]
            ...
            return false
          }(e), i = n instanceof We, _e$length = e.length; --_e$length >= 0;) {
          var s = e[_e$length]
          var c = v(_e$length)
          var u = e[c]
          ...
          if (s instanceof lt && s.body instanceof rt) {
            var s$body$value = s.body.value
            if (!s$body$value && !s.alternative && (i && !u || u instanceof rt && !u.value)) {
              o = true
              e[_e$length] = E(ke, s.condition, {
                body: s.condition
              })
              continue
            }
        ...
        function _(r) {
          ...
          for (var o = _e$length + 1, e$length = e.length; o < e$length; o++) {
            var c = e[o]
        ...
        function A() {
          var t = e.slice(_e$length + 1)
          e.length = _e$length + 1
        ...
        function v(t) {
          for (var n = t + 1, e$length = e.length; n < e$length; n++) {
            var i = e[n]
      ...
      function f(e, t) {
        for (var n, r = t.self(), i = 0, a = 0, e$length = e.length; i < e$length; i++) {
          var c = e[i]
          if (c instanceof ot) {
      ...
      function h(e, t) {
        if (!(e.length < 2)) {
          for (var n = [], r = 0, i = 0, e$length = e.length; i < e$length; i++) {
            var s = e[i]
            if (s instanceof ke) {
      ...
      function _(e, t) {
        ...
        for (var n = null, r = 0, e$body$length = e.body.length; r < e$body$length; r++) {
          var o = e.body[r]
        ...
        if (e instanceof vt) {
          ...
          if (o.value instanceof Ut && (n instanceof Mt ? r = [n] : n instanceof St && (r = n.expressions.slice()), r)) {
            ...
            do {
              ...
              var s$left$expression = s.left.expression
              ...
              var s$left$property = s.left.property
      ...
      function v(e) {
        for (var t, n = 0, r = -1, e$length = e.length; n < e$length; n++) {
          var a = e[n]
          var s = e[r]
          if (a instanceof vt) {
            if (s && s.TYPE == a.TYPE) {
    ...
    function Vr(e) {
      return e instanceof bn ? e.getValue() : e instanceof Ft && "void" == e.operator && e.expression instanceof bn ? undefined : e
    }
    function Gr(e, t) {
    ...
    !function (e) {
      ...
      e(Ut, function (e) {
        ...
        for (var this$properties$length = this.properties.length; --this$properties$length >= 0;) {
    ...
    !function (e) {
      ...
      e(Lt, function (e, t) {
        if (e.option("unsafe")) {
          for (var n = [], r = 0, this$elements$length = this.elements.length; r < this$elements$length; r++) {
      ...
      e(Ut, function (e, t) {
        if (e.option("unsafe")) {
          for (var n = {}, r = 0, this$properties$length = this.properties.length; r < this$properties$length; r++) {
      ...
      var n = S("! typeof void")
      e(Ft, function (e, t) {
        var this$expression = this.expression
      ...
      e(_n, function (e, t) {
        ...
        if (n && "object" == typeof n) {
          var this$definition$escaped = this.definition().escaped
      ...
      e(Tt, function (e, t) {
        if (e.option("unsafe")) {
          var this$property = this.property
      ...
      e(Ot, function (e, t) {
        ...
        if (e.option("unsafe") && this$expression instanceof Tt) {
          var r
          var this$expression$property = this$expression.property
          ...
          var this$expression$expression = this$expression.expression
          ...
          for (var l = [], f = 0, this$args$length = this.args.length; f < this$args$length; f++) {
            var h = this.args[f]
            var p = h._eval(e, t)
            if (h === p) {
              return this
    ...
    Bt.DEFMETHOD("is_call_pure", function (e) {
      if (e.option("unsafe")) {
        var t
        var this$expression = this.expression
        if (this$expression instanceof Lt) {
          t = Jr.get("Array")
        } else {
          ...
          var d = new Ln(function (a, u, f) {
            ...
            if (l === t) {
              ...
              if (a instanceof We && !(a instanceof Ke)) {
                for (var g = !e.option("keep_fargs"), a$argnames = a.argnames, a$argnames$length = a$argnames.length; --a$argnames$length >= 0;) {
          ...
          if (c !== t) {
            ...
            if (r && c instanceof mt) {
              ...
              if (f instanceof Ue && f.init === c) {
                if (null == l) {
                  var c$definitions0$name = c.definitions[0].name
          ...
          if (l.length > 0) {
            for (var h = 0; h < t.body.length;) {
              if (t.body[h] instanceof ke) {
                var p
                var _
                var t$bodyH$body = t.body[h].body
    ...
    vr(lt, function (e, t) {
      ...
      if (ni(e.body) && e.alternative) {
        var e$alternative = e.alternative
        e.alternative = null
        return E(De, e, {
    ...
    vr(ft, function (e, t) {
      ...
      for (var o, a, s = [], c = [], u = 0, e$body$length = e.body.length; u < e$body$length && !a; u++) {
    ...
    vr(Ot, function (e, t) {
      ...
      if (t.option("unused") && i && a && !r.uses_arguments && !r.pinned()) {
        for (var s = 0, c = 0, u = 0, _e$args$length = e.args.length; u < _e$args$length; u++) {
          if (r.argnames[u] instanceof Qe) {
            if (pr(r.argnames[u].expression, 1)) {
              for (; u < _e$args$length;) {
        ...
        if (Pr(e$expression)) {
          ...
          switch (e$expression.property) {
            case "toString":
              ...
              break
            case "join":
              if (e$expression.expression instanceof Lt) {
                e: {
                  var v
                  if (!(e.args.length > 0 && (v = e.args[0].evaluate(t)) === e.args[0])) {
                    ...
                    var b = []
                    var w = []
                    for (u = 0, _e$args$length = e$expression.expression.elements.length; u < _e$args$length; u++) {
            ...
            case "apply":
              ...
              break
            case "call":
              var e$expression$expression = e$expression.expression
      ...
      if (j) {
        ...
        if (i && !r.uses_arguments && !r.pinned() && !(t.parent() instanceof Wt) && !(r.name && r instanceof Xe) && (Q = function (e) {
          var r$body = r.body
          var r$body$length = r$body.length
          ...
          return q(e)
        }(N)) && (e$expression === r || R(e, Hn) || t.option("unused") && 1 == (z = e$expression.definition()).references.length && !ui(t, z) && r.is_constant_expression(e$expression.scope)) && !R(e, Un | Vn) && !r.contains_this() && function () {
          var n = new Set()
          do {
          ...
          return !!function (e, t) {
            for (var r$body$length = r.body.length, i = 0; i < r$body$length; i++) {
              var o = r.body[i]
              if (o instanceof mt) {
                if (!t) {
                  return false
                }
                for (var o$definitions$length = o.definitions.length; --o$definitions$length >= 0;) {
                  var o$definitionsO$definitions$length$name = o.definitions[o$definitions$length].name
                  if (o$definitionsO$definitions$length$name instanceof $e || e.has(o$definitionsO$definitions$length$name.name) || jr.has(o$definitionsO$definitions$length$name.name) || V.var_names().has(o$definitionsO$definitions$length$name.name)) {
                    return false
                  }
                  if (G) {
            ...
            for (var n = 0, r$argnames$length = r.argnames.length; n < r$argnames$length; n++) {
              var o = r.argnames[n]
              if (o instanceof jt) {
                if (pr(o.left, 1)) {
                  continue
            ...
            for (var o = 0, r$argnames$length = r.argnames.length; o < r$argnames$length; o++) {
              var s = r.argnames[o]
              if (!(s instanceof jt && pr(s.left, 1)) && !(s instanceof Qe && pr(s.expression, 1)) && !pr(s, 1) && t.has(s.name)) {
                return false
              }
            }
            for (var c = 0, r$body$length = r.body.length; c < r$body$length; c++) {
              var l = r.body[c]
              if (l instanceof mt) {
                for (var l$definitions$length = l.definitions.length; --l$definitions$length >= 0;) {
                  var l$definitionsL$definitions$length$name = l.definitions[l$definitions$length].name
          ...
          return Or(e, function (n) {
            ...
            var o = [];
            (function (t, n) {
              for (var r$argnames$length = r.argnames.length, e$args$length = e.args.length; --e$args$length >= r$argnames$length;) {
                n.push(e.args[e$args$length])
              }
              for (e$args$length = r$argnames$length; --e$args$length >= 0;) {
                var a = r.argnames[e$args$length]
                var s = e.args[e$args$length]
            ...
            (function (e, t) {
              for (var t$length = t.length, i = 0, r$body$length = r.body.length; i < r$body$length; i++) {
                var a = r.body[i]
                if (a instanceof mt) {
                  for (var s = 0, a$definitions$length = a.definitions.length; s < a$definitions$length; s++) {
      ...
      function q(t) {
        return t ? t instanceof rt ? t.value ? t.value.clone(true) : E(Tn, e) : t instanceof ke ? E(Ft, t, {
          operator: "void",
    ...
    vr(Ft, function (e, t) {
      var e$expression = e.expression
      if ("delete" == e.operator && !(e$expression instanceof _n || e$expression instanceof Tt || Lr(e$expression))) {
        if (e$expression instanceof St) {
          var r = e$expression.expressions.slice()
          r.push(E(Rn, e))
          return Or(e, r).optimize(t)
        }
        return Or(e, [e$expression, E(Rn, e)]).optimize(t)
      }
      ...
      if (t.in_boolean_context()) {
        switch (e.operator) {
          case "!":
            if (e$expression instanceof Ft && "!" == e$expression.operator) {
          ...
          case "typeof":
            ...
            return (e$expression instanceof _n ? E(Rn, e) : Or(e, [e$expression, E(Rn, e)])).optimize(t)
        }
      }
        ...
        switch (e.operator) {
          ...
          case "!=":
            if (!i && Gr(e.left, t)) {
              ...
              var e$right$expression = e.right.expression
        ...
        switch (e.operator) {
          case "+":
            ...
            if (e.left instanceof Ze && e.right instanceof Ze) {
              var aE$left$segments = (A = e.left).segments
              g = e.right
      ...
      if (t.option("reduce_vars") && Wr(e, n) !== e) {
        ...
        if (i && undefined === r.should_replace) {
          ...
          if (f) {
            ...
            var r$name$length = r.name.length
            var A = 0
    ...
    function vi(e, t, n) {
      for (var r = 0; r < n.length; r++) {
        var i = n[r]
        if (i instanceof Qe) {
          var i$expression = i.expression
          if (i$expression instanceof Lt) {
    ...
    vr(Mt, function (e, t) {
      ...
      function a(n, r) {
        ...
        var o = r.may_throw(t)
        e.right = e$right
        for (var a, e$left$definition$scope = e.left.definition().scope; (a = t.parent(n++)) !== e$left$definition$scope;) {
          if (a instanceof _t) {
            if (a.bfinally) {
              return true
            }
    ...
    vr(Nt, function (e, t) {
      ...
      if (e$consequent instanceof Ot && e$alternative.TYPE === e$consequent.TYPE && e$consequent.args.length > 0 && e$consequent.args.length == e$alternative.args.length && e$consequent.expression.equivalent_to(e$alternative.expression) && !e.condition.has_side_effects(t) && !e$consequent.expression.has_side_effects(t) && "number" == typeof (o = function () {
        for (var e$consequent$args = e$consequent.args, e$alternative$args = e$alternative.args, n = 0, e$consequent$args$length = e$consequent$args.length; n < e$consequent$args$length; n++) {
    ...
    vr(Dt, function (e, t) {
      var /* [auto-meaningful-name] */e$expression$scope
      var e$expression = e.expression
      var e$property = e.property
      ...
      e: if (t.option("arguments") && e$expression instanceof _n && "arguments" == e$expression.name && 1 == e$expression.definition().orig.length && (e$expression$scope = e$expression.scope) instanceof We && e$expression$scope.uses_arguments && !(e$expression$scope instanceof Ye) && e$property instanceof En) {
        for (var s = e$property.getValue(), c = new Set(), n$argnames = e$expression$scope.argnames, l = 0; l < n$argnames.length; l++) {
          if (!(n$argnames[l] instanceof rn)) {
            break e
          }
          var n$argnamesL$name = n$argnames[l].name
          if (c.has(n$argnamesL$name)) {
            break e
          }
          c.add(n$argnamesL$name)
        }
        var d = e$expression$scope.argnames[s]
        if (d && t.has_directive("use strict")) {
          var h = d.definition()
          if (!t.option("reduce_vars") || h.assignments || h.orig.length > 1) {
            d = null
          }
        } else if (!d && !t.option("keep_fargs") && s < e$expression$scope.argnames.length + 5) {
          for (; s >= e$expression$scope.argnames.length;) {
            d = E(rn, e$expression$scope, {
              name: e$expression$scope.make_var_name("argument_" + e$expression$scope.argnames.length),
              scope: e$expression$scope
            })
            e$expression$scope.argnames.push(d)
            e$expression$scope.enclosed.push(e$expression$scope.def_variable(d))
          }
        }
        if (d) {
          var p = E(_n, e, d)
      ...
      if (t.option("properties") && t.option("side_effects") && e$property instanceof En && e$expression instanceof Lt) {
        s = e$property.getValue()
        var e$expression$elements = e$expression.elements
        var g = e$expression$elements[s]
        e: if (Ai(g, t)) {
          for (var v = true, m = [], e$expression$elements$length = e$expression$elements.length; --e$expression$elements$length > s;) {
    ...
    Tt.DEFMETHOD("flatten_object", function (e, t) {
      if (t.option("properties")) {
        ...
        if (this$expression instanceof Ut) {
          for (var this$expression$properties = this$expression.properties, this$expression$properties$length = this$expression$properties.length; --this$expression$properties$length >= 0;) {
            ...
            if ("" + (a instanceof Qt ? a.key.name : a.key) == e) {
              ...
              return E(Dt, this, {
                expression: E(Lt, this$expression, {
    ...
    vr(Ut, function (e, t) {
      ...
      for (var e$properties = e.properties, i = 0; i < e$properties.length; i++) {
        var o = e$properties[i]
        if (o instanceof Qe) {
          var o$expression = o.expression
    ...
    vr($e, function (e, t) {
      if (1 == t.option("pure_getters") && t.option("unused") && !e.is_array && Array.isArray(e.names) && !function (e) {
        for (var t = [/^VarDef$/, /^(Const|Let|Var)$/, /^Export$/], n = 0, r = 0, t$length = t.length; n < t$length; r++) {
          var o = e.parent(r)
          if (!o) {
            return false
          }
    ...
    function Ei(t, n) {
      var nANBuiltinsFalseCacheNullDebugFalseKeep_quotedFalseOnly_cacheFalseRegexNullReservedNullUndeclaredFalseTrue$reserved = (n = A(n, {
        builtins: false,
        cache: null,
        debug: false,
        keep_quoted: false,
    ...
    function Ti(e, t) {
      var r
      var i
      var ee$warn_function = Ee.warn_function
      try {
        var a
        var s = (t = A(t, {
          compress: {},
    ...
    !function () {
      ...
      u(Cn, function (e) {
        var e$value$source = e.value.source
        var e$value$flags = e.value.flags
        return {
          type: "Literal",
          value: null,
          raw: e.print_to_string(),
      ...
      function d() {
        for (var l$length = l.length; l$length--;) {
