...
gt.wasAltered = _t;
gt.asImmutable = pt;
gt["@@transducer/init"] = gt.asMutable = ht;
...
vt.prototype.update = function (e, t, n, a, s, c, u) {
  for (var l = s === r, f = this.entries, d = 0, h = f.length; d < h && !Z(a, f[d][0]); d++) {
    ;
  }
  var p = d < h;
  if (p ? f[d][1] === s : l) {
...
mt.prototype.update = function (e, t, n, i, o, a, s) {
  ...
  if (f && !_ && 2 === h.length && Dt(h[1 ^ d])) {
    return h[1 ^ d];
  }
  if (f && _ && 1 === h.length && Dt(_)) {
    return _;
  }
  var A = e && e === this.ownerID;
  var g = f ? _ ? l : l ^ u : l | u;
  var v = f ? _ ? Rt(h, d, _, A) : function (e, t, n) {
    var r = e.length - 1;
    if (n && t === r) {
      e.pop();
      return e;
...
yt.prototype.update = function (e, t, n, i, o, a, s) {
  ...
  var _ = Rt(l, c, d, p);
  return p ? (this.count = h, this.nodes = _, this) : new yt(e, h, _);
};
...
bt.prototype.update = function (e, t, n, o, a, s, c) {
  ...
  for (var l = this.entries, f = 0, d = l.length; f < d && !Z(o, l[f][0]); f++) {
    ;
  }
  var h = f < d;
  if (h ? l[f][1] === a : u) {
...
Ut.wasAltered = _t;
Ut.asImmutable = pt;
Ut["@@transducer/init"] = Ut.asMutable = ht;
...
function qt(e, t, n) {
  ...
  var a = e._capacity;
  var s = i + t;
  var c = undefined === n ? a : n < 0 ? a + n : i + n;
  if (s === i && c === a) {
    return e;
  }
  if (s >= c) {
  ...
  for (var u = e._level, l = e._root, f = 0; s + f < 0;) {
    l = new Ht(l && l.array.length ? [undefined, l] : [], r);
    f += 1 << (u += 5);
  }
  if (f) {
    s += f;
  ...
  for (var d = $t(a), h = $t(c); h >= 1 << u + 5;) {
    l = new Ht(l && l.array.length ? [l] : [], r);
    u += 5;
  }
  var p = e._tail;
  var _ = h < d ? Yt(e, c - 1) : h > d ? new Ht([], r) : p;
  if (p && h > d && s < a && p.array.length) {
  ...
  return e.__ownerID ? (e.size = c - s, e._origin = s, e._capacity = c, e._level = u, e._root = l, e._tail = _, e.__hash = undefined, e.__altered = true, e) : Qt(s, c, u, l, _);
}
function $t(e) {
...
function nn(e, t, n) {
  ...
  if (n === r) {
    ...
    if (s.size >= 32 && s.size >= 2 * a.size) {
      ...
      i = a.remove(t);
      o = c === s.size - 1 ? s.pop() : s.set(c, undefined);
    }
  } else if (u) {
    if (n === s.get(c)[1]) {
      return e;
...
var on = function (e) {
  ...
  t.prototype.push = function () {
    ...
    return this.__ownerID ? (this.size = t, this._head = n, this.__hash = undefined, this.__altered = true, this) : cn(t, n);
  };
  t.prototype.pushAll = function (t) {
    ...
    return this.__ownerID ? (this.size = n, this._head = r, this.__hash = undefined, this.__altered = true, this) : cn(n, r);
  };
  t.prototype.pop = function () {
    return this.slice(1);
  };
  ...
  t.prototype.slice = function (t, n) {
    ...
    return this.__ownerID ? (this.size = i, this._head = o, this.__hash = undefined, this.__altered = true, this) : cn(i, o);
  };
  t.prototype.__ensureOwner = function (e) {
  ...
  t.prototype.__iterate = function (e, t) {
    ...
    for (var r = 0, i = this._head; i && false !== e(i.value, r++, this);) {
      i = i.next;
    }
    return r;
  };
...
sn.wasAltered = _t;
sn.asImmutable = pt;
sn["@@transducer/init"] = sn.asMutable = ht;
...
gn["@@__IMMUTABLE_SET__@@"] = true;
gn.delete = gn.remove;
gn.merge = gn.concat = gn.union;
gn.withMutations = dt;
gn.asImmutable = pt;
gn["@@transducer/init"] = gn.asMutable = ht;
...
var wn = function (e) {
  ...
  t.prototype.__iterate = function (e, t) {
    for (var n = this.size, r = this._step, i = t ? this._start + (n - 1) * r : this._start, o = 0; o !== n && false !== e(i, t ? n - ++o : o++, this);) {
      i += t ? -r : r;
    }
    return o;
  };
...
var kn = v.prototype;
kn["@@__IMMUTABLE_ITERABLE__@@"] = true;
kn[S] = kn.values;
kn.toJSON = kn.toArray;
kn.__toStringMapper = Ge;
...
Qn.asImmutable = pt;
Qn[S] = Qn.entries;
Qn.toJSON = Qn.toObject = kn.toObject;
...
var $n = {
  ...
  Repeat: function (e) {
    ...
    t.prototype.__iterate = function (e, t) {
      for (var n = this.size, r = 0; r !== n && false !== e(this._value, t ? n - ++r : r++, this);) {
        ;
      }
      return r;
    };
