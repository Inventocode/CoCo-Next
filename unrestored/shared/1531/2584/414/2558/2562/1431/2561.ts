...
var o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED
...
var R = {}
function k(e) {
  return !!_object$prototype$hasOwnProperty.call(R, e) || !_object$prototype$hasOwnProperty.call(N, e) && (A.test(e) ? R[e] = true : (N[e] = true, false))
}
...
var re = {
  ...
  useMemo: function (e, t) {
    ...
    if (null !== (H = Q())) {
      var h$memoizedState = H.memoizedState
  ...
  useRef: function (e) {
    U = q()
    var hQ$memoizedState = (H = Q()).memoizedState
...
var ue = /([A-Z])/g
var de = /^ms-/
var o$Children$toArray = o.Children.toArray
var o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$ReactCurrentDispatcher = o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher
var he = {
  listing: true,
  pre: true,
  textarea: true
...
var Oe = function () {
  ...
  e$prototype.destroy = function () {
    if (!this.exhausted) {
      this.exhausted = true
      this.clearProviders()
      var this$threadID = this.threadID
      S[this$threadID] = S[0]
      S[0] = this$threadID
    }
  }
  e$prototype.pushProvider = function (e) {
    ...
    var e$type$_context = e.type._context
    var this$threadID = this.threadID
  ...
  e$prototype.popProvider = function () {
    var this$contextIndex = this.contextIndex
  ...
  e$prototype.clearProviders = function () {
    for (var this$contextIndex = this.contextIndex; 0 <= this$contextIndex; this$contextIndex--) {
  ...
  e$prototype.read = function (e) {
    ...
    var t = ne
    ne = this.threadID
    var o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$ReactCurrentDispatcher$current = o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$ReactCurrentDispatcher.current
      ...
      for (var r = [""], o = false; r[0].length < e;) {
        ...
        if (o || s.childIndex >= s.children.length) {
          ...
          if ("select" === s.type) {
            ...
            if (o) {
              o = false
              var s$fallbackFrame = s.fallbackFrame
              if (!s$fallbackFrame) {
                throw Error(i(303))
              }
  ...
  e$prototype.renderDOM = function (e, t, n) {
    ...
    if ("input" === a) {
      ...
      var e$props$value = e$props.value
    ...
    for (y in e$props$value = e$props, e$props$children = this.makeStaticMarkup, u = 1 === this.stack.length, d = "<" + e.type, e$props$value) if (object$prototype$hasOwnProperty.call(e$props$value, y)) {
