...
function i(e, t) {
  try {
    for (var n = e, r = [], i = 0, a = 0, $length = " > ".length, c = undefined; n && i++ < 5 && !("html" === (c = o(n, t)) || i > 1 && a + r.length * $length + c.length >= 80);) {
      r.push(c)
      a += c.length
      n = n.parentNode
    }
...
function o(e, t) {
  ...
  } else if (l.id && f.push("#" + l.id), (l$className = l.className) && r.h(l$className)) {
