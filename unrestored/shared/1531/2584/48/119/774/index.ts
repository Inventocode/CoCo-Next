    ...
    Sha256.prototype.hash = function () {
      ...
      for (c = l & f, e = 0; e < 64; e += 4) {
        if (this.first) {
          ...
          r = (o = u & l) ^ u & f ^ c;
          A = d + (i = A + (n = (h >>> 6 | h << 26) ^ (h >>> 11 | h << 21) ^ (h >>> 25 | h << 7)) + (h & p ^ ~h & _) + K[e] + g[e]) << 0;
          d = i + (t + r) << 0;
        }
        t = (d >>> 2 | d << 30) ^ (d >>> 13 | d << 19) ^ (d >>> 22 | d << 10);
        r = (a = d & u) ^ d & l ^ o;
        _ = f + (i = _ + (n = (A >>> 6 | A << 26) ^ (A >>> 11 | A << 21) ^ (A >>> 25 | A << 7)) + (A & h ^ ~A & p) + K[e + 1] + g[e + 1]) << 0;
        t = ((f = i + (t + r) << 0) >>> 2 | f << 30) ^ (f >>> 13 | f << 19) ^ (f >>> 22 | f << 10);
        r = (s = f & d) ^ f & u ^ a;
        p = l + (i = p + (n = (_ >>> 6 | _ << 26) ^ (_ >>> 11 | _ << 21) ^ (_ >>> 25 | _ << 7)) + (_ & A ^ ~_ & h) + K[e + 2] + g[e + 2]) << 0;
        t = ((l = i + (t + r) << 0) >>> 2 | l << 30) ^ (l >>> 13 | l << 19) ^ (l >>> 22 | l << 10);
        r = (c = l & f) ^ l & d ^ s;
        h = u + (i = h + (n = (p >>> 6 | p << 26) ^ (p >>> 11 | p << 21) ^ (p >>> 25 | p << 7)) + (p & _ ^ ~p & A) + K[e + 3] + g[e + 3]) << 0;
        u = i + (t + r) << 0;
      }
      this.h0 = this.h0 + u << 0;
      this.h1 = this.h1 + l << 0;
...
}).call(this, require("../../../../../3272/3198/1187/368"), require("../../../31/251"));