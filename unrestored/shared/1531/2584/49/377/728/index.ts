...
var f = function (e) {
    ...
    for (var t = new Map(), n = 0; n < e.length;) {
      ...
      if (undefined !== r) {
        if (r.type !== i.BlockEventType.CREATE) {
          ...
          if (l.blocks[u]) {
            var l$blocksU$type = l.blocks[u].type
  ...
  t.prototype.analyze_op_and_update = function (e, t, n) {
    ...
    if (i) {
      ...
      i.pick_ops.forEach(function (e) {
        ...
        if (undefined !== t) {
          var t$event_type = t.event_type
          var t$normalized_path = t.normalized_path
          switch (t$event_type) {
  ...
  t.prototype.handle_connect = function (e) {
    if (l.is_path_3(e)) {
      for (var e$target_id = e.target_id, n = this.ws_json.blocks[e$target_id]; n.parent_id;) {
  ...
  t.prototype.handle_disconnect = function (e) {
    if (l.is_path_3(e)) {
      ...
      if (r) {
        var object$keysR$blocks$filterFunctionEReturnR$blocksE$typeO$PROCEDURE_BLOCK_TYPES$RETURNUndefinedR$blocksE$shadows$VALUE$length = Object.keys(r.blocks).filter(function (e) {
  ...
  t.prototype.reload_return_count = function (e) {
    ...
    if (t) {
      var object$keysT$blocks$filterFunctionEReturnT$blocksE$typeO$PROCEDURE_BLOCK_TYPES$RETURNUndefinedT$blocksE$shadows$VALUE$length = Object.keys(t.blocks).filter(function (e) {
