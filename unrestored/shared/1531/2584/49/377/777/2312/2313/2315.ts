...
var u = function (e) {
  ...
  t.prototype.analyze_local_operation = function (e) {
    ...
    var n = new Set()
    var this$Blink$mainWorkspace$current_gesture_ = this.Blink.mainWorkspace.current_gesture_
    ...
    if (this$Blink$mainWorkspace$current_gesture_ && o) {
      ...
      var this$Blink$mainWorkspace$current_gesture_$block_dragger = this$Blink$mainWorkspace$current_gesture_.block_dragger
    ...
    var this$Blink$runtime_data$selected = this.Blink.runtime_data.selected
    if (this$Blink$runtime_data$selected && e.has(this$Blink$runtime_data$selected.id)) {
      ...
      if ((0, c.is_block_svg)(this$Blink$runtime_data$selected)) {
        var this$Blink$runtime_data$editing = this.Blink.runtime_data.editing
  ...
  t.prototype.interrupt_edit_field = function (e) {
    ...
    if (this.Blink.runtime_data.editing === e) {
      var e$value_before_editing = e.value_before_editing
  ...
  t.prototype.interrupt_gesture = function (e) {
    var /* [auto-meaningful-name] */_e$block_dragger2
    ...
    try {
      ...
      var i = null === (_e$block_dragger2 = e.block_dragger) || undefined === _e$block_dragger2 ? undefined : _e$block_dragger2.redo_stack_before_drag.slice()
      var o = null === (e$block_dragger = e.block_dragger) || undefined === e$block_dragger ? undefined : e$block_dragger.undo_stack_before_drag.slice()
