...
function m(e, t, n) {
  ...
  var n$indent = n.indent
  var o = undefined === n$indent ? 0 : n$indent
  var t$fallbacks = t.fallbacks
  if (e) {
    o++
  }
  if (t$fallbacks) {
...
var E = function () {
  ...
  e.prototype.prop = function (e, t, n) {
    ...
    var this$options$sheet = this.options.sheet
...
var x = function (e) {
  function t(t, n, r) {
    ...
    var r$selector = r.selector
    var r$scoped = r.scoped
    var r$sheet = r.sheet
    var r$generateId = r.generateId
    if (r$selector) {
      i.selectorText = r$selector
    } else {
      if (false !== r$scoped) {
        i.id = r$generateId(f.a(f.a(i)), r$sheet)
  ...
  t$prototype.toString = function (e) {
    var this$options$sheet = this.options.sheet
    var n = !!this$options$sheet && this$options$sheet.options.link ? i.a({}, e, {
      allowEmpty: true
    }) : e
  ...
  u.a(t, [{
    ...
    set: function (e) {
      if (e !== this.selectorText) {
        this.selectorText = e
        var this$renderer = this.renderer
        var this$renderable = this.renderable
        if (this$renderable && this$renderer) {
...
var F = function () {
  function e(e, t, n) {
    ...
    this.options = n
    var n$scoped = n.scoped
    var n$sheet = n.sheet
    var n$generateId = n.generateId
    for (var c in this.id = false === n$scoped ? this.name : w(n$generateId(this, n$sheet)), this.rules = new $(i.a({}, n, {
      parent: this
...
var j = {
  ...
  onChangeValue: function (e, t, n) {
    var n$options$sheet = n.options.sheet
    if (!n$options$sheet) {
      return e
    }
    switch (t) {
...
var $ = function () {
  ...
  e$prototype.add = function (e, t, n) {
    ...
    var this$options$parent = this$options.parent
    var this$options$sheet = this$options.sheet
    var this$options$jss = this$options.jss
    var this$options$Renderer = this$options.Renderer
    var this$options$generateId = this$options.generateId
    var this$options$scoped = this$options.scoped
    var f = i.a({
  ...
  e$prototype.process = function () {
    var this$options$jss$plugins = this.options.jss.plugins
  ...
  e$prototype.toString = function (e) {
    for (var t = "", this$options$sheet = this.options.sheet, r = !!this$options$sheet && this$options$sheet.options.link, i = 0; i < this.index.length; i++) {
...
var Z = function () {
  ...
  e$prototype.onProcessRule = function (e) {
    if (!e.isProcessed) {
      for (var e$options$sheet = e.options.sheet, n = 0; n < this.registry.onProcessRule.length; n++) {
...
var ee = new (function () {
  ...
  e$prototype.add = function (e) {
    var this$registry = this.registry
    var e$options$index = e.options.index
  ...
  e$prototype.toString = function (e) {
    for (var t = undefined === e ? {} : e, t$attached = t.attached, r = d.a(t, ["attached"]), i = "", o = 0; o < this.registry.length; o++) {
...
function fe(e) {
  ...
  var e$insertionPoint = e.insertionPoint
...
var pe = function (e, t) {
  var e$cssRules$length = e.cssRules.length
...
var _e = function () {
  ...
  e$prototype.attach = function () {
    if (!this.element.parentNode && this.sheet) {
      !function (e, t) {
        var t$insertionPoint = t.insertionPoint
        var r = fe(t)
        if (false !== r && r.parent) {
  ...
  e$prototype.detach = function () {
    if (this.sheet) {
      var this$element$parentNode = this.element.parentNode
  ...
  e$prototype.deleteRule = function (e) {
    var this$element$sheet = this.element.sheet
...
var ge = function () {
  ...
  e$prototype.use = function () {
    for (var e = this, arguments$length = arguments.length, n = new Array(arguments$length), r = 0; r < arguments$length; r++) {
      n[r] = arguments[r]
    }
    ...
    onProcessRule: function (e, t) {
      if ("style" === e.type && t) {
        (function (e, t) {
          ...
          var e$style = e.style
          var o = e$style ? e$style[Te] : null
          if (o) {
            for (var a in o) t.addRule(a, o[a], i.a({}, e$options, {
        ...
        (function (e, t) {
          var e$options = e.options
          var e$style = e.style
          for (var o in e$style) if ("@" === o[0] && o.substr(0, Te.length) === Te) {
            var a = Fe(o.substr(Te.length), e.selector)
            t.addRule(a, e$style[o], i.a({}, e$options, {
              selector: a
            }))
            delete e$style[o]
          }
...
var je = function () {
  ...
  function n(e, t, n) {
    ...
    var e$options$nestingLevel = e.options.nestingLevel
  ...
  return {
    onProcessStyle: function (r, o, a) {
      ...
      var c
      var u = o
      var u$options$parent = u.options.parent
      for (var f in r) {
        var d = -1 !== f.indexOf("&")
        var h = "@" === f[0]
        if (d || h) {
          ...
          if (d) {
            ...
            p = p.replace(Me, c)
            u$options$parent.addRule(p, r[f], i.a({}, s, {
              selector: p
            }))
          } else if (h) {
...
var en = {
  ...
  generateClassName: function () {
    ...
    var e$disableGlobal = e.disableGlobal
    var n = undefined !== e$disableGlobal && e$disableGlobal
    var e$productionPrefix = e.productionPrefix
    ...
    return function (e, t) {
      var t$options$name = t.options.name
...
function cn(e, t, n) {
  ...
  if (i) {
    e$state.cacheClasses.value = ye.a({
...
function un(e, t) {
  var e$state = e.state
  var e$theme = e.theme
  var e$stylesOptions = e.stylesOptions
  var e$stylesCreator = e.stylesCreator
  var e$name = e.name
  if (!e$stylesOptions.disableGeneration) {
    ...
    var u = i.a({}, e$stylesCreator.options, e$stylesOptions, {
      theme: e$theme,
    ...
    var e$stylesOptions$sheetsRegistry = e$stylesOptions.sheetsRegistry
    if (0 === c.refs) {
      var f
      ...
      if (!f) {
        (f = e$stylesOptions.jss.createStyleSheet(d, i.a({
          link: false
        }, u))).attach()
        if (e$stylesOptions.sheetsCache) {
    ...
    if (c.dynamicStyles) {
      var h = e$stylesOptions.jss.createStyleSheet(c.dynamicStyles, i.a({
        link: true
      }, u))
      h.update(t)
      h.attach()
      e$state.dynamicSheet = h
      e$state.classes = ye.a({
...
function hn(e) {
  ...
  var t$name = t.name
  var t$classNamePrefix = t.classNamePrefix
  var t$Component = t.Component
