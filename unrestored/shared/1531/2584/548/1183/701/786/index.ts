...
function E(e) {
  var e$primary = e.primary
  var n = undefined === e$primary ? {
    light: h[300],
    main: h[500],
    dark: h[700]
  } : e$primary
  var e$secondary = e.secondary
  ...
  var e$contrastThreshold = e.contrastThreshold
  var I = undefined === e$contrastThreshold ? 3 : e$contrastThreshold
  var e$tonalOffset = e.tonalOffset
  var R = undefined === e$tonalOffset ? .2 : e$tonalOffset
...
function K() {
  for (var e = arguments.length > 0 && undefined !== arguments[0] ? arguments[0] : {}, e$breakpoints = e.breakpoints, n = undefined === e$breakpoints ? {} : e$breakpoints, e$mixins = e.mixins, a = undefined === e$mixins ? {} : e$mixins, e$palette = e.palette, l = undefined === e$palette ? {} : e$palette, e$spacing = e.spacing, e$typography = e.typography, h = undefined === e$typography ? {} : e$typography, p = i.a(e, ["breakpoints", "mixins", "palette", "spacing", "typography"]), _ = E(l), A = c(n), g = z(e$spacing), v = o.a({
      breakpoints: A,
      direction: "ltr",
      mixins: u(A, g, a),
      overrides: {},
      ...
      transitions: Q.a,
      zIndex: W.a
    }, p), arguments$length = arguments.length, y = new Array(arguments$length > 1 ? arguments$length - 1 : 0), b = 1; b < arguments$length; b++) {
    y[b - 1] = arguments[b]
  }
