...
exports.fromByteArray = function (e) {
  for (var t, e$length = e.length, i = e$length % 3, o = [], a = 0, s = e$length - i; a < s; a += 16383) {
...
for (var r = [], i = [], o = "undefined" !== typeof Uint8Array ? Uint8Array : Array, a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", s = 0, a$length = a.length; s < a$length; ++s) {
  r[s] = a[s]
  i[a.charCodeAt(s)] = s
}
function u(e) {
