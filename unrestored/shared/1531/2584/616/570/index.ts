...
(function (e) {
  ...
  c.compare = function (e, t) {
    ...
    for (var e$length = e.length, t$length = t.length, i = 0, o = Math.min(e$length, t$length); i < o; ++i) {
      if (e[i] !== t[i]) {
        e$length = e[i]
        t$length = t[i]
        break
  ...
  c.prototype.inspect = function () {
    var e = ""
    var exports$INSPECT_MAX_BYTES = exports.INSPECT_MAX_BYTES
    if (this.length > 0) {
  ...
  function U(e, t) {
    var n
    t = t || 1 / 0
    for (var e$length = e.length, i = null, o = [], a = 0; a < e$length; ++a) {
