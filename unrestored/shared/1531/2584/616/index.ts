  ...
  n = function () {
    return function (e) {
      ...
      var o = function e(t, n, r) {
        ...
        var a = o.get;
        return undefined !== a ? a.call(r) : undefined;
      };
      var i = d(n(3));
      var a = d(n(2));
      var s = d(n(0));
      ...
      var y = function () {
        function e(t) {
          ...
          this.emitter.on(c.default.events.SCROLL_UPDATE, function (e, t) {
            ...
            var o = r && 0 === r.length ? r.index : undefined;
            O.call(n, function () {
      ...
      a.prototype.emit = function (e, t, n, o, i, a) {
        ...
        if (u.fn) {
          switch (u.once && this.removeListener(e, u.fn, undefined, true), d) {
            case 1:
              u.fn.call(u.context);
              return true;
            case 2:
          ...
          var f = u.length;
          for (l = 0; l < f; l++) {
            switch (u[l].once && this.removeListener(e, u[l].fn, undefined, true), d) {
              case 1:
          ...
          value: function () {
            ...
            this.root.querySelector("a.ql-remove").addEventListener("click", function (t) {
              if (null != e.linkRange) {
                var n = e.linkRange;
                e.restoreFocus();
                e.quill.formatText(n, "link", false, s.default.sources.USER);
                delete e.linkRange;
              }
              t.preventDefault();
              e.hide();
