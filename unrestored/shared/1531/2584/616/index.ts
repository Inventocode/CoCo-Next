  ...
  n = function () {
    return function (e) {
      ...
      c.prototype.push = function (e) {
        var this$ops$length = this.ops.length
        ...
        if ("object" === typeof n) {
          ...
          if ("number" === typeof n.delete && null != e.insert && (this$ops$length -= 1, "object" !== typeof (n = this.ops[this$ops$length - 1]))) {
            this.ops.unshift(e)
            return this
          }
          if (o(e.attributes, n.attributes)) {
            if ("string" === typeof e.insert && "string" === typeof n.insert) {
              ...
              if ("object" === typeof e.attributes) {
                this.ops[this$ops$length - 1].attributes = e.attributes
              }
              return this
            }
        ...
        if (this$ops$length === this.ops.length) {
          this.ops.push(e)
        } else {
          this.ops.splice(this$ops$length, 0, e)
        }
        return this
      }
      ...
      c.prototype.compose = function (e) {
        ...
        if (null != i && "number" === typeof i.retain && null == i.attributes) {
          for (var i$retain = i.retain; "insert" === t.peekType() && t.peekLength() <= i$retain;) {
            i$retain -= t.peekLength()
            r.push(t.next())
          }
          if (i.retain - i$retain > 0) {
            n.next(i.retain - i$retain)
          }
        }
      ...
      c.prototype.diff = function (e, t) {
        ...
        l.forEach(function (e) {
          for (var e1$length = e[1].length; e1$length > 0;) {
            var n = 0
            switch (e[0]) {
              case r.INSERT:
                n = Math.min(d.peekLength(), e1$length)
                i.push(d.next(n))
                break
              case r.DELETE:
                n = Math.min(e1$length, u.peekLength())
                u.next(n)
                i.delete(n)
                break
              case r.EQUAL:
                n = Math.min(u.peekLength(), d.peekLength(), e1$length)
                var s = u.next(n),
                  c = d.next(n)
      ...
      c.prototype.eachLine = function (e, t) {
        ...
        for (var n = a.iterator(this.ops), r = new c(), o = 0; n.hasNext();) {
          ...
          if (l < 0) {
            ...
            if (false === e(r, n.next(1).attributes || {}, o)) {
              return
            }
            o += 1
            r = new c()
      ...
      var s = function (e) {
        ...
        var t
        var o = object$prototype$hasOwnProperty.call(e, "constructor")
        var i = e.constructor && e.constructor.prototype && object$prototype$hasOwnProperty.call(e.constructor.prototype, "isPrototypeOf")
        if (e.constructor && !o && !i) {
          return false
        }
        for (t in e);
        return "undefined" === typeof t || object$prototype$hasOwnProperty.call(e, t)
      }
      var c = function (e, t) {
        if (object$defineProperty && "__proto__" === t.name) {
      ...
      e.exports = function e() {
        ...
        var h = false
        for ("boolean" === typeof d && (h = d, d = arguments[1] || {}, p = 2), (null == d || "object" !== typeof d && "function" !== typeof d) && (d = {}); p < arguments$length; ++p) {
      ...
      var o = function e(t, n, r) {
        ...
        if (undefined === o) {
          ...
          return null === i ? undefined : e(i, n, r)
        }
        if ("value" in o) {
          return o.value
        }
        var o$get = o.get
        return undefined !== o$get ? o$get.call(r) : undefined
      }
      var i = d(n(3))
      var a = d(n(2))
      var s = d(n(0))
      ...
      var g = function (e) {
        ...
        r(t, [{
          ...
          key: "path",
          value: function (e) {
            return o(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "path", this).call(this, e, true)
          }
        }, {
          key: "removeChild",
          value: function (e) {
      ...
      var y = function () {
        function e(t) {
          ...
          this.emitter.on(c.default.events.SCROLL_UPDATE, function (e, t) {
            var n$selection$lastRange = n.selection.lastRange
            var o = n$selection$lastRange && 0 === n$selection$lastRange.length ? n$selection$lastRange.index : undefined
            O.call(n, function () {
        ...
        i(e, [{
          ...
          key: "focus",
          value: function () {
            var this$scrollingContainer$scrollTop = this.scrollingContainer.scrollTop
            this.selection.focus()
            this.scrollingContainer.scrollTop = this$scrollingContainer$scrollTop
            this.scrollIntoView()
          }
        }, {
          key: "format",
          value: function (e, t) {
            var n = this
            var r = arguments.length > 2 && undefined !== arguments[2] ? arguments[2] : c.default.sources.API
            return O.call(this, function () {
          ...
          value: function () {
            ...
            var t = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : this.getLength() - e
            var n = w(e, t)
            var r = o(n, 2)
            e = r[0]
            t = r[1]
          ...
          key: "getFormat",
          value: function () {
            var e = arguments.length > 0 && undefined !== arguments[0] ? arguments[0] : this.getSelection(true)
            var t = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : 0
          ...
          value: function () {
            var e = arguments.length > 0 && undefined !== arguments[0] ? arguments[0] : 0
            var t = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : Number.MAX_VALUE
          ...
          value: function (t, n, r) {
            var o = this
            var i = arguments.length > 3 && undefined !== arguments[3] ? arguments[3] : e.sources.API
            return O.call(this, function () {
          ...
          value: function (e) {
            var t = this
            var n = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : c.default.sources.API
            return O.call(this, function () {
              e = new a.default(e)
              var n = t.getLength()
          ...
          key: "setText",
          value: function (e) {
            var t = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : c.default.sources.API
          ...
          key: "update",
          value: function () {
            var e = arguments.length > 0 && undefined !== arguments[0] ? arguments[0] : c.default.sources.USER
      ...
      function E(e, t) {
        ...
        var n = (0, f.default)(true, {}, t.theme.DEFAULTS);
      ...
      function O(e, t, n, r) {
        ...
        var this$editor$delta = this.editor.delta
        var s = e()
        if (null != o) {
          if (true === n) {
            n = o.index
        ...
        if (s.length() > 0) {
          var /* [auto-meaningful-name] */_this$emitter2
          var /* [auto-meaningful-name] */this$emitter
          var d = [c.default.events.TEXT_CHANGE, s, this$editor$delta, t];
          (_this$emitter2 = this.emitter).emit.apply(_this$emitter2, [c.default.events.EDITOR_CHANGE].concat(d))
          if (t !== c.default.sources.SILENT) {
            (this$emitter = this.emitter).emit.apply(this$emitter, d)
          }
        }
        return s
      }
      ...
      ["selectionchange", "mousedown", "mouseup", "click"].forEach(function (e) {
        document.addEventListener(e, function () {
          ...
          [].slice.call(document.querySelectorAll(".ql-container")).forEach(function (e) {
            var /* [auto-meaningful-name] */e$__quill$emitter
            if (e.__quill && e.__quill.emitter) {
              (e$__quill$emitter = e.__quill.emitter).handleDOM.apply(e$__quill$emitter, t)
            }
          })
        })
      })
      var c = function (e) {
        ...
        r(t, [{
          ...
          key: "handleDOM",
          value: function (e) {
            for (var arguments$length = arguments.length, n = Array(arguments$length > 1 ? arguments$length - 1 : 0), r = 1; r < arguments$length; r++) {
              n[r - 1] = arguments[r]
            }
            (this.listeners[e.type] || []).forEach(function (t) {
              var t$node = t.node
              var t$handler = t.handler
              if (e.target === t$node || t$node.contains(e.target)) {
                t$handler.apply(undefined, [e].concat(n))
              }
            })
          }
        }, {
      ...
      function i(e) {
        if (r.indexOf(e) <= r.indexOf(o)) {
          for (var t, arguments$length = arguments.length, i = Array(arguments$length > 1 ? arguments$length - 1 : 0), a = 1; a < arguments$length; a++) {
            i[a - 1] = arguments[a]
          }
      ...
      var array$prototype$slice = Array.prototype.slice
      var o = n(52)
      var i = n(53)
      var a = e.exports = function (e, t, n) {
        ...
        return e === t || (e instanceof Date && t instanceof Date ? e.getTime() === t.getTime() : !e || !t || "object" != typeof e && "object" != typeof t ? n.strict ? e === t : e == t : function (e, t, n) {
          ...
          if (i(e)) {
            return !!i(t) && (e = array$prototype$slice.call(e), t = array$prototype$slice.call(t), a(e, t, n))
          }
          if (c(e)) {
            if (!c(t)) {
              return false
      ...
      var o = function () {
        ...
        e.prototype.add = function (e, t) {
          return !!this.canAdd(e, t) && (e.setAttribute(this.keyName, t), true)
        }
      ...
      var g = function (e) {
        ...
        o(t, [{
          ...
          value: function () {
            var e = this
            var this$domNode$textContent = this.domNode.textContent
            if (this$domNode$textContent.endsWith("\n")) {
              this$domNode$textContent = this$domNode$textContent.slice(0, -1)
            }
          ...
          value: function (e, n, r, o) {
            if (0 !== n && null != s.default.query(r, s.default.Scope.BLOCK) && (r !== this.statics.blotName || o !== this.statics.formats(this.domNode))) {
              ...
              if (!(i < 0 || i >= e + n)) {
                var a = this.newlineIndex(e, true) + 1
                var c = i - a + 1
                var l = this.isolate(a, c)
                var l$next = l.next
                l.format(r, o)
                if (l$next instanceof t) {
                  l$next.formatAt(0, e - a + n - c, r, o)
                }
              }
            }
          }
          ...
          key: "length",
          value: function () {
            var this$domNode$textContent$length = this.domNode.textContent.length
            return this.domNode.textContent.endsWith("\n") ? this$domNode$textContent$length : this$domNode$textContent$length + 1
          }
        }, {
          key: "newlineIndex",
          value: function (e) {
          ...
          value: function (e) {
            ...
            if (null != this$next && this$next.prev === this && this$next.statics.blotName === this.statics.blotName && this.statics.formats(this.domNode) === this$next.statics.formats(this$next.domNode)) {
              this$next.optimize(e)
      ...
      var b = function () {
        ...
        i(e, [{
          ...
          value: function (e) {
            ...
            (e = function (e) {
              return e.reduce(function (e, t) {
                ...
                if (!(null == t.attributes || true !== t.attributes.list && true !== t.attributes.bullet)) {
              ...
              if (null != a.insert) {
                if ("string" === typeof a.insert) {
                  var a$insert = a.insert
                  if (a$insert.endsWith("\n") && n) {
                    n = false
                    a$insert = a$insert.slice(0, -1)
                  }
                  if (e >= i && !a$insert.endsWith("\n")) {
                    n = true
                  }
                  t.scroll.insertAt(e, a$insert)
          ...
          value: function () {
            ...
            var this$scroll$children$head = this.scroll.children.head
            return this$scroll$children$head.statics.blotName === p.default.blotName && !(this$scroll$children$head.children.length > 1) && this$scroll$children$head.children.head instanceof f.default
          }
        }, {
          key: "removeFormat",
          value: function (e, t) {
          ...
          value: function (e) {
            ...
            if (1 === t.length && "characterData" === t[0].type && t[0].target.data.match(v) && c.default.find(t[0].target)) {
              ...
              this.delta = this$delta.compose(e)
            } else {
              this.delta = this.getDelta()
              if (!(e && (0, m.default)(this$delta.compose(e), this.delta))) {
                e = this$delta.diff(this.delta, n)
              }
            }
            return e
          }
      ...
      var h = function () {
        function e(t, n) {
          ...
          this.emitter.on(c.default.events.SCROLL_OPTIMIZE, function (e, t) {
            if (t.range) {
              var t$range = t.range
              var t$range$startNode = t$range.startNode
              var t$range$startOffset = t$range.startOffset
              var t$range$endNode = t$range.endNode
              var t$range$endOffset = t$range.endOffset
              r.setNativeRange(t$range$startNode, t$range$startOffset, t$range$endNode, t$range$endOffset)
            }
          })
        ...
        o(e, [{
            ...
            if (null == this.scroll.whitelist || this.scroll.whitelist[e]) {
              ...
              if (null != n && n.native.collapsed && !i.default.query(e, i.default.Scope.BLOCK)) {
                if (n.start.node !== this.cursor.textNode) {
                  var r = i.default.find(n.start.node, false)
                  if (null == r) {
                    return
                  }
          ...
          value: function (e) {
            ...
            [t.start, t.end].forEach(function (e) {
              for (var e$node = e.node, e$offset = e.offset; !(e$node instanceof Text) && e$node.childNodes.length > 0;) {
                if (e$node.childNodes.length > e$offset) {
                  e$node = e$node.childNodes[e$offset]
                  e$offset = 0
                } else {
                  if (e$node.childNodes.length !== e$offset) {
                    break
                  }
                  e$offset = (e$node = e$node.lastChild) instanceof Text ? e$node.data.length : e$node.childNodes.length + 1
                }
              }
              e.node = e$node
              e.offset = e$offset
          ...
          key: "scrollIntoView",
          value: function (e) {
            var this$lastRange = this.lastRange
            if (null != this$lastRange) {
              var n = this.getBounds(this$lastRange.index, this$lastRange.length)
              if (null != n) {
                var o = this.scroll.length() - 1
                var i = this.scroll.line(Math.min(this$lastRange.index, o))
                var a = r(i, 1)[0]
                var s = a
                if (this$lastRange.length > 0) {
                  var c = this.scroll.line(Math.min(this$lastRange.index + this$lastRange.length, o))
                  s = r(c, 1)[0]
                }
                if (null != a && null != s) {
          ...
          key: "setNativeRange",
          value: function (e, t) {
            var n = arguments.length > 2 && undefined !== arguments[2] ? arguments[2] : e
            var r = arguments.length > 3 && undefined !== arguments[3] ? arguments[3] : t
            ...
            if (null == e || null != this.root.parentNode && null != e.parentNode && null != n.parentNode) {
              ...
              if (null != i) {
                if (null != e) {
                  ...
                  var this$getNativeRange$native = (this.getNativeRange() || {}).native
                  if (null == this$getNativeRange$native || o || e !== this$getNativeRange$native.startContainer || t !== this$getNativeRange$native.startOffset || n !== this$getNativeRange$native.endContainer || r !== this$getNativeRange$native.endOffset) {
                    if ("BR" == e.tagName) {
          ...
          value: function (e) {
            var t = arguments.length > 1 && undefined !== arguments[1] && arguments[1]
            var n = arguments.length > 2 && undefined !== arguments[2] ? arguments[2] : c.default.sources.API
            if ("string" === typeof t) {
              n = t
              t = false
            }
          ...
          value: function () {
            ...
            if (!(0, s.default)(this$lastRange, this.lastRange)) {
              var /* [auto-meaningful-name] */_this$emitter5
              if (!this.composing && null != l && l.native.collapsed && l.start.node !== this.cursor.textNode) {
                this.cursor.restore()
              }
              var /* [auto-meaningful-name] */this$emitter
              var p = [c.default.events.SELECTION_CHANGE, (0, a.default)(this.lastRange), (0, a.default)(this$lastRange), e];
              (_this$emitter5 = this.emitter).emit.apply(_this$emitter5, [c.default.events.EDITOR_CHANGE].concat(p))
              if (e !== c.default.sources.SILENT) {
                (this$emitter = this.emitter).emit.apply(this$emitter, p)
              }
            }
          }
        }])
        ...
        attributes: {
          compose: function (e, t, n) {
            ...
            for (var i in n || (r = Object.keys(r).reduce(function (e, t) {
              ...
              return e
            }, {})), e) if (undefined !== e[i] && undefined === t[i]) {
              r[i] = e[i]
            }
      ...
      a.prototype.next = function (e) {
        ...
        if (t) {
          ...
          if ("number" === typeof t.retain) {
            ...
            if ("string" === typeof t.insert) {
              o.insert = t.insert.substr(this$offset, e)
            } else {
              o.insert = t.insert
            }
          }
      ...
      var m = function (e) {
        ...
        o(t, [{
          ...
          value: function (e, n) {
            ...
            if (null != f && s !== f && l > 0) {
              ...
              if (s instanceof d.default) {
                var h = s.newlineIndex(s.length(), true)
          ...
          value: function (e) {
            if (true !== this.batch) {
              var s$default$sources$USER = s.default.sources.USER
              if ("string" === typeof e) {
                s$default$sources$USER = e
              }
              if (!Array.isArray(e)) {
                e = this.observer.takeRecords()
              }
              if (e.length > 0) {
                this.emitter.emit(s.default.events.SCROLL_BEFORE_UPDATE, s$default$sources$USER, e)
              }
              i(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "update", this).call(this, e.concat([]))
              if (e.length > 0) {
                this.emitter.emit(s.default.events.SCROLL_UPDATE, s$default$sources$USER, e)
              }
            }
          }
        }])
                  ...
                  if (null != c && e.quill.hasFocus()) {
                    ...
                    if (a.some(function (t) {
                      ...
                      if (Array.isArray(t.format)) {
                        ...
                        return true === t.format[e] ? null != C.format[e] : false === t.format[e] ? null == C.format[e] : (0, s.default)(t.format[e], C.format[e])
                      })) {
                        return false
                      }
                      return !(null != t.prefix && !t.prefix.test(C.prefix)) && !(null != t.suffix && !t.suffix.test(C.suffix)) && true !== t.handler.call(e, c, C)
                    })) {
                      n.preventDefault()
                    }
                  }
      ...
      function T(e) {
        return {
          ...
          handler: function (t) {
            ...
            var a = this.quill.scroll.descendant(n, t$index)
            var s = o(a, 2)
            var c = s[0]
            var l = s[1]
            if (null != c) {
              var u = this.quill.getIndex(c)
              var f = c.newlineIndex(l, true) + 1
              var h = c.newlineIndex(u + l + t$length)
              ...
              m.forEach(function (t, o) {
                if (e) {
                  ...
                  l += n.TAB.length
                  if (0 === o) {
                    t$index += n.TAB.length
                  } else {
                    t$length += n.TAB.length
                  }
                } else {
              ...
              this.quill.setSelection(t$index, t$length, p.default.sources.SILENT)
            }
          }
        }
      }
        ...
        bindings: {
            ...
            handler: function (e, t) {
              if (null != t.format.indent) {
                ...
                if (null != t.format.list) {
                  this.quill.format("list", false, p.default.sources.USER)
                }
              }
            }
          },
          "indent code-block": T(true),
          "outdent code-block": T(false),
          "remove tab": {
            key: b.keys.TAB,
            shiftKey: true,
            collapsed: true,
          ...
          "list empty enter": {
            ...
            handler: function (e, t) {
              this.quill.format("list", false, p.default.sources.USER)
              if (t.format.indent) {
                this.quill.format("indent", false, p.default.sources.USER)
              }
            }
          },
          "checklist enter": {
          ...
          "list autofill": {
            ...
            prefix: /^\s*?(\d+\.|-|\*|\[ ?\]|\[x\])$/,
            handler: function (e, t) {
              var t$prefix$length = t.prefix.length
              var r = this.quill.getLine(e.index)
              var i = o(r, 2)
              var a = i[0]
              var s = i[1]
              if (s > t$prefix$length) {
                return true
              }
              var c = undefined
              ...
              this.quill.history.cutoff()
              var u = new l.default().retain(e.index - s).delete(t$prefix$length + 1).retain(a.length() - 2 - s).retain(1, {
                list: c
              })
              this.quill.updateContents(u, p.default.sources.USER)
              this.quill.history.cutoff()
              this.quill.setSelection(e.index - t$prefix$length, p.default.sources.SILENT)
            }
          },
          "code exit": {
            key: b.keys.ENTER,
          ...
          "embed left": y(b.keys.LEFT, false),
          "embed left shift": y(b.keys.LEFT, true),
          "embed right": y(b.keys.RIGHT, false),
          "embed right shift": y(b.keys.RIGHT, true)
        }
      }
      t.default = b
      t.SHORTKEY = v
        ...
        i(t, [{
          ...
          value: function () {
            if (!this.selection.composing && null != this.parent) {
              var this$textNode = this.textNode
              var n = this.selection.getNativeRange()
              var o = undefined
              var i = undefined
              var c = undefined
              if (null != n && n.start.node === this$textNode && n.end.node === this$textNode) {
                var l = [this$textNode, n.start.offset, n.end.offset]
                o = l[0]
                i = l[1]
                c = l[2]
              }
      ...
      var i = function (e) {
        ...
        t.prototype.add = function (e, t) {
          return !!this.canAdd(e, t) && (this.remove(e), e.classList.add(this.keyName + "-" + t), true)
        }
      ...
      var i = function (e) {
        ...
        t.prototype.add = function (e, t) {
          return !!this.canAdd(e, t) && (e.style[o(this.keyName)] = t, true)
        }
        t.prototype.remove = function (e) {
        ...
        r(t, [{
          ...
          value: function (e) {
            this.stack.undo.forEach(function (t) {
              t.undo = e.transform(t.undo, true)
              t.redo = e.transform(t.redo, true)
            })
      ...
      var _ = [false, "center", "right", "justify"]
      ...
      var b = [false, "serif", "monospace"]
      var y = ["1", "2", "3", false]
      var E = ["small", false, "large", "huge"]
      var O = function (e) {
        function t(e, n) {
          h(this, t)
      ...
      O.DEFAULTS = (0, o.default)(true, {}, c.default.DEFAULTS, {
        modules: {
          toolbar: {
            handlers: {
              formula: function () {
                ...
                if (null == t) {
                  ...
                  t.addEventListener("change", function () {
                    if (null != t.files && null != t.files[0]) {
                      ...
                      n.onload = function (n) {
                        var r = e.quill.getSelection(true)
      ...
      var w = function (e) {
        ...
        r(t, [{
          ...
          key: "edit",
          value: function () {
            var e = arguments.length > 0 && undefined !== arguments[0] ? arguments[0] : "link"
            var t = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : null
          ...
          key: "restoreFocus",
          value: function () {
            var this$quill$scrollingContainer$scrollTop = this.quill.scrollingContainer.scrollTop
            this.quill.focus()
            this.quill.scrollingContainer.scrollTop = this$quill$scrollingContainer$scrollTop
          }
        }, {
          key: "save",
          value: function () {
            var this$textbox$value = this.textbox.value
            switch (this.root.getAttribute("data-mode")) {
              case "link":
                var this$quill$root$scrollTop = this.quill.root.scrollTop
                if (this.linkRange) {
                  this.quill.formatText(this.linkRange, "link", this$textbox$value, a.default.sources.USER)
                  delete this.linkRange
                } else {
                  this.restoreFocus()
                  this.quill.format("link", this$textbox$value, a.default.sources.USER)
                }
                this.quill.root.scrollTop = this$quill$root$scrollTop
                break
              case "video":
                this$textbox$value = function (e) {
              ...
              case "formula":
                ...
                if (null != n) {
                  ...
                  this.quill.insertEmbed(r, this.root.getAttribute("data-mode"), this$textbox$value, a.default.sources.USER)
      ...
      var r = function () {
        ...
        e.prototype.offset = function (e) {
          for (var t = 0, this$head = this.head; null != this$head;) {
            if (this$head === e) {
              return t
            }
            t += this$head.length()
        ...
        t.prototype.optimize = function (t, n) {
          ...
          for (var s = function e(t, n) {
            ...
            for (l.forEach(function (e) {
              var t = i.find(e.target, true)
              if (null != t) {
                if (t.domNode === e.target) {
                  if ("childList" === e.type) {
                    s(i.find(e.previousSibling, false));
                    [].forEach.call(e.addedNodes, function (e) {
                      var t = i.find(e, false)
                      s(t, false)
                      if (t instanceof o.default) {
      ...
      var a = function (e) {
        ...
        t.prototype.optimize = function (n) {
          ...
          var this$next = this.next
          if (this$next instanceof t && this$next.prev === this && function (e, t) {
      ...
      var a = function (e) {
        ...
        r(t, e)
        t.formats = function (n) {
          var i$queryT$blotName$tagName = i.query(t.blotName).tagName
          if (n.tagName !== i$queryT$blotName$tagName) {
            return e.formats.call(this, n)
          }
        }
        t.prototype.format = function (n, r) {
      ...
      if (r.classList.contains("test-class")) {
        var dOMTokenList$prototype$toggle = DOMTokenList.prototype.toggle
        DOMTokenList.prototype.toggle = function (e, t) {
          return arguments.length > 1 && !this.contains(e) === !t ? t : dOMTokenList$prototype$toggle.call(this, e)
        }
      }
      ...
      function n(e, t, a) {
        ...
        var d = function (e, t) {
          ...
          return function (e, t) {
            for (var e$length = e.length, t$length = t.length, i = Math.ceil((e$length + t$length) / 2), a = i, s = 2 * i, c = new Array(s), l = new Array(s), u = 0; u < s; u++) {
              c[u] = -1
              l[u] = -1
            }
            c[a + 1] = 0
            l[a + 1] = 0
            for (var d = e$length - t$length, p = d % 2 != 0, f = 0, h = 0, m = 0, g = 0, _ = 0; _ < i; _++) {
              for (var v = -_ + f; v <= _ - h; v += 2) {
                for (var b = a + v, y = (T = v == -_ || v != _ && c[b - 1] < c[b + 1] ? c[b + 1] : c[b - 1] + 1) - v; T < e$length && y < t$length && e.charAt(T) == t.charAt(y);) {
                  T++
                  y++
                }
                c[b] = T
              ...
              for (var O = -_ + m; O <= _ - g; O += 2) {
                for (var w = a + O, C = (E = O == -_ || O != _ && l[w - 1] < l[w + 1] ? l[w + 1] : l[w - 1] + 1) - O; E < e$length && C < t$length && e.charAt(e$length - E - 1) == t.charAt(t$length - C - 1);) {
                  E++
                  C++
                }
                l[w] = E
      ...
      a.prototype.eventNames = function () {
        ...
        return Object.getOwnPropertySymbols ? o.concat(Object.getOwnPropertySymbols(this$_events)) : o
      }
      a.prototype.listeners = function (e, t) {
        ...
        for (var i = 0, o$length = o.length, s = new Array(o$length); i < o$length; i++) {
          s[i] = o[i].fn
        }
        return s
      }
      a.prototype.emit = function (e, t, n, o, i, a) {
        ...
        var arguments$length = arguments.length
        if (u.fn) {
          switch (u.once && this.removeListener(e, u.fn, undefined, true), arguments$length) {
            case 1:
              u.fn.call(u.context)
              return true
            case 2:
          ...
          for (l = 1, c = new Array(arguments$length - 1); l < arguments$length; l++) {
            c[l - 1] = arguments[l]
          }
          ...
          for (l = 0; l < u$length; l++) {
            switch (u[l].once && this.removeListener(e, u[l].fn, undefined, true), arguments$length) {
              case 1:
              ...
              default:
                if (!c) {
                  for (p = 1, c = new Array(arguments$length - 1); p < arguments$length; p++) {
                    c[p - 1] = arguments[p]
                  }
                }
      ...
      a.prototype.removeListener = function (e, t, n, i) {
        ...
        if (s.fn) {
          ...
          for (var c = 0, l = [], s$length = s.length; c < s$length; c++) {
      ...
      var w = [[Node.TEXT_NODE, L], [Node.TEXT_NODE, D], ["br", function (e, t) {
        ...
        for (var r = -1, e$parentNode = e.parentNode; !e$parentNode.classList.contains("ql-clipboard");) {
          if ("list" === (c.default.query(e$parentNode) || {}).blotName) {
            r += 1
          }
        ...
        i(t, [{
          ...
          value: function (e) {
            ...
            if (t[h.default.blotName]) {
              var this$container$innerText = this.container.innerText
              this.container.innerHTML = ""
              return new s.default().insert(this$container$innerText, y({}, h.default.blotName, t[h.default.blotName]))
            }
          ...
          value: function (e, t) {
            var n = arguments.length > 2 && undefined !== arguments[2] ? arguments[2] : l.default.sources.API
            if ("string" === typeof e) {
          ...
          value: function (e) {
            ...
            if (!e.defaultPrevented && this.quill.isEnabled()) {
              ...
              setTimeout(function () {
                ...
                t.quill.scrollingContainer.scrollTop = this$quill$scrollingContainer$scrollTop
                t.quill.focus()
              }, 1)
            }
          }
        ...
        n.concat(r).concat(o).forEach(function (t) {
          ...
          if (!(null != n && (i[n.attrName] = n.value(e), i[n.attrName]))) {
            if (!(null == (n = C[t]) || n.attrName !== t && n.keyName !== t)) {
              i[n.attrName] = n.value(e) || undefined
            }
      ...
      function L(e, t) {
        ...
        if ("O:P" === e.parentNode.tagName) {
          return t.insert(e$data.trim())
        }
        if (0 === e$data.trim().length && e.parentNode.classList.contains("ql-clipboard")) {
          return t
        }
            ...
            if (n) {
              ...
              e.addEventListener(o, function (o) {
                ...
                if ("SELECT" === e.tagName) {
                  ...
                  c = !l.hasAttribute("selected") && (l.value || false)
                } else {
      ...
      f.DEFAULTS = {
        ...
        handlers: {
          ...
          direction: function (e) {
            var this$quill$getFormat$align = this.quill.getFormat().align
            if ("rtl" === e && null == this$quill$getFormat$align) {
              this.quill.format("align", "right", s.default.sources.USER)
            } else {
              if (!(e || "right" !== this$quill$getFormat$align)) {
                this.quill.format("align", false, s.default.sources.USER)
              }
            }
      ...
      v.DEFAULTS = (0, a.default)(true, {}, l.default.DEFAULTS, {
        modules: {
          toolbar: {
            handlers: {
              link: function (e) {
        ...
        i(t, [{
          ...
          value: function () {
            ...
            this.root.querySelector("a.ql-remove").addEventListener("click", function (t) {
              if (null != e.linkRange) {
                var e$linkRange = e.linkRange
                e.restoreFocus()
                e.quill.formatText(e$linkRange, "link", false, s.default.sources.USER)
                delete e.linkRange
              }
              t.preventDefault()
              e.hide()
      ...
      var u = new (function (e) {
        ...
        o(t, [{
          ...
          value: function (e, n) {
            ...
            return 0 === n ? (this.remove(e), true) : i(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "add", this).call(this, e, n)
          }
        }, {
          key: "canAdd",
          value: function (e, n) {
      ...
      var f = function (e) {
        ...
        r(t, [{
          ...
          value: function (e) {
            o(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "optimize", this).call(this, e)
            var this$next = this.next
            if (null != this$next && this$next.prev === this && this$next.statics.blotName === this.statics.blotName && this$next.domNode.tagName === this.domNode.tagName && this$next.domNode.getAttribute("data-checked") === this.domNode.getAttribute("data-checked")) {
              this$next.moveChildren(this)
              this$next.remove()
            }
          }
      ...
      var d = function (e) {
        ...
        r(t, [{
          ...
          value: function (e) {
            var this$domNode$textContent = this.domNode.textContent
            if (this.cachedText !== this$domNode$textContent) {
              if (this$domNode$textContent.trim().length > 0 || null == this.cachedText) {
                this.domNode.innerHTML = e(this$domNode$textContent)
                this.domNode.normalize()
                this.attach()
              }
              this.cachedText = this$domNode$textContent
            }
          }
        }])
        return t
      ...
      g.DEFAULTS = (0, i.default)(true, {}, c.default.DEFAULTS, {
        modules: {
          toolbar: {
            handlers: {
              link: function (e) {
