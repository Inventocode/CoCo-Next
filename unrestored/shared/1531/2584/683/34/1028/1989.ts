(function (e, r) {
  ...
  !function (o) {
    ...
    function w(e) {
      ...
      for (i = n > 0 ? n + 1 : 0; i < A;) {
        for (o = g, a = 1, s = 36; i >= A && _("invalid-input"), ((u = (d = e.charCodeAt(i++)) - 48 < 10 ? d - 22 : d - 65 < 26 ? d - 65 : d - 97 < 26 ? d - 97 : 36) >= 36 || u > h((c - g) / a)) && _("overflow"), g += u * a, !(u < (l = s <= y ? 1 : s >= y + 26 ? 26 : s - y)); s += 36) {
          if (a > h(c / (f = 36 - l))) {
            _("overflow");
          }
          a *= f;
