...
var d = function () {
  ...
  e.prototype.set_pen_down = function () {
    if (!this.origin_x || !this.origin_y) {
      var this$actor = this.actor
      var this$actor$x = this$actor.x
      var this$actor$y = this$actor.y
  ...
  e.prototype.draw_image_stamp = function () {
    ...
    if (this$ctx) {
      ...
      var this$actor$rotation = this.actor.rotation
...
var v = function (e) {
  function t(t) {
    ...
    n.on_resize = function (e) {
      if (e.target_id === n.app.get_app().stage.name) {
        ...
        n.hitArea = new f(n, function (e) {
          return n.is_touching(new a.o(e.x - t$width / 2, e.y - t$height / 2))
        })
      }
    }
    ...
    n.drag_move = function () {
      if (n.is_draggable && n.drag_data) {
        ...
        if (n.has_drag_protection) {
          var u = c.d(n, s)
          s.set(r.a(-t$width / 2, t$width / 2, u.x), r.a(-t$height / 2, t$height / 2, u.y))
        }
    ...
    n.drag_end = function (e) {
      ...
      if (!(e && o.a(e.type, ["touchendoutside", "mouseupoutside"])) && t - n.mouse_down_time < 1e3) {
        var n$app$get_app$stage = n.app.get_app().stage
    ...
    n.hitArea = new f(n, function (e) {
      return n.is_touching(new a.o(e.x - i$width / 2, e.y - i$height / 2))
    })
  ...
  t.prototype.check_bumped_other = function (e) {
    ...
    for (var r = {
      ...
      }, i = new a.o(0, 0), o = 0, r$left = r.left; r$left < r.right; r$left += 2) {
      i.x = r$left
      for (var r$top = r.top; r$top > r.bottom; r$top -= 2) {
        i.y = r$top
  ...
  t.prototype.get_bounds_in_stage = function () {
    ...
    var t$height = t.height
    var o = {
      left: r.a(-t$width / 2, t$width / 2, e.min_x - 5),
      right: r.a(-t$width / 2, t$width / 2, e.max_x + 5),
      top: r.a(-t$height / 2, t$height / 2, e.min_y - 5),
      bottom: r.a(-t$height / 2, t$height / 2, e.max_y + 5)
    }
    return {
      x: Math.round(o.left),
      y: Math.round(o.top),
