...
var s = function (e) {
  ...
  t.prototype.set_anchors = function (e, t, n) {
    ...
    var u = null === (s = null === (o = null === (this$uniforms$filterGlobals = this.uniforms.filterGlobals) || undefined === this$uniforms$filterGlobals ? undefined : this$uniforms$filterGlobals.uniforms) || undefined === o ? undefined : o.outputFrame) || undefined === s ? undefined : s.clone()
    ...
    for (var f = 0; f < this.triangle_top_points.length; f++) {
      var d = a(this.triangle_top_points[f], 3)
      var h = d[0]
      var p = d[1]
      var _ = d[2]
      this.uniforms.triangles[6 * f] = Math.floor(e[h][1].x)
      this.uniforms.triangles[6 * f + 1] = Math.floor(e[h][1].y)
      ...
      var A = new i([[e[h][1], e[h][0]], [e[p][1], e[p][0]], [e[_][1], e[_][0]]])
