...
function m(e, t, n, i) {
  ...
  for (var o, s, c, u, l, f = [], d = -1, h = r.SKIP, p = 0, _ = e.length, A = 3; A < _; A++) {
    if (e[A] >>> 24 > 0) {
      d = A;
      break;
    }
  ...
  function m(e, t) {
    ...
    return 6 === i ? h === r.MOVE_UP ? r.MOVE_LEFT : r.MOVE_RIGHT : 9 === i ? h === r.MOVE_RIGHT ? r.MOVE_UP : r.MOVE_DOWN : 1 === (n = i) || 5 === n || 13 === n ? r.MOVE_UP : 8 === n || 10 === n || 11 === n ? r.MOVE_DOWN : 4 === n || 12 === n || 14 === n ? r.MOVE_LEFT : 2 === n || 3 === n || 7 === n ? r.MOVE_RIGHT : r.SKIP;
  }
  return f;
}
function y(e, t, n) {
  ...
  e.prototype.get_internal_actor = function (e, t) {
    ...
    try {
      for (var l = N(u), f = l.next(); !f.done; f = l.next()) {
        var d = f.value;
        if (c.m(d) && s(d)) {
          var h = d.get_actor_container().children;
          try {
            for (i = undefined, p = N(h), _ = p.next(), undefined; !_.done; _ = p.next()) {
              var p;
              var _;
              var g = _.value;
              if (c.k(g) && g.id === e) {
...
var J = function () {
  ...
  e.prototype.create_tween = function (e) {
    ...
    var c = (null === (t = e.to_options) || undefined === t ? undefined : t.ease) || P.QUAD;
    var u = e.to_options;
...
var ke = function () {
  ...
  e.prototype.set_enabled = function (e) {
    ...
    if (e && !this.particle_group) {
      ...
      this.init({
        x: xe.o(n.x),
        y: xe.o(n.y)
      }, null === (t = this.actor.current_style) || undefined === t ? undefined : t.texture_id);
  ...
  e.prototype.set_rotation = function (e) {
    if (this.particle_group) {
      for (var t = e - this.get_rotation(), n = this.get_position(), r = this.particle_group.m_firstIndex; r < this.particle_group.m_lastIndex; r++) {
        var i = c.p(this.particle_system.m_positionBuffer.data[r], n, t);
      ...
      if (n) {
        ...
        if (!i.length) {
          for (var l = 0; l < this.particle_system.GetTriadCount(); l++) {
            ...
            var h = f.indexB;
            var p = f.indexC;
            if (this.particle_group.ContainsParticle(d) && this.particle_group.ContainsParticle(h) && this.particle_group.ContainsParticle(p)) {
              i.push([d - u, p - u, h - u]);
            }
          }
        }
  ...
  e.prototype.apply_force = function (e) {
    var t;
    if (!(null === (t = this.particle_group) || undefined === t)) {
      t.ApplyForce(e);
    }
  };
  e.prototype.generate_position_data = function (t) {
    ...
    if (i && r) {
      ...
      for (var F = _.length, R = e.get_max_anchors() - m, P = Math.floor(d.length / R), N = new Set(); A.size < e.get_max_anchors();) {
...
var Pe = function () {
      ...
      return Fe(this, function (l) {
        switch (l.label) {
          ...
          case 3:
            ...
            c |= s.e_shapeBit;
            c |= s.e_particleBit;
            if (!(null === (t = this.debug_draw) || undefined === t)) {
              t.SetFlags(c);
            }
            this.draw_handler = function (e) {
              ...
              var n;
              var r;
              if (!(null === (n = null === (t = u.debug_draw) || undefined === t ? undefined : t.m_ctx) || undefined === n)) {
                n.clearRect(0, 0, o.width, o.height);
              }
              if (e) {
                if (!(null === (r = u.latest_world) || undefined === r)) {
                  r.world.DebugDraw();
                }
              }
            };
  ...
  e.prototype.destroy_world = function (e) {
    ...
    if (this.draw_handler && 0 === this.world_list.size) {
      ...
      if (!(null === (t = this.draw_handler) || undefined === t)) {
        t.call(this, 0);
      }
    }
  };
...
var ze = function (e) {
  ...
  t.prototype.update_dialog_style = function () {
    ...
    var c = (null === (t = null === (e = this.actor) || undefined === e ? undefined : e.app) || undefined === t ? undefined : t.get_app().renderer.type) === a.p.CANVAS;
...
var Nt = function (e) {
  function t(t) {
    ...
    for (var l = i / 2, f = 0; f < 2 * u.item_num_per_side; f++) {
      var d = new a.j();
      d.beginFill(c).drawRoundedRect(0, 0, i, u.max_item_height, l).endFill();
      d.position.x = f * n;
      u.addChild(d);
    }
    return u;
...
var Wt = function () {
  ...
  e.prototype.set_state = function (e) {
    var t;
    if (!(null === (t = this.painter) || undefined === t)) {
      t.set_state(e);
    }
    this.state = e;
  };
...
var ir = function (e) {
  function t(t, n, r, i, o, a) {
    ...
    var d = gn.ICON_MARGIN_RIGHT;
    s.icon.position.set(l, c + f);
    s.icon.width = u;
    s.icon.height = u;
    s.icon.visible = true;
    s.icon_area_width = l + u + d;
    return s;
  }
  tr(t, e);
...
var cr = function (e) {
  ...
  t.prototype.update_content = function (e) {
    ...
    var n = e.wrap_width;
    var r = false;
    if (undefined !== t && t !== this.content_string) {
      this.content_string = t.toString();
      r = true;
    }
    if (undefined !== n && n !== this.word_wrap_width) {
...
var fr = function (e) {
  function t(t) {
    ...
    c.order_width = undefined !== s ? s : c.order.width;
  ...
  t.prototype.paint_items = function (e, t) {
    ...
    if (0 !== a) {
      if (a > 0) {
        ...
        for (var u = this.value_idx + o, l = this.value_idx + this.available_item_num, f = t.slice(u, l), d = u; d < l; d++) {
          var h = f[d - u];
...
var yr = function (e) {
  ...
  t.prototype.destroy = function () {
    ...
    if (!(null === (t = this.prefix) || undefined === t)) {
      t.destroy(n);
    }
    e.prototype.destroy.call(this, {
      children: true
...
var Rr = function (e) {
  ...
  t.prototype.draw_content = function (e, t, n, r, i) {
    ...
    var d = (u - this.STATIC_HEIGHT) / 2 - f;
    s.position.y = r + f;
    s.text = n;
    s.style.wordWrapWidth = l;
    var h = Math.min(s.height, d);
    if (s.height > d && e === hr.translation) {
  ...
  t.prototype.show = function (e, t, n, r) {
    ...
    var o = e.src;
    var a = e.dst;
    var s = this.draw_content(hr.origin, t, o, this.TEXT_TITLE_PADDING, i);
    var c = s + this.DIALOG_PADDING + this.FROM_TO_MARGIN / 2;
    this.draw_separate_line(c, i);
    var u = this.draw_content(hr.translation, n, a, c + this.DIALOG_PADDING, i);
...
var Mr = function (e) {
  ...
  t.prototype.turn_off = function () {
    ...
    if (this.camera_status !== Le.d.TURN_OFF) {
      ...
      if (!(null === (e = this.stream) || undefined === e)) {
...
var Gr = function (e) {
  ...
  t.prototype.get_target_actor = function () {
    var e;
    return null === (e = this.target) || undefined === e ? undefined : e.id;
  };
  t.prototype.destroy = function () {
    if (c.l(this.target)) {
...
var Yr = function () {
  ...
  e.prototype.remove_scene_container_parent_scene_listener = function () {
    ...
    if (c.m(e) && this.on_parent_scene_destroy) {
