...
var /* [auto-meaningful-name] */require_1160_$_1160_index$Stream = require(/* 1160 */"./1160/index").Stream
...
var /* [auto-meaningful-name] */require_402_$_402_index$codes$ERR_METHOD_NOT_IMPLEMENTED = require_402_$_402_index$codes.ERR_METHOD_NOT_IMPLEMENTED
var /* [auto-meaningful-name] */require_402_$_402_index$codes$ERR_MULTIPLE_CALLBACK = require_402_$_402_index$codes.ERR_MULTIPLE_CALLBACK
var /* [auto-meaningful-name] */require_402_$_402_index$codes$ERR_STREAM_CANNOT_PIPE = require_402_$_402_index$codes.ERR_STREAM_CANNOT_PIPE
var /* [auto-meaningful-name] */require_402_$_402_index$codes$ERR_STREAM_DESTROYED = require_402_$_402_index$codes.ERR_STREAM_DESTROYED
var /* [auto-meaningful-name] */require_402_$_402_index$codes$ERR_STREAM_ALREADY_FINISHED = require_402_$_402_index$codes.ERR_STREAM_ALREADY_FINISHED
...
var /* [auto-meaningful-name] */require_402_$_402_index$codes$ERR_STREAM_WRITE_AFTER_END = require_402_$_402_index$codes.ERR_STREAM_WRITE_AFTER_END
var /* [auto-meaningful-name] */require_402_$_402_index$codes$ERR_UNKNOWN_ENCODING = require_402_$_402_index$codes.ERR_UNKNOWN_ENCODING
var /* [auto-meaningful-name] */g$errorOrDestroy = g.errorOrDestroy
function R() {}
i$ObjectSetPrototypeOf(M.prototype, require_1160_$_1160_index$Stream.prototype)
i$ObjectSetPrototypeOf(M, require_1160_$_1160_index$Stream)
...
function M(e) {
  ...
  require_1160_$_1160_index$Stream.call(this, e)
...
function L(e, t, n, i) {
  ...
  if ("function" === typeof n) {
    ...
    if (n) {
      if ("buffer" !== n && !require_333_$_333_index$Buffer.isEncoding(n)) {
        throw new require_402_$_402_index$codes$ERR_UNKNOWN_ENCODING(n)
      }
    } else {
      n = e$_writableState.defaultEncoding
    }
  ...
  if (!e$_writableState.objectMode) {
    if ("string" === typeof t) {
      ...
      if (!require_1160_$_1160_index$Stream._isUint8Array(t)) {
        throw new require_402_$_402_index$codes$ERR_INVALID_ARG_TYPE("chunk", ["string", "Buffer", "Uint8Array"], t)
      }
      t = require_1160_$_1160_index$Stream._uint8ArrayToBuffer(t)
      n = "buffer"
    }
  }
  if (e$_writableState.ending) {
    o = new require_402_$_402_index$codes$ERR_STREAM_WRITE_AFTER_END()
  } else {
    if (e$_writableState.destroyed) {
      o = new require_402_$_402_index$codes$ERR_STREAM_DESTROYED("write")
    }
  }
...
function j(e, t, n, r, i, o, a) {
  ...
  t.sync = true
  if (t.destroyed) {
    t.onwrite(new require_402_$_402_index$codes$ERR_STREAM_DESTROYED("write"))
  } else {
    if (n) {
...
function H(e, t) {
  ...
  if ("function" === typeof e$_writableState$writecb) {
    ...
    g$errorOrDestroy(e, new require_402_$_402_index$codes$ERR_MULTIPLE_CALLBACK())
  }
}
function V(e) {
...
function z(e) {
  if (!e.writing) {
    for (var /* [auto-meaningful-name] */e$bufferedIndex = e.bufferedIndex; e$bufferedIndex < e.buffered.length; ++e$bufferedIndex) {
      ...
      e.length -= a
      r$callback(null !== (e$errored = e.errored) && undefined !== e$errored ? e$errored : new require_402_$_402_index$codes$ERR_STREAM_DESTROYED("write"))
    }
    for (var s = e[F].splice(0), c = 0; c < s.length; c++) {
      var /* [auto-meaningful-name] */e$errored1
      s[c](null !== (e$errored1 = e.errored) && undefined !== e$errored1 ? e$errored1 : new require_402_$_402_index$codes$ERR_STREAM_DESTROYED("end"))
    }
    N(e)
  }
}
  ...
  if (!(t.prefinished || t.finalCalled)) {
    if ("function" !== typeof e._final || t.destroyed) {
      ...
      (function (e, t) {
        ...
        function i(i) {
          if (n) {
            g$errorOrDestroy(e, null !== i && undefined !== i ? i : require_402_$_402_index$codes$ERR_MULTIPLE_CALLBACK())
...
M.prototype.pipe = function () {
  g$errorOrDestroy(this, new require_402_$_402_index$codes$ERR_STREAM_CANNOT_PIPE())
}
...
M.prototype.setDefaultEncoding = function (e) {
  ...
  if (!require_333_$_333_index$Buffer.isEncoding(e)) {
    throw new require_402_$_402_index$codes$ERR_UNKNOWN_ENCODING(e)
  }
...
M.prototype._write = function (e, t, n) {
  if (!this._writev) {
    throw new require_402_$_402_index$codes$ERR_METHOD_NOT_IMPLEMENTED("_write()")
  }
  this._writev([
    {
      chunk: e,
  ...
  if (!i) {
    if (this$_writableState.errored || this$_writableState.ending) {
      if (this$_writableState.finished) {
        i = new require_402_$_402_index$codes$ERR_STREAM_ALREADY_FINISHED("end")
      } else {
        if (this$_writableState.destroyed) {
          i = new require_402_$_402_index$codes$ERR_STREAM_DESTROYED("end")
        }
      }
    } else {
...
M.prototype[require_983_$_1160_983$EventEmitter.captureRejectionSymbol] = function (e) {
  this.destroy(e)
}
