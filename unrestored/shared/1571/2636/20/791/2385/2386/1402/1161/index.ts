...
function z(e) {
  if (!e.writing) {
    ...
    for (var s = e[F].splice(0), c = 0; c < s.length; c++) {
      ...
      s[c](null !== (e$errored1 = e.errored) && undefined !== e$errored1 ? e$errored1 : new require$$_402$codes$ERR_STREAM_DESTROYED("end"))
    }
    N(e)
  }
}
...
M.prototype[require$_983$EventEmitter.captureRejectionSymbol] = function (e) {
  this.destroy(e)
}
