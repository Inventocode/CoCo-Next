...
var /* [auto-meaningful-name] */require$$_427_index$normalizeEncoding = require("../427/index").normalizeEncoding
var /* [auto-meaningful-name] */require$$_427_index$types = require("../427/index").types
var /* [auto-meaningful-name] */require$$_427_index$types$isAsyncFunction = require$$_427_index$types.isAsyncFunction
var /* [auto-meaningful-name] */require$$_427_index$types$isArrayBufferView = require$$_427_index$types.isArrayBufferView
var B = {}
var D = /^[0-7]+$/
...
var V = v$hideStackFrames(function (e) {
  ...
  if (!require$$_427_index$types$isArrayBufferView(e)) {
...
var Q = v$hideStackFrames(function (e, t) {
  if ("function" !== typeof e || require$$_427_index$types$isAsyncFunction(e)) {
    throw new v$codes$ERR_INVALID_ARG_TYPE(t, "Function", e)
  }
})
...
module.exports = {
  ...
  validateEncoding: function (e, t) {
    var n = require$$_427_index$normalizeEncoding(t)
