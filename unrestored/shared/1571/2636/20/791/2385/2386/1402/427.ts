...
var _ = globalThis.AbortSignal || require("./1159/857").AbortSignal
var A = globalThis.AbortController || require("./1159/857").AbortController
...
module.exports = {
  ...
  addAbortListener: require("./1160/983").addAbortListener || function (e, t) {
    if (undefined === e) {
