...
var /* [auto-meaningful-name] */require$_311_index$Symbol = require("./311/index").Symbol
var u = require("./583")
...
var p = require$_311_index$Symbol("kDestroy")
var _ = require$_311_index$Symbol("kConstruct")
function A(e, t, n) {
  if (e) {
    e.stack
    if (t && !t.errored) {
