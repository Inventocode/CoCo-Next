...
var /* [auto-meaningful-name] */require$$_1410_311$Symbol = require("../1410/311").Symbol
...
var p = require$$_1410_311$Symbol("kDestroy")
var _ = require$$_1410_311$Symbol("kConstruct")
function A(e, t, n) {
  if (e) {
    e.stack
    if (t && !t.errored) {
