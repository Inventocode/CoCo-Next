...
var /* [auto-meaningful-name] */require$$_427$normalizeEncoding = require("../427").normalizeEncoding
var /* [auto-meaningful-name] */require$$_427$types = require("../427").types
var /* [auto-meaningful-name] */require$$_427$types$isAsyncFunction = require$$_427$types.isAsyncFunction
var /* [auto-meaningful-name] */require$$_427$types$isArrayBufferView = require$$_427$types.isArrayBufferView
var B = {}
var D = /^[0-7]+$/
...
var V = v$hideStackFrames(function (e) {
  ...
  if (!require$$_427$types$isArrayBufferView(e)) {
...
var Q = v$hideStackFrames(function (e, t) {
  if ("function" !== typeof e || require$$_427$types$isAsyncFunction(e)) {
    throw new v$codes$ERR_INVALID_ARG_TYPE(t, "Function", e)
  }
})
...
module.exports = {
  ...
  validateEncoding: function (e, t) {
    var n = require$$_427$normalizeEncoding(t)
