...
var r
var /* [auto-meaningful-name] */require$$_1410_311$SymbolDispose = require("../1410/311").SymbolDispose
...
module.exports.addAbortSignalNoValidate = function (e, t) {
  ...
  if (e.aborted) {
    ...
    var s = (r = r || require("./427").addAbortListener)(e, o)
    d(t, s[require$$_1410_311$SymbolDispose])
  }
  return t
}
