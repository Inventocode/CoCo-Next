...
var /* [auto-meaningful-name] */require$_1402_1159_index$pipelineImpl = require("./1402/1159/index").pipelineImpl
...
module.exports = {
  ...
  pipeline: function () {
    ...
    return new r$Promise(function (e, n) {
      ...
      require$_1402_1159_index$pipelineImpl(t, function (t, r) {
        if (t) {
          n(t)
        } else {
          e(r)
