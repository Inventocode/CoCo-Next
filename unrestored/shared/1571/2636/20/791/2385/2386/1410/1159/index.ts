...
var m = require("../650")
var /* [auto-meaningful-name] */require$$_$$_1402_427_index$once = require("../../1402/427/index").once
var b = require("../../1402/769")
var w = require("../../1402/584/index")
var E = require("../../1402/402")
...
var z = globalThis.AbortController || require("../../1402/427/857").AbortController
function Q(e, t, n) {
  var r = false
  e.on("close", function () {
    r = true
...
function Z(e, t, r) {
  ...
  d = d || require("../../1402/427/index").addAbortListener
  if (u) {
    i = d(u, p)
  }
  var A
...
module.exports = {
  ...
  pipeline: function () {
    ...
    return Z(t, require$$_$$_1402_427_index$once(W(t)))
  }
}
