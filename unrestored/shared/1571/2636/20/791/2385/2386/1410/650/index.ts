...
function j(e, t, o) {
  ...
  if (t.signal && !z) {
    ...
    if (t.signal.aborted) {
      ...
      var q = (r = r || require("../../1402/427/index").addAbortListener)(t.signal, Y)
      var $ = o
      o = l$once(function () {
        q[v$SymbolDispose]()
...
function U(e, t, o) {
  ...
  if (t.signal) {
    ...
    if (t.signal.aborted) {
      ...
      var u = (r = r || require("../../1402/427/index").addAbortListener)(t.signal, c)
      var l = o
      o = l$once(function () {
        u[v$SymbolDispose]()
        for (var /* [auto-meaningful-name] */arguments$length = arguments.length, n = new Array(arguments$length), r = 0; r < arguments$length; r++) {
