...
module.exports = {
  ...
  isNotClosingBraceToken: R(Q),
  isNotClosingBracketToken: R(G),
  isNotClosingParenToken: R(H),
  isNotColonToken: R(j),
  isNotCommaToken: R(N),
  isNotDotToken: R(M),
  isNotOpeningBraceToken: R(z),
  isNotOpeningBracketToken: R(V),
  isNotOpeningParenToken: R(U),
  isNotSemicolonToken: R(L),
