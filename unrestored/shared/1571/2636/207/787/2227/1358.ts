...
var s = require("../180")
var c = require("../204")
var /* [auto-meaningful-name] */require$_2233_1130_index$Syntax = require("./2233/1130/index").Syntax
var l = require("./1131")
var f = require("./978")
var /* [auto-meaningful-name] */require$_2233_1359$Definition = require("./2233/1359").Definition
...
var _ = function () {
  function e(t, n, r, i, o) {
    ...
    this.isStrict = function (e, t, n, r) {
      ...
      if ("function" === e.type) {
        if (t.type === require$_2233_1130_index$Syntax.ArrowFunctionExpression && t.body.type !== require$_2233_1130_index$Syntax.BlockStatement) {
          return false
        }
        if (!(i = t.type === require$_2233_1130_index$Syntax.Program ? t : t.body)) {
          return false
        }
      } else {
        if ("global" !== e.type) {
      ...
      if (r) {
        for (var o = 0, /* [auto-meaningful-name] */i$body$length = i.body.length; o < i$body$length; ++o) {
          var s = i.body[o]
          if (s.type !== require$_2233_1130_index$Syntax.DirectiveStatement) {
            break
          }
        ...
        for (var c = 0, /* [auto-meaningful-name] */_i$body$length = i.body.length; c < _i$body$length; ++c) {
          ...
          if (f$expression.type !== require$_2233_1130_index$Syntax.Literal || "string" !== typeof f$expression.value) {
            break
          }
  ...
  c(e, [
    {
      ...
      key: "__define",
      value: function (e, t) {
        if (e && e.type === require$_2233_1130_index$Syntax.Identifier) {
      ...
      value: function (e, t, n, r, i, o) {
        if (e && e.type === require$_2233_1130_index$Syntax.Identifier && "super" !== e.name) {
      ...
      value: function (e) {
        ...
        for (h(this.__isClosed(), "Scope should be closed."), h(e.type === require$_2233_1130_index$Syntax.Identifier, "Target should be identifier."), n = 0, this$references$length = this.references.length; n < this$references$length; ++n) {
  ...
  c(n, [
    {
      ...
      value: function (e) {
        ...
        for (var c = 0, /* [auto-meaningful-name] */t$length = t.length; c < t$length; ++c) {
          var l = t[c]
          this.__defineImplicit(l.pattern, new require$_2233_1359$Definition(f.ImplicitGlobalVariable, l.pattern, l.node, null, null, null))
        }
...
var v = function (e) {
  ...
  function n(e, r, i) {
    var o
    s(this, n);
    (o = t.call(this, e, "function-expression-name", r, i, false)).__define(i.id, new require$_2233_1359$Definition(f.FunctionName, i.id, i, null, null, null))
...
var E = function (e) {
  ...
  function n(e, r, i, o) {
    var a
    s(this, n)
    if ((a = t.call(this, e, "function", r, i, o)).block.type !== require$_2233_1130_index$Syntax.ArrowFunctionExpression) {
      a.__defineArguments()
    }
    return a
  }
  c(n, [
    {
      key: "isArgumentsMaterialized",
      value: function () {
        if (this.block.type === require$_2233_1130_index$Syntax.ArrowFunctionExpression) {
          return false
        }
        if (!this.isStatic()) {
          return true
