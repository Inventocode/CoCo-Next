...
var N = function (e) {
  ...
  function n(e) {
    ...
    r.updateScrollLocker = function (e) {
      ...
      if (r$props$visible && r$props$visible !== E$visible && R && P(r$props$getContainer) !== r.scrollLocker.getContainer()) {
    ...
    r.updateOpenCount = function (e) {
      ...
      var /* [auto-meaningful-name] */r$props$visible = r$props.visible
      var /* [auto-meaningful-name] */r$props$getContainer = r$props.getContainer
      if (r$props$visible !== t$visible && R && P(r$props$getContainer) === document.body) {
    ...
    r.getContainer = function () {
      return R ? (r.container || (r.container = document.createElement("div"), r.attachToParent(true)), r.setWrapperClassName(), r.container) : null
    }
  ...
  $$_106.a(n, [
    {
      ...
      value: function () {
        ...
        if (R && P(this$props$getContainer) === document.body) {
