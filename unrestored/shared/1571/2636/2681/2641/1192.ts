...
import * as /* [auto-meaningful-name] */Module_252 from /* 252 */"../1481/252"
  ...
  for (var t = {}, n = 0, i = e; n < i.length; n++) {
    ...
    switch (o.stem) {
      ...
      case "compact-long":
        ...
        continue
      case "scientific":
        t = Module_184.a(Module_184.a(Module_184.a({}, t), {
          notation: "scientific"
        }), o.options.reduce(function (e, t) {
          return Module_184.a(Module_184.a({}, e), f(t))
        }, {}))
        continue
      case "engineering":
        t = Module_184.a(Module_184.a(Module_184.a({}, t), {
    ...
    if (s.test(o.stem)) {
      ...
      if (o.options.length) {
        t = Module_184.a(Module_184.a({}, t), u(o.options[0]))
      }
    } else if (c.test(o.stem)) {
      t = Module_184.a(Module_184.a({}, t), u(o.stem))
    } else {
      var a = l(o.stem)
      if (a) {
        t = Module_184.a(Module_184.a({}, t), a)
      }
    }
  }
  return t
...
var p = function (e, t) {
  ...
  var I = function (e, t, n) {
    return Module_184.a({
      type: "number" === t ? Module_252.a.number : "date" === t ? Module_252.a.date : Module_252.a.time,
      style: n && n[2],
      value: e
    }, at())
  }
  ...
  if (t.normalizeHashtagInPlural) {
    (function e(t) {
      t.forEach(function (t) {
        if (Module_252.h(t) || Module_252.j(t)) {
          Object.keys(t.options).forEach(function (n) {
            for (var /* [auto-meaningful-name] */a$value, a = t.options[n], s = -1, c = undefined, u = 0; u < a.value.length; u++) {
              var l = a.value[u]
              if (Module_252.e(l) && _.test(l.value)) {
                s = u
                c = l
                break
              }
            ...
            if (c) {
              ...
              var d = p(f);
              (a$value = a.value).splice.apply(a$value, Module_184.c([s, 1], d))
            }
            e(a.value)
          })
        }
