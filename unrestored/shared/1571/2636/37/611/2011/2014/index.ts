...
var r = require("./849")
var i = require("./2015")
var /* [auto-meaningful-name] */require$_1332$ArraySet = require("./1332").ArraySet
var a = require("./1331/index")
var /* [auto-meaningful-name] */require$_2016$quickSort = require("./2016").quickSort
function c(e, t) {
  var n = e
  if ("string" === typeof e) {
...
function u(e, t) {
  ...
  this._names = require$_1332$ArraySet.fromArray(s.map(String), true)
  this._sources = require$_1332$ArraySet.fromArray(a, true)
...
function f(e, t) {
  ...
  this._sources = new require$_1332$ArraySet()
  this._names = new require$_1332$ArraySet()
  var s = {
    line: -1,
    column: 0
  }
...
c.prototype.eachMapping = function (e, t, n) {
  ...
  i.map(function (e) {
    ...
    return {
      source: t = r.computeSourceURL(this$sourceRoot, t, this._sourceMapURL),
...
u.fromSourceMap = function (e, t) {
  ...
  var i = n._names = require$_1332$ArraySet.fromArray(e._names.toArray(), true)
  var a = n._sources = require$_1332$ArraySet.fromArray(e._sources.toArray(), true)
  ...
  require$_2016$quickSort(n.__originalMappings, r.compareByOriginalPositions)
  return n
}
...
u.prototype._parseMappings = function (e, t) {
  for (var n, i, o, c, /* [auto-meaningful-name] */y$value, f = 1, d = 0, h = 0, p = 0, _ = 0, A = 0, /* [auto-meaningful-name] */e$length = e.length, v = 0, m = {}, y = {}, b = [], w = []; v < e$length;) {
    if (";" === e.charAt(v)) {
      ...
      for ((n = new l()).generatedLine = f, c = v; c < e$length && !this._charIsMappingSeparator(e, c); c++) {
        ;
      }
  ...
  require$_2016$quickSort(w, r.compareByGeneratedPositionsDeflated)
  this.__generatedMappings = w
  require$_2016$quickSort(b, r.compareByOriginalPositions)
...
f.prototype._parseMappings = function (e, t) {
  ...
  require$_2016$quickSort(this.__generatedMappings, r.compareByGeneratedPositionsDeflated)
  require$_2016$quickSort(this.__originalMappings, r.compareByOriginalPositions)
}
