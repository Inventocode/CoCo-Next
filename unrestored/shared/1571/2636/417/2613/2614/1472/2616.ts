...
var /* [auto-meaningful-name] */o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED
if (!o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.hasOwnProperty("ReactCurrentDispatcher")) {
  o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher = {
    current: null
  }
}
if (!o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.hasOwnProperty("ReactCurrentBatchConfig")) {
  o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentBatchConfig = {
    suspense: null
  }
}
var C = {}
...
for (var S = new Uint16Array(16), A = 0; 15 > A; A++) {
  S[A] = A + 1
}
S[15] = 0
...
var R = {}
function k(e) {
  return !!Object$prototype$hasOwnProperty.call(R, e) || !Object$prototype$hasOwnProperty.call(N, e) && (I.test(e) ? R[e] = true : (N[e] = true, false))
}
...
function $(e, t, n) {
  ...
  H = Q()
  if (V) {
    var /* [auto-meaningful-name] */H$queue = H.queue
    t = H$queue.dispatch
    if (null !== Y && undefined !== (n = Y.get(H$queue))) {
      Y.delete(H$queue)
      H$queue = H.memoizedState
      do {
        H$queue = e(H$queue, n.action)
        n = n.next
      } while (null !== n)
      H.memoizedState = H$queue
      return [H$queue, t]
    }
...
var re = {
  ...
  useMemo: function (e, t) {
    ...
    if (null !== (H = Q())) {
      var /* [auto-meaningful-name] */H$memoizedState = H.memoizedState
      if (null !== H$memoizedState && null !== t) {
        e: {
          var r = H$memoizedState[1]
          if (null === r) {
            r = false
          } else {
  ...
  useRef: function (e) {
    W = q()
    var /* [auto-meaningful-name] */HQ$memoizedState = (H = Q()).memoizedState
    return null === HQ$memoizedState ? (e = {
      current: e
    }, H.memoizedState = e) : HQ$memoizedState
  },
  useState: function (e) {
    return $(J, e)
  },
...
var ue = /([A-Z])/g
var de = /^ms-/
var /* [auto-meaningful-name] */o$Children$toArray = o.Children.toArray
var /* [auto-meaningful-name] */o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$ReactCurrentDispatcher = o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher
var he = {
  listing: true,
  pre: true,
  textarea: true
...
function Ee(e, t, n) {
  function a(o, a) {
    ...
    } else if (W = {}, s = a(o.props, c, d), null == (s = Z(a, o.props, s, c)) || null == s.render) {
...
var Oe = function () {
  function e(e, t) {
    if (o.isValidElement(e)) {
      if (e.type !== c) {
        ...
        e = e.props.children
        e = o.isValidElement(e) ? [e] : o$Children$toArray(e)
      }
    } else {
      e = o$Children$toArray(e)
    }
    e = {
      type: null,
      domNamespace: Http__www$w3$org_1999_xhtml,
      children: e,
      childIndex: 0,
      context: C,
      footer: ""
  ...
  e$prototype.destroy = function () {
    if (!this.exhausted) {
      this.exhausted = true
      this.clearProviders()
      var /* [auto-meaningful-name] */this$threadID = this.threadID
      S[this$threadID] = S[0]
      S[0] = this$threadID
    }
  }
  e$prototype.pushProvider = function (e) {
    ...
    var /* [auto-meaningful-name] */e$type$_context = e.type._context
    var /* [auto-meaningful-name] */this$threadID = this.threadID
    T(e$type$_context, this$threadID)
    var o = e$type$_context[this$threadID]
    this.contextStack[t] = e$type$_context
    this.contextValueStack[t] = o
    e$type$_context[this$threadID] = e.props.value
  }
  e$prototype.popProvider = function () {
    var /* [auto-meaningful-name] */this$contextIndex = this.contextIndex
    var t = this.contextStack[this$contextIndex]
    var n = this.contextValueStack[this$contextIndex]
    this.contextStack[this$contextIndex] = null
    this.contextValueStack[this$contextIndex] = null
    this.contextIndex--
    t[this.threadID] = n
  }
  e$prototype.clearProviders = function () {
    for (var /* [auto-meaningful-name] */this$contextIndex = this.contextIndex; 0 <= this$contextIndex; this$contextIndex--) {
      this.contextStack[this$contextIndex][this.threadID] = this.contextValueStack[this$contextIndex]
    }
  }
  e$prototype.read = function (e) {
    ...
    var t = ne
    ne = this.threadID
    var /* [auto-meaningful-name] */o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$ReactCurrentDispatcher$current = o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$ReactCurrentDispatcher.current
    o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$ReactCurrentDispatcher.current = re
    try {
      for (var r = [""], o = false; r[0].length < e;) {
        ...
        if (o || s.childIndex >= s.children.length) {
          var /* [auto-meaningful-name] */s$footer = s.footer
          if ("" !== s$footer) {
            this.previousWasTextNode = false
          }
          this.stack.pop()
          if ("select" === s.type) {
            ...
            if (o) {
              o = false
              var /* [auto-meaningful-name] */s$fallbackFrame = s.fallbackFrame
              if (!s$fallbackFrame) {
                throw Error(i(303))
              }
              this.stack.push(s$fallbackFrame)
              r[this.suspenseDepth] += "<!--$!-->"
              continue
            }
            r[this.suspenseDepth] += l
          }
          r[this.suspenseDepth] += s$footer
        } else {
      ...
      o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$ReactCurrentDispatcher.current = o$__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$ReactCurrentDispatcher$current
      ne = t
    }
  }
  e$prototype.render = function (e, t, n) {
    ...
    switch (e$type) {
      ...
      case g:
      case c:
        e = o$Children$toArray(e.props.children)
        this.stack.push({
          type: null,
          domNamespace: n,
          children: e,
    ...
    if ("object" === typeof e$type && null !== e$type) {
      switch (e$type.$$typeof) {
        case h:
          W = {}
          var b = e$type.render(e.props, e.ref)
          b = Z(e$type.render, e.props, b, e.ref)
          b = o$Children$toArray(b)
          this.stack.push({
            type: null,
            domNamespace: n,
            children: b,
        ...
        case d:
          n = {
            type: e,
            domNamespace: n,
            children: e$type = o$Children$toArray(e.props.children),
            childIndex: 0,
            context: t,
            footer: ""
          }
        ...
        case p:
          ...
          b = e.props
          var /* [auto-meaningful-name] */this$threadID = this.threadID
          T(e$type, this$threadID)
          e$type = o$Children$toArray(b.children(e$type[this$threadID]))
          this.stack.push({
            type: e,
            domNamespace: n,
            children: e$type,
        ...
        case v:
          ...
          }(e$type = e.type), e$type._status) {
            case 1:
              e = [
                o.createElement(e$type._result, r({
                  ref: e.ref
                }, e.props))
              ]
              this.stack.push({
    ...
    throw Error(i(130, null == e$type ? e$type : typeof e$type, ""))
  }
  e$prototype.renderDOM = function (e, t, n) {
    var a = e.type.toLowerCase()
    if (n === Http__www$w3$org_1999_xhtml) {
      ie(a)
    }
    ...
    if ("input" === a) {
      e$props = r({
        ...
        value: null != e$props.value ? e$props.value : e$props.defaultValue,
        checked: null != e$props.checked ? e$props.checked : e$props.defaultChecked
      })
    } else if ("textarea" === a) {
      var /* [auto-meaningful-name] */e$props$value = e$props.value
      if (null == e$props$value) {
        e$props$value = e$props.defaultValue
        var /* [auto-meaningful-name] */e$props$children = e$props.children
        if (null != e$props$children) {
          if (null != e$props$value) {
            throw Error(i(92))
          }
          if (Array.isArray(e$props$children)) {
            if (!(1 >= e$props$children.length)) {
              throw Error(i(93))
            }
            e$props$children = e$props$children[0]
          }
          e$props$value = "" + e$props$children
        }
        if (null == e$props$value) {
          e$props$value = ""
        }
      ...
      this.currentSelectValue = null != e$props.value ? e$props.value : e$props.defaultValue
      e$props = r({}, e$props, {
        value: undefined
      })
    } else if ("option" === a) {
      e$props$children = this.currentSelectValue
      var u = function (e) {
      ...
      if (null != e$props$children) {
        var d = null != e$props.value ? e$props.value + "" : u
        e$props$value = false
        if (Array.isArray(e$props$children)) {
          for (var p = 0; p < e$props$children.length; p++) {
            if ("" + e$props$children[p] === d) {
              e$props$value = true
              break
            }
          }
        } else {
          e$props$value = "" + e$props$children === d
        }
        e$props = r({
          selected: undefined,
          children: undefined
    ...
    if (e$props$value = e$props) {
      if (se[a] && (null != e$props$value.children || null != e$props$value.dangerouslySetInnerHTML)) {
        throw Error(i(137, a, ""))
      }
      if (null != e$props$value.dangerouslySetInnerHTML) {
        if (null != e$props$value.children) {
          throw Error(i(60))
        }
        if ("object" !== typeof e$props$value.dangerouslySetInnerHTML || !("__html" in e$props$value.dangerouslySetInnerHTML)) {
          throw Error(i(61))
        }
      }
      if (null != e$props$value.style && "object" !== typeof e$props$value.style) {
        throw Error(i(62, ""))
      }
    }
    for (y in e$props$value = e$props, e$props$children = this.makeStaticMarkup, u = 1 === this.stack.length, d = "<" + e.type, e$props$value) if (_Object$prototype$hasOwnProperty.call(e$props$value, y)) {
      var f = e$props$value[y]
      if (null != f) {
        if ("style" === y) {
          p = undefined
          var h = ""
        ...
        p = null
        e: if (g = a, _ = e$props$value, -1 === g.indexOf("-")) {
    ...
    if (ae.hasOwnProperty(a)) {
      ...
      y += ">"
      e$props$value = "</" + e.type + ">"
    }
    e: {
      if (null != (e$props$children = e$props.dangerouslySetInnerHTML)) {
        if (null != e$props$children.__html) {
          e$props$children = e$props$children.__html
          break e
        }
      } else if ("string" === typeof (e$props$children = e$props.children) || "number" === typeof e$props$children) {
        e$props$children = B(e$props$children)
        break e
      }
    ...
    if (null != e$props$children) {
      e$props = []
      if (he.hasOwnProperty(a) && "\n" === e$props$children.charAt(0)) {
        y += "\n"
      }
      y += e$props$children
    } else {
      e$props = o$Children$toArray(e$props.children)
    }
    e = e.type
