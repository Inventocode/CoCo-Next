...
import * as p from "./53"
import * as f from "./9"
import * as /* [auto-meaningful-name] */$$_$$_$$_$$_src_shared_tools_url from "../../../../src/shared/tools/url"
function m(e, t) {
...
function y(e) {
  ...
  return t.includes(w(e.name)) ? new Promise(function (t) {
    ...
    n.src = $$_$$_$$_$$_src_shared_tools_url.A(e)
    n.onload = function () {
      t(true)
    }
    n.onerror = function () {
...
function O() {
  return (O = s.a(RegeneratorRuntime1.mark(function e(t, n, r) {
    var o
    var i
    var s
    var c
        ...
        switch (e.prev = e.next) {
          case 0:
            ...
            s = {
              status: "fail",
              file: t,
              message: $$_$$_$$_$$_src_shared_ui_language.c(n, "illegalFormat").toString()
            }
            c = {
              status: "success",
              file: t,
          ...
          case 11:
            if (".gif" === o) {
              if (Number(t.size) > 10 * i) {
                c.status = "fail"
                c.message = $$_$$_$$_$$_src_shared_ui_language.c(n, "tooLargeGifImage").toString()
              }
            } else {
              if (Number(t.size) > 5 * i) {
                c.status = "fail"
                c.message = $$_$$_$$_$$_src_shared_ui_language.c(n, "tooLargeImage").toString()
              }
            }
            if (!t.name.slice(0, t.name.lastIndexOf(".")).trim()) {
              c.status = "fail"
              c.message = $$_$$_$$_$$_src_shared_ui_language.c(n, "imageNameError").toString()
            }
...
function T() {
  return (T = s.a(RegeneratorRuntime1.mark(function e(t) {
    var n
    return RegeneratorRuntime1.wrap(function (e) {
      for (;;) {
        switch (e.prev = e.next) {
          case 0:
            ...
            (n = document.createElement("audio")).src = $$_$$_$$_$$_src_shared_tools_url.A(t)
...
function A() {
  return (A = s.a(RegeneratorRuntime1.mark(function e(t, n) {
    var r
    var o
    var i
    return RegeneratorRuntime1.wrap(function (e) {
        ...
        switch (e.prev = e.next) {
          ...
          case 8:
            if (Number(t.size) > 10 * r) {
              i.status = "fail"
              i.message = $$_$$_$$_$$_src_shared_ui_language.c(n, "tooLargeSound").toString()
            }
            if (!t.name.slice(0, t.name.lastIndexOf(".")).trim()) {
              i.status = "fail"
              i.message = $$_$$_$$_$$_src_shared_ui_language.c(n, "soundNameError").toString()
            }
...
function j() {
  return (j = s.a(RegeneratorRuntime1.mark(function e(t) {
    var n
    return RegeneratorRuntime1.wrap(function (e) {
      for (;;) {
        switch (e.prev = e.next) {
...
function D() {
  return (D = s.a(RegeneratorRuntime1.mark(function e(t, n, o, i) {
    var c
    return RegeneratorRuntime1.wrap(function (e) {
      for (;;) {
        switch (e.prev = e.next) {
          case 0:
            ...
            return new Promise(function (e, u) {
              ...
              if (c.includes(t.type)) {
                v.onload = s.a(RegeneratorRuntime1.mark(function t() {
...
var M = function () {
  var e = s.a(RegeneratorRuntime1.mark(function e(t) {
    var n
    return RegeneratorRuntime1.wrap(function (e) {
      for (;;) {
        switch (e.prev = e.next) {
          case 0:
            ...
            return new Promise(function (e, r) {
              ...
              if (n.includes(t.type)) {
                o.onload = s.a(RegeneratorRuntime1.mark(function t() {
...
function B() {
  return (B = s.a(RegeneratorRuntime1.mark(function e(t, n) {
    return RegeneratorRuntime1.wrap(function (e) {
      for (;;) {
        switch (e.prev = e.next) {
          case 0:
