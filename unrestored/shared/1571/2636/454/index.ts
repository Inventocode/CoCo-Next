...
import * as s from "../7"
import * as /* [auto-meaningful-name] */$_280_index from "./280/index"
import /* [auto-meaningful-name] */_$_280_index from "./280/index"
...
function A() {
  return (A = s.a(_RegeneratorRuntime.mark(function e(t, n) {
    var r
    var o
    var i
    return _RegeneratorRuntime.wrap(function (e) {
                      ...
                      switch (t.prev = t.next) {
                        case 0:
                          if ((v$result = v.result) && "string" !== typeof v$result) {
                            for (r = _$_280_index.read(v$result, {
                              type: "array"
                            }), o = r.Sheets[r.SheetNames[0]], i = _$_280_index.utils.decode_range(o["!ref"] || ""), s = i.s.r; s <= i.e.r; ++s) {
                              for (c = i.s.c; c <= i.e.c; ++c) {
                                u = {
                                  c: c,
                                  r: s
                                }
                                d = _$_280_index.utils.encode_cell(u)
                                if ((p = o[d]) && p.h) {
                                  p.w = undefined
                                  p.v = p.h
                                }
                            ...
                            f = _$_280_index.utils.sheet_to_json(o, {
                              header: 1
                            })
                            h = L(f, _)
                            e(h)
                      ...
                      switch (t.prev = t.next) {
                        case 0:
                          if ((o$result = o.result) && "string" !== typeof o$result) {
                            for (i = _$_280_index.read(o$result, {
                              type: "array"
                            }), s = i.Sheets[i.SheetNames[0]], c = _$_280_index.utils.decode_range(s["!ref"] || ""), u = c.s.r; u <= c.e.r; ++u) {
                              for (d = c.s.c; d <= c.e.c; ++d) {
                                p = {
                                  c: d,
                                  r: u
                                }
                                f = _$_280_index.utils.encode_cell(p)
                            ...
                            m = _$_280_index.utils.sheet_to_json(s, {
                              header: 1
                            })
                            g = L(m, "test", true)
                            e(g)
