...
var f = function (e) {
  ...
  t$prototype.performEnter = function (e) {
    ...
    var i = this.props.nodeRef ? [r] : [ReactDom.findDOMNode(this), r]
    var o = i[0]
    var a = i[1]
  ...
  t$prototype.performExit = function () {
    ...
    var r = this.props.nodeRef ? undefined : ReactDom.findDOMNode(this)
  ...
  t$prototype.onTransitionEnd = function (e, t) {
    ...
    var n = this.props.nodeRef ? this.props.nodeRef.current : ReactDom.findDOMNode(this)
