...
import * as /* [auto-meaningful-name] */$$_$$_1543_491 from "../../1543/491"
import * as /* [auto-meaningful-name] */ResizeObserverPolyfill from "resize-observer-polyfill"
import * as /* [auto-meaningful-name] */$$_$$_1543_561 from "../../1543/561"
function he(e, t) {
  var n = null
  var r = null
...
var Ae = React.forwardRef(function (e, t) {
  ...
  var v = function (e, t) {
    ...
    if (!g$current$disabled && g$current$target) {
      ...
      (function (e, t) {
        if (e !== document.activeElement && $$_$$_1543_561.a(t, e) && "function" === typeof e.focus) {
          e.focus()
        }
  ...
  React.useEffect(function () {
    if (e$monitorWindowResize) {
      if (!x.current) {
        x.current = $$_$$_1543_491.a(window, "resize", y)
      }
    } else {
      if (x.current) {
        x.current.remove()
