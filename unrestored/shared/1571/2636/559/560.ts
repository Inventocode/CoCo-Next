...
function d(e, t) {
  ...
  var I = React.createElement(E, Module_19.a({
  ...
  if (e$responsive) {
    I = React.createElement(Module_800.a, {
      onResize: function (e) {
        C(e.offsetWidth)
      }
    }, I)
...
var y = function (e, t) {
  ...
  if (!n) {
    ...
    return React.createElement(i, Module_19.a({}, c, {
      ref: t
    }))
  }
...
function T(e, t) {
  ...
  var ke = e$renderRawItem ? function (e, t) {
    ...
    var n = we(e, t)
    return React.createElement(f, Module_19.a({}, Re, {
      order: t,
      key: n,
      item: e,
      renderItem: Ce,
  ...
  if (e$renderRawRest) {
    ...
    Ne = React.createElement(f, Module_19.a({}, Re, xe), "function" === typeof De ? De(Oe) : De)
  }
  var Me = React.createElement(N, Module_19.a({
    className: Classnames1(!be && c, e$className),
    style: e$style,
    ref: t
  }, x), Ee.map(ke), ye ? Ne : null, e$suffix && React.createElement(f, Module_19.a({}, Re, {
    order: de,
  ...
  if (ve) {
    Me = React.createElement(Module_800.a, {
