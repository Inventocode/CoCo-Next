...
import * as /* [auto-meaningful-name] */$_744_926 from "./744/926"
var p = function () {
  function e(e, t, n) {
  ...
  e.prototype.get_cached_bounds_points_vertices = function () {
    ...
    if (this.cached_bounds_points_vertices.value) {
      ...
      if ($_744_926.a(t, this.cached_bounds_points_vertices.dependencies)) {
  ...
  e.prototype.get_cached_internal_points_vertices = function () {
    ...
    if (this.cached_internal_points_vertices.value) {
      var t = this.get_state_dependencies()
      if ($_744_926.a(t, this.cached_internal_points_vertices.dependencies)) {
...
var v = function (e) {
  function t(t) {
    ...
    n.drag_end = function (e) {
      ...
      if (!(e && $_744_index.a(e.type, ["touchendoutside", "mouseupoutside"])) && t - n.mouse_down_time < 1e3) {
  ...
  t.prototype.color_match_texture_points = function (e, t, n) {
    ...
    for (var d = c.i(n), h = undefined, p = 0; p < t.length; p++) {
      var _ = c.c(t[p])
      var A = c.q(_, this)
      var g = c.t(new $_32_index.o(A.x - e.x, A.y - e.y))
    ...
    if (this.pixel_detector.check_relation_by_vertices(e, "collision")) {
      ...
      if (t) {
        ...
        if (n) {
          ...
          var d = []
          if (this.pixel_detector.contains_edge(n, $$_105.b.RIGHT)) {
            l = -Math.abs(l)
            d.push($$_105.b.RIGHT)
          }
          if (this.pixel_detector.contains_edge(n, $$_105.b.LEFT)) {
            l = Math.abs(l)
            d.push($$_105.b.LEFT)
          }
          if (this.pixel_detector.contains_edge(n, $$_105.b.TOP)) {
            f = -Math.abs(f)
            d.push($$_105.b.TOP)
          }
          if (this.pixel_detector.contains_edge(n, $$_105.b.BOTTOM)) {
            f = Math.abs(f)
            d.push($$_105.b.BOTTOM)
          }
