...
!function (n) {
  !function (r) {
    var i = "object" === typeof global ? global : "object" === typeof self ? self : "object" === typeof this ? this : Function("return this;")()
    var o = a(n)
    function a(e, t) {
      return function (n, r) {
    ...
    (function (t) {
      ...
      var f = "object" === typeof process && Object({
        NODE_ENV: "production",
        PUBLIC_URL: "",
      ...
      var d = f || "function" !== typeof Map || "function" !== typeof Map.prototype.entries ? function () {
        ...
        var n = function () {
          ...
          e.prototype.next = function () {
            var /* [auto-meaningful-name] */this$_index = this._index
            if (this$_index >= 0 && this$_index < this._keys.length) {
              var n = this._selector(this._keys[this$_index], this._values[this$_index])
        ...
        return function () {
          ...
          t.prototype.delete = function (t) {
            ...
            if (n >= 0) {
              for (var /* [auto-meaningful-name] */this$_keys$length = this._keys.length, i = n + 1; i < this$_keys$length; i++) {
      ...
      function x(e, t) {
        ...
        return function (e, t) {
          if ("string" === t) {
            var /* [auto-meaningful-name] */e$toString = e.toString
            if (k(e$toString)) {
              if (!E(i = e$toString.call(e))) {
                return i
              }
            }
            if (k(r = e.valueOf)) {
      ...
      function I(e) {
        ...
        var r = e$prototype && Object.getPrototypeOf(e$prototype)
        if (null == r || r === Object.prototype) {
          return t
        }
        var /* [auto-meaningful-name] */r$constructor = r.constructor
        return "function" !== typeof r$constructor || r$constructor === e ? t : r$constructor
      }
      function R(e) {
        e.__ = undefined
        delete e.__
