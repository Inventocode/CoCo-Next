...
var l = function () {
  var e = (0, React.useContext(g).getPrefixCls)("empty-img-simple")
  return React.createElement("svg", {
    className: e,
    width: "64",
    height: "41",
...
var p = function (e) {
  ...
  return React.createElement($_694_index.a, {
    componentName: "Empty"
  }, function (e) {
    var a
    var c = v$getPrefixCls("empty", e$prefixCls)
    var f = "undefined" !== typeof e$description ? e$description : e.description
    var d = "string" === typeof f ? f : "empty"
    var g = null
    g = "string" === typeof u ? React.createElement("img", {
      alt: d,
      src: u
    }) : u
    return React.createElement("div", $$_19.a({
      ...
      style: e$imageStyle
    }, g), f && React.createElement("div", {
      className: "".concat(c, "-description")
    }, f), e$children && React.createElement("div", {
      className: "".concat(c, "-footer")
    }, e$children))
  })
}
p.PRESENTED_IMAGE_DEFAULT = d
p.PRESENTED_IMAGE_SIMPLE = h
var _ = p
var A = function (e) {
  return React.createElement(g$Consumer, null, function (t) {
    ...
    switch (e) {
      ...
      default:
        return React.createElement(_, null)
    }
  })
}
var g = React.createContext({
